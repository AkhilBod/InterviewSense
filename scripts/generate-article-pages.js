...
async function generateArticlePages() {
  ...
  for (const articleFile of articleFiles) {
    try {
      ...
      console.error(`❌ Error processing ${articleFile}:`, error.message);
      errorCount++;
    }
  }
...
async function generateIndividualPage(article) {
...
function generatePageTemplate(article) {
...
async function generateIndexPage(totalArticles) {
...
async function generateArticlesSitemap(articleFiles) {
