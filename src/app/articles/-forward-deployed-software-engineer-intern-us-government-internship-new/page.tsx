...
// Article metadata
const articleData = {
  slug: "-forward-deployed-software-engineer-intern-us-government-internship-new",
  title: "↳ Forward Deployed Software Engineer Intern, US Government 🇺🇸 Interview Questions",
  metaDescription: "Ace your ↳ Forward Deployed Software Engineer Intern, US Government 🇺🇸 interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  ...
  "description": "Ace your ↳ Forward Deployed Software Engineer Intern, US Government 🇺🇸 interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-forward-deployed-software-engineer-intern-us-government-internship-new"
},
  openGraph: {
  "title": "↳ Forward Deployed Software Engineer Intern, US Government 🇺🇸 Interview Questions",
  "description": "Ace your ↳ Forward Deployed Software Engineer Intern, US Government 🇺🇸 interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-forward-deployed-software-engineer-intern-us-government-internship-new", outputDir);
