...
// Article metadata
const articleData = {
  slug: "-product-manager-intern-tiktok-shop-ipr-product-internship-seattle",
  title: "↳ Product Manager Intern, TikTok Shop IPR Product Interview Questions",
  metaDescription: "Ace your ↳ Product Manager Intern, TikTok Shop IPR Product interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
  keywords: ["↳ interview", "Product Manager Intern, TikTok Shop IPR Product interview questions", "↳ internship", "interview practice", "AI interview prep", "↳ Product Manager Intern, TikTok Shop IPR Product", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.225Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "↳ Product Manager Intern, TikTok Shop IPR Product Interview Questions",
  "description": "Ace your ↳ Product Manager Intern, TikTok Shop IPR Product interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-product-manager-intern-tiktok-shop-ipr-product-internship-seattle"
},
  openGraph: {
  "title": "↳ Product Manager Intern, TikTok Shop IPR Product Interview Questions",
  "description": "Ace your ↳ Product Manager Intern, TikTok Shop IPR Product interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-product-manager-intern-tiktok-shop-ipr-product-internship-seattle", outputDir);
