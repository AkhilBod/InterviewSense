...
// Article metadata
const articleData = {
  slug: "-software-engineer-intern-backend-pms-internship-new",
  title: "↳ Software Engineer Intern, Backend, PMS Interview Questions",
  metaDescription: "Ace your ↳ Software Engineer Intern, Backend, PMS interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  keywords: ["↳ interview", "Software Engineer Intern, Backend, PMS interview questions", "↳ internship", "interview practice", "AI interview prep", "↳ Software Engineer Intern, Backend, PMS", "Java interview questions"],
  lastUpdated: "2025-08-05T22:46:29.221Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "↳ Software Engineer Intern, Backend, PMS Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern, Backend, PMS interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-software-engineer-intern-backend-pms-internship-new"
},
  openGraph: {
  "title": "↳ Software Engineer Intern, Backend, PMS Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern, Backend, PMS interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-software-engineer-intern-backend-pms-internship-new", outputDir);
