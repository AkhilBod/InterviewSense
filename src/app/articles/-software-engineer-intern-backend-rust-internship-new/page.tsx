...
// Article metadata
const articleData = {
  slug: "-software-engineer-intern-backend-rust-internship-new",
  title: "↳ Software Engineer Intern (Backend, Rust) Interview Questions",
  metaDescription: "Ace your ↳ Software Engineer Intern (Backend, Rust) interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
  keywords: ["↳ interview", "Software Engineer Intern (Backend, Rust) interview questions", "↳ internship", "interview practice", "AI interview prep", "↳ Software Engineer Intern (Backend, Rust)", "Java interview questions"],
  lastUpdated: "2025-08-05T22:46:29.234Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "↳ Software Engineer Intern (Backend, Rust) Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern (Backend, Rust) interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-software-engineer-intern-backend-rust-internship-new"
},
  openGraph: {
  "title": "↳ Software Engineer Intern (Backend, Rust) Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern (Backend, Rust) interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-software-engineer-intern-backend-rust-internship-new", outputDir);
