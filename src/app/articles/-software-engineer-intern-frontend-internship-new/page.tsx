...
// Article metadata
const articleData = {
  slug: "-software-engineer-intern-frontend-internship-new",
  title: "↳ Software Engineer Intern, Frontend Interview Questions",
  metaDescription: "Ace your ↳ Software Engineer Intern, Frontend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  keywords: ["↳ interview", "Software Engineer Intern, Frontend interview questions", "↳ internship", "interview practice", "AI interview prep", "↳ Software Engineer Intern, Frontend", "JavaScript interview questions"],
  lastUpdated: "2025-08-05T22:46:29.223Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "↳ Software Engineer Intern, Frontend Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern, Frontend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-software-engineer-intern-frontend-internship-new"
},
  openGraph: {
  "title": "↳ Software Engineer Intern, Frontend Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern, Frontend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-software-engineer-intern-frontend-internship-new", outputDir);
