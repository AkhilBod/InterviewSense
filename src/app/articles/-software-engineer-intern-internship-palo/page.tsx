...
// Article metadata
const articleData = {
  slug: "-software-engineer-intern-internship-palo",
  title: "↳ Software Engineer Intern Interview Questions",
  metaDescription: "Ace your ↳ Software Engineer Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA internship.",
  ...
  "description": "Ace your ↳ Software Engineer Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/-software-engineer-intern-internship-palo"
},
  openGraph: {
  "title": "↳ Software Engineer Intern Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-software-engineer-intern-internship-palo", outputDir);
