...
// Article metadata
const articleData = {
  slug: "-software-engineer-intern-tiktokintelligent-creation-generative-ai-and-graphics-internship-san",
  title: "↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) Interview Questions",
  metaDescription: "Ace your ↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) interview with AI-powered practice questions and feedback. Get ready for your San Jose, CA internship.",
  keywords: ["↳ interview", "Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) interview questions", "↳ internship", "interview practice", "AI interview prep", "↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics)", "Python interview questions"],
  lastUpdated: "2025-08-05T22:46:29.192Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) interview with AI-powered practice questions and feedback. Get ready for your San Jose, CA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "datePublished": "2025-08-05T22:46:29.192Z",
  "url": "https://interviewsense.org/opportunities/-software-engineer-intern-tiktokintelligent-creation-generative-ai-and-graphics-internship-san"
},
  openGraph: {
  "title": "↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) Interview Questions",
  "description": "Ace your ↳ Software Engineer Intern (TikTok-Intelligent Creation - Generative AI and Graphics) interview with AI-powered practice questions and feedback. Get ready for your San Jose, CA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("-software-engineer-intern-tiktokintelligent-creation-generative-ai-and-graphics-internship-san", outputDir);
