...
const articleData = {
  ...
  metaDescription: "Apply now for the 7-Eleven Machine Learning Engineer Intern internship in Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("7eleven-machine-learning-engineer-intern-internship-irving", outputDir);
