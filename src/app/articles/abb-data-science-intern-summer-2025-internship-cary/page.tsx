...
const articleData = {
  ...
  metaDescription: "Apply now for the ABB Data Science Intern- Summer 2025 internship in Cary, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("abb-data-science-intern-summer-2025-internship-cary", outputDir);
