...
const articleData = {
  ...
  metaDescription: "Apply now for the ABB IT Intern - Spring & Summer 2025 internship in Fort Smith, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("abb-it-intern-spring-summer-2025-internship-fort-smith", outputDir);
