...
const articleData = {
  ...
  metaDescription: "Apply now for the Accenture Center for Advanced AI – Applied Research Scientist Graduate Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("accenture-center-for-advanced-ai-applied-research-scientist-graduate-intern-inte", outputDir);
