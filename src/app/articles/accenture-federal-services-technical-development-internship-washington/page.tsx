...
const articleData = {
  ...
  metaDescription: "Apply now for the Accenture Federal Services Technical Development internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("accenture-federal-services-technical-development-internship-washington", outputDir);
