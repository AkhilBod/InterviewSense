...
const articleData = {
  ...
  metaDescription: "Apply now for the Activision-Blizzard 2025 Summer Internships - AI Engineering - Infinity Ward internship in Canoga Park, LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("activisionblizzard-2025-summer-internships-ai-engineering-infinity-ward-internsh", outputDir);
