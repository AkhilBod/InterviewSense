...
const articleData = {
  ...
  metaDescription: "Apply now for the Activision-Blizzard Machine Learning Security Intern internship in Sherman Oaks, LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("activisionblizzard-machine-learning-security-intern-internship-sherman-oaks", outputDir);
