...
const articleData = {
  ...
  metaDescription: "Apply now for the Activision-Blizzard Software Development Co-op internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("activisionblizzard-software-development-coop-internship-vancouver", outputDir);
