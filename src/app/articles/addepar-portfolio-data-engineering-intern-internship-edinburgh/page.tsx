...
const articleData = {
  ...
  metaDescription: "Apply now for the Addepar Portfolio Data Engineering Intern internship in Edinburgh, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("addepar-portfolio-data-engineering-intern-internship-edinburgh", outputDir);
