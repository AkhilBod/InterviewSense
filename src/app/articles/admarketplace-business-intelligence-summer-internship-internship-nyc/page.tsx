...
const articleData = {
  ...
  metaDescription: "Apply now for the adMarketplace Business Intelligence Summer Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("admarketplace-business-intelligence-summer-internship-internship-nyc", outputDir);
