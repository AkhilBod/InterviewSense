...
const articleData = {
  ...
  metaDescription: "Apply now for the Adobe 2025 Intern - Data Scientist internship in SF</br>San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("adobe-2025-intern-data-scientist-internship-sfbrsan-jose", outputDir);
