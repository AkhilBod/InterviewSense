...
const articleData = {
  ...
  metaDescription: "Apply now for the Adobe 2025 Intern - Software Engineer internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("adobe-2025-intern-software-engineer-internship-nyc", outputDir);
