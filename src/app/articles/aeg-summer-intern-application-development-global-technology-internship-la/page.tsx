...
const articleData = {
  ...
  metaDescription: "Apply now for the AEG Summer Intern - Application Development - Global Technology internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aeg-summer-intern-application-development-global-technology-internship-la", outputDir);
