...
const articleData = {
  ...
  metaDescription: "Apply now for the AES Advanced Analytics and Visualization Intern internship in Lafayette, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aes-advanced-analytics-and-visualization-intern-internship-lafayette", outputDir);
