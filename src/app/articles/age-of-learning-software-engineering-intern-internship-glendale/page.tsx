...
const articleData = {
  ...
  metaDescription: "Apply now for the Age of Learning Software Engineering Intern internship in Glendale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("age-of-learning-software-engineering-intern-internship-glendale", outputDir);
