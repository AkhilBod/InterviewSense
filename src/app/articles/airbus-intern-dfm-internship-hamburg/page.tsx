...
const articleData = {
  ...
  metaDescription: "Apply now for the Airbus Intern – d/f/m internship in Hamburg, Germany. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("airbus-intern-dfm-internship-hamburg", outputDir);
