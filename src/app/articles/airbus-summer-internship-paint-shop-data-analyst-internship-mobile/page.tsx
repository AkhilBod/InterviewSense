...
const articleData = {
  ...
  metaDescription: "Apply now for the Airbus Summer Internship - Paint Shop Data Analyst internship in Mobile, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("airbus-summer-internship-paint-shop-data-analyst-internship-mobile", outputDir);
