...
const articleData = {
  ...
  metaDescription: "Apply now for the Airbus Summer Internship - Project Data Analyst internship in Mobile, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("airbus-summer-internship-project-data-analyst-internship-mobile", outputDir);
