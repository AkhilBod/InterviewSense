...
const articleData = {
  ...
  metaDescription: "Apply now for the Akima EMG STEM Summer Internship - IT/ SOFTWARE / Engineering internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("akima-emg-stem-summer-internship-it-software-engineering-internship-reston", outputDir);
