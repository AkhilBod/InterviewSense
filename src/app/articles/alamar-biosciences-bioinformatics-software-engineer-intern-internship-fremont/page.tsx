...
const articleData = {
  ...
  metaDescription: "Apply now for the Alamar Biosciences Bioinformatics Software Engineer Intern internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alamar-biosciences-bioinformatics-software-engineer-intern-internship-fremont", outputDir);
