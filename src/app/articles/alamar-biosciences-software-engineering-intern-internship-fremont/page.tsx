...
const articleData = {
  ...
  metaDescription: "Apply now for the Alamar Biosciences Software Engineering Intern internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alamar-biosciences-software-engineering-intern-internship-fremont", outputDir);
