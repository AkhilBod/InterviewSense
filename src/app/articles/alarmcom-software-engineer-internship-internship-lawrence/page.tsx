...
const articleData = {
  ...
  metaDescription: "Apply now for the Alarm.com Software Engineer Internship internship in Lawrence, KS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alarmcom-software-engineer-internship-internship-lawrence", outputDir);
