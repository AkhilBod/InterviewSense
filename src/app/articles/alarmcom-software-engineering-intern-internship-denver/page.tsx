...
const articleData = {
  ...
  metaDescription: "Apply now for the Alarm.com Software Engineering Intern internship in Denver, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alarmcom-software-engineering-intern-internship-denver", outputDir);
