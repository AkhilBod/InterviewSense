...
const articleData = {
  ...
  metaDescription: "Apply now for the Alcon Summer 2025 Intern - Fiber Engineering internship in Lake Forest, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alcon-summer-2025-intern-fiber-engineering-internship-lake-forest", outputDir);
