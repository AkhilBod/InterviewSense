...
const articleData = {
  ...
  metaDescription: "Apply now for the Alice L. Walton School of Medicine Education Data Analyst Intern internship in Bentonville, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alice-l-walton-school-of-medicine-education-data-analyst-intern-internship-bento", outputDir);
