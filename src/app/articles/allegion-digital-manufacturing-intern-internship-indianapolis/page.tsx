...
const articleData = {
  ...
  metaDescription: "Apply now for the Allegion Digital Manufacturing Intern internship in Indianapolis, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("allegion-digital-manufacturing-intern-internship-indianapolis", outputDir);
