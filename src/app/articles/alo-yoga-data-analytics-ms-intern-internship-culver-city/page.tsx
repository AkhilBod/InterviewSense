...
const articleData = {
  ...
  metaDescription: "Apply now for the Alo Yoga Data Analytics MS Intern internship in Culver City, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("alo-yoga-data-analytics-ms-intern-internship-culver-city", outputDir);
