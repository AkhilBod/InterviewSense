...
const articleData = {
  ...
  metaDescription: "Apply now for the Altamira Technologies Software Development Intern internship in Augusta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("altamira-technologies-software-development-intern-internship-augusta", outputDir);
