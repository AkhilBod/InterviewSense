...
const articleData = {
  ...
  metaDescription: "Apply now for the Altera Software Engineer - Intern internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("altera-software-engineer-intern-internship-toronto", outputDir);
