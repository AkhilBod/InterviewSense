...
// Article metadata
const articleData = {
  slug: "amazon-program-manager-intern-internship-seattle",
  title: "Amazon Program Manager Intern 🛂 Interview Questions",
  metaDescription: "Ace your Amazon Program Manager Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
  keywords: ["Amazon interview", "Program Manager Intern 🛂 interview questions", "Amazon internship", "interview practice", "AI interview prep", "Amazon Program Manager Intern 🛂", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.222Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Amazon Program Manager Intern 🛂 Interview Questions",
  "description": "Ace your Amazon Program Manager Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/amazon-program-manager-intern-internship-seattle"
},
  openGraph: {
  "title": "Amazon Program Manager Intern 🛂 Interview Questions",
  "description": "Ace your Amazon Program Manager Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Seattle, WA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("amazon-program-manager-intern-internship-seattle", outputDir);
