...
const articleData = {
  ...
  metaDescription: "Apply now for the AMD Software Engineering Intern/Co-Op (Undergrad internship in Summer, 2025. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("amdsoftware-engineering-interncoop-undergradinternshipsummer-2025", outputDir);
