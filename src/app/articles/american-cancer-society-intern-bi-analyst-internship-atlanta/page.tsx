...
const articleData = {
  ...
  metaDescription: "Apply now for the American Cancer Society Intern – BI Analyst internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-cancer-society-intern-bi-analyst-internship-atlanta", outputDir);
