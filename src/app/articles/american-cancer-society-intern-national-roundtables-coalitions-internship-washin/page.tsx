...
const articleData = {
  ...
  metaDescription: "Apply now for the American Cancer Society Intern – National Roundtables & Coalitions internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-cancer-society-intern-national-roundtables-coalitions-internship-washin", outputDir);
