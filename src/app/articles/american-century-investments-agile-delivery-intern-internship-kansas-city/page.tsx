...
const articleData = {
  ...
  metaDescription: "Apply now for the American Century Investments Agile Delivery Intern internship in Kansas City, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-century-investments-agile-delivery-intern-internship-kansas-city", outputDir);
