...
const articleData = {
  ...
  metaDescription: "Apply now for the American Century Investments Data Scientist Intern internship in Santa Clara, CA</br>Kansas City, MO</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-century-investments-data-scientist-intern-internship-santa-clara", outputDir);
