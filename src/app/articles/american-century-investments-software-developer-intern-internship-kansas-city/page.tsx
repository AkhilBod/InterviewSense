...
const articleData = {
  ...
  metaDescription: "Apply now for the American Century Investments Software Developer Intern internship in Kansas City, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-century-investments-software-developer-intern-internship-kansas-city", outputDir);
