...
const articleData = {
  ...
  metaDescription: "Apply now for the American Electric Power Tech & Security Intern internship in Columbus, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-electric-power-tech-security-intern-internship-columbus", outputDir);
