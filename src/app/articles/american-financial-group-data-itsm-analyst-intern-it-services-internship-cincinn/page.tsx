...
const articleData = {
  ...
  metaDescription: "Apply now for the American Financial Group Data ITSM Analyst Intern - IT Services internship in Cincinnati, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-financial-group-data-itsm-analyst-intern-it-services-internship-cincinn", outputDir);
