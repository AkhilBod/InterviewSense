...
const articleData = {
  ...
  metaDescription: "Apply now for the American Financial Group IT Data Intern internship in Cincinnati, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-financial-group-it-data-intern-internship-cincinnati", outputDir);
