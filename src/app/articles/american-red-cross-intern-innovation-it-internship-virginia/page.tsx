...
const articleData = {
  ...
  metaDescription: "Apply now for the American Red Cross Intern – Innovation - IT internship in Virginia. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("american-red-cross-intern-innovation-it-internship-virginia", outputDir);
