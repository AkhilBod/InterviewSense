...
const articleData = {
  ...
  metaDescription: "Apply now for the America's Electric Cooperatives Web Interface Development Intern internship in Arlington, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("americas-electric-cooperatives-web-interface-development-intern-internship-arlin", outputDir);
