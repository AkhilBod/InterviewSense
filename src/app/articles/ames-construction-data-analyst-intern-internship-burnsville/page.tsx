...
const articleData = {
  ...
  metaDescription: "Apply now for the Ames Construction Data Analyst Intern internship in Burnsville, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ames-construction-data-analyst-intern-internship-burnsville", outputDir);
