...
const articleData = {
  ...
  metaDescription: "Apply now for the Amp Robotics Robotics Software Intern internship in Lafayette, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("amp-robotics-robotics-software-intern-internship-lafayette", outputDir);
