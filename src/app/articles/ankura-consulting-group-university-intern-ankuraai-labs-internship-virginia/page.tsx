...
const articleData = {
  ...
  metaDescription: "Apply now for the Ankura Consulting Group University Intern - Ankura.AI Labs internship in Virginia. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ankura-consulting-group-university-intern-ankuraai-labs-internship-virginia", outputDir);
