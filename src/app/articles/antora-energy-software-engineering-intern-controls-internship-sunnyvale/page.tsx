...
const articleData = {
  ...
  metaDescription: "Apply now for the Antora Energy Software Engineering Intern - Controls internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("antora-energy-software-engineering-intern-controls-internship-sunnyvale", outputDir);
