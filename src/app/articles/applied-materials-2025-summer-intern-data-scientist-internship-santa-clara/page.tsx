...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials 2025 Summer Intern - Data Scientist internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-2025-summer-intern-data-scientist-internship-santa-clara", outputDir);
