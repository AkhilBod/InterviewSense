...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Corporate Strategy Intern - Data Science internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-corporate-strategy-intern-data-science-internship-santa-clara", outputDir);
