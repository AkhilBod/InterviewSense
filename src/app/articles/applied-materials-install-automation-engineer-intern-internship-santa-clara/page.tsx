...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Install Automation Engineer Intern internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-install-automation-engineer-intern-internship-santa-clara", outputDir);
