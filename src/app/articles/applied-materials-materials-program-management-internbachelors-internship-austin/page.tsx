...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Materials Program Management Intern-Bachelor's internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-materials-program-management-internbachelors-internship-austin", outputDir);
