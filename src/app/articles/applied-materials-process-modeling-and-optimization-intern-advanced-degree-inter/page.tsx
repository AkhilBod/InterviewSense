...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Process Modeling and Optimization Intern - Advanced Degree internship in Boise, ID. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-process-modeling-and-optimization-intern-advanced-degree-inter", outputDir);
