...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Summer 2025 Data Analyst Intern internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-summer-2025-data-analyst-intern-internship-santa-clara", outputDir);
