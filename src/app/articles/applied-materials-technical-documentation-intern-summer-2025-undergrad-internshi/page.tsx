...
const articleData = {
  ...
  metaDescription: "Apply now for the Applied Materials Technical Documentation Intern - Summer 2025 - Undergrad internship in California</br>Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applied-materials-technical-documentation-intern-summer-2025-undergrad-internshi", outputDir);
