...
const articleData = {
  ...
  metaDescription: "Apply now for the ApplyBoard Software Engineer Co-Op internship in Kitchener, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("applyboard-software-engineer-coop-internship-kitchener", outputDir);
