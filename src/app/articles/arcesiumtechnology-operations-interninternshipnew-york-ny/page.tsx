...
const articleData = {
  ...
  metaDescription: "Apply now for the Arcesium Technology Operations Intern internship in New York, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arcesiumtechnology-operations-interninternshipnew-york-ny", outputDir);
