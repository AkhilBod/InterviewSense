...
const articleData = {
  ...
  metaDescription: "Apply now for the Archer Full Stack Application Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("archer-full-stack-application-intern-internship-san-jose", outputDir);
