...
const articleData = {
  ...
  metaDescription: "Apply now for the Arevon Data Management Intern internship in Scottsdale, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arevon-data-management-intern-internship-scottsdale", outputDir);
