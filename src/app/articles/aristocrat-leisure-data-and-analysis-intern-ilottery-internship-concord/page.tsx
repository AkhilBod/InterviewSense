...
const articleData = {
  ...
  metaDescription: "Apply now for the Aristocrat Leisure Data and Analysis Intern - Ilottery internship in Concord, NH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aristocrat-leisure-data-and-analysis-intern-ilottery-internship-concord", outputDir);
