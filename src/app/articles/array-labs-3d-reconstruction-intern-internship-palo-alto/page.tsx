...
const articleData = {
  ...
  metaDescription: "Apply now for the Array Labs 3D Reconstruction Intern internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("array-labs-3d-reconstruction-intern-internship-palo-alto", outputDir);
