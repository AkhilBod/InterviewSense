...
const articleData = {
  ...
  metaDescription: "Apply now for the Arrowstreet Capital Frameworks Software Engineer Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arrowstreet-capital-frameworks-software-engineer-intern-internship-boston", outputDir);
