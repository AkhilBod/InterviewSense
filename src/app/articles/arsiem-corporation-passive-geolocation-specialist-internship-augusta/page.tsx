...
const articleData = {
  ...
  metaDescription: "Apply now for the Arsiem Corporation Passive Geolocation Specialist internship in Augusta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arsiem-corporation-passive-geolocation-specialist-internship-augusta", outputDir);
