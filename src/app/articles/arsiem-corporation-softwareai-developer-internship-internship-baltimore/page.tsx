...
const articleData = {
  ...
  metaDescription: "Apply now for the Arsiem Corporation Software/AI Developer – Internship internship in Baltimore, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arsiem-corporation-softwareai-developer-internship-internship-baltimore", outputDir);
