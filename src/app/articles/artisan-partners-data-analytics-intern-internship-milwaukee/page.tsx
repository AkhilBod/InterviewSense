...
const articleData = {
  ...
  metaDescription: "Apply now for the Artisan Partners Data Analytics Intern internship in Milwaukee, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("artisan-partners-data-analytics-intern-internship-milwaukee", outputDir);
