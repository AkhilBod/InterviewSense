...
const articleData = {
  ...
  metaDescription: "Apply now for the Artisan Partners Trading Summer Intern - Undergraduate internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("artisan-partners-trading-summer-intern-undergraduate-internship-boston", outputDir);
