...
const articleData = {
  ...
  metaDescription: "Apply now for the Arvinas 2025 Summer Internship - Computational Chemistry & Artificial Intelligence internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("arvinas-2025-summer-internship-computational-chemistry-artificial-intelligence-i", outputDir);
