...
const articleData = {
  ...
  metaDescription: "Apply now for the ASML Internship - Data Science and Image Processing internship in Wilton, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("asml-internship-data-science-and-image-processing-internship-wilton", outputDir);
