...
const articleData = {
  ...
  metaDescription: "Apply now for the ASML Internship - Droplet Position Control internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("asml-internship-droplet-position-control-internship-san-diego", outputDir);
