...
const articleData = {
  ...
  metaDescription: "Apply now for the ASML Internship - Full Stack Software Engineer internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("asml-internship-full-stack-software-engineer-internship-san-jose", outputDir);
