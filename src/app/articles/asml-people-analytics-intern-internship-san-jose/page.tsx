...
const articleData = {
  ...
  metaDescription: "Apply now for the ASML People Analytics Intern internship in San Jose, CA</br>Chandler, AZ</br>San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("asml-people-analytics-intern-internship-san-jose", outputDir);
