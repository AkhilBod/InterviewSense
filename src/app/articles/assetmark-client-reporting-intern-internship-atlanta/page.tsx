...
const articleData = {
  ...
  metaDescription: "Apply now for the AssetMark Client Reporting Intern internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("assetmark-client-reporting-intern-internship-atlanta", outputDir);
