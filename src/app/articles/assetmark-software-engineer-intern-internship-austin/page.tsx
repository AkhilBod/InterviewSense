...
const articleData = {
  ...
  metaDescription: "Apply now for the AssetMark Software Engineer Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("assetmark-software-engineer-intern-internship-austin", outputDir);
