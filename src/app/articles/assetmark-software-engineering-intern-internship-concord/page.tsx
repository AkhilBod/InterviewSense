...
const articleData = {
  ...
  metaDescription: "Apply now for the AssetMark Software Engineering Intern internship in Concord, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("assetmark-software-engineering-intern-internship-concord", outputDir);
