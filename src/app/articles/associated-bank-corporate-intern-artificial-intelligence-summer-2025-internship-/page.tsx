...
const articleData = {
  ...
  metaDescription: "Apply now for the Associated Bank Corporate Intern - Artificial Intelligence - Summer 2025 internship in Milwaukee, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("associated-bank-corporate-intern-artificial-intelligence-summer-2025-internship-", outputDir);
