...
const articleData = {
  ...
  metaDescription: "Apply now for the Assurant Data Analytics Intern internship in Lewisville, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("assurant-data-analytics-intern-internship-lewisville", outputDir);
