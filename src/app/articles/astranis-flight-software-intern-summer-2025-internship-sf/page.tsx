...
const articleData = {
  ...
  metaDescription: "Apply now for the Astranis Flight Software Intern - Summer 2025 internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("astranis-flight-software-intern-summer-2025-internship-sf", outputDir);
