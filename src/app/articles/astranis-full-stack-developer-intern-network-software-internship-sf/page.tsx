...
const articleData = {
  ...
  metaDescription: "Apply now for the Astranis Full Stack Developer – Intern - Network Software internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("astranis-full-stack-developer-intern-network-software-internship-sf", outputDir);
