...
const articleData = {
  ...
  metaDescription: "Apply now for the Astranis Ground Software Engineer - Summer 2025 internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("astranis-ground-software-engineer-summer-2025-internship-sf", outputDir);
