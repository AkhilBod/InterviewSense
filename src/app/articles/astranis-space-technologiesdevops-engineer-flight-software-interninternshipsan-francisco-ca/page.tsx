...
const articleData = {
  ...
  metaDescription: "Apply now for the Astranis Space Technologies DevOps Engineer (Flight Software) - Intern internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("astranis-space-technologiesdevops-engineer-flight-software-interninternshipsan-francisco-ca", outputDir);
