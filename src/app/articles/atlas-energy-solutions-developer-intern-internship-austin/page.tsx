...
const articleData = {
  ...
  metaDescription: "Apply now for the Atlas Energy Solutions Developer Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("atlas-energy-solutions-developer-intern-internship-austin", outputDir);
