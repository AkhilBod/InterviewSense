...
const articleData = {
  ...
  metaDescription: "Apply now for the ATLAS SP Summer 2025 Aspire Technology Internship internship in Raleigh, NC</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("atlas-sp-summer-2025-aspire-technology-internship-internship-raleigh", outputDir);
