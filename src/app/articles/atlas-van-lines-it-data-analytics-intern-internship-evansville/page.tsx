...
const articleData = {
  ...
  metaDescription: "Apply now for the Atlas Van Lines IT Data Analytics Intern internship in Evansville, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("atlas-van-lines-it-data-analytics-intern-internship-evansville", outputDir);
