...
const articleData = {
  ...
  metaDescription: "Apply now for the ATPCO Platform Capability Engineering Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("atpco-platform-capability-engineering-intern-internship-reston", outputDir);
