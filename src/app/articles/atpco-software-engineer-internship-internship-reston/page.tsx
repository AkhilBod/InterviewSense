...
const articleData = {
  ...
  metaDescription: "Apply now for the ATPCO Software Engineer Internship internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("atpco-software-engineer-internship-internship-reston", outputDir);
