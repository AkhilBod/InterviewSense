...
const articleData = {
  ...
  metaDescription: "Apply now for the Auctane Marketing Intern - Data Analytics internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("auctane-marketing-intern-data-analytics-internship-austin", outputDir);
