...
const articleData = {
  ...
  metaDescription: "Apply now for the Auto Club Enterprises Information Systems Intern - Classic Team internship in Newport Beach, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("auto-club-enterprises-information-systems-intern-classic-team-internship-newport", outputDir);
