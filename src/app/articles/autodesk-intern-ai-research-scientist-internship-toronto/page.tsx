...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern, AI Research Scientist internship in Toronto, ON, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-ai-research-scientist-internship-toronto", outputDir);
