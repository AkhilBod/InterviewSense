...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Data Analyst internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-data-analyst-internship-remote-in-usa", outputDir);
