...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Full Stack Software Developer internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-full-stack-software-developer-internship-remote-in-canada", outputDir);
