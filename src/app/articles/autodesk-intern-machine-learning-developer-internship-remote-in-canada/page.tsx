...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Machine Learning Developer internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-machine-learning-developer-internship-remote-in-canada", outputDir);
