...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Machine Learning Engineer internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-machine-learning-engineer-internship-sf", outputDir);
