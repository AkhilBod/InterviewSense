...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Research Engineer - Real-Time Simulation & Artificial Intelligence internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-research-engineer-realtime-simulation-artificial-intelligence-in", outputDir);
