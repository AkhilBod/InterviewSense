...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Software Developer internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-software-developer-internship-montreal", outputDir);
