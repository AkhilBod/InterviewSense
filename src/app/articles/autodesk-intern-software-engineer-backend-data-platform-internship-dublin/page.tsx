...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Intern – Software Engineer - Backend - Data Platform internship in Dublin, Ireland. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-intern-software-engineer-backend-data-platform-internship-dublin", outputDir);
