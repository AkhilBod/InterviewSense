...
const articleData = {
  ...
  metaDescription: "Apply now for the Autodesk Stagire en développement logiciels/ Intern - Software Developer internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autodesk-stagire-en-dveloppement-logiciels-intern-software-developer-internship-", outputDir);
