...
const articleData = {
  ...
  metaDescription: "Apply now for the Auto-Owners Insurance Intern – Technical Data Analyst internship in East Lansing, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("autoowners-insurance-intern-technical-data-analyst-internship-east-lansing", outputDir);
