...
const articleData = {
  ...
  metaDescription: "Apply now for the Ava Labs Engineering Internship internship in Brooklyn, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ava-labs-engineering-internship-internship-brooklyn", outputDir);
