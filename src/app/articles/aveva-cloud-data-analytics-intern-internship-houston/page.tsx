...
const articleData = {
  ...
  metaDescription: "Apply now for the AVEVA Cloud Data & Analytics Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aveva-cloud-data-analytics-intern-internship-houston", outputDir);
