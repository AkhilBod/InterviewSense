...
const articleData = {
  ...
  metaDescription: "Apply now for the AVEVA Software Developer Intern internship in Cambridge, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aveva-software-developer-intern-internship-cambridge", outputDir);
