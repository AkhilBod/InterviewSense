...
const articleData = {
  ...
  metaDescription: "Apply now for the Aviva Marketing and Data Analytics Intern - Global Corporate Specialty internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("aviva-marketing-and-data-analytics-intern-global-corporate-specialty-internship-", outputDir);
