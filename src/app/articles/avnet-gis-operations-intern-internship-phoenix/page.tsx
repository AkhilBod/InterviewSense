...
const articleData = {
  ...
  metaDescription: "Apply now for the Avnet GIS Operations Intern internship in Phoenix, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("avnet-gis-operations-intern-internship-phoenix", outputDir);
