...
const articleData = {
  ...
  metaDescription: "Apply now for the Avnet Logistics Analytics Intern internship in Chandler, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("avnet-logistics-analytics-intern-internship-chandler", outputDir);
