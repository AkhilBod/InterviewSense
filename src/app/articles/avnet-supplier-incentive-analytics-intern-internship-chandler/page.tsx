...
const articleData = {
  ...
  metaDescription: "Apply now for the Avnet Supplier Incentive Analytics Intern internship in Chandler, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("avnet-supplier-incentive-analytics-intern-internship-chandler", outputDir);
