...
const articleData = {
  ...
  metaDescription: "Apply now for the Axiom Space Software Application Engineering Intern - Summer 2025 internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("axiom-space-software-application-engineering-intern-summer-2025-internship-houst", outputDir);
