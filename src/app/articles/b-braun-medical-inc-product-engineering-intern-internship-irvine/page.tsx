...
const articleData = {
  ...
  metaDescription: "Apply now for the B. Braun Medical Inc Product Engineering Intern internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("b-braun-medical-inc-product-engineering-intern-internship-irvine", outputDir);
