...
const articleData = {
  ...
  metaDescription: "Apply now for the Badger Meter Software Engineering Intern internship in Los Gatos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("badger-meter-software-engineering-intern-internship-los-gatos", outputDir);
