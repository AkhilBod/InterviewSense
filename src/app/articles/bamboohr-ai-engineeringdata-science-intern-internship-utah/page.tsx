...
const articleData = {
  ...
  metaDescription: "Apply now for the BambooHR AI Engineering/Data Science Intern internship in Utah. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bamboohr-ai-engineeringdata-science-intern-internship-utah", outputDir);
