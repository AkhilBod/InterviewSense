...
const articleData = {
  ...
  metaDescription: "Apply now for the BambooHR Software Developer – Intern internship in Utah. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bamboohr-software-developer-intern-internship-utah", outputDir);
