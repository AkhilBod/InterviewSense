...
const articleData = {
  ...
  metaDescription: "Apply now for the Banco Bilbao Vizcaya Argentaria Trading Summer Internship internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("banco-bilbao-vizcaya-argentaria-trading-summer-internship-internship-london", outputDir);
