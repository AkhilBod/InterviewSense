...
// Article metadata
const articleData = {
  slug: "bank-of-america-analytics-modeling-and-insights-ami-analyst-intern-internship-charlotte",
  title: "Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 Interview Questions",
  metaDescription: "Ace your Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charlotte, NC internship.",
  keywords: ["Bank of America interview", "Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 interview questions", "Bank of America internship", "interview practice", "AI interview prep", "Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂", "Python interview questions"],
  lastUpdated: "2025-08-05T22:46:29.229Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 Interview Questions",
  "description": "Ace your Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charlotte, NC internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "datePublished": "2025-08-05T22:46:29.229Z",
  "url": "https://interviewsense.org/opportunities/bank-of-america-analytics-modeling-and-insights-ami-analyst-intern-internship-charlotte"
},
  openGraph: {
  "title": "Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 Interview Questions",
  "description": "Ace your Bank of America Analytics, Modeling and Insights (AMI) Analyst Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charlotte, NC internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bank-of-america-analytics-modeling-and-insights-ami-analyst-intern-internship-charlotte", outputDir);
