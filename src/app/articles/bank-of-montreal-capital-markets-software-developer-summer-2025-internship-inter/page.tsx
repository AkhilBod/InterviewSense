...
const articleData = {
  ...
  metaDescription: "Apply now for the Bank of Montreal Capital Markets Software Developer Summer 2025 Internship internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bank-of-montreal-capital-markets-software-developer-summer-2025-internship-inter", outputDir);
