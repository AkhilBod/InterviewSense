...
const articleData = {
  ...
  metaDescription: "Apply now for the Bank of Montreal Data Analyst Intern – Co-op/Internship - Business Banking internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bank-of-montreal-data-analyst-intern-coopinternship-business-banking-internship-", outputDir);
