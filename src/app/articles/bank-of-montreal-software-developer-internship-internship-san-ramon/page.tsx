...
const articleData = {
  ...
  metaDescription: "Apply now for the Bank of Montreal Software Developer – Internship internship in San Ramon, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bank-of-montreal-software-developer-internship-internship-san-ramon", outputDir);
