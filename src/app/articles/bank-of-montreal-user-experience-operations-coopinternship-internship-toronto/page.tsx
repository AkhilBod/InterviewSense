...
const articleData = {
  ...
  metaDescription: "Apply now for the Bank of Montreal User Experience Operations – Co-op/Internship internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bank-of-montreal-user-experience-operations-coopinternship-internship-toronto", outputDir);
