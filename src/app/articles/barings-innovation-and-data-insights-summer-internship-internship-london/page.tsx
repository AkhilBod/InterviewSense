...
const articleData = {
  ...
  metaDescription: "Apply now for the Barings Innovation and Data Insights – Summer Internship internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("barings-innovation-and-data-insights-summer-internship-internship-london", outputDir);
