...
const articleData = {
  ...
  metaDescription: "Apply now for the Baxter International 2025 Summer Internship-Data Science internship in Johnsburg, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("baxter-international-2025-summer-internshipdata-science-internship-johnsburg", outputDir);
