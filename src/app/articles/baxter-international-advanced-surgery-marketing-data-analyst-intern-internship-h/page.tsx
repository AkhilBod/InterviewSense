...
const articleData = {
  ...
  metaDescription: "Apply now for the Baxter International Advanced Surgery Marketing Data Analyst Intern internship in Highland Park, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("baxter-international-advanced-surgery-marketing-data-analyst-intern-internship-h", outputDir);
