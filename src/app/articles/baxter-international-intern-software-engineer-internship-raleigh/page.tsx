...
const articleData = {
  ...
  metaDescription: "Apply now for the Baxter International Intern - Software Engineer internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("baxter-international-intern-software-engineer-internship-raleigh", outputDir);
