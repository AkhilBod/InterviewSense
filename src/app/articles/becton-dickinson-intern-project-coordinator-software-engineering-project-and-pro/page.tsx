...
const articleData = {
  ...
  metaDescription: "Apply now for the Becton Dickinson Intern Project Coordinator - Software Engineering Project and Program Management internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("becton-dickinson-intern-project-coordinator-software-engineering-project-and-pro", outputDir);
