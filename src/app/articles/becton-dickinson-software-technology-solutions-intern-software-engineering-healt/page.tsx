...
const articleData = {
  ...
  metaDescription: "Apply now for the Becton Dickinson Software Technology Solutions Intern - Software Engineering - Healthsight internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("becton-dickinson-software-technology-solutions-intern-software-engineering-healt", outputDir);
