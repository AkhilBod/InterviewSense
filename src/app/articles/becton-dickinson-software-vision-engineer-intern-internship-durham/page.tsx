...
const articleData = {
  ...
  metaDescription: "Apply now for the Becton Dickinson Software Vision Engineer Intern internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("becton-dickinson-software-vision-engineer-intern-internship-durham", outputDir);
