...
const articleData = {
  ...
  metaDescription: "Apply now for the Bernhard Utility Analyst Intern internship in Little Rock, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bernhard-utility-analyst-intern-internship-little-rock", outputDir);
