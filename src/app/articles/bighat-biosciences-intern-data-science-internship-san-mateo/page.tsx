...
const articleData = {
  ...
  metaDescription: "Apply now for the BigHat Biosciences Intern – Data Science internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bighat-biosciences-intern-data-science-internship-san-mateo", outputDir);
