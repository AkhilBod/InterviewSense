...
const articleData = {
  ...
  metaDescription: "Apply now for the BillionToOne Software Engineering Intern internship in Menlo Park, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("billiontoone-software-engineering-intern-internship-menlo-park", outputDir);
