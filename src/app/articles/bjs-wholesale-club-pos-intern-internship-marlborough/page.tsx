...
const articleData = {
  ...
  metaDescription: "Apply now for the BJ's Wholesale Club POS Intern internship in Marlborough, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bjs-wholesale-club-pos-intern-internship-marlborough", outputDir);
