...
const articleData = {
  ...
  metaDescription: "Apply now for the BlackSky Software Development Engineer in Test – Intern - Sdet internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blacksky-software-development-engineer-in-test-intern-sdet-internship-reston", outputDir);
