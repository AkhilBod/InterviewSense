...
const articleData = {
  ...
  metaDescription: "Apply now for the Blizzard Entertainment 2025 US Summer Internship - AI Localization internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blizzard-entertainment-2025-us-summer-internship-ai-localization-internship-irvi", outputDir);
