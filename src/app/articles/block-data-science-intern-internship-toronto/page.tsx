...
const articleData = {
  ...
  metaDescription: "Apply now for the Block Data Science Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("block-data-science-intern-internship-toronto", outputDir);
