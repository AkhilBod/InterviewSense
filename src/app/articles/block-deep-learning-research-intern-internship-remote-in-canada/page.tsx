...
const articleData = {
  ...
  metaDescription: "Apply now for the Block Deep Learning Research Intern internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("block-deep-learning-research-intern-internship-remote-in-canada", outputDir);
