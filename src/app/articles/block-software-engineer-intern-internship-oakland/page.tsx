...
const articleData = {
  ...
  metaDescription: "Apply now for the Block Software Engineer Intern internship in Oakland, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("block-software-engineer-intern-internship-oakland", outputDir);
