...
const articleData = {
  ...
  metaDescription: "Apply now for the Blockhouse Crypto Data Analyst Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blockhouse-crypto-data-analyst-intern-internship-nyc", outputDir);
