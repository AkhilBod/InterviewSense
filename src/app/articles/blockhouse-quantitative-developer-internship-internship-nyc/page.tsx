...
const articleData = {
  ...
  metaDescription: "Apply now for the Blockhouse Quantitative Developer Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blockhouse-quantitative-developer-internship-internship-nyc", outputDir);
