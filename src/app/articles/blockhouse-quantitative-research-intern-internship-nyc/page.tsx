...
const articleData = {
  ...
  metaDescription: "Apply now for the Blockhouse Quantitative Research Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blockhouse-quantitative-research-intern-internship-nyc", outputDir);
