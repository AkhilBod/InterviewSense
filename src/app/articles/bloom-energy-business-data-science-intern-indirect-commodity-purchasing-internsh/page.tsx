...
const articleData = {
  ...
  metaDescription: "Apply now for the Bloom Energy Business Data Science Intern - Indirect Commodity & Purchasing internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bloom-energy-business-data-science-intern-indirect-commodity-purchasing-internsh", outputDir);
