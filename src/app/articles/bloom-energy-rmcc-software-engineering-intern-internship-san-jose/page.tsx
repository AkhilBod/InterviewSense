...
const articleData = {
  ...
  metaDescription: "Apply now for the Bloom Energy RMCC Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bloom-energy-rmcc-software-engineering-intern-internship-san-jose", outputDir);
