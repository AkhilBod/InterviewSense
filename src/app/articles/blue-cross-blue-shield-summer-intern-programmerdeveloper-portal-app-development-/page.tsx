...
const articleData = {
  ...
  metaDescription: "Apply now for the Blue Cross Blue Shield Summer Intern - Programmer/Developer - Portal App Development internship in Phoenix, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blue-cross-blue-shield-summer-intern-programmerdeveloper-portal-app-development-", outputDir);
