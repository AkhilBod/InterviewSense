...
const articleData = {
  ...
  metaDescription: "Apply now for the Blue Yonder GenAI Prompt Engineer Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("blue-yonder-genai-prompt-engineer-intern-internship-dallas", outputDir);
