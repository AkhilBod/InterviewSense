...
const articleData = {
  ...
  metaDescription: "Apply now for the Bombardier Intern in Information Technology (Summer 2025) internship in Dorval, Québec, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bombardier-intern-in-information-technology-summer-2025-internship-dorval", outputDir);
