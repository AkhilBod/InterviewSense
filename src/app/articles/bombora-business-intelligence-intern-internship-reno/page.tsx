...
const articleData = {
  ...
  metaDescription: "Apply now for the Bombora Business Intelligence Intern internship in Reno, NV. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bombora-business-intelligence-intern-internship-reno", outputDir);
