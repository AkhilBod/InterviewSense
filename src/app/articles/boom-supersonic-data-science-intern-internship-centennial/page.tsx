...
const articleData = {
  ...
  metaDescription: "Apply now for the Boom Supersonic Data Science Intern internship in Centennial, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("boom-supersonic-data-science-intern-internship-centennial", outputDir);
