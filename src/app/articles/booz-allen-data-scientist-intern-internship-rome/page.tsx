...
const articleData = {
  ...
  metaDescription: "Apply now for the Booz Allen Data Scientist Intern internship in Rome, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("booz-allen-data-scientist-intern-internship-rome", outputDir);
