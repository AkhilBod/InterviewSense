...
const articleData = {
  ...
  metaDescription: "Apply now for the Booz Allen University – Systems Engineer Intern internship in Fayetteville, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("booz-allen-university-systems-engineer-intern-internship-fayetteville", outputDir);
