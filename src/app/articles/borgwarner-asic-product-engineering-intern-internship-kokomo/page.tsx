...
const articleData = {
  ...
  metaDescription: "Apply now for the BorgWarner ASIC Product Engineering Intern internship in Kokomo, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("borgwarner-asic-product-engineering-intern-internship-kokomo", outputDir);
