...
const articleData = {
  ...
  metaDescription: "Apply now for the BorgWarner Shop Floor Systems Developer Intern internship in Kokomo, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("borgwarner-shop-floor-systems-developer-intern-internship-kokomo", outputDir);
