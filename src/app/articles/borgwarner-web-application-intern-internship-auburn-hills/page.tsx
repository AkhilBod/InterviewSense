...
const articleData = {
  ...
  metaDescription: "Apply now for the BorgWarner Web Application Intern internship in Auburn Hills, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("borgwarner-web-application-intern-internship-auburn-hills", outputDir);
