...
const articleData = {
  ...
  metaDescription: "Apply now for the Bose Algorithms Software Engineer Co-op internship in Framingham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bose-algorithms-software-engineer-coop-internship-framingham", outputDir);
