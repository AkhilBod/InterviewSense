...
const articleData = {
  ...
  metaDescription: "Apply now for the Bose Data Science Co-Op - NLP & GenAI internship in Framingham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bose-data-science-coop-nlp-genai-internship-framingham", outputDir);
