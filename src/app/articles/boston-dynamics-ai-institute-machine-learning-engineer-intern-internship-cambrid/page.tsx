...
const articleData = {
  ...
  metaDescription: "Apply now for the Boston Dynamics AI Institute Machine Learning Engineer – Intern internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("boston-dynamics-ai-institute-machine-learning-engineer-intern-internship-cambrid", outputDir);
