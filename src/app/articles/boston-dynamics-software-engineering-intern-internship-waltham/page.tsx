...
const articleData = {
  ...
  metaDescription: "Apply now for the Boston Dynamics Software Engineering Intern internship in Waltham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("boston-dynamics-software-engineering-intern-internship-waltham", outputDir);
