...
const articleData = {
  ...
  metaDescription: "Apply now for the Boston Scientific Software Development Intern internship in Montreal, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("boston-scientific-software-development-intern-internship-montreal", outputDir);
