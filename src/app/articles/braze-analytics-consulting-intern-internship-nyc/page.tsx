...
const articleData = {
  ...
  metaDescription: "Apply now for the Braze Analytics Consulting Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("braze-analytics-consulting-intern-internship-nyc", outputDir);
