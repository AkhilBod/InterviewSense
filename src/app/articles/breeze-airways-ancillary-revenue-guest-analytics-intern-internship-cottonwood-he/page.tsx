...
const articleData = {
  ...
  metaDescription: "Apply now for the Breeze Airways Ancillary Revenue & Guest Analytics Intern internship in Cottonwood Heights, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("breeze-airways-ancillary-revenue-guest-analytics-intern-internship-cottonwood-he", outputDir);
