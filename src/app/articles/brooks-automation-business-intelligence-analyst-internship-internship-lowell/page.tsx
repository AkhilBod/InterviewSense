...
const articleData = {
  ...
  metaDescription: "Apply now for the Brooks Automation Business Intelligence Analyst Internship internship in Lowell, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("brooks-automation-business-intelligence-analyst-internship-internship-lowell", outputDir);
