...
const articleData = {
  ...
  metaDescription: "Apply now for the Brooks Automation Computer Science Intern - Summer 2025 internship in Lowell, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("brooks-automation-computer-science-intern-summer-2025-internship-lowell", outputDir);
