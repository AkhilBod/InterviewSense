...
const articleData = {
  ...
  metaDescription: "Apply now for the Brooks Automation Systems Engineer Intern internship in Livermore, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("brooks-automation-systems-engineer-intern-internship-livermore", outputDir);
