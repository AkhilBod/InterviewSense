...
const articleData = {
  ...
  metaDescription: "Apply now for the Brunswick Computer Graphics Software Developer Intern internship in Urbana, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("brunswick-computer-graphics-software-developer-intern-internship-urbana", outputDir);
