...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Backend Software Engineer Intern - Product RD and Infrastructure internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-backend-software-engineer-intern-product-rd-and-infrastructure-interns", outputDir);
