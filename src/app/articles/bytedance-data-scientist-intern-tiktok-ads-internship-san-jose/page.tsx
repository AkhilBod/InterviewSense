...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Data Scientist Intern - Tiktok Ads internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-data-scientist-intern-tiktok-ads-internship-san-jose", outputDir);
