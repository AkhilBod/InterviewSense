...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Data Scientist Intern - Traffic Infrastructure Global Engineering - BS/MS internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-data-scientist-intern-traffic-infrastructure-global-engineering-bsms-i", outputDir);
