...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Immersive Video Research Intern - Multimedia Streaming internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-immersive-video-research-intern-multimedia-streaming-internship-seattl", outputDir);
