...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Mobile App Engineering Intern - Product RD and Infrastructure - Global E-Commerce internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-mobile-app-engineering-intern-product-rd-and-infrastructure-global-eco", outputDir);
