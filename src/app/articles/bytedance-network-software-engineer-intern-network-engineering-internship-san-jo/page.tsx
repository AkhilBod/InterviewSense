...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Network Software Engineer Intern - Network Engineering internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-network-software-engineer-intern-network-engineering-internship-san-jo", outputDir);
