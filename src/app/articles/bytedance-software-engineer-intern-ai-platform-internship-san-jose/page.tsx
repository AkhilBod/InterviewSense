...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Software Engineer Intern - AI Platform internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-software-engineer-intern-ai-platform-internship-san-jose", outputDir);
