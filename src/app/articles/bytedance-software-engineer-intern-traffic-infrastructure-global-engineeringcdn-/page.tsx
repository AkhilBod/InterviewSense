...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Software Engineer Intern - Traffic Infrastructure Global Engineering-CDN - BS/MS internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-software-engineer-intern-traffic-infrastructure-global-engineeringcdn-", outputDir);
