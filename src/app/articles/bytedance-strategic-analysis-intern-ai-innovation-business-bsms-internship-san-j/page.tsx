...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Strategic Analysis Intern - AI Innovation Business - BS/MS internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-strategic-analysis-intern-ai-innovation-business-bsms-internship-san-j", outputDir);
