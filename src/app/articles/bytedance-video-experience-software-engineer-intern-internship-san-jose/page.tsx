...
const articleData = {
  ...
  metaDescription: "Apply now for the ByteDance Video Experience Software Engineer Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("bytedance-video-experience-software-engineer-intern-internship-san-jose", outputDir);
