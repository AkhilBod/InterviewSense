...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI BD Ops Reporting & Analytics Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-bd-ops-reporting-analytics-intern-internship-reston", outputDir);
