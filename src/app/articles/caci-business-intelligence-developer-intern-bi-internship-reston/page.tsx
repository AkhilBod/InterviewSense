...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Business Intelligence – Developer Intern - BI internship in Reston, VA</br>Oklahoma City, OK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-business-intelligence-developer-intern-bi-internship-reston", outputDir);
