...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Software Development Intern internship in Aurora, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-software-development-intern-internship-aurora", outputDir);
