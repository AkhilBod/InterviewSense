...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Software Development Intern - Summer 2025 internship in Ashburn, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-software-development-intern-summer-2025-internship-ashburn", outputDir);
