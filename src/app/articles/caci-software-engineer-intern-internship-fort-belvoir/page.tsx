...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Software Engineer Intern internship in Fort Belvoir, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-software-engineer-intern-internship-fort-belvoir", outputDir);
