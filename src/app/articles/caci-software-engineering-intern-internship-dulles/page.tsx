...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Software Engineering Intern internship in Dulles, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-software-engineering-intern-internship-dulles", outputDir);
