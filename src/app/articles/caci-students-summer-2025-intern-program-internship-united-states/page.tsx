...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Students – Summer 2025 Intern Program internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-students-summer-2025-intern-program-internship-united-states", outputDir);
