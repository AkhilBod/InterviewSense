...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Summer Internship 2025 internship in Reston, VA</br>Dulles, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-summer-internship-2025-internship-reston", outputDir);
