...
const articleData = {
  ...
  metaDescription: "Apply now for the CACI Systems/Software Engineering Intern internship in High Point, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caci-systemssoftware-engineering-intern-internship-high-point", outputDir);
