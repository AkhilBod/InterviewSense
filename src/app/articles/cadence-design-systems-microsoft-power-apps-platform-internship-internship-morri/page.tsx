...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems Microsoft Power Apps Platform Internship internship in Morrisville, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-microsoft-power-apps-platform-internship-internship-morri", outputDir);
