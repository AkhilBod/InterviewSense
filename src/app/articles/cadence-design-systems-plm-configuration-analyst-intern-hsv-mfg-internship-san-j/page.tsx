...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems PLM Configuration Analyst Intern - Hsv MFG internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-plm-configuration-analyst-intern-hsv-mfg-internship-san-j", outputDir);
