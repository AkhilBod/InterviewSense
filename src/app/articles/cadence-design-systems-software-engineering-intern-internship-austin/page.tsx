...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems Software Engineering Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-software-engineering-intern-internship-austin", outputDir);
