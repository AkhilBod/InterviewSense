...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems Software Intern - Automation internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-software-intern-automation-internship-pittsburgh", outputDir);
