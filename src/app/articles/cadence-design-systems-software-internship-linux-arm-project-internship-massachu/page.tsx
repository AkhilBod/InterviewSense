...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems Software Internship - Linux ARM Project internship in Massachusetts. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-software-internship-linux-arm-project-internship-massachu", outputDir);
