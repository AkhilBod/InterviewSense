...
const articleData = {
  ...
  metaDescription: "Apply now for the Cadence Design Systems SVG Software Intern internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cadence-design-systems-svg-software-intern-internship-burlington", outputDir);
