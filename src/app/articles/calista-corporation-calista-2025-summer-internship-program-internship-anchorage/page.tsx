...
const articleData = {
  ...
  metaDescription: "Apply now for the Calista Corporation Calista 2025 Summer Internship Program internship in Anchorage, AK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("calista-corporation-calista-2025-summer-internship-program-internship-anchorage", outputDir);
