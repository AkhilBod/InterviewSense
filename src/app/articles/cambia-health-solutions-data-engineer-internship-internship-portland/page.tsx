...
const articleData = {
  ...
  metaDescription: "Apply now for the Cambia Health Solutions Data Engineer Internship internship in Portland, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cambia-health-solutions-data-engineer-internship-internship-portland", outputDir);
