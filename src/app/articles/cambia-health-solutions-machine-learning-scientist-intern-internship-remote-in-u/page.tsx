...
const articleData = {
  ...
  metaDescription: "Apply now for the Cambia Health Solutions Machine Learning Scientist Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cambia-health-solutions-machine-learning-scientist-intern-internship-remote-in-u", outputDir);
