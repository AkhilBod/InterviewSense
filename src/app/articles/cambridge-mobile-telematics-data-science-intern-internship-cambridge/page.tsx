...
const articleData = {
  ...
  metaDescription: "Apply now for the Cambridge Mobile Telematics Data Science Intern internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cambridge-mobile-telematics-data-science-intern-internship-cambridge", outputDir);
