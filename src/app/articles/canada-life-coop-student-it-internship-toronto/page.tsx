...
const articleData = {
  ...
  metaDescription: "Apply now for the Canada Life Co-op Student IT internship in Toronto, ON. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("canada-life-coop-student-it-internship-toronto", outputDir);
