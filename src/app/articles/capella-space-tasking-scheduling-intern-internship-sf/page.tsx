...
const articleData = {
  ...
  metaDescription: "Apply now for the Capella Space Tasking & Scheduling Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("capella-space-tasking-scheduling-intern-internship-sf", outputDir);
