...
const articleData = {
  ...
  metaDescription: "Apply now for the Capital One Data Scientist – Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("capital-one-data-scientist-intern-internship-toronto", outputDir);
