...
const articleData = {
  ...
  metaDescription: "Apply now for the Capital Power Engineering – Student Intern internship in Calgary, AB, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("capital-power-engineering-student-intern-internship-calgary", outputDir);
