...
const articleData = {
  ...
  metaDescription: "Apply now for the Caribou Financial Data Science Intern internship in SF</br>Chicago, IL</br>Denver, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caribou-financial-data-science-intern-internship-sfbrchicago", outputDir);
