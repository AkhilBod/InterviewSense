...
const articleData = {
  ...
  metaDescription: "Apply now for the Carrier Global Data Science and Analytics Intern-Summer internship in East Syracuse, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("carrier-global-data-science-and-analytics-internsummer-internship-east-syracuse", outputDir);
