...
const articleData = {
  ...
  metaDescription: "Apply now for the Carrier Global Enterprise Business System Intern-Summer internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("carrier-global-enterprise-business-system-internsummer-internship-atlanta", outputDir);
