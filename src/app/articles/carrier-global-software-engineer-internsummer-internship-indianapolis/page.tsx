...
const articleData = {
  ...
  metaDescription: "Apply now for the Carrier Global Software Engineer Intern-Summer internship in Indianapolis, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("carrier-global-software-engineer-internsummer-internship-indianapolis", outputDir);
