...
const articleData = {
  ...
  metaDescription: "Apply now for the Carter's Data Engineering Intern internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("carters-data-engineering-intern-internship-atlanta", outputDir);
