...
const articleData = {
  ...
  metaDescription: "Apply now for the Casca (YC S23) Full-Stack Engineering Intern internship in San Francisco</br>Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("casca-yc-s23-fullstack-engineering-intern-internship-san-franciscobrremote", outputDir);
