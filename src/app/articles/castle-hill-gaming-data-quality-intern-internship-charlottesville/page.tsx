...
const articleData = {
  ...
  metaDescription: "Apply now for the Castle Hill Gaming Data Quality Intern internship in Charlottesville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("castle-hill-gaming-data-quality-intern-internship-charlottesville", outputDir);
