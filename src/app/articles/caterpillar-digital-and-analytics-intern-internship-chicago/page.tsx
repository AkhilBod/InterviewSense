...
// Article metadata
const articleData = {
  slug: "caterpillar-digital-and-analytics-intern-internship-chicago",
  title: "Caterpillar Digital and Analytics Intern Interview Questions",
  metaDescription: "Ace your Caterpillar Digital and Analytics Intern interview with AI-powered practice questions and feedback. Get ready for your Chicago, IL</br>Peoria, IL</br>Irving, TX internship.",
  keywords: ["Caterpillar interview", "Digital and Analytics Intern interview questions", "Caterpillar internship", "interview practice", "AI interview prep", "Caterpillar Digital and Analytics Intern", "Python interview questions"],
  lastUpdated: "2025-08-05T22:46:29.251Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Caterpillar Digital and Analytics Intern Interview Questions",
  "description": "Ace your Caterpillar Digital and Analytics Intern interview with AI-powered practice questions and feedback. Get ready for your Chicago, IL</br>Peoria, IL</br>Irving, TX internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/caterpillar-digital-and-analytics-intern-internship-chicago"
},
  openGraph: {
  "title": "Caterpillar Digital and Analytics Intern Interview Questions",
  "description": "Ace your Caterpillar Digital and Analytics Intern interview with AI-powered practice questions and feedback. Get ready for your Chicago, IL</br>Peoria, IL</br>Irving, TX internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caterpillar-digital-and-analytics-intern-internship-chicago", outputDir);
