...
const articleData = {
  ...
  metaDescription: "Apply now for the Caterpillar Inc. Corporate Intern - Digital and Analytics internship in Peoria, IL</br>Chicago, IL</br>Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caterpillar-inc-corporate-intern-digital-and-analytics-internship-peoria", outputDir);
