...
// Article metadata
const articleData = {
  slug: "caterpillar-inc-software-designer-intern-stagiaire-en-conception-de-logiciels-in",
  title: "Caterpillar Inc. Internship: Software Designer Intern / Stagiaire en conception de logiciels Position in Laval, QC, Canada (2025)",
  metaDescription: "Apply now for the Caterpillar Inc. Software Designer Intern / Stagiaire en conception de logiciels internship in Laval, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["Caterpillar Inc. internship", "Software Designer Intern / Stagiaire en conception de logiciels internship", "Caterpillar Inc. Software Designer Intern / Stagiaire en conception de logiciels", "summer 2025 internship", "tech internship Laval, QC, Canada", "software internship", "Caterpillar Inc. careers", "internship application", "tech jobs 2025", "Laval internship", "Caterpillar Inc. Laval", "QC internship", "Caterpillar Inc. QC", "Canada internship", "Caterpillar Inc. Canada"],
  lastUpdated: "2025-06-19T22:10:25.759Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "Software Designer Intern / Stagiaire en conception de logiciels Internship",
  "description": "Software Designer Intern / Stagiaire en conception de logiciels internship opportunity at Caterpillar Inc. in Laval, QC, Canada for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
  ...
  "url": "http://localhost:3000/internships/caterpillar-inc-software-designer-intern-stagiaire-en-conception-de-logiciels-in",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "Caterpillar Inc. Internship: Software Designer Intern / Stagiaire en conception de logiciels Position in Laval, QC, Canada (2025)",
  "description": "Apply now for the Caterpillar Inc. Software Designer Intern / Stagiaire en conception de logiciels internship in Laval, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("caterpillar-inc-software-designer-intern-stagiaire-en-conception-de-logiciels-in", outputDir);
