...
const articleData = {
  ...
  metaDescription: "Apply now for the Cboe Quantitative Analytics Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cboe-quantitative-analytics-intern-internship-london", outputDir);
