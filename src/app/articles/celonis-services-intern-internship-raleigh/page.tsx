...
const articleData = {
  ...
  metaDescription: "Apply now for the Celonis Services Intern internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("celonis-services-intern-internship-raleigh", outputDir);
