...
const articleData = {
  ...
  metaDescription: "Apply now for the Centene Application Development Intern - Undergraduate internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("centene-application-development-intern-undergraduate-internship-remote-in-usa", outputDir);
