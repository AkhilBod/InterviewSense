...
const articleData = {
  ...
  metaDescription: "Apply now for the Centene Software License Management Intern - Undergraduate - Summer internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("centene-software-license-management-intern-undergraduate-summer-internship-remot", outputDir);
