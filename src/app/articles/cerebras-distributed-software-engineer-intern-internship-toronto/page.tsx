...
const articleData = {
  ...
  metaDescription: "Apply now for the Cerebras Distributed Software Engineer – Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cerebras-distributed-software-engineer-intern-internship-toronto", outputDir);
