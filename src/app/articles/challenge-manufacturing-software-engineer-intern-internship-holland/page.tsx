...
const articleData = {
  ...
  metaDescription: "Apply now for the Challenge Manufacturing Software Engineer Intern internship in Holland, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("challenge-manufacturing-software-engineer-intern-internship-holland", outputDir);
