...
const articleData = {
  ...
  metaDescription: "Apply now for the Chewy AI Innovator Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chewy-ai-innovator-intern-internship-boston", outputDir);
