...
const articleData = {
  ...
  metaDescription: "Apply now for the Chewy Data Engineer I Co-op internship in Bellevue, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chewy-data-engineer-i-coop-internship-bellevue", outputDir);
