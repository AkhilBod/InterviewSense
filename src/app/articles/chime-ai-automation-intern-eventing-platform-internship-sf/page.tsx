...
const articleData = {
  ...
  metaDescription: "Apply now for the Chime AI Automation Intern - Eventing Platform internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chime-ai-automation-intern-eventing-platform-internship-sf", outputDir);
