...
const articleData = {
  ...
  metaDescription: "Apply now for the Chime Business Intelligence Engineer Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chime-business-intelligence-engineer-intern-internship-sf", outputDir);
