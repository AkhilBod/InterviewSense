...
const articleData = {
  ...
  metaDescription: "Apply now for the Chime Reporting and Data Infrastructure Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chime-reporting-and-data-infrastructure-intern-internship-sf", outputDir);
