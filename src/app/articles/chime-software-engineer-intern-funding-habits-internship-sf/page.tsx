...
const articleData = {
  ...
  metaDescription: "Apply now for the Chime Software Engineer Intern - Funding Habits internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("chime-software-engineer-intern-funding-habits-internship-sf", outputDir);
