...
const articleData = {
  ...
  metaDescription: "Apply now for the Cibc Data Analyst Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cibc-data-analyst-coop-internship-toronto", outputDir);
