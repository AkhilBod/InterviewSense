...
const articleData = {
  ...
  metaDescription: "Apply now for the CIBC Data Management – Summer Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cibc-data-management-summer-intern-internship-chicago", outputDir);
