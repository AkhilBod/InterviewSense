...
const articleData = {
  ...
  metaDescription: "Apply now for the Cibc Production Application Support Co-op - Capital Markets Technology internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cibc-production-application-support-coop-capital-markets-technology-internship-t", outputDir);
