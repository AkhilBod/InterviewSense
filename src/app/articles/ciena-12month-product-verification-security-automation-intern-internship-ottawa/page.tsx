...
const articleData = {
  ...
  metaDescription: "Apply now for the Ciena 12-month Product Verification Security Automation Intern internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciena-12month-product-verification-security-automation-intern-internship-ottawa", outputDir);
