...
const articleData = {
  ...
  metaDescription: "Apply now for the Ciena Software Engineer Intern internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciena-software-engineer-intern-internship-montreal", outputDir);
