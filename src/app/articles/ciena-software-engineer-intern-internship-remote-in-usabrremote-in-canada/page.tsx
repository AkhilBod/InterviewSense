...
const articleData = {
  ...
  metaDescription: "Apply now for the Ciena Software Engineer Intern internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciena-software-engineer-intern-internship-remote-in-usabrremote-in-canada", outputDir);
