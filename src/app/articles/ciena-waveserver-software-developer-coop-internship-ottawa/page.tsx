...
const articleData = {
  ...
  metaDescription: "Apply now for the Ciena Waveserver Software Developer Co-op internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciena-waveserver-software-developer-coop-internship-ottawa", outputDir);
