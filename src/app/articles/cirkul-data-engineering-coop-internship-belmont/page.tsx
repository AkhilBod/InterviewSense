...
const articleData = {
  ...
  metaDescription: "Apply now for the Cirkul Data Engineering Coop internship in Belmont, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cirkul-data-engineering-coop-internship-belmont", outputDir);
