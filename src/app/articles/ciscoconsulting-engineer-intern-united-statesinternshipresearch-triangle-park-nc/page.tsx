...
const articleData = {
  ...
  metaDescription: "Apply now for the Cisco Consulting Engineer (Intern) United States internship in Research Triangle Park, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciscoconsulting-engineer-intern-united-statesinternshipresearch-triangle-park-nc", outputDir);
