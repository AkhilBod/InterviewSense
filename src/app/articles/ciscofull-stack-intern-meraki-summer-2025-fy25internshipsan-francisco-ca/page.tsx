...
const articleData = {
  ...
  metaDescription: "Apply now for the Cisco Full Stack Intern Meraki Summer 2025 FY25 internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ciscofull-stack-intern-meraki-summer-2025-fy25internshipsan-francisco-ca", outputDir);
