...
// Article metadata
const articleData = {
  slug: "citadel-securities-designated-market-maker-dmm-trading-intern-internship-new",
  title: "Citadel Securities Designated Market Maker (DMM) Trading Intern Interview Questions",
  metaDescription: "Ace your Citadel Securities Designated Market Maker (DMM) Trading Intern interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  keywords: ["Citadel Securities interview", "Designated Market Maker (DMM) Trading Intern interview questions", "Citadel Securities internship", "interview practice", "AI interview prep", "Citadel Securities Designated Market Maker (DMM) Trading Intern", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.231Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Citadel Securities Designated Market Maker (DMM) Trading Intern Interview Questions",
  "description": "Ace your Citadel Securities Designated Market Maker (DMM) Trading Intern interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "datePublished": "2025-08-05T22:46:29.231Z",
  "url": "https://interviewsense.org/opportunities/citadel-securities-designated-market-maker-dmm-trading-intern-internship-new"
},
  openGraph: {
  "title": "Citadel Securities Designated Market Maker (DMM) Trading Intern Interview Questions",
  "description": "Ace your Citadel Securities Designated Market Maker (DMM) Trading Intern interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("citadel-securities-designated-market-maker-dmm-trading-intern-internship-new", outputDir);
