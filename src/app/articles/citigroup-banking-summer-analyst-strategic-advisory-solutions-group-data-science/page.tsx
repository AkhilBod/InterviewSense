...
const articleData = {
  ...
  metaDescription: "Apply now for the Citigroup Banking – Summer Analyst - Strategic Advisory Solutions Group - Data Science - 2026 internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("citigroup-banking-summer-analyst-strategic-advisory-solutions-group-data-science", outputDir);
