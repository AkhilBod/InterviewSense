...
const articleData = {
  ...
  metaDescription: "Apply now for the Citigroup Markets – Summer Analyst - Sales and Trading internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("citigroup-markets-summer-analyst-sales-and-trading-internship-nyc", outputDir);
