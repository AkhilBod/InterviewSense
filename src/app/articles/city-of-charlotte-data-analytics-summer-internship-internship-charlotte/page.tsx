...
const articleData = {
  ...
  metaDescription: "Apply now for the City of Charlotte Data Analytics Summer Internship internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("city-of-charlotte-data-analytics-summer-internship-internship-charlotte", outputDir);
