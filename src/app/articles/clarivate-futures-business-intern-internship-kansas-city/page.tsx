...
const articleData = {
  ...
  metaDescription: "Apply now for the Clarivate Futures Business Intern internship in Kansas City, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("clarivate-futures-business-intern-internship-kansas-city", outputDir);
