...
const articleData = {
  ...
  metaDescription: "Apply now for the Clayton Internship - Accounting Data Analytics internship in Maryville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("clayton-internship-accounting-data-analytics-internship-maryville", outputDir);
