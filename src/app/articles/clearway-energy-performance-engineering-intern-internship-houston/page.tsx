...
const articleData = {
  ...
  metaDescription: "Apply now for the Clearway Energy Performance Engineering Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("clearway-energy-performance-engineering-intern-internship-houston", outputDir);
