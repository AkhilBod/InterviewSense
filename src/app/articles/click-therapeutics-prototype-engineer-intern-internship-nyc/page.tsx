...
const articleData = {
  ...
  metaDescription: "Apply now for the Click Therapeutics Prototype Engineer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("click-therapeutics-prototype-engineer-intern-internship-nyc", outputDir);
