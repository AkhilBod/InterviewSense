...
const articleData = {
  ...
  metaDescription: "Apply now for the Clorox Data Engineer Intern internship in Pleasanton, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("clorox-data-engineer-intern-internship-pleasanton", outputDir);
