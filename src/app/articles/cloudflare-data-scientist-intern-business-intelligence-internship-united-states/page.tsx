...
const articleData = {
  ...
  metaDescription: "Apply now for the Cloudflare Data Scientist Intern - Business Intelligence internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cloudflare-data-scientist-intern-business-intelligence-internship-united-states", outputDir);
