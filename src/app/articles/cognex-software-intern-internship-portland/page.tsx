...
const articleData = {
  ...
  metaDescription: "Apply now for the Cognex Software Intern internship in Portland, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cognex-software-intern-internship-portland", outputDir);
