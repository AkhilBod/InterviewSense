...
const articleData = {
  ...
  metaDescription: "Apply now for the Comcast Comcast HR Analytics Intern internship in Philadelphia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("comcast-comcast-hr-analytics-intern-internship-philadelphia", outputDir);
