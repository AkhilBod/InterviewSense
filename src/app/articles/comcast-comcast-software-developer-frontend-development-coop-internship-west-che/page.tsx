...
const articleData = {
  ...
  metaDescription: "Apply now for the Comcast Comcast Software Developer – Frontend Development Co-op internship in West Chester, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("comcast-comcast-software-developer-frontend-development-coop-internship-west-che", outputDir);
