...
const articleData = {
  ...
  metaDescription: "Apply now for the Comcast Comcast Software Engineer Intern - Beeswax Serving internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("comcast-comcast-software-engineer-intern-beeswax-serving-internship-nyc", outputDir);
