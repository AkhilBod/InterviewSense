...
// Article metadata
const articleData = {
  slug: "comcast-erp-internship-rising-senior-technology-internship-orlando",
  title: "Comcast ERP Internship: Rising Senior Technology Interview Questions",
  metaDescription: "Ace your Comcast ERP Internship: Rising Senior Technology interview with AI-powered practice questions and feedback. Get ready for your Orlando, FL</br>Philadelphia, PA</br>New York, NY internship.",
  keywords: ["Comcast interview", "ERP Internship: Rising Senior Technology interview questions", "Comcast internship", "interview practice", "AI interview prep", "Comcast ERP Internship: Rising Senior Technology", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.213Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Comcast ERP Internship: Rising Senior Technology Interview Questions",
  "description": "Ace your Comcast ERP Internship: Rising Senior Technology interview with AI-powered practice questions and feedback. Get ready for your Orlando, FL</br>Philadelphia, PA</br>New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/comcast-erp-internship-rising-senior-technology-internship-orlando"
},
  openGraph: {
  "title": "Comcast ERP Internship: Rising Senior Technology Interview Questions",
  "description": "Ace your Comcast ERP Internship: Rising Senior Technology interview with AI-powered practice questions and feedback. Get ready for your Orlando, FL</br>Philadelphia, PA</br>New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("comcast-erp-internship-rising-senior-technology-internship-orlando", outputDir);
