...
const articleData = {
  ...
  metaDescription: "Apply now for the Commure Software Engineering Intern - Integrations internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("commure-software-engineering-intern-integrations-internship-mountain-view", outputDir);
