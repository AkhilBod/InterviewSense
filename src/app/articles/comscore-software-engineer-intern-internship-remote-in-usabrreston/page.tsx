...
const articleData = {
  ...
  metaDescription: "Apply now for the Comscore Software Engineer Intern internship in Remote in USA</br>Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("comscore-software-engineer-intern-internship-remote-in-usabrreston", outputDir);
