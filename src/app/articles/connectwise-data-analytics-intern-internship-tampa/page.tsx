...
const articleData = {
  ...
  metaDescription: "Apply now for the ConnectWise Data Analytics Intern internship in Tampa, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("connectwise-data-analytics-intern-internship-tampa", outputDir);
