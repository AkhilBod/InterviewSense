...
const articleData = {
  ...
  metaDescription: "Apply now for the Constellation Brands Intern – Beer Operations Digitalization internship in San Antonio, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("constellation-brands-intern-beer-operations-digitalization-internship-san-antoni", outputDir);
