...
const articleData = {
  ...
  metaDescription: "Apply now for the Coral Software Engineer Intern - AI Anime Avatar Apps 🤖 internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("coral-software-engineer-intern-ai-anime-avatar-apps-internship-remote-in-usabrre", outputDir);
