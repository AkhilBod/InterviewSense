...
const articleData = {
  ...
  metaDescription: "Apply now for the Corelogic Intern – Business/Data Analyst - Insurance Insights internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("corelogic-intern-businessdata-analyst-insurance-insights-internship-dallas", outputDir);
