...
const articleData = {
  ...
  metaDescription: "Apply now for the Corelogic Intern – Data Engineer internship in Irvine, CA</br>Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("corelogic-intern-data-engineer-internship-irvine", outputDir);
