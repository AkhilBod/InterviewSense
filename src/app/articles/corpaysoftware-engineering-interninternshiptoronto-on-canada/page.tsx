...
const articleData = {
  ...
  metaDescription: "Apply now for the Corpay Software Engineering Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("corpaysoftware-engineering-interninternshiptoronto-on-canada", outputDir);
