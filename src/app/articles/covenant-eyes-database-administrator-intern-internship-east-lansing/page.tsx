...
const articleData = {
  ...
  metaDescription: "Apply now for the Covenant Eyes Database Administrator Intern internship in East Lansing, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("covenant-eyes-database-administrator-intern-internship-east-lansing", outputDir);
