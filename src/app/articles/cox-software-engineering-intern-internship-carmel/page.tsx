...
const articleData = {
  ...
  metaDescription: "Apply now for the Cox Software Engineering Intern internship in Carmel, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cox-software-engineering-intern-internship-carmel", outputDir);
