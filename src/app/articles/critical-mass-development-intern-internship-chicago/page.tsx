...
const articleData = {
  ...
  metaDescription: "Apply now for the Critical Mass Development Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("critical-mass-development-intern-internship-chicago", outputDir);
