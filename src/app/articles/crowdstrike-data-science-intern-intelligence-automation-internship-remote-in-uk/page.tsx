...
const articleData = {
  ...
  metaDescription: "Apply now for the Crowdstrike Data Science Intern - Intelligence Automation internship in Remote in UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("crowdstrike-data-science-intern-intelligence-automation-internship-remote-in-uk", outputDir);
