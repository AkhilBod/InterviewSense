...
const articleData = {
  ...
  metaDescription: "Apply now for the Crowdstrike IT AI Solutions Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("crowdstrike-it-ai-solutions-intern-internship-remote-in-usa", outputDir);
