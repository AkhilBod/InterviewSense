...
const articleData = {
  ...
  metaDescription: "Apply now for the Crowdstrike ML Data Engineering and Data Science Intern internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("crowdstrike-ml-data-engineering-and-data-science-intern-internship-remote-in-usa", outputDir);
