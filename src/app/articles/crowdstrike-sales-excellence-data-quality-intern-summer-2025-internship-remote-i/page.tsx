...
const articleData = {
  ...
  metaDescription: "Apply now for the Crowdstrike Sales Excellence Data Quality Intern - Summer 2025 internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("crowdstrike-sales-excellence-data-quality-intern-summer-2025-internship-remote-i", outputDir);
