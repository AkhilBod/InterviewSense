...
const articleData = {
  ...
  metaDescription: "Apply now for the C&S Wholesale Grocers Application Migration Intern - Mainframe internship in Brattleboro, VT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cs-wholesale-grocers-application-migration-intern-mainframe-internship-brattlebo", outputDir);
