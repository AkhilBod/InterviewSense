...
const articleData = {
  ...
  metaDescription: "Apply now for the C&S Wholesale Grocers Data Analyst Intern internship in Edison, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cs-wholesale-grocers-data-analyst-intern-internship-edison", outputDir);
