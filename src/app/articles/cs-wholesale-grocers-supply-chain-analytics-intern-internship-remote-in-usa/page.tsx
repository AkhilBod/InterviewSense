...
const articleData = {
  ...
  metaDescription: "Apply now for the C&S Wholesale Grocers Supply Chain Analytics Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cs-wholesale-grocers-supply-chain-analytics-intern-internship-remote-in-usa", outputDir);
