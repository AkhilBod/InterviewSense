...
const articleData = {
  ...
  metaDescription: "Apply now for the CSL Development Engineer in Test Co-op internship in King of Prussia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("csl-development-engineer-in-test-coop-internship-king-of-prussia", outputDir);
