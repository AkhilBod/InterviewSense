...
const articleData = {
  ...
  metaDescription: "Apply now for the CSL Enterprise AI Platform Co-Op internship in King of Prussia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("csl-enterprise-ai-platform-coop-internship-king-of-prussia", outputDir);
