...
const articleData = {
  ...
  metaDescription: "Apply now for the Cubic Innovation Intern AI internship in Crawley, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cubic-innovation-intern-ai-internship-crawley", outputDir);
