...
const articleData = {
  ...
  metaDescription: "Apply now for the Curtiss-Wright Corporation Database Creation Intern internship in Plainview, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("curtisswright-corporation-database-creation-intern-internship-plainview", outputDir);
