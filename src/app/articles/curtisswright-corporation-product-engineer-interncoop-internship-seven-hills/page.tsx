...
const articleData = {
  ...
  metaDescription: "Apply now for the Curtiss-Wright Corporation Product Engineer Intern/Co-op internship in Seven Hills, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("curtisswright-corporation-product-engineer-interncoop-internship-seven-hills", outputDir);
