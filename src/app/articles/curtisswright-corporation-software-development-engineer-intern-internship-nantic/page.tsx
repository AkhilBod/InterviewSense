...
const articleData = {
  ...
  metaDescription: "Apply now for the Curtiss-Wright Corporation Software Development Engineer – Intern internship in Nanticoke, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("curtisswright-corporation-software-development-engineer-intern-internship-nantic", outputDir);
