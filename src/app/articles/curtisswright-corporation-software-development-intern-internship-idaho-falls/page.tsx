...
const articleData = {
  ...
  metaDescription: "Apply now for the Curtiss-Wright Corporation Software Development Intern internship in Idaho Falls, ID. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("curtisswright-corporation-software-development-intern-internship-idaho-falls", outputDir);
