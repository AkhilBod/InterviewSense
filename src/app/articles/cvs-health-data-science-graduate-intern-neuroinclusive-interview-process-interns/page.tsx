...
const articleData = {
  ...
  metaDescription: "Apply now for the CVS Health Data Science Graduate Intern: Neuroinclusive Interview Process internship in Needham, MA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cvs-health-data-science-graduate-intern-neuroinclusive-interview-process-interns", outputDir);
