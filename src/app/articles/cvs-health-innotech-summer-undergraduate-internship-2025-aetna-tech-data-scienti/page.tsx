...
const articleData = {
  ...
  metaDescription: "Apply now for the CVS Health Innotech Summer Undergraduate Internship 2025 - Aetna Tech - Data Scientist internship in Hartford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cvs-health-innotech-summer-undergraduate-internship-2025-aetna-tech-data-scienti", outputDir);
