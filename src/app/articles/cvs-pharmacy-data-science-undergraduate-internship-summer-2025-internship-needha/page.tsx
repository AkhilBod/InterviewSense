...
const articleData = {
  ...
  metaDescription: "Apply now for the CVS Pharmacy Data Science Undergraduate Internship - Summer 2025 internship in Needham, MA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cvs-pharmacy-data-science-undergraduate-internship-summer-2025-internship-needha", outputDir);
