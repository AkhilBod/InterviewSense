...
const articleData = {
  ...
  metaDescription: "Apply now for the Cyberark AI GTM Intern internship in Newton, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("cyberark-ai-gtm-intern-internship-newton", outputDir);
