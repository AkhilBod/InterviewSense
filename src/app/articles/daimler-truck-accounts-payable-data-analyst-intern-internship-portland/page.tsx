...
const articleData = {
  ...
  metaDescription: "Apply now for the Daimler Truck Accounts Payable Data Analyst Intern internship in Portland, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("daimler-truck-accounts-payable-data-analyst-intern-internship-portland", outputDir);
