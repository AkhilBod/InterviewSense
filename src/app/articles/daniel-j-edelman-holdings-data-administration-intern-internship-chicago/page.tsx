...
const articleData = {
  ...
  metaDescription: "Apply now for the Daniel J Edelman Holdings Data Administration Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("daniel-j-edelman-holdings-data-administration-intern-internship-chicago", outputDir);
