...
const articleData = {
  ...
  metaDescription: "Apply now for the Daniel J Edelman Holdings Intern – Predictive Analytics internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("daniel-j-edelman-holdings-intern-predictive-analytics-internship-chicago", outputDir);
