...
const articleData = {
  ...
  metaDescription: "Apply now for the David Zwirner Gallery Technical Operations Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("david-zwirner-gallery-technical-operations-internship-internship-nyc", outputDir);
