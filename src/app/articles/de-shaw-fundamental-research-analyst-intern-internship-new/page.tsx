...
// Article metadata
const articleData = {
  slug: "de-shaw-fundamental-research-analyst-intern-internship-new",
  ...
  "url": "https://interviewsense.org/opportunities/de-shaw-fundamental-research-analyst-intern-internship-new"
},
  openGraph: {
  "title": "D.E Shaw Fundamental Research Analyst Intern Interview Questions",
  "description": "Ace your D.E Shaw Fundamental Research Analyst Intern interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("de-shaw-fundamental-research-analyst-intern-internship-new", outputDir);
