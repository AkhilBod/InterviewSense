...
const articleData = {
  ...
  metaDescription: "Apply now for the Definitive Healthcare Data Intern internship in Framingham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("definitive-healthcare-data-intern-internship-framingham", outputDir);
