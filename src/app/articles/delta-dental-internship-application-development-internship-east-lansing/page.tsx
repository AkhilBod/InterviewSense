...
const articleData = {
  ...
  metaDescription: "Apply now for the Delta Dental Internship - Application Development internship in East Lansing, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("delta-dental-internship-application-development-internship-east-lansing", outputDir);
