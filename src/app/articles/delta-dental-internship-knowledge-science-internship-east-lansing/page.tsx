...
const articleData = {
  ...
  metaDescription: "Apply now for the Delta Dental Internship - Knowledge Science internship in East Lansing, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("delta-dental-internship-knowledge-science-internship-east-lansing", outputDir);
