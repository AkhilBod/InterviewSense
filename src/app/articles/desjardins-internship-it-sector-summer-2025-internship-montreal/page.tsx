...
const articleData = {
  ...
  metaDescription: "Apply now for the Desjardins Internship, IT sector, Summer 2025 internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("desjardins-internship-it-sector-summer-2025-internship-montreal", outputDir);
