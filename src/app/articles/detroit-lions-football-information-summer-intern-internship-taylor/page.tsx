...
const articleData = {
  ...
  metaDescription: "Apply now for the Detroit Lions Football Information Summer Intern internship in Taylor, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("detroit-lions-football-information-summer-intern-internship-taylor", outputDir);
