...
const articleData = {
  ...
  metaDescription: "Apply now for the Dexcom Intern I – Manufacturing Data Management internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dexcom-intern-i-manufacturing-data-management-internship-san-diego", outputDir);
