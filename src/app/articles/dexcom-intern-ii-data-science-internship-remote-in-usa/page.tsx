...
const articleData = {
  ...
  metaDescription: "Apply now for the Dexcom Intern II – Data Science internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dexcom-intern-ii-data-science-internship-remote-in-usa", outputDir);
