...
const articleData = {
  ...
  metaDescription: "Apply now for the Dick's Sporting Goods Analytics Engineer Intern - Analytics Hub internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dicks-sporting-goods-analytics-engineer-intern-analytics-hub-internship-remote-i", outputDir);
