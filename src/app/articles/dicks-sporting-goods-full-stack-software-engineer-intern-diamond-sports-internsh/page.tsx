...
const articleData = {
  ...
  metaDescription: "Apply now for the Dick's Sporting Goods Full Stack Software Engineer Intern - Diamond Sports internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dicks-sporting-goods-full-stack-software-engineer-intern-diamond-sports-internsh", outputDir);
