...
const articleData = {
  ...
  metaDescription: "Apply now for the Dick's Sporting Goods Software Engineer Intern - User Growth internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dicks-sporting-goods-software-engineer-intern-user-growth-internship-remote-in-u", outputDir);
