...
// Article metadata
const articleData = {
  slug: "dicks-sporting-goods-software-engineer-intern-user-growth-internship-remote",
  title: "Dick's Sporting Goods Software Engineer Intern - User Growth Interview Questions",
  metaDescription: "Ace your Dick's Sporting Goods Software Engineer Intern - User Growth interview with AI-powered practice questions and feedback. Get ready for your Remote in USA internship.",
  keywords: ["Dick's Sporting Goods interview", "Software Engineer Intern - User Growth interview questions", "Dick's Sporting Goods internship", "interview practice", "AI interview prep", "Dick's Sporting Goods Software Engineer Intern - User Growth", "Software Engineering interview questions"],
  lastUpdated: "2025-06-24T12:16:11.376Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Dick's Sporting Goods Software Engineer Intern - User Growth Interview Questions",
  "description": "Ace your Dick's Sporting Goods Software Engineer Intern - User Growth interview with AI-powered practice questions and feedback. Get ready for your Remote in USA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/dicks-sporting-goods-software-engineer-intern-user-growth-internship-remote"
},
  openGraph: {
  "title": "Dick's Sporting Goods Software Engineer Intern - User Growth Interview Questions",
  "description": "Ace your Dick's Sporting Goods Software Engineer Intern - User Growth interview with AI-powered practice questions and feedback. Get ready for your Remote in USA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dicks-sporting-goods-software-engineer-intern-user-growth-internship-remote", outputDir);
