...
const articleData = {
  ...
  metaDescription: "Apply now for the Diligent Corporation Data Journalist/Data Science Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("diligent-corporation-data-journalistdata-science-intern-internship-nyc", outputDir);
