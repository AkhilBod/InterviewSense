...
const articleData = {
  ...
  metaDescription: "Apply now for the Dillards Technology Internship internship in Little Rock, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dillards-technology-internship-internship-little-rock", outputDir);
