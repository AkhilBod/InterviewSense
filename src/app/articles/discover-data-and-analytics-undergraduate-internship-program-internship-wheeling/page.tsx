...
const articleData = {
  ...
  metaDescription: "Apply now for the Discover Data and Analytics Undergraduate Internship Program internship in Wheeling, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("discover-data-and-analytics-undergraduate-internship-program-internship-wheeling", outputDir);
