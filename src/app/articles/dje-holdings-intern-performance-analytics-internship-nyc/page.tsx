...
const articleData = {
  ...
  metaDescription: "Apply now for the DJE Holdings Intern – Performance Analytics internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dje-holdings-intern-performance-analytics-internship-nyc", outputDir);
