...
const articleData = {
  ...
  metaDescription: "Apply now for the Domo AI Connector Engineer – Intern internship in American Fork, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("domo-ai-connector-engineer-intern-internship-american-fork", outputDir);
