...
const articleData = {
  ...
  metaDescription: "Apply now for the Drivetrain Engineering Intern - Gen AI for FP&a Platform internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("drivetrain-engineering-intern-gen-ai-for-fpa-platform-internship-remote-in-usa", outputDir);
