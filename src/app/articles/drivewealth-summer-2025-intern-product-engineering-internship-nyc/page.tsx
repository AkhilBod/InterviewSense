...
const articleData = {
  ...
  metaDescription: "Apply now for the DriveWealth Summer 2025 Intern - Product Engineering internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("drivewealth-summer-2025-intern-product-engineering-internship-nyc", outputDir);
