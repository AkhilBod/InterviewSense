...
const articleData = {
  ...
  metaDescription: "Apply now for the DRW AI/ML Research Intern internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("drw-aiml-research-intern-internship-montreal", outputDir);
