...
const articleData = {
  ...
  metaDescription: "Apply now for the Dun & Bradstreet 2025 Summer Internship Program - People Analytics internship in Jacksonville, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dun-bradstreet-2025-summer-internship-program-people-analytics-internship-jackso", outputDir);
