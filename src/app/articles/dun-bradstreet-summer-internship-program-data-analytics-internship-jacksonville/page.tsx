...
const articleData = {
  ...
  metaDescription: "Apply now for the Dun & Bradstreet Summer Internship Program - Data & Analytics internship in Jacksonville, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dun-bradstreet-summer-internship-program-data-analytics-internship-jacksonville", outputDir);
