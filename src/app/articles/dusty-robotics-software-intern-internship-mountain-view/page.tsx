...
const articleData = {
  ...
  metaDescription: "Apply now for the Dusty Robotics Software Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dusty-robotics-software-intern-internship-mountain-view", outputDir);
