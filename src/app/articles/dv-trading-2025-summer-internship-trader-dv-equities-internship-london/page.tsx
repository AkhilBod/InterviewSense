...
const articleData = {
  ...
  metaDescription: "Apply now for the DV Trading 2025 Summer Internship - Trader - DV Equities internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dv-trading-2025-summer-internship-trader-dv-equities-internship-london", outputDir);
