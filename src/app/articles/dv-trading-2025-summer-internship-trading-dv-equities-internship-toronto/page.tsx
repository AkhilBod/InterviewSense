...
// Article metadata
const articleData = {
  slug: "dv-trading-2025-summer-internship-trading-dv-equities-internship-toronto",
  title: "DV Trading Internship: 2025 Summer Internship - Trading - DV Equities Position in Toronto, ON, Canada (2025)",
  metaDescription: "Apply now for the DV Trading 2025 Summer Internship - Trading - DV Equities internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["DV Trading internship", "2025 Summer Internship - Trading - DV Equities internship", "DV Trading 2025 Summer Internship - Trading - DV Equities", "summer 2025 internship", "tech internship Toronto, ON, Canada", "quant internship", "DV Trading careers", "internship application", "tech jobs 2025", "Toronto internship", "DV Trading Toronto", "ON internship", "DV Trading ON", "Canada internship", "DV Trading Canada"],
  lastUpdated: "2025-06-19T22:10:26.037Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "2025 Summer Internship - Trading - DV Equities Internship",
  "description": "2025 Summer Internship - Trading - DV Equities internship opportunity at DV Trading in Toronto, ON, Canada for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
    "name": "DV Trading"
  },
  ...
  "url": "http://localhost:3000/internships/dv-trading-2025-summer-internship-trading-dv-equities-internship-toronto",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "DV Trading Internship: 2025 Summer Internship - Trading - DV Equities Position in Toronto, ON, Canada (2025)",
  "description": "Apply now for the DV Trading 2025 Summer Internship - Trading - DV Equities internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dv-trading-2025-summer-internship-trading-dv-equities-internship-toronto", outputDir);
