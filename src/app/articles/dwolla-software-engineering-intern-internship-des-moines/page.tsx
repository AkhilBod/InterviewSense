...
const articleData = {
  ...
  metaDescription: "Apply now for the Dwolla Software Engineering Intern internship in Des Moines, IA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dwolla-software-engineering-intern-internship-des-moines", outputDir);
