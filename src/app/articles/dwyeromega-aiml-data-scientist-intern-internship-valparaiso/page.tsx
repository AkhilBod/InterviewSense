...
const articleData = {
  ...
  metaDescription: "Apply now for the DwyerOmega AI/ML Data Scientist Intern internship in Valparaiso, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("dwyeromega-aiml-data-scientist-intern-internship-valparaiso", outputDir);
