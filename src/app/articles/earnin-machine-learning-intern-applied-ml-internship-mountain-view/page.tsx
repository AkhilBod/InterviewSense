...
const articleData = {
  ...
  metaDescription: "Apply now for the EarnIn Machine Learning Intern - Applied ML internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("earnin-machine-learning-intern-applied-ml-internship-mountain-view", outputDir);
