...
const articleData = {
  ...
  metaDescription: "Apply now for the Echo Global Logistics RPA Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("echo-global-logistics-rpa-intern-internship-chicago", outputDir);
