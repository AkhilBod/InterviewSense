...
const articleData = {
  ...
  metaDescription: "Apply now for the Echostar Digital Marketing & Analytics Intern internship in Germantown, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("echostar-digital-marketing-analytics-intern-internship-germantown", outputDir);
