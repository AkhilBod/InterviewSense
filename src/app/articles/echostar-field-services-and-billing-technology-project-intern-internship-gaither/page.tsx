...
const articleData = {
  ...
  metaDescription: "Apply now for the Echostar Field Services and Billing Technology Project Intern internship in Gaithersburg, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("echostar-field-services-and-billing-technology-project-intern-internship-gaither", outputDir);
