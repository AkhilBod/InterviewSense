...
const articleData = {
  ...
  metaDescription: "Apply now for the Echostar Pilot Engineering and Solutions Architecture Intern internship in Germantown, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("echostar-pilot-engineering-and-solutions-architecture-intern-internship-germanto", outputDir);
