...
const articleData = {
  ...
  metaDescription: "Apply now for the Einride Einride Summer Internship 2025 internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("einride-einride-summer-internship-2025-internship-austin", outputDir);
