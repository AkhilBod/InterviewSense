...
const articleData = {
  ...
  metaDescription: "Apply now for the Ekimetrics 2025 Summer internship - Data Analyst & Marketing consultant internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ekimetrics-2025-summer-internship-data-analyst-marketing-consultant-internship-l", outputDir);
