...
const articleData = {
  ...
  metaDescription: "Apply now for the Ekimetrics 2025 Summer internship - Data Engineering and Developer Consultant internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ekimetrics-2025-summer-internship-data-engineering-and-developer-consultant-inte", outputDir);
