...
const articleData = {
  ...
  metaDescription: "Apply now for the Electric Mind Software Developer Intern internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("electric-mind-software-developer-intern-internship-toronto", outputDir);
