...
const articleData = {
  ...
  metaDescription: "Apply now for the Element Biosciences Software Development Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("element-biosciences-software-development-intern-internship-san-diego", outputDir);
