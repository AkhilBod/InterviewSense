...
const articleData = {
  ...
  metaDescription: "Apply now for the Elevance Health Business Analytics Internship internship in Canoga Park, LA</br>Sacramento, CA</br>Walnut Creek, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("elevance-health-business-analytics-internship-internship-canoga-park", outputDir);
