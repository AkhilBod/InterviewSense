...
const articleData = {
  ...
  metaDescription: "Apply now for the Elevance Health Data Science Internship internship in Chicago, IL</br>Walnut Creek, CA</br>Norfolk, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("elevance-health-data-science-internship-internship-chicago", outputDir);
