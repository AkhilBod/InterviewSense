...
const articleData = {
  ...
  metaDescription: "Apply now for the Elevance Health Undergraduate Engineering Intern internship in Norwalk, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("elevance-health-undergraduate-engineering-intern-internship-norwalk", outputDir);
