...
const articleData = {
  ...
  metaDescription: "Apply now for the Elf Beauty Summer Intern - Master Data internship in Oakland, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("elf-beauty-summer-intern-master-data-internship-oakland", outputDir);
