...
const articleData = {
  ...
  metaDescription: "Apply now for the Elsevier Data Scientist Health Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("elsevier-data-scientist-health-intern-internship-remote-in-usa", outputDir);
