...
const articleData = {
  ...
  metaDescription: "Apply now for the Energy Recovery Mechanical Engineering Intern - Product Engineering internship in San Leandro, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("energy-recovery-mechanical-engineering-intern-product-engineering-internship-san", outputDir);
