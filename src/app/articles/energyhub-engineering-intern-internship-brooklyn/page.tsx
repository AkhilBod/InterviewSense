...
const articleData = {
  ...
  metaDescription: "Apply now for the EnergyHub Engineering Intern internship in Brooklyn, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("energyhub-engineering-intern-internship-brooklyn", outputDir);
