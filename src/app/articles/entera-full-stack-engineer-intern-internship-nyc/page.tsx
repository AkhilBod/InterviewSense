...
const articleData = {
  ...
  metaDescription: "Apply now for the Entera Full Stack Engineer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("entera-full-stack-engineer-intern-internship-nyc", outputDir);
