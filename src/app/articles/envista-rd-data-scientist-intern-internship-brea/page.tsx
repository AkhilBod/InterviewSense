...
const articleData = {
  ...
  metaDescription: "Apply now for the Envista R&D Data Scientist Intern internship in Brea, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("envista-rd-data-scientist-intern-internship-brea", outputDir);
