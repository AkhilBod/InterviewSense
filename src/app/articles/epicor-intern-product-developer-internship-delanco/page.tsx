...
const articleData = {
  ...
  metaDescription: "Apply now for the Epicor Intern – Product Developer internship in Delanco, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("epicor-intern-product-developer-internship-delanco", outputDir);
