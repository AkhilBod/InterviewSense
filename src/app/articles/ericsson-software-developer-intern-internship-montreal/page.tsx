...
const articleData = {
  ...
  metaDescription: "Apply now for the Ericsson Software Developer Intern internship in Montreal, Quebec, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ericsson-software-developer-intern-internship-montreal", outputDir);
