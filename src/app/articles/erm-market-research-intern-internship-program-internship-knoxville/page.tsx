...
const articleData = {
  ...
  metaDescription: "Apply now for the ERM Market Research Intern – Internship Program internship in Knoxville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("erm-market-research-intern-internship-program-internship-knoxville", outputDir);
