...
const articleData = {
  ...
  metaDescription: "Apply now for the Ethereum Foundation Research Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ethereum-foundation-research-intern-internship-remote-in-usa", outputDir);
