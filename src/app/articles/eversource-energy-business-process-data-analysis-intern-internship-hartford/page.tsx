...
const articleData = {
  ...
  metaDescription: "Apply now for the Eversource Energy Business Process & Data Analysis Intern internship in Hartford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("eversource-energy-business-process-data-analysis-intern-internship-hartford", outputDir);
