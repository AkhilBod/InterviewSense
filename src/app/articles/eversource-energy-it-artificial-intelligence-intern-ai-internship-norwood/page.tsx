...
const articleData = {
  ...
  metaDescription: "Apply now for the Eversource Energy IT Artificial Intelligence – Intern - AI internship in Norwood, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("eversource-energy-it-artificial-intelligence-intern-ai-internship-norwood", outputDir);
