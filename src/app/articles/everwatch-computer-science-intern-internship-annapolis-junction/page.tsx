...
const articleData = {
  ...
  metaDescription: "Apply now for the Everwatch Computer Science Intern internship in Annapolis Junction, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("everwatch-computer-science-intern-internship-annapolis-junction", outputDir);
