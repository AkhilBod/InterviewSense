...
const articleData = {
  ...
  metaDescription: "Apply now for the EVgo Intern – Firmware Development internship in El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("evgo-intern-firmware-development-internship-el-segundo", outputDir);
