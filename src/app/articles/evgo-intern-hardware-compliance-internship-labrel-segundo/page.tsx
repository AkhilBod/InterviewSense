...
const articleData = {
  ...
  metaDescription: "Apply now for the EVgo Intern – Hardware Compliance internship in LA</br>El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("evgo-intern-hardware-compliance-internship-labrel-segundo", outputDir);
