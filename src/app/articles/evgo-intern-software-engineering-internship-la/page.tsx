...
const articleData = {
  ...
  metaDescription: "Apply now for the EVgo Intern – Software Engineering internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("evgo-intern-software-engineering-internship-la", outputDir);
