...
const articleData = {
  ...
  metaDescription: "Apply now for the EVgo Intern – Technical Data Solutions internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("evgo-intern-technical-data-solutions-internship-la", outputDir);
