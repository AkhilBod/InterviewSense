...
const articleData = {
  ...
  metaDescription: "Apply now for the Exact Sciences Data Science Intern internship in Madison, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("exact-sciences-data-science-intern-internship-madison", outputDir);
