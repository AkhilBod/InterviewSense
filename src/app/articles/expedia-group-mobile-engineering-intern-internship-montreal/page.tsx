...
const articleData = {
  ...
  metaDescription: "Apply now for the Expedia Group Mobile Engineering Intern internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("expedia-group-mobile-engineering-intern-internship-montreal", outputDir);
