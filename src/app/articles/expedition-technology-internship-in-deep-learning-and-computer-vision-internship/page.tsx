...
const articleData = {
  ...
  metaDescription: "Apply now for the Expedition Technology Internship in Deep Learning and Computer Vision internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("expedition-technology-internship-in-deep-learning-and-computer-vision-internship", outputDir);
