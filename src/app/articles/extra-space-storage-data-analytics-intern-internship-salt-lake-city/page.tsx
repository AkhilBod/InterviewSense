...
const articleData = {
  ...
  metaDescription: "Apply now for the Extra Space Storage Data Analytics Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("extra-space-storage-data-analytics-intern-internship-salt-lake-city", outputDir);
