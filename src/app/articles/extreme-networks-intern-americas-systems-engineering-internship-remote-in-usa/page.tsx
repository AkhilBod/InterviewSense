...
const articleData = {
  ...
  metaDescription: "Apply now for the Extreme Networks Intern: Americas Systems Engineering internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("extreme-networks-intern-americas-systems-engineering-internship-remote-in-usa", outputDir);
