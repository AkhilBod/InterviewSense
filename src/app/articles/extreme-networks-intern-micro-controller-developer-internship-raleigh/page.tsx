...
const articleData = {
  ...
  metaDescription: "Apply now for the Extreme Networks Intern – Micro Controller Developer internship in Raleigh, NC</br>Salem, NH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("extreme-networks-intern-micro-controller-developer-internship-raleigh", outputDir);
