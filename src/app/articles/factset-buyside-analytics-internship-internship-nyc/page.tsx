...
const articleData = {
  ...
  metaDescription: "Apply now for the FactSet Buy-Side Analytics Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("factset-buyside-analytics-internship-internship-nyc", outputDir);
