...
const articleData = {
  ...
  metaDescription: "Apply now for the FactSet Engineering Internship - Summer 2025 internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("factset-engineering-internship-summer-2025-internship-london", outputDir);
