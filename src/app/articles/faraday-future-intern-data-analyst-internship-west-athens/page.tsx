...
const articleData = {
  ...
  metaDescription: "Apply now for the Faraday Future Intern – Data Analyst internship in West Athens, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("faraday-future-intern-data-analyst-internship-west-athens", outputDir);
