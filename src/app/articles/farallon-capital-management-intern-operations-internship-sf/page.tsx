...
const articleData = {
  ...
  metaDescription: "Apply now for the Farallon Capital Management Intern – Operations internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("farallon-capital-management-intern-operations-internship-sf", outputDir);
