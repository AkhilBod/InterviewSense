...
const articleData = {
  ...
  metaDescription: "Apply now for the Fidelity Investments Advanced Strategies & Research Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fidelity-investments-advanced-strategies-research-intern-internship-boston", outputDir);
