...
const articleData = {
  ...
  metaDescription: "Apply now for the Fifth Third Bank Data Science & Data Engineering Intern internship in Cincinnati, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fifth-third-bank-data-science-data-engineering-intern-internship-cincinnati", outputDir);
