...
const articleData = {
  ...
  metaDescription: "Apply now for the Fifth Third Bank Enterprise Data Office College Co-op - Summer 2025 internship in Cincinnati, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fifth-third-bank-enterprise-data-office-college-coop-summer-2025-internship-cinc", outputDir);
