...
const articleData = {
  ...
  metaDescription: "Apply now for the Figure AI Robot Safety Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("figure-ai-robot-safety-intern-internship-san-jose", outputDir);
