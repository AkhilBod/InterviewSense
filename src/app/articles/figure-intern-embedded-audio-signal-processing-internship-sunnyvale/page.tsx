...
const articleData = {
  ...
  metaDescription: "Apply now for the Figure Intern – Embedded Audio Signal Processing internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("figure-intern-embedded-audio-signal-processing-internship-sunnyvale", outputDir);
