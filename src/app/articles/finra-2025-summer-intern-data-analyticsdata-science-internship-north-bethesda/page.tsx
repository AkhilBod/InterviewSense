...
const articleData = {
  ...
  metaDescription: "Apply now for the Finra 2025 Summer Intern - Data Analytics/Data Science internship in North Bethesda, MD</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("finra-2025-summer-intern-data-analyticsdata-science-internship-north-bethesda", outputDir);
