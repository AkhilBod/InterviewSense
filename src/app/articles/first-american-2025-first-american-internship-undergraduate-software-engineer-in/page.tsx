...
const articleData = {
  ...
  metaDescription: "Apply now for the First American 2025 First American Internship - Undergraduate - Software Engineer internship in Orange, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("first-american-2025-first-american-internship-undergraduate-software-engineer-in", outputDir);
