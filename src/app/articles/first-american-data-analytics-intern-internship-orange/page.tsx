...
const articleData = {
  ...
  metaDescription: "Apply now for the First American Data Analytics Intern internship in Orange, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("first-american-data-analytics-intern-internship-orange", outputDir);
