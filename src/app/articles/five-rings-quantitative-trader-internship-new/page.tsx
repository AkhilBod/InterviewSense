...
// Article metadata
const articleData = {
  slug: "five-rings-quantitative-trader-internship-new",
  title: "Five Rings Quantitative Trader Interview Questions",
  metaDescription: "Ace your Five Rings Quantitative Trader interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
  keywords: ["Five Rings interview", "Quantitative Trader interview questions", "Five Rings internship", "interview practice", "AI interview prep", "Five Rings Quantitative Trader", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.214Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Five Rings Quantitative Trader Interview Questions",
  "description": "Ace your Five Rings Quantitative Trader interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/five-rings-quantitative-trader-internship-new"
},
  openGraph: {
  "title": "Five Rings Quantitative Trader Interview Questions",
  "description": "Ace your Five Rings Quantitative Trader interview with AI-powered practice questions and feedback. Get ready for your New York internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("five-rings-quantitative-trader-internship-new", outputDir);
