...
const articleData = {
  ...
  metaDescription: "Apply now for the Five9 Data Science Intern internship in San Ramon, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("five9-data-science-intern-internship-san-ramon", outputDir);
