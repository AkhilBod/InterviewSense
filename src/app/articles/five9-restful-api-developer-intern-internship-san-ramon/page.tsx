...
const articleData = {
  ...
  metaDescription: "Apply now for the Five9 Restful API Developer Intern internship in San Ramon, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("five9-restful-api-developer-intern-internship-san-ramon", outputDir);
