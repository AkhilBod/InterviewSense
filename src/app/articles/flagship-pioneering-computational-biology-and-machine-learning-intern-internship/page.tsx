...
const articleData = {
  ...
  metaDescription: "Apply now for the Flagship Pioneering Computational Biology and Machine Learning Intern internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("flagship-pioneering-computational-biology-and-machine-learning-intern-internship", outputDir);
