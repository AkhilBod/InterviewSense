...
const articleData = {
  ...
  metaDescription: "Apply now for the Flipp Associate Software Engineer – Internship internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("flipp-associate-software-engineer-internship-internship-remote-in-canada", outputDir);
