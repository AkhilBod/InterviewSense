...
const articleData = {
  ...
  metaDescription: "Apply now for the FM Global Corporate Underwriting Data Analyst Intern internship in Providence, RI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fm-global-corporate-underwriting-data-analyst-intern-internship-providence", outputDir);
