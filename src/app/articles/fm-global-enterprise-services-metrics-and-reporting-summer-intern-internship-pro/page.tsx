...
const articleData = {
  ...
  metaDescription: "Apply now for the FM Global Enterprise Services Metrics and Reporting Summer Intern internship in Providence, RI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fm-global-enterprise-services-metrics-and-reporting-summer-intern-internship-pro", outputDir);
