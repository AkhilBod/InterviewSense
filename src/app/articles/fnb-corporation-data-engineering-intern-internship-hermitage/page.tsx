...
const articleData = {
  ...
  metaDescription: "Apply now for the F.N.B. Corporation Data Engineering Intern internship in Hermitage, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fnb-corporation-data-engineering-intern-internship-hermitage", outputDir);
