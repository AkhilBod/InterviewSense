...
const articleData = {
  ...
  metaDescription: "Apply now for the FNBO Summer Intern - System Support internship in Omaha, NE. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fnbo-summer-intern-system-support-internship-omaha", outputDir);
