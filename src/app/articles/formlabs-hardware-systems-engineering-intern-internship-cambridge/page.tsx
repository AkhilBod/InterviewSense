...
const articleData = {
  ...
  metaDescription: "Apply now for the Formlabs Hardware Systems Engineering Intern internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("formlabs-hardware-systems-engineering-intern-internship-cambridge", outputDir);
