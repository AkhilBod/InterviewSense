...
const articleData = {
  ...
  metaDescription: "Apply now for the Formlabs Python Software Intern - Summer 2025 internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("formlabs-python-software-intern-summer-2025-internship-cambridge", outputDir);
