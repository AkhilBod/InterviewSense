...
const articleData = {
  ...
  metaDescription: "Apply now for the Fortra Software Development Intern - Python and Linux internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fortra-software-development-intern-python-and-linux-internship-united-states", outputDir);
