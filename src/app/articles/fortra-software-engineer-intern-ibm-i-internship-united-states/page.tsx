...
const articleData = {
  ...
  metaDescription: "Apply now for the Fortra Software Engineer Intern - Ibm i internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fortra-software-engineer-intern-ibm-i-internship-united-states", outputDir);
