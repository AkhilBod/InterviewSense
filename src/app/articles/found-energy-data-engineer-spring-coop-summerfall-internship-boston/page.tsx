...
const articleData = {
  ...
  metaDescription: "Apply now for the Found Energy Data Engineer Spring Co-op Summer/Fall internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("found-energy-data-engineer-spring-coop-summerfall-internship-boston", outputDir);
