...
const articleData = {
  ...
  metaDescription: "Apply now for the FOX Summer 2025 FOX Technology Internship Program internship in Tempe, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fox-summer-2025-fox-technology-internship-program-internship-tempe", outputDir);
