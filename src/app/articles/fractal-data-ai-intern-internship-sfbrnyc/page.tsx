...
const articleData = {
  ...
  metaDescription: "Apply now for the Fractal Data & AI Intern internship in SF</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fractal-data-ai-intern-internship-sfbrnyc", outputDir);
