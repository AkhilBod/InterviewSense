...
const articleData = {
  ...
  metaDescription: "Apply now for the Franklin Templeton Enterprise Data & Analytics – Undergrad Intern internship in Baltimore, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("franklin-templeton-enterprise-data-analytics-undergrad-intern-internship-baltimo", outputDir);
