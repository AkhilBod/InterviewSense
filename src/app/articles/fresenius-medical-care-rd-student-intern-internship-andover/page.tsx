...
const articleData = {
  ...
  metaDescription: "Apply now for the Fresenius Medical Care R&D Student Intern internship in Andover, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("fresenius-medical-care-rd-student-intern-internship-andover", outputDir);
