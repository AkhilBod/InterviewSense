...
const articleData = {
  ...
  metaDescription: "Apply now for the G2 Data Analytics Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("g2-data-analytics-intern-internship-chicago", outputDir);
