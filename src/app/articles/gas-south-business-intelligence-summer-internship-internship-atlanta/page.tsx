...
const articleData = {
  ...
  metaDescription: "Apply now for the Gas South Business Intelligence Summer Internship internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gas-south-business-intelligence-summer-internship-internship-atlanta", outputDir);
