...
const articleData = {
  ...
  metaDescription: "Apply now for the GCM Grosvenor HR Data and Analytics Summer Intern internship in Chicago, IL</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gcm-grosvenor-hr-data-and-analytics-summer-intern-internship-chicago", outputDir);
