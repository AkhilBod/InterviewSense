...
const articleData = {
  ...
  metaDescription: "Apply now for the GCM Grosvenor Software Engineering Summer Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gcm-grosvenor-software-engineering-summer-intern-internship-chicago", outputDir);
