...
const articleData = {
  ...
  metaDescription: "Apply now for the GE Aerospace Analytics Co-op - Tableau Dashboard Development internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ge-aerospace-analytics-coop-tableau-dashboard-development-internship-boston", outputDir);
