...
const articleData = {
  ...
  metaDescription: "Apply now for the Gelber Group Algorithmic Trading Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gelber-group-algorithmic-trading-internship-internship-chicago", outputDir);
