...
const articleData = {
  ...
  metaDescription: "Apply now for the Gen Software Development Intern internship in Tempe, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gen-software-development-intern-internship-tempe", outputDir);
