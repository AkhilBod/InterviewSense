...
const articleData = {
  ...
  metaDescription: "Apply now for the Gen Software Engineering Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gen-software-engineering-intern-internship-mountain-view", outputDir);
