...
const articleData = {
  ...
  metaDescription: "Apply now for the General Atomics Intern - Software Developer internship in Poway, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("general-atomics-intern-software-developer-internship-poway", outputDir);
