...
const articleData = {
  ...
  metaDescription: "Apply now for the General Dynamics Software Intern Engineer internship in Florham Park, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("general-dynamicssoftware-intern-engineerinternshipflorham-park-nj", outputDir);
