...
const articleData = {
  ...
  metaDescription: "Apply now for the General Motors 2025 Summer Intern - ADAS Insights internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("general-motors-2025-summer-intern-adas-insights-internship-mountain-view", outputDir);
