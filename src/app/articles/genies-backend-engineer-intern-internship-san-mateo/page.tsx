...
const articleData = {
  ...
  metaDescription: "Apply now for the Genies Backend Engineer Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("genies-backend-engineer-intern-internship-san-mateo", outputDir);
