...
const articleData = {
  ...
  metaDescription: "Apply now for the Genies Full Stack Web Developer Intern internship in LA</br>San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("genies-full-stack-web-developer-intern-internship-labrsan-mateo", outputDir);
