...
const articleData = {
  ...
  metaDescription: "Apply now for the Gensler Student Internship - Gensler Research Institute - Data internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gensler-student-internship-gensler-research-institute-data-internship-nyc", outputDir);
