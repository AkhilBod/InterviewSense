...
const articleData = {
  ...
  metaDescription: "Apply now for the Genworth Financial IT Development Program Internship internship in Richmond, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("genworth-financial-it-development-program-internship-internship-richmond", outputDir);
