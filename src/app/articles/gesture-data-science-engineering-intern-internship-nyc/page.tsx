...
const articleData = {
  ...
  metaDescription: "Apply now for the Gesture Data Science Engineering Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gesture-data-science-engineering-intern-internship-nyc", outputDir);
