...
const articleData = {
  ...
  metaDescription: "Apply now for the Glassdoor Mobile Software Engineer in Test Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("glassdoor-mobile-software-engineer-in-test-intern-internship-sf", outputDir);
