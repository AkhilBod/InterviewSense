...
const articleData = {
  ...
  metaDescription: "Apply now for the Glean Software Engineer Intern - Design Systems - Summer internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("glean-software-engineer-intern-design-systems-summer-internship-palo-alto", outputDir);
