...
const articleData = {
  ...
  metaDescription: "Apply now for the Global Payments Data Analyst Intern internship in Alpharetta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("global-payments-data-analyst-intern-internship-alpharetta", outputDir);
