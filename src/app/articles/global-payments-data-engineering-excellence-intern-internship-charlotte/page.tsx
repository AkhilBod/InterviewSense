...
const articleData = {
  ...
  metaDescription: "Apply now for the Global Payments Data Engineering Excellence Intern internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("global-payments-data-engineering-excellence-intern-internship-charlotte", outputDir);
