...
const articleData = {
  ...
  metaDescription: "Apply now for the Global Relay Co-op Data Scientist internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("global-relay-coop-data-scientist-internship-vancouver", outputDir);
