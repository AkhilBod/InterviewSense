...
const articleData = {
  ...
  metaDescription: "Apply now for the GlobalFoundries End Markets Intern - Aerospace & Defense internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("globalfoundries-end-markets-intern-aerospace-defense-internship-santa-clara", outputDir);
