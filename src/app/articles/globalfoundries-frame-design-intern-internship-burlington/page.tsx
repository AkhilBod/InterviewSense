...
const articleData = {
  ...
  metaDescription: "Apply now for the GlobalFoundries Frame Design Intern internship in Burlington, VT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("globalfoundries-frame-design-intern-internship-burlington", outputDir);
