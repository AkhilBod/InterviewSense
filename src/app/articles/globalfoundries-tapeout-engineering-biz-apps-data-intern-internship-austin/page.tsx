...
const articleData = {
  ...
  metaDescription: "Apply now for the GlobalFoundries Tapeout Engineering Biz Apps & Data Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("globalfoundries-tapeout-engineering-biz-apps-data-intern-internship-austin", outputDir);
