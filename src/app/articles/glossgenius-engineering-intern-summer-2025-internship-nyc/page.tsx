...
const articleData = {
  ...
  metaDescription: "Apply now for the GlossGenius Engineering Intern - Summer 2025 internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("glossgenius-engineering-intern-summer-2025-internship-nyc", outputDir);
