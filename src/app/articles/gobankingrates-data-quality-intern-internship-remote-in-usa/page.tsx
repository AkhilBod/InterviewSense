...
const articleData = {
  ...
  metaDescription: "Apply now for the GOBankingRates Data Quality Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gobankingrates-data-quality-intern-internship-remote-in-usa", outputDir);
