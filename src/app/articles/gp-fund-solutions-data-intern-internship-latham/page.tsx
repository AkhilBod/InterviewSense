...
const articleData = {
  ...
  metaDescription: "Apply now for the GP Fund Solutions Data Intern internship in Latham, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gp-fund-solutions-data-intern-internship-latham", outputDir);
