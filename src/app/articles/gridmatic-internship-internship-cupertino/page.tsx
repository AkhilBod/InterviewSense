...
const articleData = {
  ...
  metaDescription: "Apply now for the Gridmatic Internship internship in Cupertino, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("gridmatic-internship-internship-cupertino", outputDir);
