...
const articleData = {
  ...
  metaDescription: "Apply now for the Groq Compound AI Engineering Intern internship in Palo Alto, CA</br>Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("groq-compound-ai-engineering-intern-internship-palo-alto", outputDir);
