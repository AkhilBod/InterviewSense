...
const articleData = {
  ...
  metaDescription: "Apply now for the Groupe Touchette Software Developer Intern (3 months) internship in Montreal, Quebec, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("groupe-touchette-software-developer-intern-3-months-internship-montreal", outputDir);
