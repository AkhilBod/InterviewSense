...
const articleData = {
  ...
  metaDescription: "Apply now for the Guidewire Consultant Developer Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("guidewire-consultant-developer-intern-internship-toronto", outputDir);
