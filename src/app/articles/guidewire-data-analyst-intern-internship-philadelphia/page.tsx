...
const articleData = {
  ...
  metaDescription: "Apply now for the Guidewire Data Analyst Intern internship in Philadelphia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("guidewire-data-analyst-intern-internship-philadelphia", outputDir);
