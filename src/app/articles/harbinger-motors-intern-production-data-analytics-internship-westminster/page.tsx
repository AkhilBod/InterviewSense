...
const articleData = {
  ...
  metaDescription: "Apply now for the Harbinger Motors Intern – Production Data Analytics internship in Westminster, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harbinger-motors-intern-production-data-analytics-internship-westminster", outputDir);
