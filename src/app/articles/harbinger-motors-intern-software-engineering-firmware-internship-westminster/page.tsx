...
const articleData = {
  ...
  metaDescription: "Apply now for the Harbinger Motors Intern – Software Engineering - Firmware internship in Westminster, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harbinger-motors-intern-software-engineering-firmware-internship-westminster", outputDir);
