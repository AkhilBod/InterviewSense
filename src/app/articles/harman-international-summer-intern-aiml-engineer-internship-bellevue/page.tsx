...
const articleData = {
  ...
  metaDescription: "Apply now for the HARMAN International Summer Intern - AI/ML Engineer internship in Bellevue, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harman-international-summer-intern-aiml-engineer-internship-bellevue", outputDir);
