...
const articleData = {
  ...
  metaDescription: "Apply now for the HARMAN International Summer Intern-Data Analyst internship in Novi, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harman-international-summer-interndata-analyst-internship-novi", outputDir);
