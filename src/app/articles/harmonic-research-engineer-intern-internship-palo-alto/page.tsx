...
const articleData = {
  ...
  metaDescription: "Apply now for the Harmonic Research Engineer – Intern internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harmonic-research-engineer-intern-internship-palo-alto", outputDir);
