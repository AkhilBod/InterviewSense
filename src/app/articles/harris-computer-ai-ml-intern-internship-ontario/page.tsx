...
const articleData = {
  ...
  metaDescription: "Apply now for the Harris Computer AI / ML Intern internship in Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harris-computer-ai-ml-intern-internship-ontario", outputDir);
