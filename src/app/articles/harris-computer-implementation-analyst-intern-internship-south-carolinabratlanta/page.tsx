...
const articleData = {
  ...
  metaDescription: "Apply now for the Harris Computer Implementation Analyst Intern internship in South Carolina</br>Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harris-computer-implementation-analyst-intern-internship-south-carolinabratlanta", outputDir);
