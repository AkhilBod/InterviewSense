...
const articleData = {
  ...
  metaDescription: "Apply now for the Harris Computer Software Development Intern internship in Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("harris-computer-software-development-intern-internship-ontario", outputDir);
