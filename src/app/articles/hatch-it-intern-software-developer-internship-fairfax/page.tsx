...
const articleData = {
  ...
  metaDescription: "Apply now for the Hatch IT Intern – Software Developer internship in Fairfax, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hatch-it-intern-software-developer-internship-fairfax", outputDir);
