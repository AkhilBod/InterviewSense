...
const articleData = {
  ...
  metaDescription: "Apply now for the Hatch IT Intern--Generative AI internship in Fairfax, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hatch-it-interngenerative-ai-internship-fairfax", outputDir);
