...
const articleData = {
  ...
  metaDescription: "Apply now for the HCSC University Relations – Associate Automation Programmer Intern internship in Richardson, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hcsc-university-relations-associate-automation-programmer-intern-internship-rich", outputDir);
