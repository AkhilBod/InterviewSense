...
const articleData = {
  ...
  metaDescription: "Apply now for the Healthfirst Provider Risk Analytics Intern - Finance internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("healthfirst-provider-risk-analytics-intern-finance-internship-nyc", outputDir);
