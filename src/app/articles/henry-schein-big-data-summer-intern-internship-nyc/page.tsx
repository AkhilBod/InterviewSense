...
const articleData = {
  ...
  metaDescription: "Apply now for the Henry Schein Big Data Summer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("henry-schein-big-data-summer-intern-internship-nyc", outputDir);
