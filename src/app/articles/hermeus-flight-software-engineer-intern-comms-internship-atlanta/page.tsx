...
const articleData = {
  ...
  metaDescription: "Apply now for the Hermeus Flight Software Engineer – Intern - Comms internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hermeus-flight-software-engineer-intern-comms-internship-atlanta", outputDir);
