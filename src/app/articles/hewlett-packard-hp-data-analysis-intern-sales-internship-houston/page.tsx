...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Data Analysis Intern - Sales internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-data-analysis-intern-sales-internship-houston", outputDir);
