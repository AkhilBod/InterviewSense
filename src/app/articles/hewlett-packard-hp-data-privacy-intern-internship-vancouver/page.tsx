...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Data Privacy Intern internship in Vancouver, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-data-privacy-intern-internship-vancouver", outputDir);
