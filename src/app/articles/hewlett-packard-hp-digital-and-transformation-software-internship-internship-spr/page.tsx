...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Digital and Transformation Software Internship internship in Spring, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-digital-and-transformation-software-internship-internship-spr", outputDir);
