...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Gaming Software Experience Engineer Intern internship in Spring, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-gaming-software-experience-engineer-intern-internship-spring", outputDir);
