...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Internship in Data Analysis and Dashboard Development internship in Sant Cugat del Vallès, Barcelona, Spain. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-internship-in-data-analysis-and-dashboard-development-interns", outputDir);
