...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Sales Analytics Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-sales-analytics-intern-internship-houston", outputDir);
