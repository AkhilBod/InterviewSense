...
const articleData = {
  ...
  metaDescription: "Apply now for the Hewlett Packard (HP) Software Developer Co-op internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hewlett-packard-hp-software-developer-coop-internship-kitchener", outputDir);
