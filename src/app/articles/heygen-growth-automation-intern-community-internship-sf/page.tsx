...
const articleData = {
  ...
  metaDescription: "Apply now for the HeyGen Growth Automation Intern - Community internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("heygen-growth-automation-intern-community-internship-sf", outputDir);
