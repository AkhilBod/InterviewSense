...
const articleData = {
  ...
  metaDescription: "Apply now for the Hitachi Rail Software Analyst Intern - C, C++, Python internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hitachi-railsoftware-analyst-intern-c-c-pythoninternshiptoronto-canada", outputDir);
