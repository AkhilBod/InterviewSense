...
const articleData = {
  ...
  metaDescription: "Apply now for the Hitachi Vantara Intern – Federal Data Science internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hitachi-vantara-intern-federal-data-science-internship-reston", outputDir);
