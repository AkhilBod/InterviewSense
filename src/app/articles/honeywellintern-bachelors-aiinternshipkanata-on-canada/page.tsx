...
const articleData = {
  ...
  metaDescription: "Apply now for the Honeywell Intern Bachelors AI internship in Kanata, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("honeywellintern-bachelors-aiinternshipkanata-on-canada", outputDir);
