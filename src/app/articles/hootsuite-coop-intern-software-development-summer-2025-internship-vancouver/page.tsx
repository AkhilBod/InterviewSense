...
const articleData = {
  ...
  metaDescription: "Apply now for the Hootsuite Co-Op/ Intern, Software Development - Summer 2025 internship in Vancouver, British Columbia, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hootsuite-coop-intern-software-development-summer-2025-internship-vancouver", outputDir);
