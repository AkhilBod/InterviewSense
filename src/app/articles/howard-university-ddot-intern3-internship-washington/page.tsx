...
const articleData = {
  ...
  metaDescription: "Apply now for the Howard University DDOT Intern-3 internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("howard-university-ddot-intern3-internship-washington", outputDir);
