...
const articleData = {
  ...
  metaDescription: "Apply now for the Howden Programmer Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("howden-programmer-intern-internship-dallas", outputDir);
