...
// Article metadata
const articleData = {
  slug: "hpr-hyannis-port-research-software-engineering-intern-internship-needham",
  title: "HPR (Hyannis Port Research) Software Engineering Intern 🛂 Interview Questions",
  metaDescription: "Ace your HPR (Hyannis Port Research) Software Engineering Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Needham, MA internship.",
  keywords: ["HPR (Hyannis Port Research) interview", "Software Engineering Intern 🛂 interview questions", "HPR (Hyannis Port Research) internship", "interview practice", "AI interview prep", "HPR (Hyannis Port Research) Software Engineering Intern 🛂", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.193Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "HPR (Hyannis Port Research) Software Engineering Intern 🛂 Interview Questions",
  "description": "Ace your HPR (Hyannis Port Research) Software Engineering Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Needham, MA internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/hpr-hyannis-port-research-software-engineering-intern-internship-needham"
},
  openGraph: {
  "title": "HPR (Hyannis Port Research) Software Engineering Intern 🛂 Interview Questions",
  "description": "Ace your HPR (Hyannis Port Research) Software Engineering Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Needham, MA internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hpr-hyannis-port-research-software-engineering-intern-internship-needham", outputDir);
