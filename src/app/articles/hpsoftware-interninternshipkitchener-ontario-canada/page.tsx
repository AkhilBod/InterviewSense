...
const articleData = {
  ...
  metaDescription: "Apply now for the HP Software Intern internship in Kitchener, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hpsoftware-interninternshipkitchener-ontario-canada", outputDir);
