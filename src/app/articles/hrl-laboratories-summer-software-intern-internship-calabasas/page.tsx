...
const articleData = {
  ...
  metaDescription: "Apply now for the HRL Laboratories Summer Software Intern internship in Calabasas, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hrl-laboratories-summer-software-intern-internship-calabasas", outputDir);
