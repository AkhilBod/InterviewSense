...
const articleData = {
  ...
  metaDescription: "Apply now for the HUB HUB International Internship Program Data Enablement Summer 2025 internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hub-hub-international-internship-program-data-enablement-summer-2025-internship-", outputDir);
