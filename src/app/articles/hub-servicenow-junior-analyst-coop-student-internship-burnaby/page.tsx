...
const articleData = {
  ...
  metaDescription: "Apply now for the HUB Servicenow Junior Analyst – Co-Op Student internship in Burnaby, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hub-servicenow-junior-analyst-coop-student-internship-burnaby", outputDir);
