...
const articleData = {
  ...
  metaDescription: "Apply now for the Hudl FP&a – Data Analyst Intern internship in Lincoln, NE. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hudl-fpa-data-analyst-intern-internship-lincoln", outputDir);
