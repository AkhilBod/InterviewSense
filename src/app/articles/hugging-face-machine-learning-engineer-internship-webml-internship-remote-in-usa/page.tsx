...
const articleData = {
  ...
  metaDescription: "Apply now for the Hugging Face Machine Learning Engineer Internship - Webml internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hugging-face-machine-learning-engineer-internship-webml-internship-remote-in-usa", outputDir);
