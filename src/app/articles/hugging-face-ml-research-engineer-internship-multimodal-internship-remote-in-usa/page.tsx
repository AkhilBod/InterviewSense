...
const articleData = {
  ...
  metaDescription: "Apply now for the Hugging Face ML Research Engineer Internship - Multimodal internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hugging-face-ml-research-engineer-internship-multimodal-internship-remote-in-usa", outputDir);
