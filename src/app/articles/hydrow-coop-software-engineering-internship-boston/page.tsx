...
const articleData = {
  ...
  metaDescription: "Apply now for the Hydrow Co-op: Software Engineering internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hydrow-coop-software-engineering-internship-boston", outputDir);
