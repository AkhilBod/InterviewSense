...
const articleData = {
  ...
  metaDescription: "Apply now for the Hypertherm Associates Intern – Software Engineering internship in California</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("hypertherm-associates-intern-software-engineering-internship-californiabrnyc", outputDir);
