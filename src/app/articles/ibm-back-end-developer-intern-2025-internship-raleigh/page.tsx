...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Back End Developer Intern: 2025 internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-back-end-developer-intern-2025-internship-raleigh", outputDir);
