...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Data and AI Intern internship in New York, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-data-and-ai-intern-internship-new-york", outputDir);
