...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Senior Data Scientist Intern - Corporate Development - M&a internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-senior-data-scientist-intern-corporate-development-ma-internship-nyc", outputDir);
