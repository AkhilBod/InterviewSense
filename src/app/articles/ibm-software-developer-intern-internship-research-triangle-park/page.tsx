...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Software Developer Intern internship in Research Triangle Park, NC</br>Poughkeepsie, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-software-developer-intern-internship-research-triangle-park", outputDir);
