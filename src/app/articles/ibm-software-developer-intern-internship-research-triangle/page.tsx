...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Software Developer Intern internship in Research Triangle, Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-software-developer-intern-internship-research-triangle", outputDir);
