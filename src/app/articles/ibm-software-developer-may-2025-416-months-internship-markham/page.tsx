...
const articleData = {
  ...
  metaDescription: "Apply now for the IBM Software Developer (May 2025 4-16 months) internship in Markham, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibm-software-developer-may-2025-416-months-internship-markham", outputDir);
