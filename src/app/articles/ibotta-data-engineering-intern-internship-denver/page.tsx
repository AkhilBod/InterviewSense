...
const articleData = {
  ...
  metaDescription: "Apply now for the ibotta Data Engineering Intern internship in Denver, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ibotta-data-engineering-intern-internship-denver", outputDir);
