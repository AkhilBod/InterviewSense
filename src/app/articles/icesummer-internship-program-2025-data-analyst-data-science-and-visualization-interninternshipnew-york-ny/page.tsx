...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("icesummer-internship-program-2025-data-analyst-data-science-and-visualization-interninternshipnew-york-ny", outputDir);
