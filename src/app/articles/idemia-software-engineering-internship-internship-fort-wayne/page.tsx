...
const articleData = {
  ...
  metaDescription: "Apply now for the IDEMIA Software Engineering Internship internship in Fort Wayne, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("idemia-software-engineering-internship-internship-fort-wayne", outputDir);
