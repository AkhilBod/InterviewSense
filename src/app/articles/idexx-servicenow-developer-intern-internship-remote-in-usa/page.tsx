...
const articleData = {
  ...
  metaDescription: "Apply now for the IDEXX Servicenow Developer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("idexx-servicenow-developer-intern-internship-remote-in-usa", outputDir);
