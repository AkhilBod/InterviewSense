...
const articleData = {
  ...
  metaDescription: "Apply now for the IKO BI Developer Co-Op internship in Mississauga, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("iko-bi-developer-coop-internship-mississauga", outputDir);
