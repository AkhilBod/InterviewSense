...
const articleData = {
  ...
  metaDescription: "Apply now for the Illumio Application Developer Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("illumio-application-developer-intern-internship-sunnyvale", outputDir);
