...
const articleData = {
  ...
  metaDescription: "Apply now for the Illumio Core – Intern - Unified Platform internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("illumio-core-intern-unified-platform-internship-sunnyvale", outputDir);
