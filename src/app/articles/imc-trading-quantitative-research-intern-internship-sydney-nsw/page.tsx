...
const articleData = {
  ...
  metaDescription: "Apply now for the IMC Trading Quantitative Research Intern internship in Sydney NSW, Australia. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("imc-trading-quantitative-research-intern-internship-sydney-nsw", outputDir);
