...
const articleData = {
  ...
  metaDescription: "Apply now for the IMO Health Natural Language Processing – Intern - NLP internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("imo-health-natural-language-processing-intern-nlp-internship-houston", outputDir);
