...
const articleData = {
  ...
  metaDescription: "Apply now for the Inflection Inflection AI Summer Internship Program internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("inflection-inflection-ai-summer-internship-program-internship-palo-alto", outputDir);
