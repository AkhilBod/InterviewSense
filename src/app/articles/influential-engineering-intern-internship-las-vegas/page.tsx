...
const articleData = {
  ...
  metaDescription: "Apply now for the Influential Engineering Intern internship in Las Vegas, NV</br>LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("influential-engineering-intern-internship-las-vegas", outputDir);
