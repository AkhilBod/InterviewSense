...
const articleData = {
  ...
  metaDescription: "Apply now for the Ingredion Analytics Power BI Development Intern internship in Brookfield, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ingredion-analytics-power-bi-development-intern-internship-brookfield", outputDir);
