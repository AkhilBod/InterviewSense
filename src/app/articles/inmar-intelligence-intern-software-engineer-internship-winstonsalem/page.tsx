...
const articleData = {
  ...
  metaDescription: "Apply now for the Inmar Intelligence Intern – Software Engineer internship in Winston-Salem, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("inmar-intelligence-intern-software-engineer-internship-winstonsalem", outputDir);
