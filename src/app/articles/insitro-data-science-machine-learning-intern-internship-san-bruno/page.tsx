...
const articleData = {
  ...
  metaDescription: "Apply now for the Insitro Data Science & Machine Learning Intern internship in San Bruno, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("insitro-data-science-machine-learning-intern-internship-san-bruno", outputDir);
