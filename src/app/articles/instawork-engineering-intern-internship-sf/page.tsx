...
const articleData = {
  ...
  metaDescription: "Apply now for the Instawork Engineering Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("instawork-engineering-intern-internship-sf", outputDir);
