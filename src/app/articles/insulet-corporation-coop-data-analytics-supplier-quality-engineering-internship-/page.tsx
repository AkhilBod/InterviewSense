...
const articleData = {
  ...
  metaDescription: "Apply now for the Insulet Corporation Co-op – Data Analytics Supplier Quality Engineering internship in Acton, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("insulet-corporation-coop-data-analytics-supplier-quality-engineering-internship-", outputDir);
