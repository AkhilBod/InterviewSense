...
const articleData = {
  ...
  metaDescription: "Apply now for the Insulet Corporation Intern – R&D Engineering Operations: June internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("insulet-corporation-intern-rd-engineering-operations-june-internship-san-diego", outputDir);
