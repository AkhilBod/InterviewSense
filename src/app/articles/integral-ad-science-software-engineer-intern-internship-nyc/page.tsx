...
const articleData = {
  ...
  metaDescription: "Apply now for the Integral Ad Science Software Engineer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("integral-ad-science-software-engineer-intern-internship-nyc", outputDir);
