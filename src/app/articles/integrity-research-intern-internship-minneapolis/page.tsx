...
const articleData = {
  ...
  metaDescription: "Apply now for the Integrity Research Intern internship in Minneapolis, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("integrity-research-intern-internship-minneapolis", outputDir);
