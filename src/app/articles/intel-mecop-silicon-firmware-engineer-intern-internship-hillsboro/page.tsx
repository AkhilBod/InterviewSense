...
const articleData = {
  ...
  metaDescription: "Apply now for the Intel MECOP Silicon Firmware Engineer Intern internship in Hillsboro, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intel-mecop-silicon-firmware-engineer-intern-internship-hillsboro", outputDir);
