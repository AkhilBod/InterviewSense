...
const articleData = {
  ...
  metaDescription: "Apply now for the Intel System and Software Optimization Engineer – Undergrad Intern - AI/ML internship in Marlborough, MA</br>Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intel-system-and-software-optimization-engineer-undergrad-intern-aiml-internship", outputDir);
