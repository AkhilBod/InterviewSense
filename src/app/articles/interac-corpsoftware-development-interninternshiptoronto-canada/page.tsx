...
const articleData = {
  ...
  metaDescription: "Apply now for the Interac Corp. Software Development Intern internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("interac-corpsoftware-development-interninternshiptoronto-canada", outputDir);
