...
const articleData = {
  ...
  metaDescription: "Apply now for the Intercontinental Exchange Intern - Database Analyst - Dba internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intercontinental-exchange-intern-database-analyst-dba-internship-atlanta", outputDir);
