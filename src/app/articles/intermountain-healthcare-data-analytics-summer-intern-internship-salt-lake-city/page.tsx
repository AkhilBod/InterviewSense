...
const articleData = {
  ...
  metaDescription: "Apply now for the Intermountain Healthcare Data Analytics Summer Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intermountain-healthcare-data-analytics-summer-intern-internship-salt-lake-city", outputDir);
