...
const articleData = {
  ...
  metaDescription: "Apply now for the Intermountain Healthcare Data Science Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intermountain-healthcare-data-science-intern-internship-salt-lake-city", outputDir);
