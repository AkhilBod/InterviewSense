...
const articleData = {
  ...
  metaDescription: "Apply now for the International Flavors & Fragrances Intern – Data Analytics internship in Matawan, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("international-flavors-fragrances-intern-data-analytics-internship-matawan", outputDir);
