...
const articleData = {
  ...
  metaDescription: "Apply now for the Intersect Power Data Systems Internship - Market Risk & Analytics internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intersect-power-data-systems-internship-market-risk-analytics-internship-remote-", outputDir);
