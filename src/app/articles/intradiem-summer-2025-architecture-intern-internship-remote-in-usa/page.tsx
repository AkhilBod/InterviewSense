...
const articleData = {
  ...
  metaDescription: "Apply now for the Intradiem Summer 2025 Architecture Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intradiem-summer-2025-architecture-intern-internship-remote-in-usa", outputDir);
