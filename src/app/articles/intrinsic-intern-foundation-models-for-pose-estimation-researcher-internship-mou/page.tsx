...
const articleData = {
  ...
  metaDescription: "Apply now for the Intrinsic Intern: Foundation Models for Pose Estimation Researcher internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intrinsic-intern-foundation-models-for-pose-estimation-researcher-internship-mou", outputDir);
