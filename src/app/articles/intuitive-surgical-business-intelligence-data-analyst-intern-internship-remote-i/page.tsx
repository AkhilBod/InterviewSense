...
const articleData = {
  ...
  metaDescription: "Apply now for the Intuitive Surgical Business Intelligence Data Analyst Intern internship in Remote in USA</br>Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intuitive-surgical-business-intelligence-data-analyst-intern-internship-remote-i", outputDir);
