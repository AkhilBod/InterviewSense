...
const articleData = {
  ...
  metaDescription: "Apply now for the Intuitive Surgical Data Science Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intuitive-surgical-data-science-intern-internship-sunnyvale", outputDir);
