...
const articleData = {
  ...
  metaDescription: "Apply now for the Intuitive Surgical Servo Software Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intuitive-surgical-servo-software-intern-internship-sunnyvale", outputDir);
