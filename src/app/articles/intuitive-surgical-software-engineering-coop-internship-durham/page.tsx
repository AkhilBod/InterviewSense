...
const articleData = {
  ...
  metaDescription: "Apply now for the Intuitive Surgical Software Engineering Co-op internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("intuitive-surgical-software-engineering-coop-internship-durham", outputDir);
