...
const articleData = {
  ...
  metaDescription: "Apply now for the Invesco Technology Intern internship in Houston, TX</br>Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("invesco-technology-intern-internship-houston", outputDir);
