...
const articleData = {
  ...
  metaDescription: "Apply now for the Invoice Cloud Data Analyst Intern internship in Boston, MA</br>Quincy, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("invoice-cloud-data-analyst-intern-internship-boston", outputDir);
