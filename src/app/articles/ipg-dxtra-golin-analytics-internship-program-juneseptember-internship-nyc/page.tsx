...
const articleData = {
  ...
  metaDescription: "Apply now for the IPG DXTRA Golin Analytics Internship Program - June-September internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ipg-dxtra-golin-analytics-internship-program-juneseptember-internship-nyc", outputDir);
