...
const articleData = {
  ...
  metaDescription: "Apply now for the Ivalua Customer Application Engineer Intern – 6 months full time internship internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ivalua-customer-application-engineer-intern-6-months-full-time-internship-intern", outputDir);
