...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Business Intelligence Analyst and Developer Intern internship in St. Petersburg, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-business-intelligence-analyst-and-developer-intern-internship-st-petersbur", outputDir);
