...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Finance Data Engineer Intern internship in St. Petersburg, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-finance-data-engineer-intern-internship-st-petersburg", outputDir);
