...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Financial Systems Developer Internship internship in St. Petersburg, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-financial-systems-developer-internship-internship-st-petersburg", outputDir);
