...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Operations Data Analyst Intern internship in Tampa, FL</br>St. Petersburg, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-operations-data-analyst-intern-internship-tampa", outputDir);
