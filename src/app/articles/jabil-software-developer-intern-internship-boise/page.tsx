...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Software Developer Intern internship in Boise, ID. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-software-developer-intern-internship-boise", outputDir);
