...
const articleData = {
  ...
  metaDescription: "Apply now for the Jabil Software Engineering Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jabil-software-engineering-intern-internship-austin", outputDir);
