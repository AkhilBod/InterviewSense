...
const articleData = {
  ...
  metaDescription: "Apply now for the Jackson Lewis Data Services Intern internship in Jacksonville, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jackson-lewis-data-services-intern-internship-jacksonville", outputDir);
