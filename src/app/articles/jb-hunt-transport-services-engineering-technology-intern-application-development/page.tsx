...
const articleData = {
  ...
  metaDescription: "Apply now for the J.B. Hunt Transport Services Engineering & Technology Intern: Application Development internship in Rogers, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jb-hunt-transport-services-engineering-technology-intern-application-development", outputDir);
