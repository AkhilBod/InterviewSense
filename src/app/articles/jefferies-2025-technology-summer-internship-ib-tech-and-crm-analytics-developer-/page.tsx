...
const articleData = {
  ...
  metaDescription: "Apply now for the Jefferies 2025 Technology Summer Internship - IB Tech and CRM & Analytics - Developer internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jefferies-2025-technology-summer-internship-ib-tech-and-crm-analytics-developer-", outputDir);
