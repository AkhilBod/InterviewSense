...
const articleData = {
  ...
  metaDescription: "Apply now for the JM Family Intern – Fixed Operations Data Analyst internship in Deerfield Beach, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jm-family-intern-fixed-operations-data-analyst-internship-deerfield-beach", outputDir);
