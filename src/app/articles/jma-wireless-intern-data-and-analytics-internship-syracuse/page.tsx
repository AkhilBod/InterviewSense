...
const articleData = {
  ...
  metaDescription: "Apply now for the JMA Wireless Intern – Data and Analytics internship in Syracuse, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jma-wireless-intern-data-and-analytics-internship-syracuse", outputDir);
