...
const articleData = {
  ...
  metaDescription: "Apply now for the Johnson Matthey Internship Program - Operations - Data Science internship in Berwyn, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("johnson-matthey-internship-program-operations-data-science-internship-berwyn", outputDir);
