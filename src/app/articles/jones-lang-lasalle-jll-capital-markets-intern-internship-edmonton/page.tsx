...
const articleData = {
  ...
  metaDescription: "Apply now for the Jones Lang LaSalle (JLL) Capital Markets Intern internship in Edmonton, AB, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jones-lang-lasalle-jll-capital-markets-intern-internship-edmonton", outputDir);
