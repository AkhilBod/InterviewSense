...
// Article metadata
const articleData = {
  slug: "jones-lang-lasalle-jll-cre-technology-summer-2025-internship-internship-chicago",
  title: "Jones Lang LaSalle (JLL) Internship: CRE Technology Summer 2025 Internship Position in Chicago, IL (2025)",
  metaDescription: "Apply now for the Jones Lang LaSalle (JLL) CRE Technology Summer 2025 Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["Jones Lang LaSalle (JLL) internship", "CRE Technology Summer 2025 Internship internship", "Jones Lang LaSalle (JLL) CRE Technology Summer 2025 Internship", "summer 2025 internship", "tech internship Chicago, IL", "software internship", "Jones Lang LaSalle (JLL) careers", "internship application", "tech jobs 2025", "Chicago internship", "Jones Lang LaSalle (JLL) Chicago", "IL internship", "Jones Lang LaSalle (JLL) IL", "software engineering internship", "software developer internship"],
  lastUpdated: "2025-06-19T22:10:25.665Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "CRE Technology Summer 2025 Internship Internship",
  "description": "CRE Technology Summer 2025 Internship internship opportunity at Jones Lang LaSalle (JLL) in Chicago, IL for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
  ...
  "url": "http://localhost:3000/internships/jones-lang-lasalle-jll-cre-technology-summer-2025-internship-internship-chicago",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "Jones Lang LaSalle (JLL) Internship: CRE Technology Summer 2025 Internship Position in Chicago, IL (2025)",
  "description": "Apply now for the Jones Lang LaSalle (JLL) CRE Technology Summer 2025 Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jones-lang-lasalle-jll-cre-technology-summer-2025-internship-internship-chicago", outputDir);
