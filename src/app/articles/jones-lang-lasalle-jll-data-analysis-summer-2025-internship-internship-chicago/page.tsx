...
const articleData = {
  ...
  metaDescription: "Apply now for the Jones Lang LaSalle (JLL) Data Analysis Summer 2025 Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jones-lang-lasalle-jll-data-analysis-summer-2025-internship-internship-chicago", outputDir);
