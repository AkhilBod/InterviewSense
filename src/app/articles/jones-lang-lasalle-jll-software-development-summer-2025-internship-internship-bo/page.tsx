...
const articleData = {
  ...
  metaDescription: "Apply now for the Jones Lang LaSalle (JLL) Software Development Summer 2025 Internship internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jones-lang-lasalle-jll-software-development-summer-2025-internship-internship-bo", outputDir);
