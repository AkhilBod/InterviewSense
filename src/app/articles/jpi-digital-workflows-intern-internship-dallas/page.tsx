...
const articleData = {
  ...
  metaDescription: "Apply now for the JPI Digital Workflows Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("jpi-digital-workflows-intern-internship-dallas", outputDir);
