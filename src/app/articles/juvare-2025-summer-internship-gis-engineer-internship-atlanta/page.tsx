...
const articleData = {
  ...
  metaDescription: "Apply now for the Juvare 2025 Summer Internship - GIS Engineer internship in Atlanta, GA</br>Fort Wayne, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("juvare-2025-summer-internship-gis-engineer-internship-atlanta", outputDir);
