...
const articleData = {
  ...
  metaDescription: "Apply now for the Kabam Backend Software Engineer Co-op internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kabam-backend-software-engineer-coop-internship-vancouver", outputDir);
