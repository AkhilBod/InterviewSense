...
const articleData = {
  ...
  metaDescription: "Apply now for the Kalderos Data Engineering Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kalderos-data-engineering-intern-internship-boston", outputDir);
