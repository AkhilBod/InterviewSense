...
const articleData = {
  ...
  metaDescription: "Apply now for the KBR Intern for Total Operational Weather Readiness-Satellites - Towr-S internship in Silver Spring, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-intern-for-total-operational-weather-readinesssatellites-towrs-internship-si", outputDir);
