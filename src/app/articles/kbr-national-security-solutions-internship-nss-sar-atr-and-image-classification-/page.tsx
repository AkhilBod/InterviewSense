...
const articleData = {
  ...
  metaDescription: "Apply now for the KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification internship in Beavercreek, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-national-security-solutions-internship-nss-sar-atr-and-image-classification-", outputDir);
