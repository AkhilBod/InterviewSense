...
// Article metadata
const articleData = {
  slug: "kbr-national-security-solutions-internship-nss-sar-atr-and-image-classification-internship-beavercreek",
  title: "KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification Interview Questions",
  metaDescription: "Ace your KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification interview with AI-powered practice questions and feedback. Get ready for your Beavercreek, OH internship.",
  keywords: ["KBR interview", "National Security Solutions – Internship - Nss - SAR ATR and Image Classification interview questions", "KBR internship", "interview practice", "AI interview prep", "KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification", "Cybersecurity interview questions"],
  lastUpdated: "2025-06-24T12:16:11.369Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification Interview Questions",
  "description": "Ace your KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification interview with AI-powered practice questions and feedback. Get ready for your Beavercreek, OH internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "datePublished": "2025-06-24T12:16:11.369Z",
  "url": "https://interviewsense.org/opportunities/kbr-national-security-solutions-internship-nss-sar-atr-and-image-classification-internship-beavercreek"
},
  openGraph: {
  "title": "KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification Interview Questions",
  "description": "Ace your KBR National Security Solutions – Internship - Nss - SAR ATR and Image Classification interview with AI-powered practice questions and feedback. Get ready for your Beavercreek, OH internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-national-security-solutions-internship-nss-sar-atr-and-image-classification-internship-beavercreek", outputDir);
