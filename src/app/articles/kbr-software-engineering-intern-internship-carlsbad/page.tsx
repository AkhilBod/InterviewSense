...
const articleData = {
  ...
  metaDescription: "Apply now for the KBR Software Engineering Intern internship in Carlsbad, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-software-engineering-intern-internship-carlsbad", outputDir);
