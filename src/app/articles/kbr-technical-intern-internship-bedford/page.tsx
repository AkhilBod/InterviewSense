...
const articleData = {
  ...
  metaDescription: "Apply now for the KBR Technical Intern internship in Bedford, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-technical-intern-internship-bedford", outputDir);
