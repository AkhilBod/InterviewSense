...
const articleData = {
  ...
  metaDescription: "Apply now for the KBR UAS Software Development Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kbr-uas-software-development-intern-internship-mountain-view", outputDir);
