...
const articleData = {
  ...
  metaDescription: "Apply now for the KeyBank 2025 Summer Consumer Analytics Internship internship in Brooklyn, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keybank-2025-summer-consumer-analytics-internship-internship-brooklyn", outputDir);
