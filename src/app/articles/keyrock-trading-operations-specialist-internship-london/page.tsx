...
const articleData = {
  ...
  metaDescription: "Apply now for the Keyrock Trading Operations Specialist internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keyrock-trading-operations-specialist-internship-london", outputDir);
