...
const articleData = {
  ...
  metaDescription: "Apply now for the Keysight Technologies, Inc. Application Engineering Intern internship in Colorado Springs, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keysight-technologies-inc-application-engineering-intern-internship-colorado-spr", outputDir);
