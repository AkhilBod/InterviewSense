...
const articleData = {
  ...
  metaDescription: "Apply now for the Keysight Technologies, Inc. Intern Tech III internship in Santa Rosa, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keysight-technologies-inc-intern-tech-iii-internship-santa-rosa", outputDir);
