...
const articleData = {
  ...
  metaDescription: "Apply now for the Keysight Technologies, Inc. IOT Security Researcher Internship internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keysight-technologies-inc-iot-security-researcher-internship-internship-austin", outputDir);
