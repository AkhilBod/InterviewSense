...
const articleData = {
  ...
  metaDescription: "Apply now for the Keysight Technologies, Inc. R&D – Software Intern - Network Test internship in Calabasas, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("keysight-technologies-inc-rd-software-intern-network-test-internship-calabasas", outputDir);
