...
const articleData = {
  ...
  metaDescription: "Apply now for the Kimberly-Clark Product Engineer Co-Op - Summer/Fall Term internship in Roswell, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kimberlyclark-product-engineer-coop-summerfall-term-internship-roswell", outputDir);
