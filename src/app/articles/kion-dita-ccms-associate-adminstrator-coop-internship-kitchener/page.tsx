...
const articleData = {
  ...
  metaDescription: "Apply now for the KION DITA CCMS Associate Adminstrator Co-op internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kion-dita-ccms-associate-adminstrator-coop-internship-kitchener", outputDir);
