...
const articleData = {
  ...
  metaDescription: "Apply now for the KION GenAI Agent Development Intern internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kion-genai-agent-development-intern-internship-atlanta", outputDir);
