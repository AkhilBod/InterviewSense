...
const articleData = {
  ...
  metaDescription: "Apply now for the KION Software Consultant Intern/Co-op internship in Grand Rapids, MI</br>Dallas, TX</br>Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kion-software-consultant-interncoop-internship-grand-rapids", outputDir);
