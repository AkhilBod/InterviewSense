...
const articleData = {
  ...
  metaDescription: "Apply now for the Kioxia Memory Business Unit Analyst Intern internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kioxia-memory-business-unit-analyst-intern-internship-irvine", outputDir);
