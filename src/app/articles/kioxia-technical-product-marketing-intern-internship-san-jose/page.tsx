...
const articleData = {
  ...
  metaDescription: "Apply now for the Kioxia Technical Product Marketing Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kioxia-technical-product-marketing-intern-internship-san-jose", outputDir);
