...
const articleData = {
  ...
  metaDescription: "Apply now for the Kitware Computer Vision Software Development Internship internship in Clifton Park, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kitware-computer-vision-software-development-internship-internship-clifton-park", outputDir);
