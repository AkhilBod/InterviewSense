...
const articleData = {
  ...
  metaDescription: "Apply now for the KLA HPC Product Engineer Intern internship in Milpitas, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kla-hpc-product-engineer-intern-internship-milpitas", outputDir);
