...
const articleData = {
  ...
  metaDescription: "Apply now for the Kodiak Robotics Intern - Motion Planning internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kodiak-robotics-intern-motion-planning-internship-mountain-view", outputDir);
