...
const articleData = {
  ...
  metaDescription: "Apply now for the Kodiak Robotics Summer 2025 Intern - Artificial Intelligence/Machine Learning internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kodiak-robotics-summer-2025-intern-artificial-intelligencemachine-learning-inter", outputDir);
