...
const articleData = {
  ...
  metaDescription: "Apply now for the Kodiak Robotics Summer 2025 Intern - Data Science internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kodiak-robotics-summer-2025-intern-data-science-internship-mountain-view", outputDir);
