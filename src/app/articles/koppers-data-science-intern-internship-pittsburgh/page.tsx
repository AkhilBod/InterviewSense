...
const articleData = {
  ...
  metaDescription: "Apply now for the Koppers Data Science Intern internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("koppers-data-science-intern-internship-pittsburgh", outputDir);
