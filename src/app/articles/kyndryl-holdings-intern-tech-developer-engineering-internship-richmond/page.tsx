...
const articleData = {
  ...
  metaDescription: "Apply now for the Kyndryl Holdings Intern - Tech Developer & Engineering internship in Richmond, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kyndryl-holdings-intern-tech-developer-engineering-internship-richmond", outputDir);
