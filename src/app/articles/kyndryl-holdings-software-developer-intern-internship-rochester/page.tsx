...
const articleData = {
  ...
  metaDescription: "Apply now for the Kyndryl Holdings Software Developer – Intern internship in Rochester, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("kyndryl-holdings-software-developer-intern-internship-rochester", outputDir);
