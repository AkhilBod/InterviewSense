...
const articleData = {
  ...
  metaDescription: "Apply now for the LabCorp Business Intelligence Intern internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("labcorp-business-intelligence-intern-internship-durham", outputDir);
