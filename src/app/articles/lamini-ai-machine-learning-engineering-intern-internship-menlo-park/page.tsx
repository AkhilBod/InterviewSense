...
const articleData = {
  ...
  metaDescription: "Apply now for the Lamini AI Machine Learning Engineering Intern internship in Menlo Park, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lamini-ai-machine-learning-engineering-intern-internship-menlo-park", outputDir);
