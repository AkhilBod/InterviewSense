...
const articleData = {
  ...
  metaDescription: "Apply now for the Las Vegas Sands Corp Intern – Sds internship in Las Vegas, NV. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("las-vegas-sands-corp-intern-sds-internship-las-vegas", outputDir);
