...
const articleData = {
  ...
  metaDescription: "Apply now for the Last Mile Education Fund 2025 REU Supplemental Funding internship in Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("last-mile-education-fund-2025-reu-supplemental-funding-internship-remote", outputDir);
