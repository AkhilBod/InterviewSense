...
const articleData = {
  ...
  metaDescription: "Apply now for the Lazard Quant Researcher Summer Internship internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lazard-quant-researcher-summer-internship-internship-boston", outputDir);
