...
const articleData = {
  ...
  metaDescription: "Apply now for the Legend Biotech Data Science Intern internship in Bridgewater Township, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("legend-biotech-data-science-intern-internship-bridgewater-township", outputDir);
