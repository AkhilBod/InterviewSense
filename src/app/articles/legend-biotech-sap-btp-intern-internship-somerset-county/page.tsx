...
const articleData = {
  ...
  metaDescription: "Apply now for the Legend Biotech Sap Btp Intern internship in Somerset County, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("legend-biotech-sap-btp-intern-internship-somerset-county", outputDir);
