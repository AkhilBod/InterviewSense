...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Aviation Software Engineer Intern internship in Huntsville, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-aviation-software-engineer-intern-internship-huntsville", outputDir);
