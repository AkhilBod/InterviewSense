...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos CTO Technical Intern - Artificial Intelligence internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-cto-technical-intern-artificial-intelligence-internship-reston", outputDir);
