...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Interactive AI Developer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-interactive-ai-developer-intern-internship-remote-in-usa", outputDir);
