...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Junior Software Engineer Intern internship in Tucson, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-junior-software-engineer-intern-internship-tucson", outputDir);
