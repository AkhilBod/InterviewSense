...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Machine Learning Intern internship in Arlington, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-machine-learning-intern-internship-arlington", outputDir);
