...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Power BI Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-power-bi-intern-internship-reston", outputDir);
