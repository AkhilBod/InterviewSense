...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Developer Co-op internship in Bethesda, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-developer-coop-internship-bethesda", outputDir);
