...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Development Intern internship in Chantilly, VA</br>Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-development-intern-internship-chantilly", outputDir);
