...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Engineer – Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-engineer-intern-internship-san-diego", outputDir);
