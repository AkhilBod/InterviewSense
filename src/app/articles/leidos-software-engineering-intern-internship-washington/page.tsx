...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Engineering Intern internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-engineering-intern-internship-washington", outputDir);
