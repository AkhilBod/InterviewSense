...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Specialist Intern internship in Gunpowder, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-specialist-intern-internship-gunpowder", outputDir);
