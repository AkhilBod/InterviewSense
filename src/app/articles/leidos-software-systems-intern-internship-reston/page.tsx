...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Software Systems Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-software-systems-intern-internship-reston", outputDir);
