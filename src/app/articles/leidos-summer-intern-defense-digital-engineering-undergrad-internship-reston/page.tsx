...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Summer Intern - Defense Digital Engineering Undergrad internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-summer-intern-defense-digital-engineering-undergrad-internship-reston", outputDir);
