...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Systems Integrator and Developer Intern internship in Bowie, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-systems-integrator-and-developer-intern-internship-bowie", outputDir);
