...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Tech Refresh/Data Analyst Intern internship in Alexandria, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-tech-refreshdata-analyst-intern-internship-alexandria", outputDir);
