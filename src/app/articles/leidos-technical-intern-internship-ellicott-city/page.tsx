...
const articleData = {
  ...
  metaDescription: "Apply now for the Leidos Technical Intern internship in Ellicott City, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("leidos-technical-intern-internship-ellicott-city", outputDir);
