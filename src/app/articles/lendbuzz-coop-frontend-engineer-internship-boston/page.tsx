...
const articleData = {
  ...
  metaDescription: "Apply now for the Lendbuzz Co-op – Frontend Engineer internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lendbuzz-coop-frontend-engineer-internship-boston", outputDir);
