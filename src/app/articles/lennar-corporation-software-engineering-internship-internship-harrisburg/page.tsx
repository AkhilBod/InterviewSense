...
const articleData = {
  ...
  metaDescription: "Apply now for the Lennar Corporation Software Engineering Internship internship in Harrisburg, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lennar-corporation-software-engineering-internship-internship-harrisburg", outputDir);
