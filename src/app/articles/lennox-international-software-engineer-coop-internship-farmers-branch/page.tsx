...
const articleData = {
  ...
  metaDescription: "Apply now for the Lennox International Software Engineer Co-Op internship in Farmers Branch, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lennox-international-software-engineer-coop-internship-farmers-branch", outputDir);
