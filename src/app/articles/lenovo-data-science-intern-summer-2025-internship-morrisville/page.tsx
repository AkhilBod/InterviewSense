...
const articleData = {
  ...
  metaDescription: "Apply now for the Lenovo Data Science Intern - Summer 2025 internship in Morrisville, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lenovo-data-science-intern-summer-2025-internship-morrisville", outputDir);
