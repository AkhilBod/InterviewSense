...
// Article metadata
const articleData = {
  slug: "lincoln-electric-robotics-software-engineering-student-intern-internship-waterlo",
  ...
  "url": "http://localhost:3000/internships/lincoln-electric-robotics-software-engineering-student-intern-internship-waterlo",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lincoln-electric-robotics-software-engineering-student-intern-internship-waterlo", outputDir);
