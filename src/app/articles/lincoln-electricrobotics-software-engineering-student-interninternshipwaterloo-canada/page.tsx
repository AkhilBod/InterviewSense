...
const articleData = {
  ...
  metaDescription: "Apply now for the Lincoln Electric Robotics Software Engineering Student Intern internship in Waterloo, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lincoln-electricrobotics-software-engineering-student-interninternshipwaterloo-canada", outputDir);
