...
const articleData = {
  ...
  metaDescription: "Apply now for the Live Nation Entertainment Data Analytics Intern internship in Culver City, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("live-nation-entertainment-data-analytics-intern-internship-culver-city", outputDir);
