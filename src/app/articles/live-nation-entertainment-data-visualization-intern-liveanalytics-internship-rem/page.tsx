...
const articleData = {
  ...
  metaDescription: "Apply now for the Live Nation Entertainment Data Visualization Intern - Liveanalytics internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("live-nation-entertainment-data-visualization-intern-liveanalytics-internship-rem", outputDir);
