...
const articleData = {
  ...
  metaDescription: "Apply now for the Live Nation Entertainment Software Engineer Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("live-nation-entertainment-software-engineer-intern-internship-reston", outputDir);
