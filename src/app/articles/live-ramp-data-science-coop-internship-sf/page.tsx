...
const articleData = {
  ...
  metaDescription: "Apply now for the Live Ramp Data Science Co-Op internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("live-ramp-data-science-coop-internship-sf", outputDir);
