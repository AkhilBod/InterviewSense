...
const articleData = {
  ...
  metaDescription: "Apply now for the LiveRamp Co-Op – Software Engineering internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("liveramp-coop-software-engineering-internship-sf", outputDir);
