...
const articleData = {
  ...
  metaDescription: "Apply now for the LiveRamp Intern – Data & Analytics Engineering internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("liveramp-intern-data-analytics-engineering-internship-remote-in-usa", outputDir);
