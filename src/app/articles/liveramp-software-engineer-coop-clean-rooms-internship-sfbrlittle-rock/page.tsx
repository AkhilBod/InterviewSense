...
const articleData = {
  ...
  metaDescription: "Apply now for the LiveRamp Software Engineer – Co-op - Clean Rooms internship in SF</br>Little Rock, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("liveramp-software-engineer-coop-clean-rooms-internship-sfbrlittle-rock", outputDir);
