...
const articleData = {
  ...
  metaDescription: "Apply now for the LKQ Software Development IT Internship internship in Nashville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lkq-software-development-it-internship-internship-nashville", outputDir);
