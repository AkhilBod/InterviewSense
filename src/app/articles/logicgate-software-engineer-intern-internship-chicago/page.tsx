...
const articleData = {
  ...
  metaDescription: "Apply now for the LogicGate Software Engineer Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("logicgate-software-engineer-intern-internship-chicago", outputDir);
