...
const articleData = {
  ...
  metaDescription: "Apply now for the Lowe's Software Engineer – Undergraduate Internship internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lowes-software-engineer-undergraduate-internship-internship-charlotte", outputDir);
