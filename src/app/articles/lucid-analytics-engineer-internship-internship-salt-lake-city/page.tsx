...
const articleData = {
  ...
  metaDescription: "Apply now for the Lucid Analytics Engineer Internship internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lucid-analytics-engineer-internship-internship-salt-lake-city", outputDir);
