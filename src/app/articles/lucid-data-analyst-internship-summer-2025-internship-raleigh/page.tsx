...
const articleData = {
  ...
  metaDescription: "Apply now for the Lucid Data Analyst Internship Summer 2025 internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lucid-data-analyst-internship-summer-2025-internship-raleigh", outputDir);
