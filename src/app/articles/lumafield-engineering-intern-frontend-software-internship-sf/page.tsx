...
const articleData = {
  ...
  metaDescription: "Apply now for the Lumafield Engineering Intern - Frontend Software internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lumafield-engineering-intern-frontend-software-internship-sf", outputDir);
