...
const articleData = {
  ...
  metaDescription: "Apply now for the Lumentum Metrology Simulator Co-op/Intern internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lumentum-metrology-simulator-coopintern-internship-ottawa", outputDir);
