...
const articleData = {
  ...
  metaDescription: "Apply now for the Lumentum Optical Algorithms and Analytics Engineering Co-op/Intern internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("lumentum-optical-algorithms-and-analytics-engineering-coopintern-internship-otta", outputDir);
