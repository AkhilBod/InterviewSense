...
const articleData = {
  ...
  metaDescription: "Apply now for the Mach9 Full-Stack Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mach9-fullstack-intern-internship-sf", outputDir);
