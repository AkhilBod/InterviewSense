...
const articleData = {
  ...
  metaDescription: "Apply now for the Magna Embedded Software Intern internship in Troy, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("magna-embedded-software-intern-internship-troy", outputDir);
