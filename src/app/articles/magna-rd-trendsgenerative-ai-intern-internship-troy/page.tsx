...
const articleData = {
  ...
  metaDescription: "Apply now for the Magna R&D Trends-Generative AI Intern internship in Troy, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("magna-rd-trendsgenerative-ai-intern-internship-troy", outputDir);
