...
const articleData = {
  ...
  metaDescription: "Apply now for the Major League Baseball 2025 Summer Intern - Technology internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("major-league-baseball-2025-summer-intern-technology-internship-nyc", outputDir);
