...
const articleData = {
  ...
  metaDescription: "Apply now for the Manulife Financial Data Specialist Intern/Co-op internship in Toronto, ON, Canada</br>Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("manulife-financial-data-specialist-interncoop-internship-toronto", outputDir);
