...
const articleData = {
  ...
  metaDescription: "Apply now for the Manulife Financial Investment Analyst Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("manulife-financial-investment-analyst-intern-internship-boston", outputDir);
