...
// Article metadata
const articleData = {
  slug: "manulife-financial-technology-coopintern-program-internship-kitchener",
  title: "Manulife Financial Internship: Technology Co-op/Intern Program Position in Kitchener, ON, Canada (2025)",
  metaDescription: "Apply now for the Manulife Financial Technology Co-op/Intern Program internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["Manulife Financial internship", "Technology Co-op/Intern Program internship", "Manulife Financial Technology Co-op/Intern Program", "summer 2025 internship", "tech internship Kitchener, ON, Canada", "software internship", "Manulife Financial careers", "internship application", "tech jobs 2025", "Kitchener internship", "Manulife Financial Kitchener", "ON internship", "Manulife Financial ON", "Canada internship", "Manulife Financial Canada"],
  lastUpdated: "2025-06-19T22:10:25.802Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "Technology Co-op/Intern Program Internship",
  "description": "Technology Co-op/Intern Program internship opportunity at Manulife Financial in Kitchener, ON, Canada for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
  ...
  "url": "http://localhost:3000/internships/manulife-financial-technology-coopintern-program-internship-kitchener",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "Manulife Financial Internship: Technology Co-op/Intern Program Position in Kitchener, ON, Canada (2025)",
  "description": "Apply now for the Manulife Financial Technology Co-op/Intern Program internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("manulife-financial-technology-coopintern-program-internship-kitchener", outputDir);
