...
const articleData = {
  ...
  metaDescription: "Apply now for the Marathon Petroleum Intern/Co-op RAD-IT internship in Ashland, KY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marathon-petroleum-interncoop-radit-internship-ashland", outputDir);
