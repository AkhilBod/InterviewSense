...
const articleData = {
  ...
  metaDescription: "Apply now for the Mark43 Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mark43-engineering-intern-internship-remote-in-usa", outputDir);
