...
// Article metadata
const articleData = {
  slug: "marquee-insurance-group-software-engineer-intern-internship-charleston",
  title: "Marquee Insurance Group Software Engineer Intern 🛂 Interview Questions",
  metaDescription: "Ace your Marquee Insurance Group Software Engineer Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charleston, SC internship.",
  keywords: ["Marquee Insurance Group interview", "Software Engineer Intern 🛂 interview questions", "Marquee Insurance Group internship", "interview practice", "AI interview prep", "Marquee Insurance Group Software Engineer Intern 🛂", "Software Engineering interview questions"],
  lastUpdated: "2025-08-05T22:46:29.191Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Marquee Insurance Group Software Engineer Intern 🛂 Interview Questions",
  "description": "Ace your Marquee Insurance Group Software Engineer Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charleston, SC internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/marquee-insurance-group-software-engineer-intern-internship-charleston"
},
  openGraph: {
  "title": "Marquee Insurance Group Software Engineer Intern 🛂 Interview Questions",
  "description": "Ace your Marquee Insurance Group Software Engineer Intern 🛂 interview with AI-powered practice questions and feedback. Get ready for your Charleston, SC internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marquee-insurance-group-software-engineer-intern-internship-charleston", outputDir);
