...
const articleData = {
  ...
  metaDescription: "Apply now for the Marsh & McLennan Catastrophe Advisory Co-op - College Program 2025 internship in Boston, MA</br>Philadelphia, PA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marsh-mclennan-catastrophe-advisory-coop-college-program-2025-internship-boston", outputDir);
