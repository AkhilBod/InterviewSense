...
const articleData = {
  ...
  metaDescription: "Apply now for the Marsh & McLennan Data Strategy Analytics Engineering Co-op - College Program 2025 internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marsh-mclennan-data-strategy-analytics-engineering-coop-college-program-2025-int", outputDir);
