...
const articleData = {
  ...
  metaDescription: "Apply now for the Marsh & McLennan ICAT Applications Development Intern internship in Broomfield, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marsh-mclennan-icat-applications-development-intern-internship-broomfield", outputDir);
