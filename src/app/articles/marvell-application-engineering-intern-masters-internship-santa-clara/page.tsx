...
const articleData = {
  ...
  metaDescription: "Apply now for the Marvell Application Engineering Intern - Masters internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marvell-application-engineering-intern-masters-internship-santa-clara", outputDir);
