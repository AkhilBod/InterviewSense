...
const articleData = {
  ...
  metaDescription: "Apply now for the Marvell Comprehensive Simulator Framework Developer Intern - Bachelors internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marvell-comprehensive-simulator-framework-developer-intern-bachelors-internship-", outputDir);
