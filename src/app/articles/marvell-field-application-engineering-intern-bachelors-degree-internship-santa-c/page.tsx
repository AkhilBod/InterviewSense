...
const articleData = {
  ...
  metaDescription: "Apply now for the Marvell Field Application Engineering Intern - Bachelor's degree internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marvell-field-application-engineering-intern-bachelors-degree-internship-santa-c", outputDir);
