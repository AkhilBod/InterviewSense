...
const articleData = {
  ...
  metaDescription: "Apply now for the Marvell People Analytics Intern internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("marvell-people-analytics-intern-internship-santa-clara", outputDir);
