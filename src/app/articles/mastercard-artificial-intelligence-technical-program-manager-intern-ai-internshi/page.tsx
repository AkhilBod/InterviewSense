...
const articleData = {
  ...
  metaDescription: "Apply now for the Mastercard Artificial Intelligence – Technical Program Manager Intern - AI internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mastercard-artificial-intelligence-technical-program-manager-intern-ai-internshi", outputDir);
