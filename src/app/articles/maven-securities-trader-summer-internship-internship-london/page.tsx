...
const articleData = {
  ...
  metaDescription: "Apply now for the Maven Securities Trader Summer Internship internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("maven-securities-trader-summer-internship-internship-london", outputDir);
