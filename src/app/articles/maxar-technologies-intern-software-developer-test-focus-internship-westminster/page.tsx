...
const articleData = {
  ...
  metaDescription: "Apply now for the Maxar Technologies Intern – Software Developer - Test Focus internship in Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("maxar-technologies-intern-software-developer-test-focus-internship-westminster", outputDir);
