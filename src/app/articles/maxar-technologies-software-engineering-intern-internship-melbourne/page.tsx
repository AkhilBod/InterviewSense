...
const articleData = {
  ...
  metaDescription: "Apply now for the Maxar Technologies Software Engineering Intern internship in Melbourne, FL</br>Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("maxar-technologies-software-engineering-intern-internship-melbourne", outputDir);
