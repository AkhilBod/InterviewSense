...
const articleData = {
  ...
  metaDescription: "Apply now for the MBTA Intern – Transit Tech internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mbta-intern-transit-tech-internship-boston", outputDir);
