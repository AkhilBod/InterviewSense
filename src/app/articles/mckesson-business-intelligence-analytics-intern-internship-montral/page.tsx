...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Business Intelligence & Analytics Intern internship in Montréal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-business-intelligence-analytics-intern-internship-montral", outputDir);
