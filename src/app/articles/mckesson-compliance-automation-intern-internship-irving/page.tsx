...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Compliance Automation Intern internship in Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-compliance-automation-intern-internship-irving", outputDir);
