...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Data Engineering/Quality Intern internship in Montréal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-data-engineeringquality-intern-internship-montral", outputDir);
