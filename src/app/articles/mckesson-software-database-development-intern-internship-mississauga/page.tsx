...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Software & Database Development Intern internship in Mississauga, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-software-database-development-intern-internship-mississauga", outputDir);
