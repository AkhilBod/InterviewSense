...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Stagiaire en automatisation robotisée des processus – Intern - Arp - RPA internship in Montréal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-stagiaire-en-automatisation-robotise-des-processus-intern-arp-rpa-inter", outputDir);
