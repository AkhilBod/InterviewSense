...
const articleData = {
  ...
  metaDescription: "Apply now for the McKesson Stagiaire en gestion des données maîtresses – Intern - MDM internship in Montréal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mckesson-stagiaire-en-gestion-des-donnes-matresses-intern-mdm-internship-montral", outputDir);
