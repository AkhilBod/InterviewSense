...
const articleData = {
  ...
  metaDescription: "Apply now for the Medline Business Analytics Intern internship in Northbrook, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("medline-business-analytics-intern-internship-northbrook", outputDir);
