...
const articleData = {
  ...
  metaDescription: "Apply now for the Medline IT Business Systems Intern - Sap/Erp internship in Northbrook, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("medline-it-business-systems-intern-saperp-internship-northbrook", outputDir);
