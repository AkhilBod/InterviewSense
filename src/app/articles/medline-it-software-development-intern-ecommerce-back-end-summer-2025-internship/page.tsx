...
const articleData = {
  ...
  metaDescription: "Apply now for the Medline IT Software Development Intern - E-Commerce Back End - Summer 2025 internship in Northbrook, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("medline-it-software-development-intern-ecommerce-back-end-summer-2025-internship", outputDir);
