...
const articleData = {
  ...
  metaDescription: "Apply now for the Medpace, Inc. Software Development Co-Op internship in Cincinnati, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("medpace-inc-software-development-coop-internship-cincinnati", outputDir);
