...
const articleData = {
  ...
  metaDescription: "Apply now for the Mercedes-Benz Speech AI Intern - Speech Product Development internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mercedesbenz-speech-ai-intern-speech-product-development-internship-san-jose", outputDir);
