...
const articleData = {
  ...
  metaDescription: "Apply now for the Merck 2025 University Recruiting - Data Science Intern internship in Rahway, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("merck-2025-university-recruiting-data-science-intern-internship-rahway", outputDir);
