...
const articleData = {
  ...
  metaDescription: "Apply now for the Merck Technologue numérique - Digital Technologist internship in Pointe-Claire, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("merck-technologue-numrique-digital-technologist-internship-pointeclaire", outputDir);
