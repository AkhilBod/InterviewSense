...
const articleData = {
  ...
  metaDescription: "Apply now for the MFS Quant Research Associate Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mfs-quant-research-associate-intern-internship-boston", outputDir);
