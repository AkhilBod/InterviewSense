...
const articleData = {
  ...
  metaDescription: "Apply now for the Minitab Information Development Intern internship in State College, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("minitab-information-development-intern-internship-state-college", outputDir);
