...
const articleData = {
  ...
  metaDescription: "Apply now for the Mistplay Stagiaire en science des données – Data Scientist Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mistplay-stagiaire-en-science-des-donnes-data-scientist-intern-internship-toront", outputDir);
