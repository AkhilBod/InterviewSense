...
const articleData = {
  ...
  metaDescription: "Apply now for the Mistral AI Applied AI Engineer – Internship internship in Paris, France. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mistral-ai-applied-ai-engineer-internship-internship-paris", outputDir);
