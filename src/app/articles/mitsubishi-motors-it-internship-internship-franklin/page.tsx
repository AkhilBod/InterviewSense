...
const articleData = {
  ...
  metaDescription: "Apply now for the Mitsubishi Motors IT Internship internship in Franklin, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mitsubishi-motors-it-internship-internship-franklin", outputDir);
