...
const articleData = {
  ...
  metaDescription: "Apply now for the MKS Instruments 2025 Summer IT Analytics and Dashboards Intern/co-op internship in Andover, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mks-instruments-2025-summer-it-analytics-and-dashboards-interncoop-internship-an", outputDir);
