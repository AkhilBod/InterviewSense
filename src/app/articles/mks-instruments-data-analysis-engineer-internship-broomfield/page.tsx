...
const articleData = {
  ...
  metaDescription: "Apply now for the MKS Instruments Data Analysis Engineer internship in Broomfield, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mks-instruments-data-analysis-engineer-internship-broomfield", outputDir);
