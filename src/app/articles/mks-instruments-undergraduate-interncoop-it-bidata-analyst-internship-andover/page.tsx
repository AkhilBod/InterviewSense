...
const articleData = {
  ...
  metaDescription: "Apply now for the MKS Instruments Undergraduate Intern/Co-op - IT BI/Data Analyst internship in Andover, MA</br>Austin, TX</br>Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mks-instruments-undergraduate-interncoop-it-bidata-analyst-internship-andover", outputDir);
