...
const articleData = {
  ...
  metaDescription: "Apply now for the Modernizing Medicine Data Engineering Intern internship in Boca Raton, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("modernizing-medicine-data-engineering-intern-internship-boca-raton", outputDir);
