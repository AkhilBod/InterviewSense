...
const articleData = {
  ...
  metaDescription: "Apply now for the Modular Summer Internship 2025 - Data Engineering internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("modular-summer-internship-2025-data-engineering-internship-mountain-view", outputDir);
