...
const articleData = {
  ...
  metaDescription: "Apply now for the Monad Labs Summer 2025 Research Intern internship in Remote in USA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("monad-labs-summer-2025-research-intern-internship-remote-in-usabrnyc", outputDir);
