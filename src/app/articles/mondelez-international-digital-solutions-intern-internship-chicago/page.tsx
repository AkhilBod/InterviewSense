...
const articleData = {
  ...
  metaDescription: "Apply now for the Mondelez International Digital Solutions Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mondelez-international-digital-solutions-intern-internship-chicago", outputDir);
