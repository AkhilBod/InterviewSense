...
const articleData = {
  ...
  metaDescription: "Apply now for the MoneyLion Backend Java Engineering Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moneylion-backend-java-engineering-intern-internship-nyc", outputDir);
