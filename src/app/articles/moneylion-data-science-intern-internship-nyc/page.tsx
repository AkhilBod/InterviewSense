...
const articleData = {
  ...
  metaDescription: "Apply now for the MoneyLion Data Science Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moneylion-data-science-intern-internship-nyc", outputDir);
