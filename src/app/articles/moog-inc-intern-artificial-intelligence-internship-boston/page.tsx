...
const articleData = {
  ...
  metaDescription: "Apply now for the Moog Inc Intern – Artificial Intelligence internship in Boston, NY</br>Buffalo, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moog-inc-intern-artificial-intelligence-internship-boston", outputDir);
