...
const articleData = {
  ...
  metaDescription: "Apply now for the Moog Inc Intern – Engineering internship in Cheektowaga, NY</br>Buffalo, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moog-inc-intern-engineering-internship-cheektowaga", outputDir);
