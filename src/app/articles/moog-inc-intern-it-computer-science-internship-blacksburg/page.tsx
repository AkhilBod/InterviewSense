...
const articleData = {
  ...
  metaDescription: "Apply now for the Moog Inc Intern – IT Computer Science internship in Blacksburg, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moog-inc-intern-it-computer-science-internship-blacksburg", outputDir);
