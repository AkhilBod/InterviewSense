...
const articleData = {
  ...
  metaDescription: "Apply now for the Moog Inc Intern – Software Engineering internship in Wheat Ridge, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("moog-inc-intern-software-engineering-internship-wheat-ridge", outputDir);
