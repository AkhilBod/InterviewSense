...
const articleData = {
  ...
  metaDescription: "Apply now for the Motive Embedded Engineer Intern internship in Buffalo, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motive-embedded-engineer-intern-internship-buffalo", outputDir);
