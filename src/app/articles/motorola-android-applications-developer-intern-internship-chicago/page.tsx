...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Android Applications Developer Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-android-applications-developer-intern-internship-chicago", outputDir);
