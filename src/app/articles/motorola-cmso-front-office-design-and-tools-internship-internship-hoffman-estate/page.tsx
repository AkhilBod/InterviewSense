...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola CMSO Front Office Design and Tools Internship internship in Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-cmso-front-office-design-and-tools-internship-internship-hoffman-estate", outputDir);
