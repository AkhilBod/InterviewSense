...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Computer Engineer Intern - Summer 2025 internship in Irmo, SC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-computer-engineer-intern-summer-2025-internship-irmo", outputDir);
