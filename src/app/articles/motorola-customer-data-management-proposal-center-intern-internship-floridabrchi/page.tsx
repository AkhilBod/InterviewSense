...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Customer Data Management & Proposal Center Intern internship in Florida</br>Chicago, IL</br>Plantation, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-customer-data-management-proposal-center-intern-internship-floridabrchi", outputDir);
