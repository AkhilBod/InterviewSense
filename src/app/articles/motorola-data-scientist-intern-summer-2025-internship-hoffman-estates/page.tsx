...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Data Scientist Intern - Summer 2025 internship in Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-data-scientist-intern-summer-2025-internship-hoffman-estates", outputDir);
