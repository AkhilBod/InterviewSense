...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Devops Software Internship internship in Dallas, TX</br>Remote in USA</br>Culver City, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-devops-software-internship-internship-dallas", outputDir);
