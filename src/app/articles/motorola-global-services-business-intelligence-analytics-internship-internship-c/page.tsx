...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Global Services Business Intelligence & Analytics Internship internship in Chicago, IL</br>Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-global-services-business-intelligence-analytics-internship-internship-c", outputDir);
