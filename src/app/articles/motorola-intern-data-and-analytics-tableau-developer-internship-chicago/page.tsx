...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Intern - Data and Analytics Tableau Developer internship in Chicago, IL</br>Plantation, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-intern-data-and-analytics-tableau-developer-internship-chicago", outputDir);
