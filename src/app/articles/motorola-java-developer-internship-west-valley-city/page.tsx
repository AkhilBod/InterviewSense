...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Java Developer internship in West Valley City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-java-developer-internship-west-valley-city", outputDir);
