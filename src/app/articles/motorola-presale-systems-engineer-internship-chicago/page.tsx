...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Presale Systems Engineer internship in Chicago, IL</br>Minnesota</br>Illinois. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-presale-systems-engineer-internship-chicago", outputDir);
