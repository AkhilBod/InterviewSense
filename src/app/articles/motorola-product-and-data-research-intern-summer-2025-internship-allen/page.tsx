...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Product and Data Research Intern - Summer 2025 internship in Allen, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-product-and-data-research-intern-summer-2025-internship-allen", outputDir);
