...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software as a Service – Presales Intern – 2025 Summer Internship internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-as-a-service-presales-intern-2025-summer-internship-internship", outputDir);
