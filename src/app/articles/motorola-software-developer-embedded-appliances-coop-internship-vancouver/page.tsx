...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Developer – Embedded Appliances Co-Op internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-developer-embedded-appliances-coop-internship-vancouver", outputDir);
