...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Development 2024 Co-Op internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-development-2024-coop-internship-united-states", outputDir);
