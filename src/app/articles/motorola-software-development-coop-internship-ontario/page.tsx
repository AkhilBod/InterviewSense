...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Development Co-Op internship in Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-development-coop-internship-ontario", outputDir);
