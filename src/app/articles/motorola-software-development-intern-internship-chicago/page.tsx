...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Development Intern internship in Chicago, IL</br>Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-development-intern-internship-chicago", outputDir);
