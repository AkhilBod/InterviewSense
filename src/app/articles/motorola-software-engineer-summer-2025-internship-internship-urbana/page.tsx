...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Engineer Summer 2025 Internship internship in Urbana, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-engineer-summer-2025-internship-internship-urbana", outputDir);
