...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Engineering – 2025 Summer Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-engineering-2025-summer-internship-internship-chicago", outputDir);
