...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Engineering Co-Op internship in Allen, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-engineering-coop-internship-allen", outputDir);
