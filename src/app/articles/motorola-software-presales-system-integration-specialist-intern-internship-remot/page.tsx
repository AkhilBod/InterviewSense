...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Software Presales System Integration Specialist Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-software-presales-system-integration-specialist-intern-internship-remot", outputDir);
