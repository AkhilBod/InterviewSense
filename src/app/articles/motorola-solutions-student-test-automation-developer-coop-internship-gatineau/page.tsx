...
const articleData = {
  ...
  metaDescription: "Apply now for the Motorola Solutions Student Test Automation Developer Co-Op internship in Gatineau, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("motorola-solutions-student-test-automation-developer-coop-internship-gatineau", outputDir);
