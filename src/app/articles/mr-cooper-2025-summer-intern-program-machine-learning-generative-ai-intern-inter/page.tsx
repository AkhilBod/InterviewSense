...
const articleData = {
  ...
  metaDescription: "Apply now for the Mr. Cooper 2025 Summer Intern Program - Machine Learning & Generative AI Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mr-cooper-2025-summer-intern-program-machine-learning-generative-ai-intern-inter", outputDir);
