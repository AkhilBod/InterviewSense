...
const articleData = {
  ...
  metaDescription: "Apply now for the Mr. Cooper Capital Markets Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mr-cooper-capital-markets-intern-internship-dallas", outputDir);
