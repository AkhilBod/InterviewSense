...
const articleData = {
  ...
  metaDescription: "Apply now for the Mr. Cooper Data Engineer Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mr-cooper-data-engineer-intern-internship-dallas", outputDir);
