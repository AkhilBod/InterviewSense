...
const articleData = {
  ...
  metaDescription: "Apply now for the Mr. Cooper Product Analyst - AI / Machine Learning Intern internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mr-cooper-product-analyst-ai-machine-learning-intern-internship-dallas", outputDir);
