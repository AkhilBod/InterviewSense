...
const articleData = {
  ...
  metaDescription: "Apply now for the MRC Global Summer Intern-Data and Analytics internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mrc-global-summer-interndata-and-analytics-internship-houston", outputDir);
