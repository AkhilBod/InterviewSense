...
const articleData = {
  ...
  metaDescription: "Apply now for the MRI Software Software Engineering Intern internship in Cleveland, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mri-software-software-engineering-intern-internship-cleveland", outputDir);
