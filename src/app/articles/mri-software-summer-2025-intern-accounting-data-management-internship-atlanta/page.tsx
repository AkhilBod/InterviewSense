...
const articleData = {
  ...
  metaDescription: "Apply now for the MRI Software Summer 2025 Intern - Accounting Data Management internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mri-software-summer-2025-intern-accounting-data-management-internship-atlanta", outputDir);
