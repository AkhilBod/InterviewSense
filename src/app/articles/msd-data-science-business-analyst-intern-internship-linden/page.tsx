...
const articleData = {
  ...
  metaDescription: "Apply now for the MSD Data Science Business Analyst Intern internship in Linden, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("msd-data-science-business-analyst-intern-internship-linden", outputDir);
