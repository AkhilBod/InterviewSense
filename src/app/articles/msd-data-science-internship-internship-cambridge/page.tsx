...
const articleData = {
  ...
  metaDescription: "Apply now for the MSD Data Science Internship internship in Cambridge, MA</br>North Wales, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("msd-data-science-internship-internship-cambridge", outputDir);
