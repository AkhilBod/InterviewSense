...
const articleData = {
  ...
  metaDescription: "Apply now for the MSD Performance Data Management Intern internship in North Wales, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("msd-performance-data-management-intern-internship-north-wales", outputDir);
