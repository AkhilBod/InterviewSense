...
const articleData = {
  ...
  metaDescription: "Apply now for the Mujin Mujin – Internships internship in Suwanee, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("mujin-mujin-internships-internship-suwanee", outputDir);
