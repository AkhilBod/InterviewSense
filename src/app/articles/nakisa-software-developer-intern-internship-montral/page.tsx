...
const articleData = {
  ...
  metaDescription: "Apply now for the Nakisa Software Developer Intern internship in Montréal, Quebec, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nakisa-software-developer-intern-internship-montral", outputDir);
