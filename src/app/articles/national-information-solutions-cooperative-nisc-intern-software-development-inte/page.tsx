...
// Article metadata
const articleData = {
  slug: "national-information-solutions-cooperative-nisc-intern-software-development-inte",
  title: "National Information Solutions Cooperative (NISC) Internship: Intern – Software Development Position in Lake St Louis, MO (2025)",
  metaDescription: "Apply now for the National Information Solutions Cooperative (NISC) Intern – Software Development internship in Lake St Louis, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["National Information Solutions Cooperative (NISC) internship", "Intern – Software Development internship", "National Information Solutions Cooperative (NISC) Intern – Software Development", "summer 2025 internship", "tech internship Lake St Louis, MO", "software internship", "National Information Solutions Cooperative (NISC) careers", "internship application", "tech jobs 2025", "Lake St Louis internship", "National Information Solutions Cooperative (NISC) Lake St Louis", "MO internship", "National Information Solutions Cooperative (NISC) MO", "software engineering internship", "software developer internship"],
  lastUpdated: "2025-06-19T22:10:25.814Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "Intern – Software Development Internship",
  "description": "Intern – Software Development internship opportunity at National Information Solutions Cooperative (NISC) in Lake St Louis, MO for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
  ...
  "url": "http://localhost:3000/internships/national-information-solutions-cooperative-nisc-intern-software-development-inte",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "National Information Solutions Cooperative (NISC) Internship: Intern – Software Development Position in Lake St Louis, MO (2025)",
  "description": "Apply now for the National Information Solutions Cooperative (NISC) Intern – Software Development internship in Lake St Louis, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("national-information-solutions-cooperative-nisc-intern-software-development-inte", outputDir);
