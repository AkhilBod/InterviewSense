...
const articleData = {
  ...
  metaDescription: "Apply now for the National Information Solutions Cooperative (NISC) Intern – Software Development - IOS internship in Lake St Louis, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("national-information-solutions-cooperative-nisc-intern-software-development-ios-", outputDir);
