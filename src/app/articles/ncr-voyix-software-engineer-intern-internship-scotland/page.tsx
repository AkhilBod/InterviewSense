...
const articleData = {
  ...
  metaDescription: "Apply now for the NCR Voyix Software Engineer Intern internship in Scotland, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ncr-voyix-software-engineer-intern-internship-scotland", outputDir);
