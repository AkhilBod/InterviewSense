...
const articleData = {
  ...
  metaDescription: "Apply now for the Nethermind Agentic Internship Program internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nethermind-agentic-internship-program-internship-remote-in-usa", outputDir);
