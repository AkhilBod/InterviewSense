...
const articleData = {
  ...
  metaDescription: "Apply now for the Nethermind Internship Program 2024 internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nethermind-internship-program-2024-internship-remote-in-usa", outputDir);
