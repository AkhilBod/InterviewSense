...
const articleData = {
  ...
  metaDescription: "Apply now for the Netsmart Software Engineer Intern internship in Overland Park, KS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("netsmart-software-engineer-intern-internship-overland-park", outputDir);
