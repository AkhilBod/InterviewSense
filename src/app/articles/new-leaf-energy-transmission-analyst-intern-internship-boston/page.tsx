...
const articleData = {
  ...
  metaDescription: "Apply now for the New Leaf Energy Transmission Analyst Intern internship in Boston, MA</br>Lowell, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("new-leaf-energy-transmission-analyst-intern-internship-boston", outputDir);
