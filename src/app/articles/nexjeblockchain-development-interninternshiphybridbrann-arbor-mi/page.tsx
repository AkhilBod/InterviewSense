...
const articleData = {
  ...
  metaDescription: "Apply now for the Nexje Blockchain Development Intern internship in Hybrid</br>Ann Arbor, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nexjeblockchain-development-interninternshiphybridbrann-arbor-mi", outputDir);
