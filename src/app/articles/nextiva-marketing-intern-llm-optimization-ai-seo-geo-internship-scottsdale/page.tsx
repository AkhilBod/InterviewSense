...
const articleData = {
  ...
  metaDescription: "Apply now for the Nextiva Marketing Intern - LLM Optimization - AI SEO / GEO internship in Scottsdale, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nextiva-marketing-intern-llm-optimization-ai-seo-geo-internship-scottsdale", outputDir);
