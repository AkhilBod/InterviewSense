...
const articleData = {
  ...
  metaDescription: "Apply now for the Nextracker Application Engineer Intern internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nextracker-application-engineer-intern-internship-fremont", outputDir);
