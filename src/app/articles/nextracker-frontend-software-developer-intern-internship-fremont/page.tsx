...
const articleData = {
  ...
  metaDescription: "Apply now for the Nextracker Front-end Software Developer Intern internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nextracker-frontend-software-developer-intern-internship-fremont", outputDir);
