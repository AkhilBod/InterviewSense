...
const articleData = {
  ...
  metaDescription: "Apply now for the NineDot Energy Intern – Data Engineering internship in Brooklyn, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ninedot-energy-intern-data-engineering-internship-brooklyn", outputDir);
