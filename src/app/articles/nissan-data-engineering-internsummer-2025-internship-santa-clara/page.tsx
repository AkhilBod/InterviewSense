...
const articleData = {
  ...
  metaDescription: "Apply now for the Nissan Data Engineering Intern-Summer 2025 internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nissan-data-engineering-internsummer-2025-internship-santa-clara", outputDir);
