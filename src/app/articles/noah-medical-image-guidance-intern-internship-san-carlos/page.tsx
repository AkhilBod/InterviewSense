...
const articleData = {
  ...
  metaDescription: "Apply now for the Noah Medical Image Guidance Intern internship in San Carlos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("noah-medical-image-guidance-intern-internship-san-carlos", outputDir);
