...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Automation & AI/ML Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-automation-aiml-intern-internship-remote-in-usa", outputDir);
