...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Bell Labs Autonomous Systems Intern internship in Berkeley Heights, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-bell-labs-autonomous-systems-intern-internship-berkeley-heights", outputDir);
