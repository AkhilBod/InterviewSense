...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Incubation Developer Student internship in Ottawa, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-incubation-developer-student-internship-ottawa", outputDir);
