...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Nokia Ventures Software Intern internship in Berkeley Heights, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-nokia-ventures-software-intern-internship-berkeley-heights", outputDir);
