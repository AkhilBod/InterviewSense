...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Platforms Engineering Architecture Co-op internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-platforms-engineering-architecture-coop-internship-united-states", outputDir);
