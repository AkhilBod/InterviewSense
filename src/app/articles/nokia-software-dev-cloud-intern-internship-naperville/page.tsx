...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Software Dev Cloud Intern internship in Naperville, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-software-dev-cloud-intern-internship-naperville", outputDir);
