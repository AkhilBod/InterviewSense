...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Software Developer Co-op/Intern internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-software-developer-coopintern-internship-ottawa", outputDir);
