...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Software Developer Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-software-developer-intern-internship-sunnyvale", outputDir);
