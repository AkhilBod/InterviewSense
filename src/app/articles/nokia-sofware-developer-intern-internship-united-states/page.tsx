...
const articleData = {
  ...
  metaDescription: "Apply now for the Nokia Sofware Developer Intern internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nokia-sofware-developer-intern-internship-united-states", outputDir);
