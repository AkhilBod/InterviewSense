...
const articleData = {
  ...
  metaDescription: "Apply now for the Nordson Computer Engineering Intern internship in Duluth, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nordson-computer-engineering-intern-internship-duluth", outputDir);
