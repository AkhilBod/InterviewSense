...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Business Development/Data Analyst Intern internship in El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-business-developmentdata-analyst-intern-internship-el-segu", outputDir);
