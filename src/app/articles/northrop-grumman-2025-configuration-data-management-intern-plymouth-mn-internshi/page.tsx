...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Configuration & Data Management Intern - Plymouth MN internship in Wayzata, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-configuration-data-management-intern-plymouth-mn-internshi", outputDir);
