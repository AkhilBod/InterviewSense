...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Cyber Software Intern internship in Colorado Springs, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-cyber-software-intern-internship-colorado-springs", outputDir);
