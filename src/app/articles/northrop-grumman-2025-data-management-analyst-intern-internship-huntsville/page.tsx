...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Data Management Analyst Intern internship in Huntsville, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-data-management-analyst-intern-internship-huntsville", outputDir);
