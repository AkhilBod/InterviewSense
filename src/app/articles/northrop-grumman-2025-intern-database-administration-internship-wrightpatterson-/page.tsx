...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Intern Database Administration internship in Wright-Patterson AFB, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-intern-database-administration-internship-wrightpatterson-", outputDir);
