...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Software Engineer Technical Intern internship in Melbourne, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-software-engineer-technical-intern-internship-melbourne", outputDir);
