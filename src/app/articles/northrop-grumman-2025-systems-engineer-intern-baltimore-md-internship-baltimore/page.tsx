...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman 2025 Systems Engineer Intern - Baltimore MD internship in Baltimore, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-2025-systems-engineer-intern-baltimore-md-internship-baltimore", outputDir);
