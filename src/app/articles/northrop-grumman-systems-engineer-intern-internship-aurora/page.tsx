...
const articleData = {
  ...
  metaDescription: "Apply now for the Northrop Grumman Systems Engineer Intern internship in Aurora, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northrop-grumman-systems-engineer-intern-internship-aurora", outputDir);
