...
const articleData = {
  ...
  metaDescription: "Apply now for the Northwestern Mutual Analytics Engineering Intern internship in Milwaukee, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northwestern-mutual-analytics-engineering-intern-internship-milwaukee", outputDir);
