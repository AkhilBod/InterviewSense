...
const articleData = {
  ...
  metaDescription: "Apply now for the Northwestern Mutual Financial Data Science Intern internship in Milwaukee, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("northwestern-mutual-financial-data-science-intern-internship-milwaukee", outputDir);
