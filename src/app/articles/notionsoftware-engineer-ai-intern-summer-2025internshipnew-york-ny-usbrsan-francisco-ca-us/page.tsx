...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("notionsoftware-engineer-ai-intern-summer-2025internshipnew-york-ny-usbrsan-francisco-ca-us", outputDir);
