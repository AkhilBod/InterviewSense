...
const articleData = {
  ...
  metaDescription: "Apply now for the NT Concepts Software Development Intern internship in Vienna, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nt-concepts-software-development-intern-internship-vienna", outputDir);
