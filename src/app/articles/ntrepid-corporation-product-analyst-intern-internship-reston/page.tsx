...
const articleData = {
  ...
  metaDescription: "Apply now for the Ntrepid Corporation Product Analyst Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ntrepid-corporation-product-analyst-intern-internship-reston", outputDir);
