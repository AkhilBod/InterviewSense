...
const articleData = {
  ...
  metaDescription: "Apply now for the Nuro Systems Engineering Intern - Validation internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nuro-systems-engineering-intern-validation-internship-mountain-view", outputDir);
