...
const articleData = {
  ...
  metaDescription: "Apply now for the Nutanix Software Engineering Intern - C++/Linux/Multi-threading internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nutanix-software-engineering-intern-clinuxmultithreading-internship-durham", outputDir);
