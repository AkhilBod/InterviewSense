...
const articleData = {
  ...
  metaDescription: "Apply now for the Nutanix Workday Integration Developer Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nutanix-workday-integration-developer-intern-internship-san-jose", outputDir);
