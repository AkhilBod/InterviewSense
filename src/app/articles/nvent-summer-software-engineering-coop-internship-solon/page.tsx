...
const articleData = {
  ...
  metaDescription: "Apply now for the nVent Summer Software Engineering Co-op internship in Solon, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("nvent-summer-software-engineering-coop-internship-solon", outputDir);
