...
const articleData = {
  ...
  metaDescription: "Apply now for the Ohio State University - Columbus Student Intern - Cancer Program Analytics internship in Columbus, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ohio-state-university-columbus-student-intern-cancer-program-analytics-internshi", outputDir);
