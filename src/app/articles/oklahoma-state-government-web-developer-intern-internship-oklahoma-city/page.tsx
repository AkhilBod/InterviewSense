...
const articleData = {
  ...
  metaDescription: "Apply now for the Oklahoma State Government Web Developer Intern internship in Oklahoma City, OK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oklahoma-state-government-web-developer-intern-internship-oklahoma-city", outputDir);
