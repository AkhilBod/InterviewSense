...
const articleData = {
  ...
  metaDescription: "Apply now for the Ontario Teachers' Pension Plan Intern – Product Engineering - Summer 2025 - Months internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ontario-teachers-pension-plan-intern-product-engineering-summer-2025-months-inte", outputDir);
