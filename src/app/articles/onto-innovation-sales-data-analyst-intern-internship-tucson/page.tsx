...
const articleData = {
  ...
  metaDescription: "Apply now for the Onto Innovation Sales Data Analyst Intern internship in Tucson, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("onto-innovation-sales-data-analyst-intern-internship-tucson", outputDir);
