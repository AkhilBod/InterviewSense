...
const articleData = {
  ...
  metaDescription: "Apply now for the Onto Innovation Software Engineer 1 – Intern internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("onto-innovation-software-engineer-1-intern-internship-burlington", outputDir);
