...
const articleData = {
  ...
  metaDescription: "Apply now for the Ontra Machine Learning Engineering Intern internship in SF</br>NYC</br>Santa Barbara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ontra-machine-learning-engineering-intern-internship-sfbrnycbrsanta-barbara", outputDir);
