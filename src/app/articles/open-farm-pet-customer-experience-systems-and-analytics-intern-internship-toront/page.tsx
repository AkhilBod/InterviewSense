...
const articleData = {
  ...
  metaDescription: "Apply now for the Open Farm Pet Customer Experience – Systems and Analytics Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("open-farm-pet-customer-experience-systems-and-analytics-intern-internship-toront", outputDir);
