...
const articleData = {
  ...
  metaDescription: "Apply now for the OpenInfer Inc. Inference Performance Optimization Engineer internship in San Mateo, California. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("openinfer-incinference-performance-optimization-engineerinternshipsan-mateo-california", outputDir);
