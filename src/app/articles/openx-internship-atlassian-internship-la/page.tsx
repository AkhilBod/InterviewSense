...
const articleData = {
  ...
  metaDescription: "Apply now for the OpenX Internship - Atlassian internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("openx-internship-atlassian-internship-la", outputDir);
