...
const articleData = {
  ...
  metaDescription: "Apply now for the OpsLevel Software Engineering Intern – Co-op Student internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("opslevel-software-engineering-intern-coop-student-internship-remote-in-canada", outputDir);
