...
// Article metadata
const articleData = {
  slug: "opslevel-software-engineering-intern-coop-student-internship-remote",
  title: "OpsLevel Software Engineering Intern – Co-op Student Interview Questions",
  metaDescription: "Ace your OpsLevel Software Engineering Intern – Co-op Student interview with AI-powered practice questions and feedback. Get ready for your Remote in Canada internship.",
  keywords: ["OpsLevel interview", "Software Engineering Intern – Co-op Student interview questions", "OpsLevel internship", "interview practice", "AI interview prep", "OpsLevel Software Engineering Intern – Co-op Student", "Software Engineering interview questions"],
  lastUpdated: "2025-06-24T12:16:11.310Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "OpsLevel Software Engineering Intern – Co-op Student Interview Questions",
  "description": "Ace your OpsLevel Software Engineering Intern – Co-op Student interview with AI-powered practice questions and feedback. Get ready for your Remote in Canada internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/opslevel-software-engineering-intern-coop-student-internship-remote"
},
  openGraph: {
  "title": "OpsLevel Software Engineering Intern – Co-op Student Interview Questions",
  "description": "Ace your OpsLevel Software Engineering Intern – Co-op Student interview with AI-powered practice questions and feedback. Get ready for your Remote in Canada internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("opslevel-software-engineering-intern-coop-student-internship-remote", outputDir);
