...
const articleData = {
  ...
  metaDescription: "Apply now for the Oracle MySQL Heatwave - Software Developer Intern (6 month duration) internship in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oracle-mysql-heatwave-software-developer-intern-6-month-duration-internship-cana", outputDir);
