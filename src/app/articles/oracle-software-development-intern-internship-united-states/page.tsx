...
const articleData = {
  ...
  metaDescription: "Apply now for the Oracle Software Development Intern internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oracle-software-development-intern-internship-united-states", outputDir);
