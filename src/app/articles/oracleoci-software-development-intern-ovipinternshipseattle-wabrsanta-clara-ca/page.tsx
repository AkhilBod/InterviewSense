...
const articleData = {
  ...
  metaDescription: "Apply now for the Oracle OCI Software Development Intern - OVIP internship in Seattle, WA</br>Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oracleoci-software-development-intern-ovipinternshipseattle-wabrsanta-clara-ca", outputDir);
