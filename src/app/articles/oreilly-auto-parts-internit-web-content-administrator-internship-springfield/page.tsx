...
const articleData = {
  ...
  metaDescription: "Apply now for the O'Reilly Auto Parts Intern-IT Web Content Administrator internship in Springfield, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oreilly-auto-parts-internit-web-content-administrator-internship-springfield", outputDir);
