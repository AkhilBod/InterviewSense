...
const articleData = {
  ...
  metaDescription: "Apply now for the Orthofix Intern – Business Intelligence internship in Carlsbad, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("orthofix-intern-business-intelligence-internship-carlsbad", outputDir);
