...
const articleData = {
  ...
  metaDescription: "Apply now for the Oshkosh Advanced Digital Technology Intern internship in Oshkosh, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oshkosh-advanced-digital-technology-intern-internship-oshkosh", outputDir);
