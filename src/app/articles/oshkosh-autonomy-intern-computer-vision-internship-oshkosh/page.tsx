...
const articleData = {
  ...
  metaDescription: "Apply now for the Oshkosh Autonomy Intern - Computer Vision internship in Oshkosh, WI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oshkosh-autonomy-intern-computer-vision-internship-oshkosh", outputDir);
