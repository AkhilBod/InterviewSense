...
const articleData = {
  ...
  metaDescription: "Apply now for the Oshkosh Autonomy Intern-ML/AI internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oshkosh-autonomy-internmlai-internship-pittsburgh", outputDir);
