...
const articleData = {
  ...
  metaDescription: "Apply now for the Oshkosh ERP Implementation Internship internship in Hagerstown, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oshkosh-erp-implementation-internship-internship-hagerstown", outputDir);
