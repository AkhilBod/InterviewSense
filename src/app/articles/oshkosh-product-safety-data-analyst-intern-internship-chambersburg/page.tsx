...
const articleData = {
  ...
  metaDescription: "Apply now for the Oshkosh Product Safety – Data Analyst Intern internship in Chambersburg, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("oshkosh-product-safety-data-analyst-intern-internship-chambersburg", outputDir);
