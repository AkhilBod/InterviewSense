...
const articleData = {
  ...
  metaDescription: "Apply now for the Otis Product Data Management Intern internship in Florence, SC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("otis-product-data-management-intern-internship-florence", outputDir);
