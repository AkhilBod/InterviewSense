...
const articleData = {
  ...
  metaDescription: "Apply now for the Owens & Minor Data Analytics Intern internship in Richmond, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("owens-minor-data-analytics-intern-internship-richmond", outputDir);
