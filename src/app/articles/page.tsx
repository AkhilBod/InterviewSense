...
export const metadata: Metadata = {
  ...
  description: 'Browse 1031+ comprehensive guides for tech internship opportunities at top companies. Get application tips, requirements, and interview preparation advice.',
  keywords: ['tech internships', 'software engineering internships', 'internship applications', 'tech careers', 'interview preparation'],
  openGraph: {
    title: 'Tech Internship Articles & Opportunities | InterviewSense',
    description: 'Browse 1031+ comprehensive guides for tech internship opportunities at top companies.',
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 mb-6">
          Comprehensive guides for 1031+ internship opportunities at top tech companies
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div className="text-center p-6 bg-blue-50 rounded-lg">
          <div className="text-3xl font-bold text-blue-600">1031+</div>
