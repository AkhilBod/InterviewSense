...
const articleData = {
  ...
  metaDescription: "Apply now for the Panasonic Avionics Computer Engineering Intern internship in Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("panasonic-avionics-computer-engineering-intern-internship-hoffman-estates", outputDir);
