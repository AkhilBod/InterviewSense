...
const articleData = {
  ...
  metaDescription: "Apply now for the Panasonic Avionics Data Analytics Internal Audit Intern internship in Newark, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("panasonic-avionics-data-analytics-internal-audit-intern-internship-newark", outputDir);
