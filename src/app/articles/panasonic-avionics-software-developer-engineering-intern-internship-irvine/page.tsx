...
const articleData = {
  ...
  metaDescription: "Apply now for the Panasonic Avionics Software Developer Engineering Intern internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("panasonic-avionics-software-developer-engineering-intern-internship-irvine", outputDir);
