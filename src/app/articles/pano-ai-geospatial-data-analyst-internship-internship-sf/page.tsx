...
const articleData = {
  ...
  metaDescription: "Apply now for the Pano AI Geospatial Data Analyst Internship internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pano-ai-geospatial-data-analyst-internship-internship-sf", outputDir);
