...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Application Specialist Intern Summer 2025 internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-application-specialist-intern-summer-2025-internship-remote-in-usa", outputDir);
