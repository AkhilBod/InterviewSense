...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons CNO Engineering Intern internship in Centreville, VA</br>Columbia, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-cno-engineering-intern-internship-centreville", outputDir);
