...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Computer Engineer Intern internship in Aberdeen, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-computer-engineer-intern-internship-aberdeen", outputDir);
