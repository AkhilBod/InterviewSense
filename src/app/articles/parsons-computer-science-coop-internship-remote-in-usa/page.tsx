...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Computer Science Co-Op internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-computer-science-coop-internship-remote-in-usa", outputDir);
