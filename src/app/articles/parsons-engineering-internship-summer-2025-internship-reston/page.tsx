...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Engineering Internship Summer 2025 internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-engineering-internship-summer-2025-internship-reston", outputDir);
