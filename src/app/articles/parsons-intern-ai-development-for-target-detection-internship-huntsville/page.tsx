...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Intern - AI Development for Target Detection internship in Huntsville, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-intern-ai-development-for-target-detection-internship-huntsville", outputDir);
