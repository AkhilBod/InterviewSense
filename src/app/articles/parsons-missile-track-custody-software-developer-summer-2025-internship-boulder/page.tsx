...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Missile Track Custody Software Developer - Summer 2025 internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-missile-track-custody-software-developer-summer-2025-internship-boulder", outputDir);
