...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Software Developer Intern internship in Centreville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-software-developer-intern-internship-centreville", outputDir);
