...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Software Engineering Co-Op internship in Centreville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-software-engineering-coop-internship-centreville", outputDir);
