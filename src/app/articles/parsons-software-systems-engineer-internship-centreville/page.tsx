...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Software & Systems Engineer internship in Centreville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-software-systems-engineer-internship-centreville", outputDir);
