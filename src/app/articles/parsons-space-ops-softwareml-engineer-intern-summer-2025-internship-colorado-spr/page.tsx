...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Space Ops Software/ML Engineer Intern - Summer 2025 internship in Colorado Springs, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-space-ops-softwareml-engineer-intern-summer-2025-internship-colorado-spr", outputDir);
