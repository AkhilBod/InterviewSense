...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Space Systems Engineer Intern internship in Colorado Springs, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-space-systems-engineer-intern-internship-colorado-springs", outputDir);
