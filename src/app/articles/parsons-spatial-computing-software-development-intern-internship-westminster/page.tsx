...
const articleData = {
  ...
  metaDescription: "Apply now for the Parsons Spatial Computing – Software Development Intern internship in Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("parsons-spatial-computing-software-development-intern-internship-westminster", outputDir);
