...
const articleData = {
  ...
  metaDescription: "Apply now for the Penumbra Inc Data Science Engineer Intern T internship in Alameda, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("penumbra-inc-data-science-engineer-intern-t-internship-alameda", outputDir);
