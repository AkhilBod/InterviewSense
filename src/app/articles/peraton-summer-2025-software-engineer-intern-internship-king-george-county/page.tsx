...
const articleData = {
  ...
  metaDescription: "Apply now for the Peraton Summer 2025 Software Engineer Intern internship in King George County, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("peraton-summer-2025-software-engineer-intern-internship-king-george-county", outputDir);
