...
const articleData = {
  ...
  metaDescription: "Apply now for the Pico C Developer Summer Intern 2025 internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pico-c-developer-summer-intern-2025-internship-burlington", outputDir);
