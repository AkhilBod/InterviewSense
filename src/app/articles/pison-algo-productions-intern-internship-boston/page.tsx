...
const articleData = {
  ...
  metaDescription: "Apply now for the Pison Algo Productions Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pison-algo-productions-intern-internship-boston", outputDir);
