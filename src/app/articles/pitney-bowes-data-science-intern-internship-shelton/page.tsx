...
const articleData = {
  ...
  metaDescription: "Apply now for the Pitney Bowes Data Science Intern internship in Shelton, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pitney-bowes-data-science-intern-internship-shelton", outputDir);
