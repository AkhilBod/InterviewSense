...
const articleData = {
  ...
  metaDescription: "Apply now for the Pitney Bowes Presort Data Product Engineering Intern - Summer 2025 internship in Shelton, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pitney-bowes-presort-data-product-engineering-intern-summer-2025-internship-shel", outputDir);
