...
const articleData = {
  ...
  metaDescription: "Apply now for the Planet Intern – Flight Software Engineering internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("planet-intern-flight-software-engineering-internship-sf", outputDir);
