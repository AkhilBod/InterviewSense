...
const articleData = {
  ...
  metaDescription: "Apply now for the PlusAI Software Engineer Intern-Runtime - Compute Platform internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("plusai-software-engineer-internruntime-compute-platform-internship-fremont", outputDir);
