...
const articleData = {
  ...
  metaDescription: "Apply now for the Plusgrade Intégrateur Web – Intern - Stagiaire/Web Integrator internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("plusgrade-intgrateur-web-intern-stagiaireweb-integrator-internship-montreal", outputDir);
