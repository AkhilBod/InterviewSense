...
const articleData = {
  ...
  metaDescription: "Apply now for the PMG Engineering Operations Summer Internship internship in Dallas, TX</br>Fort Worth, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pmg-engineering-operations-summer-internship-internship-dallas", outputDir);
