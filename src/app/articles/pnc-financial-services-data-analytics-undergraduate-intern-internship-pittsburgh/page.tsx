...
const articleData = {
  ...
  metaDescription: "Apply now for the PNC Financial Services Data Analytics Undergraduate Intern internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pnc-financial-services-data-analytics-undergraduate-intern-internship-pittsburgh", outputDir);
