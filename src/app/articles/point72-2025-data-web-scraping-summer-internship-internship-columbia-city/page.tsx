...
const articleData = {
  ...
  metaDescription: "Apply now for the Point72 2025 Data – Web Scraping Summer Internship internship in Columbia City, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("point72-2025-data-web-scraping-summer-internship-internship-columbia-city", outputDir);
