...
const articleData = {
  ...
  metaDescription: "Apply now for the Point72 2025 Summer Internship - Facilities and Critical Systems Engineer internship in Stamford, CT</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("point72-2025-summer-internship-facilities-and-critical-systems-engineer-internsh", outputDir);
