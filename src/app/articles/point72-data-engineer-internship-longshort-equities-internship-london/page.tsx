...
const articleData = {
  ...
  metaDescription: "Apply now for the Point72 Data Engineer Internship - Long/Short Equities internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("point72-data-engineer-internship-longshort-equities-internship-london", outputDir);
