...
const articleData = {
  ...
  metaDescription: "Apply now for the Point72 Quantitative Research Intern - NLP internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("point72-quantitative-research-intern-nlp-internship-nyc", outputDir);
