...
const articleData = {
  ...
  metaDescription: "Apply now for the Potential Motors Data Collection Intern internship in Fredericton, NB, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("potential-motors-data-collection-intern-internship-fredericton", outputDir);
