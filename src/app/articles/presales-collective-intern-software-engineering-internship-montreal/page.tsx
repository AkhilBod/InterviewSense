...
const articleData = {
  ...
  metaDescription: "Apply now for the PreSales Collective Intern, Software Engineering internship in Montreal, QC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("presales-collective-intern-software-engineering-internship-montreal", outputDir);
