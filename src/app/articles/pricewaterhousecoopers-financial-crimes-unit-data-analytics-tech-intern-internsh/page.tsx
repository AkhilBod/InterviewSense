...
const articleData = {
  ...
  metaDescription: "Apply now for the PricewaterhouseCoopers Financial Crimes Unit Data & Analytics Tech Intern internship in Norridge, IL</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("pricewaterhousecoopers-financial-crimes-unit-data-analytics-tech-intern-internsh", outputDir);
