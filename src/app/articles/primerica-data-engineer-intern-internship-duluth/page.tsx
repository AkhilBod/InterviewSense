...
const articleData = {
  ...
  metaDescription: "Apply now for the Primerica Data Engineer Intern internship in Duluth, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("primerica-data-engineer-intern-internship-duluth", outputDir);
