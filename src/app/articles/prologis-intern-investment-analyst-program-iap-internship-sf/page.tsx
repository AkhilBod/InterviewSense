...
const articleData = {
  ...
  metaDescription: "Apply now for the Prologis Intern – Investment Analyst Program - Iap internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("prologis-intern-investment-analyst-program-iap-internship-sf", outputDir);
