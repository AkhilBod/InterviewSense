...
const articleData = {
  ...
  metaDescription: "Apply now for the Proofpoint Marketing Performance & Analytics Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("proofpoint-marketing-performance-analytics-intern-internship-sunnyvale", outputDir);
