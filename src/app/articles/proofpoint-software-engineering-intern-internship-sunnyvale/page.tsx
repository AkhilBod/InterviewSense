...
const articleData = {
  ...
  metaDescription: "Apply now for the Proofpoint Software Engineering Intern internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("proofpoint-software-engineering-intern-internship-sunnyvale", outputDir);
