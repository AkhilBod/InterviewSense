...
const articleData = {
  ...
  metaDescription: "Apply now for the Prudential Financial Coding and Software Development Internship Program internship in Newark, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("prudential-financial-coding-and-software-development-internship-program-internsh", outputDir);
