...
const articleData = {
  ...
  metaDescription: "Apply now for the Qrypt Embedded Engineering Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("qrypt-embedded-engineering-intern-internship-nyc", outputDir);
