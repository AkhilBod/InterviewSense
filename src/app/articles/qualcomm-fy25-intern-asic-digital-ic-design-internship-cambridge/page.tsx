...
const articleData = {
  ...
  metaDescription: "Apply now for the Qualcomm FY25 Intern - ASIC Digital IC Design internship in Cambridge, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("qualcomm-fy25-intern-asic-digital-ic-design-internship-cambridge", outputDir);
