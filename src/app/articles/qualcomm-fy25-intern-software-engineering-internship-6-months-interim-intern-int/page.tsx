...
const articleData = {
  ...
  metaDescription: "Apply now for the Qualcomm FY25 Intern – Software Engineering Internship - 6 months - Interim Intern internship in Cork, Ireland. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("qualcomm-fy25-intern-software-engineering-internship-6-months-interim-intern-int", outputDir);
