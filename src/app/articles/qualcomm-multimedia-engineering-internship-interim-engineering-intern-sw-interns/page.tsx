...
const articleData = {
  ...
  metaDescription: "Apply now for the Qualcomm Multimedia Engineering Internship - Interim Engineering Intern - SW internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("qualcomm-multimedia-engineering-internship-interim-engineering-intern-sw-interns", outputDir);
