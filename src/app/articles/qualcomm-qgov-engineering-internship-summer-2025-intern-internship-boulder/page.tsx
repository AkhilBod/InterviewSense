...
const articleData = {
  ...
  metaDescription: "Apply now for the Qualcomm QGOV Engineering Internship - Summer 2025 - Intern internship in Boulder, CO</br>San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("qualcomm-qgov-engineering-internship-summer-2025-intern-internship-boulder", outputDir);
