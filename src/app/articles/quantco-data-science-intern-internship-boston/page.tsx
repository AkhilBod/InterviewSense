...
const articleData = {
  ...
  metaDescription: "Apply now for the QuantCo Data Science Intern internship in Boston, MA</br>London, UK</br>SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("quantco-data-science-intern-internship-boston", outputDir);
