...
const articleData = {
  ...
  metaDescription: "Apply now for the Quest Analytics Software Data Engineer Internship internship in Overland Park, KS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("quest-analytics-software-data-engineer-internship-internship-overland-park", outputDir);
