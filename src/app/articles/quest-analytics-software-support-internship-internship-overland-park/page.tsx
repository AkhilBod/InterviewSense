...
const articleData = {
  ...
  metaDescription: "Apply now for the Quest Analytics Software Support Internship internship in Overland Park, KS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("quest-analytics-software-support-internship-internship-overland-park", outputDir);
