...
const articleData = {
  ...
  metaDescription: "Apply now for the Rad AI Software Engineer Internship internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rad-ai-software-engineer-internship-internship-remote-in-usa", outputDir);
