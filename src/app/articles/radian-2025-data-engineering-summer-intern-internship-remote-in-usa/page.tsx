...
const articleData = {
  ...
  metaDescription: "Apply now for the Radian 2025 Data Engineering Summer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("radian-2025-data-engineering-summer-intern-internship-remote-in-usa", outputDir);
