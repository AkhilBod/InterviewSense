...
// Article metadata
const articleData = {
  slug: "ramp-software-engineer-intern-backend-internship-new",
  title: "Ramp Software Engineer Intern, Backend Interview Questions",
  metaDescription: "Ace your Ramp Software Engineer Intern, Backend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  keywords: ["Ramp interview", "Software Engineer Intern, Backend interview questions", "Ramp internship", "interview practice", "AI interview prep", "Ramp Software Engineer Intern, Backend", "Java interview questions"],
  lastUpdated: "2025-08-05T22:46:29.222Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "Ramp Software Engineer Intern, Backend Interview Questions",
  "description": "Ace your Ramp Software Engineer Intern, Backend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/ramp-software-engineer-intern-backend-internship-new"
},
  openGraph: {
  "title": "Ramp Software Engineer Intern, Backend Interview Questions",
  "description": "Ace your Ramp Software Engineer Intern, Backend interview with AI-powered practice questions and feedback. Get ready for your New York, NY internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ramp-software-engineer-intern-backend-internship-new", outputDir);
