...
const articleData = {
  ...
  metaDescription: "Apply now for the RapidSOS Implementation Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rapidsos-implementation-engineering-intern-internship-remote-in-usa", outputDir);
