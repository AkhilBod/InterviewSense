...
const articleData = {
  ...
  metaDescription: "Apply now for the Red Horse Corp Summer Intern - Software Developer internship in Gainesville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("red-horse-corp-summer-intern-software-developer-internship-gainesville", outputDir);
