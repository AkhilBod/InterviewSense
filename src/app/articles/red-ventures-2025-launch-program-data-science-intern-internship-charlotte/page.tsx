...
const articleData = {
  ...
  metaDescription: "Apply now for the Red Ventures 2025 Launch Program: Data Science Intern internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("red-ventures-2025-launch-program-data-science-intern-internship-charlotte", outputDir);
