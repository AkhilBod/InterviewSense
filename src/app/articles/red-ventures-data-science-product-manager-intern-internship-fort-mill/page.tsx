...
const articleData = {
  ...
  metaDescription: "Apply now for the Red Ventures Data Science Product Manager Intern internship in Fort Mill, SC</br>Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("red-ventures-data-science-product-manager-intern-internship-fort-mill", outputDir);
