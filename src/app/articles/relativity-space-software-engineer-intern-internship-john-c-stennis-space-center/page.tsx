...
const articleData = {
  ...
  metaDescription: "Apply now for the Relativity Space Software Engineer Intern internship in John C. Stennis Space Center, MS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("relativity-space-software-engineer-intern-internship-john-c-stennis-space-center", outputDir);
