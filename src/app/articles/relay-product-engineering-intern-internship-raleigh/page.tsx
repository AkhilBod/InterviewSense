...
const articleData = {
  ...
  metaDescription: "Apply now for the Relay Product Engineering Intern internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("relay-product-engineering-intern-internship-raleigh", outputDir);
