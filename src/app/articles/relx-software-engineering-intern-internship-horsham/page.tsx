...
const articleData = {
  ...
  metaDescription: "Apply now for the RELX Software Engineering Intern internship in Horsham, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("relx-software-engineering-intern-internship-horsham", outputDir);
