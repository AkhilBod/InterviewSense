...
const articleData = {
  ...
  metaDescription: "Apply now for the RELX Student / Internship Data Scientists internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("relx-student-internship-data-scientists-internship-london", outputDir);
