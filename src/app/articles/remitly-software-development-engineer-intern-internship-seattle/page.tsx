...
const articleData = {
  ...
  metaDescription: "Apply now for the Remitly Software Development Engineer Intern internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("remitly-software-development-engineer-intern-internship-seattle", outputDir);
