...
const articleData = {
  ...
  metaDescription: "Apply now for the Remitly Summer Internship internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("remitly-summer-internship-internship-united-states", outputDir);
