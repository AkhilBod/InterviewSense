...
const articleData = {
  ...
  metaDescription: "Apply now for the Resmed Data Engineering Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("resmed-data-engineering-intern-internship-san-diego", outputDir);
