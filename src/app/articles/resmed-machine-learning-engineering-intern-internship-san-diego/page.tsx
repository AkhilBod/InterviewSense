...
const articleData = {
  ...
  metaDescription: "Apply now for the Resmed Machine Learning Engineering Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("resmed-machine-learning-engineering-intern-internship-san-diego", outputDir);
