...
const articleData = {
  ...
  metaDescription: "Apply now for the Resmed Software Developer Intern internship in Halifax, NS, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("resmed-software-developer-intern-internship-halifax", outputDir);
