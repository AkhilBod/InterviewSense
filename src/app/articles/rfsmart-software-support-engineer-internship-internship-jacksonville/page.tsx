...
const articleData = {
  ...
  metaDescription: "Apply now for the RF-SMART Software Support Engineer Internship internship in Jacksonville, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rfsmart-software-support-engineer-internship-internship-jacksonville", outputDir);
