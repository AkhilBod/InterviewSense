...
const articleData = {
  ...
  metaDescription: "Apply now for the RippleMatch Innotech Summer Undergraduate Internship - Aetna Tech - Aetna Health Digital internship in Hartford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ripplematch-innotech-summer-undergraduate-internship-aetna-tech-aetna-health-dig", outputDir);
