...
const articleData = {
  ...
  metaDescription: "Apply now for the RippleMatch Investment Analyst Intern internship in Detroit, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ripplematch-investment-analyst-intern-internship-detroit", outputDir);
