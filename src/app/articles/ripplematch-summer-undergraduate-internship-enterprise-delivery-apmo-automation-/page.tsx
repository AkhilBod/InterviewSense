...
const articleData = {
  ...
  metaDescription: "Apply now for the RippleMatch Summer Undergraduate Internship - Enterprise Delivery - APMO Automation & Analytics internship in Hartford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ripplematch-summer-undergraduate-internship-enterprise-delivery-apmo-automation-", outputDir);
