...
const articleData = {
  ...
  metaDescription: "Apply now for the Rivian Engineering Intern – Manufacturing Engineering Co-Op Program - Machine Learning - Summer internship in Normal, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rivian-engineering-intern-manufacturing-engineering-coop-program-machine-learnin", outputDir);
