...
const articleData = {
  ...
  metaDescription: "Apply now for the Rivian Intern - Computational Methods Development internship in Urbana, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rivian-intern-computational-methods-development-internship-urbana", outputDir);
