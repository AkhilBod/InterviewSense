...
const articleData = {
  ...
  metaDescription: "Apply now for the Rivian Software Engineering Intern - Offline Perception - Autonomy internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rivian-software-engineering-intern-offline-perception-autonomy-internship-palo-a", outputDir);
