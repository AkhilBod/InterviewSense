...
const articleData = {
  ...
  metaDescription: "Apply now for the Roadie Software Engineer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("roadie-software-engineer-intern-internship-remote-in-usa", outputDir);
