...
const articleData = {
  ...
  metaDescription: "Apply now for the Robert Half Business Systems Engineer Internship internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("robert-half-business-systems-engineer-internship-internship-remote-in-usa", outputDir);
