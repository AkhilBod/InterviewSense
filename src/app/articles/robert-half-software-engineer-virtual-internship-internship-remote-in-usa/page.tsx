...
const articleData = {
  ...
  metaDescription: "Apply now for the Robert Half Software Engineer Virtual Internship internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("robert-half-software-engineer-virtual-internship-internship-remote-in-usa", outputDir);
