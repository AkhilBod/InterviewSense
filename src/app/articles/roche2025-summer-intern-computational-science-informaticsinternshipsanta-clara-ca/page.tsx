...
const articleData = {
  ...
  metaDescription: "Apply now for the Roche 2025 Summer Intern - Computational Science & Informatics internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("roche2025-summer-intern-computational-science-informaticsinternshipsanta-clara-ca", outputDir);
