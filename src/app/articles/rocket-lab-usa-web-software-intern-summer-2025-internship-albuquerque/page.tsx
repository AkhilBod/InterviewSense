...
const articleData = {
  ...
  metaDescription: "Apply now for the Rocket Lab USA Web Software Intern - Summer 2025 internship in Albuquerque, NM. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rocket-lab-usa-web-software-intern-summer-2025-internship-albuquerque", outputDir);
