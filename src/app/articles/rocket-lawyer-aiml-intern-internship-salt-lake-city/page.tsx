...
const articleData = {
  ...
  metaDescription: "Apply now for the Rocket Lawyer AI/ML Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rocket-lawyer-aiml-intern-internship-salt-lake-city", outputDir);
