...
const articleData = {
  ...
  metaDescription: "Apply now for the Rocket Lawyer Software Engineering Intern internship in Arizona. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rocket-lawyer-software-engineering-intern-internship-arizona", outputDir);
