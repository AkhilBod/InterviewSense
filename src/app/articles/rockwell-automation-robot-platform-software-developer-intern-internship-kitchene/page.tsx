...
const articleData = {
  ...
  metaDescription: "Apply now for the Rockwell Automation Robot Platform Software Developer Intern internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rockwell-automation-robot-platform-software-developer-intern-internship-kitchene", outputDir);
