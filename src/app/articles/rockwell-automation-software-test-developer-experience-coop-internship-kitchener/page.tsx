...
const articleData = {
  ...
  metaDescription: "Apply now for the Rockwell Automation Software Test & Developer Experience Co-op internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rockwell-automation-software-test-developer-experience-coop-internship-kitchener", outputDir);
