...
const articleData = {
  ...
  metaDescription: "Apply now for the Rokt ML Engineering Summer Internship internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rokt-ml-engineering-summer-internship-internship-seattle", outputDir);
