...
const articleData = {
  ...
  metaDescription: "Apply now for the Roku Data Engineer Intern internship in Cambridge, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("roku-data-engineer-intern-internship-cambridge", outputDir);
