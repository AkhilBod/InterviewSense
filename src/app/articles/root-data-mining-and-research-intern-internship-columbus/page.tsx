...
const articleData = {
  ...
  metaDescription: "Apply now for the Root Data Mining and Research Intern internship in Columbus, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("root-data-mining-and-research-intern-internship-columbus", outputDir);
