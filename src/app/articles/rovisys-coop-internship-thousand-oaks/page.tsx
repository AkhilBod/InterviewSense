...
const articleData = {
  ...
  metaDescription: "Apply now for the RoviSys Co-op internship in Thousand Oaks, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rovisys-coop-internship-thousand-oaks", outputDir);
