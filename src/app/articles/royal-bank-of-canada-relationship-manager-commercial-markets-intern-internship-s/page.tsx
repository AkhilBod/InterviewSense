...
const articleData = {
  ...
  metaDescription: "Apply now for the Royal Bank of Canada Relationship Manager Commercial Markets Intern internship in St. John's, NL, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("royal-bank-of-canada-relationship-manager-commercial-markets-intern-internship-s", outputDir);
