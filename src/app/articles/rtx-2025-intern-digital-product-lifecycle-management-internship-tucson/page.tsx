...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX 2025 Intern - Digital - Product Lifecycle Management internship in Tucson, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-2025-intern-digital-product-lifecycle-management-internship-tucson", outputDir);
