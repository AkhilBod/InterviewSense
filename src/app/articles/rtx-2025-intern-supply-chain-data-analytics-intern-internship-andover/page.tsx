...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX 2025 Intern – Supply Chain Data Analytics Intern internship in Andover, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-2025-intern-supply-chain-data-analytics-intern-internship-andover", outputDir);
