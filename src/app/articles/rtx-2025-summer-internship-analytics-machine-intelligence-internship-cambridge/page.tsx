...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX 2025 Summer Internship - Analytics & Machine Intelligence internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-2025-summer-internship-analytics-machine-intelligence-internship-cambridge", outputDir);
