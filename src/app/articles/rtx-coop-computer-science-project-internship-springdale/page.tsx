...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Co-Op: Computer Science Project internship in Springdale, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-coop-computer-science-project-internship-springdale", outputDir);
