...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Data Analytics RMS Co-op internship in Indian Trail, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-data-analytics-rms-coop-internship-indian-trail", outputDir);
