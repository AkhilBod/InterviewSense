...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Intern: Statistical and Mathematical Analysis internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-intern-statistical-and-mathematical-analysis-internship-remote-in-usa", outputDir);
