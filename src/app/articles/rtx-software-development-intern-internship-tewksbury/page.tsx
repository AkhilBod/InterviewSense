...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Software Development Intern internship in Tewksbury, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-software-development-intern-internship-tewksbury", outputDir);
