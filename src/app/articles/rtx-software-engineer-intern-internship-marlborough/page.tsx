...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Software Engineer Intern internship in Marlborough, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-software-engineer-intern-internship-marlborough", outputDir);
