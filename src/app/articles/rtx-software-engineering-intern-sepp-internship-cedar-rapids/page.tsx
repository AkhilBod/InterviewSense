...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Software Engineering Intern SEPP internship in Cedar Rapids, IA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-software-engineering-intern-sepp-internship-cedar-rapids", outputDir);
