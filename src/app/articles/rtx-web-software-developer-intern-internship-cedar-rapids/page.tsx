...
const articleData = {
  ...
  metaDescription: "Apply now for the RTX Web Software Developer Intern internship in Cedar Rapids, IA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("rtx-web-software-developer-intern-internship-cedar-rapids", outputDir);
