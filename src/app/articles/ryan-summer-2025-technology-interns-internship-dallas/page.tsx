...
const articleData = {
  ...
  metaDescription: "Apply now for the Ryan Summer 2025 Technology Interns internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ryan-summer-2025-technology-interns-internship-dallas", outputDir);
