...
// Article metadata
const articleData = {
  slug: "sabre-corporationsoftware-engineer-2025-summer-interninternshipsouthlake-tx",
  ...
  "url": "http://localhost:3000/internships/sabre-corporationsoftware-engineer-2025-summer-interninternshipsouthlake-tx",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sabre-corporationsoftware-engineer-2025-summer-interninternshipsouthlake-tx", outputDir);
