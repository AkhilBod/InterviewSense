...
const articleData = {
  ...
  metaDescription: "Apply now for the Safari AI 8 Month CV/ML Intern internship in Washington, DC</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("safari-ai-8-month-cvml-intern-internship-washington", outputDir);
