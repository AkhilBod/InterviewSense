...
const articleData = {
  ...
  metaDescription: "Apply now for the Safran Engineering Internships! internship in Rochester, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("safran-engineering-internships-internship-rochester", outputDir);
