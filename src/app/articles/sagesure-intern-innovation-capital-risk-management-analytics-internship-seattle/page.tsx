...
const articleData = {
  ...
  metaDescription: "Apply now for the SageSure Intern – Innovation - Capital Risk Management Analytics internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sagesure-intern-innovation-capital-risk-management-analytics-internship-seattle", outputDir);
