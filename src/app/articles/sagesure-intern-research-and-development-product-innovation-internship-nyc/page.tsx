...
const articleData = {
  ...
  metaDescription: "Apply now for the SageSure Intern – Research and Development - Product Innovation internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sagesure-intern-research-and-development-product-innovation-internship-nyc", outputDir);
