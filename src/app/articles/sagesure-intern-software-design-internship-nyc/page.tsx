...
const articleData = {
  ...
  metaDescription: "Apply now for the SageSure Intern – Software - Design internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sagesure-intern-software-design-internship-nyc", outputDir);
