...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsara Co-op Operations Data Analyst internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsara-coop-operations-data-analyst-internship-remote-in-usa", outputDir);
