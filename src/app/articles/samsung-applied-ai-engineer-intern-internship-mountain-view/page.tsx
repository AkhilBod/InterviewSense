...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Applied AI Engineer – Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-applied-ai-engineer-intern-internship-mountain-view", outputDir);
