...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Data Analyst – Intern - Samsung Product Management - Services internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-data-analyst-intern-samsung-product-management-services-internship-plano", outputDir);
