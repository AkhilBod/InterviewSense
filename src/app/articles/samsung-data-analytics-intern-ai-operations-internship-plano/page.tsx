...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Data Analytics – Intern - AI & Operations internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-data-analytics-intern-ai-operations-internship-plano", outputDir);
