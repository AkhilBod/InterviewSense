...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Intern – Visualization Engineer internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-intern-visualization-engineer-internship-san-jose", outputDir);
