...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung MPC Business Insight Intern internship in Coppell, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-mpc-business-insight-intern-internship-coppell", outputDir);
