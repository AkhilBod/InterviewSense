...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Promotions Analyst Intern internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-promotions-analyst-intern-internship-plano", outputDir);
