...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Research America 2025 Summer Intern - Computational Imaging internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-research-america-2025-summer-intern-computational-imaging-internship-pla", outputDir);
