...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Research America Summer Intern - Tech Incubation internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-research-america-summer-intern-tech-incubation-internship-mountain-view", outputDir);
