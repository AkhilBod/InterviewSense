...
const articleData = {
  ...
  metaDescription: "Apply now for the Samsung Summer Intern - Software Dev Engineer internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("samsung-summer-intern-software-dev-engineer-internship-plano", outputDir);
