...
const articleData = {
  ...
  metaDescription: "Apply now for the Sanofi Data and AI Engineer internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sanofi-data-and-ai-engineer-internship-cambridge", outputDir);
