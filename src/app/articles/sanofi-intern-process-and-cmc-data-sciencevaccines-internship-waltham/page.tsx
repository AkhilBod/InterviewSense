...
const articleData = {
  ...
  metaDescription: "Apply now for the Sanofi Intern Process and CMC Data Science-Vaccines internship in Waltham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sanofi-intern-process-and-cmc-data-sciencevaccines-internship-waltham", outputDir);
