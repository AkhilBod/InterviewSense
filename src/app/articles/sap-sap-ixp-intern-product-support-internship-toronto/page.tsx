...
const articleData = {
  ...
  metaDescription: "Apply now for the SAP SAP iXp Intern - Product Support internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sap-sap-ixp-intern-product-support-internship-toronto", outputDir);
