...
const articleData = {
  ...
  metaDescription: "Apply now for the SAP SAP iXp Intern - CX Data & AI Software Developer internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sapsap-ixp-intern-cx-data-ai-software-developerinternshipsan-francisco-ca", outputDir);
