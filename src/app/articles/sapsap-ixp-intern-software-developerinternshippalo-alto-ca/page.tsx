...
const articleData = {
  ...
  metaDescription: "Apply now for the SAP SAP iXp Intern - Software Developer internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sapsap-ixp-intern-software-developerinternshippalo-alto-ca", outputDir);
