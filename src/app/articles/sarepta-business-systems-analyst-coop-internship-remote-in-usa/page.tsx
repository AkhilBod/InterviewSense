...
const articleData = {
  ...
  metaDescription: "Apply now for the Sarepta Business Systems Analyst Co-op internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sarepta-business-systems-analyst-coop-internship-remote-in-usa", outputDir);
