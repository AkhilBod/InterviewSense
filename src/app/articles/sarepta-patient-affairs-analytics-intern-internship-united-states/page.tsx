...
const articleData = {
  ...
  metaDescription: "Apply now for the Sarepta Patient Affairs Analytics Intern internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sarepta-patient-affairs-analytics-intern-internship-united-states", outputDir);
