...
const articleData = {
  ...
  metaDescription: "Apply now for the Saronic Intern - Summer 2025 internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("saronic-intern-summer-2025-internship-austin", outputDir);
