...
const articleData = {
  ...
  metaDescription: "Apply now for the Sayari Machine Learning Engineer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sayari-machine-learning-engineer-intern-internship-remote-in-usa", outputDir);
