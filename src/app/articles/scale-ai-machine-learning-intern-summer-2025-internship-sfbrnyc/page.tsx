...
const articleData = {
  ...
  metaDescription: "Apply now for the Scale AI Machine Learning Intern - Summer 2025 internship in SF</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scale-ai-machine-learning-intern-summer-2025-internship-sfbrnyc", outputDir);
