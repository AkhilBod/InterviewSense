...
const articleData = {
  ...
  metaDescription: "Apply now for the Scale AI Research Intern - Post-training - Summer 2025 internship in SF</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scale-ai-research-intern-posttraining-summer-2025-internship-sfbrnyc", outputDir);
