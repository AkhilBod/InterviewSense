...
const articleData = {
  ...
  metaDescription: "Apply now for the Scale AI SEAL Research Scientist Intern internship in SF</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scale-ai-seal-research-scientist-intern-internship-sfbrnyc", outputDir);
