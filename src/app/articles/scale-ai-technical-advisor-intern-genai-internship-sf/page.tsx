...
const articleData = {
  ...
  metaDescription: "Apply now for the Scale AI Technical Advisor Intern - GenAI internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scale-ai-technical-advisor-intern-genai-internship-sf", outputDir);
