...
const articleData = {
  ...
  metaDescription: "Apply now for the Schneider Electric Computer Science Intern internship in Nashville, TN</br>Columbia, SC</br>El Paso, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("schneider-electriccomputer-science-interninternshipnashville-tnbrcolumbia-scbrel-paso-tx", outputDir);
