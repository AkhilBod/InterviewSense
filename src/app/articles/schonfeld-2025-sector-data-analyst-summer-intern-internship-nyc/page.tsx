...
const articleData = {
  ...
  metaDescription: "Apply now for the Schonfeld 2025 Sector Data Analyst Summer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("schonfeld-2025-sector-data-analyst-summer-intern-internship-nyc", outputDir);
