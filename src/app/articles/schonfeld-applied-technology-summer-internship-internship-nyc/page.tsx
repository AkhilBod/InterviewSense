...
const articleData = {
  ...
  metaDescription: "Apply now for the Schonfeld Applied Technology Summer Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("schonfeld-applied-technology-summer-internship-internship-nyc", outputDir);
