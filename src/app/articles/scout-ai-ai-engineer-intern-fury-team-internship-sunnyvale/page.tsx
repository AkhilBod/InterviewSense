...
const articleData = {
  ...
  metaDescription: "Apply now for the Scout AI AI Engineer Intern - Fury Team internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scout-ai-ai-engineer-intern-fury-team-internship-sunnyvale", outputDir);
