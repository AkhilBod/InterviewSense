...
const articleData = {
  ...
  metaDescription: "Apply now for the Scout Motors 2025 Summer Internship - Production - AI Implementation internship in Columbia, SC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scout-motors-2025-summer-internship-production-ai-implementation-internship-colu", outputDir);
