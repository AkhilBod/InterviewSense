...
const articleData = {
  ...
  metaDescription: "Apply now for the Scout Motors Intern – Production - Plant Launch internship in Columbia, SC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("scout-motors-intern-production-plant-launch-internship-columbia", outputDir);
