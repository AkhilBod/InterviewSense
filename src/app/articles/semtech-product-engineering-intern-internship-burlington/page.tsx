...
const articleData = {
  ...
  metaDescription: "Apply now for the Semtech Product Engineering Intern internship in Burlington, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("semtech-product-engineering-intern-internship-burlington", outputDir);
