...
const articleData = {
  ...
  metaDescription: "Apply now for the Semtech Software Developer – Co-op - Web/Cloud Application internship in Richmond, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("semtech-software-developer-coop-webcloud-application-internship-richmond", outputDir);
