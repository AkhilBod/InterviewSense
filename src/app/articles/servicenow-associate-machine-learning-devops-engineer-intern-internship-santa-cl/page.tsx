...
const articleData = {
  ...
  metaDescription: "Apply now for the ServiceNow Associate Machine Learning Devops Engineer Intern internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("servicenow-associate-machine-learning-devops-engineer-intern-internship-santa-cl", outputDir);
