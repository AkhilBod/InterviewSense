...
const articleData = {
  ...
  metaDescription: "Apply now for the ServiceNow Associate Machine Learning Engineer Intern internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("servicenow-associate-machine-learning-engineer-intern-internship-montreal", outputDir);
