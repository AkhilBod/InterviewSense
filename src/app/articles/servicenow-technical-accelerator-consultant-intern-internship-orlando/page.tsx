...
const articleData = {
  ...
  metaDescription: "Apply now for the ServiceNow Technical Accelerator Consultant – Intern internship in Orlando, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("servicenow-technical-accelerator-consultant-intern-internship-orlando", outputDir);
