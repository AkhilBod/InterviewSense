...
const articleData = {
  ...
  metaDescription: "Apply now for the Seurat Technologies Application Engineering Intern internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("seurat-technologies-application-engineering-intern-internship-burlington", outputDir);
