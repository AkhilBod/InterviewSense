...
const articleData = {
  ...
  metaDescription: "Apply now for the Seurat Technologies Data & AI/ML Intern internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("seurat-technologies-data-aiml-intern-internship-burlington", outputDir);
