...
const articleData = {
  ...
  metaDescription: "Apply now for the Shamrock Trading Data Science / Machine Learning Intern internship in Overland Park, KS. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("shamrock-trading-data-science-machine-learning-intern-internship-overland-park", outputDir);
