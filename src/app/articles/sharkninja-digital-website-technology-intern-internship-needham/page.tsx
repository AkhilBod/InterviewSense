...
const articleData = {
  ...
  metaDescription: "Apply now for the SharkNinja Digital & Website Technology Intern internship in Needham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sharkninja-digital-website-technology-intern-internship-needham", outputDir);
