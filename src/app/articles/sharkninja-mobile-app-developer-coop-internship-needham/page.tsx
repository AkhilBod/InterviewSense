...
const articleData = {
  ...
  metaDescription: "Apply now for the SharkNinja Mobile App Developer Co-op internship in Needham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sharkninja-mobile-app-developer-coop-internship-needham", outputDir);
