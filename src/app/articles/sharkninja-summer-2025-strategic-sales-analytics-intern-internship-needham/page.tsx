...
const articleData = {
  ...
  metaDescription: "Apply now for the SharkNinja Summer 2025: Strategic Sales & Analytics Intern internship in Needham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sharkninja-summer-2025-strategic-sales-analytics-intern-internship-needham", outputDir);
