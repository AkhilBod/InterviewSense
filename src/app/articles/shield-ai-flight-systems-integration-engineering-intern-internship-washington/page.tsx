...
const articleData = {
  ...
  metaDescription: "Apply now for the Shield AI Flight Systems Integration Engineering Intern internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("shield-ai-flight-systems-integration-engineering-intern-internship-washington", outputDir);
