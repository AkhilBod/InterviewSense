...
const articleData = {
  ...
  metaDescription: "Apply now for the Shopify Engineering and Data Internships, Summer 2025 internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("shopify-engineering-and-data-internships-summer-2025-internship-remote-in-canada", outputDir);
