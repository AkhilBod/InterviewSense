...
const articleData = {
  ...
  metaDescription: "Apply now for the Siemens Healthineers Application Software Developer Intern internship in Ottawa, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("siemens-healthineers-application-software-developer-intern-internship-ottawa", outputDir);
