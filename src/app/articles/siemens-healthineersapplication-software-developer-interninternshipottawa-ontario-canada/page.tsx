...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("siemens-healthineersapplication-software-developer-interninternshipottawa-ontario-canada", outputDir);
