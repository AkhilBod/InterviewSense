...
const articleData = {
  ...
  metaDescription: "Apply now for the Sierra Nevada Coporation Software Engineer Intern internship in Southern Pines, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sierra-nevada-coporation-software-engineer-intern-internship-southern-pines", outputDir);
