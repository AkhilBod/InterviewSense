...
const articleData = {
  ...
  metaDescription: "Apply now for the Signify Software Development Programmer Intern internship in Langley, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("signify-software-development-programmer-intern-internship-langley", outputDir);
