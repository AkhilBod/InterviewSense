...
const articleData = {
  ...
  metaDescription: "Apply now for the Signifyd Engineering Intern internship in Remote in UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("signifyd-engineering-intern-internship-remote-in-uk", outputDir);
