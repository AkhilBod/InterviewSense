...
const articleData = {
  ...
  metaDescription: "Apply now for the Simons Foundation High-Performance Computing Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("simons-foundation-highperformance-computing-intern-internship-nyc", outputDir);
