...
const articleData = {
  ...
  metaDescription: "Apply now for the Simons Foundation Scientific Visual Exploration Software Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("simons-foundation-scientific-visual-exploration-software-intern-internship-nyc", outputDir);
