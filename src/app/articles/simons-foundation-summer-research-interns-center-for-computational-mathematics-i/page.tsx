...
const articleData = {
  ...
  metaDescription: "Apply now for the Simons Foundation Summer Research Interns - Center for Computational Mathematics internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("simons-foundation-summer-research-interns-center-for-computational-mathematics-i", outputDir);
