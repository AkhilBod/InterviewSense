...
const articleData = {
  ...
  metaDescription: "Apply now for the Simons Foundation Summer Research Interns - CMB Analysis and Simulation internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("simons-foundation-summer-research-interns-cmb-analysis-and-simulation-internship", outputDir);
