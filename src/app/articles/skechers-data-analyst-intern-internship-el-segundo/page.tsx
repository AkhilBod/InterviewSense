...
const articleData = {
  ...
  metaDescription: "Apply now for the Skechers Data Analyst Intern internship in El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("skechers-data-analyst-intern-internship-el-segundo", outputDir);
