...
const articleData = {
  ...
  metaDescription: "Apply now for the skillz Data Engineering Co-Op internship in Las Vegas, NV. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("skillz-data-engineering-coop-internship-las-vegas", outputDir);
