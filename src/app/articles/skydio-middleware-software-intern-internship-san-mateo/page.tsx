...
const articleData = {
  ...
  metaDescription: "Apply now for the Skydio Middleware Software Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("skydio-middleware-software-intern-internship-san-mateo", outputDir);
