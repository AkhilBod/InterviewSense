...
const articleData = {
  ...
  metaDescription: "Apply now for the Skylo Technologies Data Analyst Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("skylo-technologies-data-analyst-intern-internship-mountain-view", outputDir);
