...
const articleData = {
  ...
  metaDescription: "Apply now for the Skyryse Software Engineer Intern - AI internship in El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("skyryse-software-engineer-intern-ai-internship-el-segundo", outputDir);
