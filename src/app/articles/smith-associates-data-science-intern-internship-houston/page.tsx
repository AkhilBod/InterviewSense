...
const articleData = {
  ...
  metaDescription: "Apply now for the Smith & Associates Data Science Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("smith-associates-data-science-intern-internship-houston", outputDir);
