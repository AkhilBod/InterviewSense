...
const articleData = {
  ...
  metaDescription: "Apply now for the Smith Micro Software AI & Data Science Intern internship in Aliso Viejo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("smith-micro-software-ai-data-science-intern-internship-aliso-viejo", outputDir);
