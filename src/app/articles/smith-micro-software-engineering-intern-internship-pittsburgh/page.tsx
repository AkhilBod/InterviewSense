...
const articleData = {
  ...
  metaDescription: "Apply now for the Smith Micro Software Engineering Intern internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("smith-micro-software-engineering-intern-internship-pittsburgh", outputDir);
