...
const articleData = {
  ...
  metaDescription: "Apply now for the Snowflake Academic Program Growth & Analytics Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("snowflake-academic-program-growth-analytics-intern-internship-san-mateo", outputDir);
