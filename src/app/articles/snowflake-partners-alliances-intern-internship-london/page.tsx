...
const articleData = {
  ...
  metaDescription: "Apply now for the Snowflake Partners Alliances Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("snowflake-partners-alliances-intern-internship-london", outputDir);
