...
const articleData = {
  ...
  metaDescription: "Apply now for the Snowflake Product Marketing Intern - Artificial Intelligence - AI internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("snowflake-product-marketing-intern-artificial-intelligence-ai-internship-san-mat", outputDir);
