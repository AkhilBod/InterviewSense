...
const articleData = {
  ...
  metaDescription: "Apply now for the Snyk R&D Engineering Co-op internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("snyk-rd-engineering-coop-internship-boston", outputDir);
