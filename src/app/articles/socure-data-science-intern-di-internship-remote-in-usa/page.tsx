...
const articleData = {
  ...
  metaDescription: "Apply now for the Socure Data Science Intern - DI internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("socure-data-science-intern-di-internship-remote-in-usa", outputDir);
