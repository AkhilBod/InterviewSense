...
const articleData = {
  ...
  metaDescription: "Apply now for the SoFi Intern – Credit Risk Analytics internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sofi-intern-credit-risk-analytics-internship-sf", outputDir);
