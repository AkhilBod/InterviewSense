...
const articleData = {
  ...
  metaDescription: "Apply now for the SoFi Intern – Data Scientist - Borrow internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sofi-intern-data-scientist-borrow-internship-sf", outputDir);
