...
const articleData = {
  ...
  metaDescription: "Apply now for the SoFi Intern – Enterprise Applications Engineer internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sofi-intern-enterprise-applications-engineer-internship-sf", outputDir);
