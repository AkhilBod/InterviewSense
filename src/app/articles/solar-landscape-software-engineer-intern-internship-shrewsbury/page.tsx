...
const articleData = {
  ...
  metaDescription: "Apply now for the Solar Landscape Software Engineer Intern internship in Shrewsbury, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("solar-landscape-software-engineer-intern-internship-shrewsbury", outputDir);
