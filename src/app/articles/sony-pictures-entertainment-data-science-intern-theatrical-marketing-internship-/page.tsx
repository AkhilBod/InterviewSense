...
const articleData = {
  ...
  metaDescription: "Apply now for the Sony Pictures Entertainment Data Science Intern - Theatrical Marketing internship in Culver City, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sony-pictures-entertainment-data-science-intern-theatrical-marketing-internship-", outputDir);
