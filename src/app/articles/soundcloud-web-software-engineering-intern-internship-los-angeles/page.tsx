...
const articleData = {
  ...
  metaDescription: "Apply now for the SoundCloud Web Software Engineering Intern internship in Los Angeles, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("soundcloud-web-software-engineering-intern-internship-los-angeles", outputDir);
