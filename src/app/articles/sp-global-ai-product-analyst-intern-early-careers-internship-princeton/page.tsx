...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global AI Product Analyst Intern - Early Careers internship in Princeton, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-ai-product-analyst-intern-early-careers-internship-princeton", outputDir);
