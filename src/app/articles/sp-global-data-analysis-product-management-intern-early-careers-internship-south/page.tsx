...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Data Analysis Product Management Intern - Early Careers internship in Southfield, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-data-analysis-product-management-intern-early-careers-internship-south", outputDir);
