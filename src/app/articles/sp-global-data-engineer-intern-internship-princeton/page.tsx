...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Data Engineer Intern internship in Princeton, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-data-engineer-intern-internship-princeton", outputDir);
