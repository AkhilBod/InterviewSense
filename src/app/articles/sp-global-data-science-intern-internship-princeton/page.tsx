...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Data Science Intern internship in Princeton, NJ</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-data-science-intern-internship-princeton", outputDir);
