...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Data Science & Modeling Intern - Early Careers internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-data-science-modeling-intern-early-careers-internship-remote-in-usa", outputDir);
