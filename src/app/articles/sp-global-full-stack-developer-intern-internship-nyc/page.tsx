...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Full Stack Developer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-full-stack-developer-intern-internship-nyc", outputDir);
