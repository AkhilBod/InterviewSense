...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Intern – Software Developer internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-intern-software-developer-internship-remote-in-canada", outputDir);
