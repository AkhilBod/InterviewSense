...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Land & Data Analyst Research Intern - Early Careers internship in Calgary, AB, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-land-data-analyst-research-intern-early-careers-internship-calgary", outputDir);
