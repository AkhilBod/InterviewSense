...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Machine Learning Engineer internship in Cambridge, MA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-machine-learning-engineer-internship-cambridge", outputDir);
