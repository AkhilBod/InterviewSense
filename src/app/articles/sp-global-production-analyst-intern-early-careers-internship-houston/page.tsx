...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Production Analyst Intern - Early Careers internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-production-analyst-intern-early-careers-internship-houston", outputDir);
