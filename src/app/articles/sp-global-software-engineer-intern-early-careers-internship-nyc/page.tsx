...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Software Engineer Intern - Early Careers internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-software-engineer-intern-early-careers-internship-nyc", outputDir);
