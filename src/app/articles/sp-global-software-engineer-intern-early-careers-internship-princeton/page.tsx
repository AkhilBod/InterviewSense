...
const articleData = {
  ...
  keywords: ["S&P Global internship", "Software Engineer Intern - Early Careers internship", "S&P Global Software Engineer Intern - Early Careers", "summer 2025 internship", "tech internship Princeton, NJ", "software internship", "S&P Global careers", "internship application", "tech jobs 2025", "Princeton internship", "S&P Global Princeton", "NJ internship", "S&P Global NJ", "software engineering internship", "software developer internship"],
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-software-engineer-intern-early-careers-internship-princeton", outputDir);
