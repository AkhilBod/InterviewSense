...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Sustainability Data Analytics Summer Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-sustainability-data-analytics-summer-intern-internship-london", outputDir);
