...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Upstream Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-global-upstream-intern-internship-houston", outputDir);
