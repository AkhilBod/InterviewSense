...
const articleData = {
  ...
  metaDescription: "Apply now for the S&P Global Security Engineering Intern (Early Careers) internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sp-globalsecurity-engineering-intern-early-careersinternshiptoronto-canada", outputDir);
