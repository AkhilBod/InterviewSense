...
const articleData = {
  ...
  metaDescription: "Apply now for the SpartanNash IT Database Administration Intern internship in Wyoming, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("spartannash-it-database-administration-intern-internship-wyoming", outputDir);
