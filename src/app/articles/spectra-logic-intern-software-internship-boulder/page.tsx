...
const articleData = {
  ...
  metaDescription: "Apply now for the Spectra Logic Intern - Software internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("spectra-logic-intern-software-internship-boulder", outputDir);
