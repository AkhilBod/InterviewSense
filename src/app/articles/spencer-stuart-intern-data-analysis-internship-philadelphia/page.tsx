...
const articleData = {
  ...
  metaDescription: "Apply now for the Spencer Stuart Intern – Data Analysis internship in Philadelphia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("spencer-stuart-intern-data-analysis-internship-philadelphia", outputDir);
