...
const articleData = {
  ...
  metaDescription: "Apply now for the Splunk Data Analyst Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("splunk-data-analyst-intern-internship-remote-in-usa", outputDir);
