...
const articleData = {
  ...
  metaDescription: "Apply now for the Splunk Data Scientist/Product Analyst Intern internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("splunk-data-scientistproduct-analyst-intern-internship-boulder", outputDir);
