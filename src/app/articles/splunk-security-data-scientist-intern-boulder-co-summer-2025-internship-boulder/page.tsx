...
const articleData = {
  ...
  metaDescription: "Apply now for the Splunk Security Data Scientist Intern - Boulder - CO - Summer 2025 internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("splunk-security-data-scientist-intern-boulder-co-summer-2025-internship-boulder", outputDir);
