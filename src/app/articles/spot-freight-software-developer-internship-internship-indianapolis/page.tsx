...
const articleData = {
  ...
  metaDescription: "Apply now for the Spot Freight Software Developer Internship internship in Indianapolis, IN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("spot-freight-software-developer-internship-internship-indianapolis", outputDir);
