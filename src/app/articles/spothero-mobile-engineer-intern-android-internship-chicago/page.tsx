...
const articleData = {
  ...
  metaDescription: "Apply now for the SpotHero Mobile Engineer Intern - Android internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("spothero-mobile-engineer-intern-android-internship-chicago", outputDir);
