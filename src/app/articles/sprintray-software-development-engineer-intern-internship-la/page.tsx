...
const articleData = {
  ...
  metaDescription: "Apply now for the SprintRay Software Development Engineer Intern internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sprintray-software-development-engineer-intern-internship-la", outputDir);
