...
const articleData = {
  ...
  metaDescription: "Apply now for the SPS Commerce Software Engineer Intern internship in Rogers, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sps-commerce-software-engineer-intern-internship-rogers", outputDir);
