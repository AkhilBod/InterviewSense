...
const articleData = {
  ...
  metaDescription: "Apply now for the SS&C Software Engineer Intern internship in Waltham, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ssc-software-engineer-intern-internship-waltham", outputDir);
