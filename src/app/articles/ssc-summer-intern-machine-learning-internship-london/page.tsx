...
const articleData = {
  ...
  metaDescription: "Apply now for the SS&C Summer Intern - Machine Learning internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ssc-summer-intern-machine-learning-internship-london", outputDir);
