...
const articleData = {
  ...
  metaDescription: "Apply now for the SS&C Technologies Intern - Technical internship in Toronto, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ssc-technologies-intern-technical-internship-toronto", outputDir);
