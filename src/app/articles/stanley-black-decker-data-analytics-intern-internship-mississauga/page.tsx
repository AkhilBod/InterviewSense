...
const articleData = {
  ...
  metaDescription: "Apply now for the Stanley Black & Decker Data Analytics Intern internship in Mississauga, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("stanley-black-decker-data-analytics-intern-internship-mississauga", outputDir);
