...
const articleData = {
  ...
  metaDescription: "Apply now for the State Street Software engineer Internship internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("state-street-software-engineer-internship-internship-burlington", outputDir);
