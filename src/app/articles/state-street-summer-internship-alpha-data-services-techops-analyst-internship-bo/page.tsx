...
const articleData = {
  ...
  metaDescription: "Apply now for the State Street Summer Internship - Alpha Data Services - Techops Analyst internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("state-street-summer-internship-alpha-data-services-techops-analyst-internship-bo", outputDir);
