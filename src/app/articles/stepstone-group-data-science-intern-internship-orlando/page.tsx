...
const articleData = {
  ...
  metaDescription: "Apply now for the StepStone Group Data Science Intern internship in Orlando, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("stepstone-group-data-science-intern-internship-orlando", outputDir);
