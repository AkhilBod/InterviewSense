...
const articleData = {
  ...
  metaDescription: "Apply now for the Strategic Education Enterprise Partnerships – Software Engineer Intern internship in Minneapolis, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("strategic-education-enterprise-partnerships-software-engineer-intern-internship-", outputDir);
