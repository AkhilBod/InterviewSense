...
const articleData = {
  ...
  metaDescription: "Apply now for the Strategic Education IT Interns internship in Reston, VA</br>Minneapolis, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("strategic-education-it-interns-internship-reston", outputDir);
