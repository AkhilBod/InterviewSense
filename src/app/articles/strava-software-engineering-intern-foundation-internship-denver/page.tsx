...
const articleData = {
  ...
  metaDescription: "Apply now for the Strava Software Engineering Intern - Foundation internship in Denver, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("strava-software-engineering-intern-foundation-internship-denver", outputDir);
