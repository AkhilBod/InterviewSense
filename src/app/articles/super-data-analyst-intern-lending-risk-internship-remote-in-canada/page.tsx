...
const articleData = {
  ...
  metaDescription: "Apply now for the Super Data Analyst Intern - Lending Risk internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("super-data-analyst-intern-lending-risk-internship-remote-in-canada", outputDir);
