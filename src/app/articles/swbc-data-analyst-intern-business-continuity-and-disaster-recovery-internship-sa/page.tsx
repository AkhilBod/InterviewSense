...
const articleData = {
  ...
  metaDescription: "Apply now for the SWBC Data Analyst Intern - Business Continuity and Disaster Recovery internship in San Antonio, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("swbc-data-analyst-intern-business-continuity-and-disaster-recovery-internship-sa", outputDir);
