...
const articleData = {
  ...
  metaDescription: "Apply now for the Sylvera Graduate Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sylvera-graduate-intern-internship-london", outputDir);
