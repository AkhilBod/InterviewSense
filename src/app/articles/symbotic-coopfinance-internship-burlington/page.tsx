...
const articleData = {
  ...
  metaDescription: "Apply now for the Symbotic Co-op-Finance internship in Burlington, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("symbotic-coopfinance-internship-burlington", outputDir);
