...
const articleData = {
  ...
  metaDescription: "Apply now for the Synechron Summer Internship Program - AI - Data and Data Science internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("synechron-summer-internship-program-ai-data-and-data-science-internship-charlott", outputDir);
