...
const articleData = {
  ...
  metaDescription: "Apply now for the Synthego Software Engineering Intern internship in San Carlos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("synthego-software-engineering-intern-internship-san-carlos", outputDir);
