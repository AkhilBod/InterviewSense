...
const articleData = {
  ...
  metaDescription: "Apply now for the Syntronic Software Designer – Co-op/Summer Student internship in Kanata, Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("syntronic-software-designer-coopsummer-student-internship-kanata", outputDir);
