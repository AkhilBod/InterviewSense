...
const articleData = {
  ...
  metaDescription: "Apply now for the Sysco Functional Analyst Intern internship in Houston, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("sysco-functional-analyst-intern-internship-houston", outputDir);
