...
const articleData = {
  ...
  metaDescription: "Apply now for the Takeda Summer Internship Program: Digital Analyst Intern internship in Thousand Oaks, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("takeda-summer-internship-program-digital-analyst-intern-internship-thousand-oaks", outputDir);
