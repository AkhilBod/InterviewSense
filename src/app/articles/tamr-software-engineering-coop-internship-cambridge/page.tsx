...
const articleData = {
  ...
  metaDescription: "Apply now for the Tamr Software Engineering Co-op internship in Cambridge, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tamr-software-engineering-coop-internship-cambridge", outputDir);
