...
const articleData = {
  ...
  metaDescription: "Apply now for the Tanium Business Intelligence & Data Analytics Intern internship in Oakland, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tanium-business-intelligence-data-analytics-intern-internship-oakland", outputDir);
