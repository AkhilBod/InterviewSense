...
const articleData = {
  ...
  metaDescription: "Apply now for the Tanium Data Scientist Intern internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tanium-data-scientist-intern-internship-durham", outputDir);
