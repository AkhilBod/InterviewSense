...
const articleData = {
  ...
  metaDescription: "Apply now for the Tarsus Pharamceuticals Intern – IT internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tarsus-pharamceuticals-intern-it-internship-irvine", outputDir);
