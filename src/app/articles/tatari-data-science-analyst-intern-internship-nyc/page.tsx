...
const articleData = {
  ...
  metaDescription: "Apply now for the Tatari Data Science Analyst – Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tatari-data-science-analyst-intern-internship-nyc", outputDir);
