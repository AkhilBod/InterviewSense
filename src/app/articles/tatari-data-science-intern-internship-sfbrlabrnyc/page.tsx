...
const articleData = {
  ...
  metaDescription: "Apply now for the Tatari Data Science – Intern internship in SF</br>LA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tatari-data-science-intern-internship-sfbrlabrnyc", outputDir);
