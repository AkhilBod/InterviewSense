...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank AI2 Finance Analytics and Data Science Intern/Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-ai2-finance-analytics-and-data-science-interncoop-internship-toronto", outputDir);
