...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank Business Systems Analyst Intern/Co-op - Tds internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-business-systems-analyst-interncoop-tds-internship-toronto", outputDir);
