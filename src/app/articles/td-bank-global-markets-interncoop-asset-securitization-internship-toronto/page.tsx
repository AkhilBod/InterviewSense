...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank Global Markets Intern/Co-op - Asset Securitization internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-global-markets-interncoop-asset-securitization-internship-toronto", outputDir);
