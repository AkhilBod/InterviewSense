...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank Portfolio Analytics Data Analyst Intern / Co-Op internship in Oakland, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-portfolio-analytics-data-analyst-intern-coop-internship-oakland", outputDir);
