...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank Software Developer Intern/Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-software-developer-interncoop-internship-toronto", outputDir);
