...
const articleData = {
  ...
  metaDescription: "Apply now for the TD Bank Tdi Data – Analytics and Insights Intern/Co-op internship in Montreal, QC, Canada</br>Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("td-bank-tdi-data-analytics-and-insights-interncoop-internship-montreal", outputDir);
