...
const articleData = {
  ...
  metaDescription: "Apply now for the Tecovas Technology Core Systems Intern - Internal Opportunity internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tecovas-technology-core-systems-intern-internal-opportunity-internship-austin", outputDir);
