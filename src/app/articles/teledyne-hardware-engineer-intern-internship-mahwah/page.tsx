...
const articleData = {
  ...
  metaDescription: "Apply now for the Teledyne Hardware Engineer Intern internship in Mahwah, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("teledyne-hardware-engineer-intern-internship-mahwah", outputDir);
