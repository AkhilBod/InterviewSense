...
const articleData = {
  ...
  metaDescription: "Apply now for the Teledyne Technical Intern - Summer internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("teledyne-technical-intern-summer-internship-durham", outputDir);
