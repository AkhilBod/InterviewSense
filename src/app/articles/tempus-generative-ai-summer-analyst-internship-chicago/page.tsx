...
const articleData = {
  ...
  metaDescription: "Apply now for the Tempus Generative AI Summer Analyst internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tempus-generative-ai-summer-analyst-internship-chicago", outputDir);
