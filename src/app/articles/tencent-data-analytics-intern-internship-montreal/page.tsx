...
const articleData = {
  ...
  metaDescription: "Apply now for the Tencent Data Analytics Intern internship in Montreal, QC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tencent-data-analytics-intern-internship-montreal", outputDir);
