...
const articleData = {
  ...
  metaDescription: "Apply now for the Tencent Game AI Engineer Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tencent-game-ai-engineer-intern-internship-london", outputDir);
