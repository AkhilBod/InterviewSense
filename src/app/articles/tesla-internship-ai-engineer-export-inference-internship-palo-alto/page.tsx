...
const articleData = {
  ...
  keywords: ["Tesla internship", "Internship, AI Engineer, Export & Inference internship", "Tesla Internship, AI Engineer, Export & Inference", "summer 2025 internship", "tech internship Palo Alto, CA", "software internship", "Tesla careers", "internship application", "tech jobs 2025", "Palo Alto internship", "Tesla Palo Alto", "CA internship", "Tesla CA", "software engineering internship", "software developer internship"],
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tesla-internship-ai-engineer-export-inference-internship-palo-alto", outputDir);
