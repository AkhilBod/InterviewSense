...
const articleData = {
  ...
  metaDescription: "Apply now for the The Allen Institute for AI Artificial Intelligence Internship - Skylight Team internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-allen-institute-for-ai-artificial-intelligence-internship-skylight-team-inte", outputDir);
