...
const articleData = {
  ...
  metaDescription: "Apply now for the The Federal Reserve System BTS Innovation Analyst Intern internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-federal-reserve-system-bts-innovation-analyst-intern-internship-atlanta", outputDir);
