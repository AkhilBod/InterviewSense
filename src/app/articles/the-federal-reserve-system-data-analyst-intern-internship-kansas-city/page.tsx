...
const articleData = {
  ...
  metaDescription: "Apply now for the The Federal Reserve System Data Analyst Intern internship in Kansas City, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-federal-reserve-system-data-analyst-intern-internship-kansas-city", outputDir);
