...
const articleData = {
  ...
  metaDescription: "Apply now for the The Federal Reserve System Software Engineering Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-federal-reserve-system-software-engineering-intern-internship-boston", outputDir);
