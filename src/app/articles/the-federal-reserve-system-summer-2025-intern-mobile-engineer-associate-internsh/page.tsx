...
const articleData = {
  ...
  metaDescription: "Apply now for the The Federal Reserve System Summer 2025 Intern - Mobile Engineer - Associate internship in Dallas, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-federal-reserve-system-summer-2025-intern-mobile-engineer-associate-internsh", outputDir);
