...
const articleData = {
  ...
  metaDescription: "Apply now for the The Federal Reserve System Summer 2025 Intern-Data Science - Business Analytics - And Sharepoint internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-federal-reserve-system-summer-2025-interndata-science-business-analytics-and", outputDir);
