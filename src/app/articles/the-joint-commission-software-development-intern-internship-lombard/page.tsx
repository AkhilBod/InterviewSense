...
const articleData = {
  ...
  metaDescription: "Apply now for the The Joint Commission Software Development Intern internship in Lombard, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-joint-commission-software-development-intern-internship-lombard", outputDir);
