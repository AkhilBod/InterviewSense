...
const articleData = {
  ...
  metaDescription: "Apply now for the The Scion Group Revenue Analytics Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-scion-group-revenue-analytics-intern-internship-chicago", outputDir);
