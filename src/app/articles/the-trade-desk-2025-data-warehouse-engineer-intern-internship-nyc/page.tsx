...
const articleData = {
  ...
  metaDescription: "Apply now for the The Trade Desk 2025 Data Warehouse Engineer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-trade-desk-2025-data-warehouse-engineer-intern-internship-nyc", outputDir);
