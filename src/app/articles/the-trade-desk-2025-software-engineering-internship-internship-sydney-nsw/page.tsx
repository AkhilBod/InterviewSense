...
const articleData = {
  ...
  metaDescription: "Apply now for the The Trade Desk 2025 Software Engineering Internship internship in Sydney NSW, Australia. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-trade-desk-2025-software-engineering-internship-internship-sydney-nsw", outputDir);
