...
const articleData = {
  ...
  metaDescription: "Apply now for the The Trade Desk 2025 Summer Intern - Data Science - London internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-trade-desk-2025-summer-intern-data-science-london-internship-london", outputDir);
