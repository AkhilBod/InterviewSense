...
const articleData = {
  ...
  metaDescription: "Apply now for the The Trade Desk Business Intelligence Intern - Summer 2025 internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("the-trade-desk-business-intelligence-intern-summer-2025-internship-irvine", outputDir);
