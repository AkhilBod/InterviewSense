...
const articleData = {
  ...
  metaDescription: "Apply now for the Thermo Fisher Scientific Artificial Intelligence Internship internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thermo-fisher-scientificartificial-intelligence-internshipinternshippittsburgh-pa", outputDir);
