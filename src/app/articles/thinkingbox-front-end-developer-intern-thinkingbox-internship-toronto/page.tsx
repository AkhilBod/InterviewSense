...
const articleData = {
  ...
  metaDescription: "Apply now for the Thinkingbox Front End Developer Intern - Thinkingbox internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thinkingbox-front-end-developer-intern-thinkingbox-internship-toronto", outputDir);
