...
const articleData = {
  ...
  metaDescription: "Apply now for the Thousand Eyes Software Engineer Intern - Cloud and Enterprise Agents internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thousand-eyes-software-engineer-intern-cloud-and-enterprise-agents-internship-sf", outputDir);
