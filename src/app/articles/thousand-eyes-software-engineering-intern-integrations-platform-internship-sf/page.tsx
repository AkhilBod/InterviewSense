...
const articleData = {
  ...
  metaDescription: "Apply now for the Thousand Eyes Software Engineering Intern - Integrations Platform internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thousand-eyes-software-engineering-intern-integrations-platform-internship-sf", outputDir);
