...
const articleData = {
  ...
  metaDescription: "Apply now for the Thousand Eyes Software Engineering Intern - Subscription Management Platform internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thousand-eyes-software-engineering-intern-subscription-management-platform-inter", outputDir);
