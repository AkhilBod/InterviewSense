...
const articleData = {
  ...
  metaDescription: "Apply now for the ThredUp Fintech Software Engineering Intern internship in Oakland, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thredup-fintech-software-engineering-intern-internship-oakland", outputDir);
