...
const articleData = {
  ...
  metaDescription: "Apply now for the ThredUp Machine Learning Engineer Intern internship in Scottsdale, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("thredup-machine-learning-engineer-intern-internship-scottsdale", outputDir);
