...
const articleData = {
  ...
  metaDescription: "Apply now for the TIFIN Intern – Data Integration internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tifin-intern-data-integration-internship-charlotte", outputDir);
