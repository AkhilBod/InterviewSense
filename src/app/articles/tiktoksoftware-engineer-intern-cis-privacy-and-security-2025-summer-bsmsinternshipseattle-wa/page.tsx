...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tiktoksoftware-engineer-intern-cis-privacy-and-security-2025-summer-bsmsinternshipseattle-wa", outputDir);
