...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tmobilesummer-2025-software-engineer-digital-orders-platform-team-interninternshipatlanta-ga", outputDir);
