...
const articleData = {
  ...
  metaDescription: "Apply now for the Together AI Research Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("together-ai-research-intern-internship-sf", outputDir);
