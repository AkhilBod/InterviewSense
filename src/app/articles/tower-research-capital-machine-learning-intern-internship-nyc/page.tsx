...
const articleData = {
  ...
  metaDescription: "Apply now for the Tower Research Capital Machine Learning Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tower-research-capital-machine-learning-intern-internship-nyc", outputDir);
