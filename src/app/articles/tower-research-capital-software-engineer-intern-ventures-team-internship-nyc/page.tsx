...
const articleData = {
  ...
  metaDescription: "Apply now for the Tower Research Capital Software Engineer Intern - Ventures Team internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tower-research-capital-software-engineer-intern-ventures-team-internship-nyc", outputDir);
