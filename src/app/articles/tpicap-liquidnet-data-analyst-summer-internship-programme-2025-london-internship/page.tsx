...
const articleData = {
  ...
  metaDescription: "Apply now for the TP-ICAP Liquidnet Data Analyst – Summer Internship Programme 2025 - London internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tpicap-liquidnet-data-analyst-summer-internship-programme-2025-london-internship", outputDir);
