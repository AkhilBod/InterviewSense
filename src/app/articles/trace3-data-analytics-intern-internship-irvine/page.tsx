...
const articleData = {
  ...
  metaDescription: "Apply now for the Trace3 Data & Analytics Intern internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trace3-data-analytics-intern-internship-irvine", outputDir);
