...
const articleData = {
  ...
  metaDescription: "Apply now for the Tradeweb Summer Internship Program - C++/ OOP Developer internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tradeweb-summer-internship-program-c-oop-developer-internship-london", outputDir);
