...
const articleData = {
  ...
  metaDescription: "Apply now for the Transcarent Data Engineering Intern internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("transcarent-data-engineering-intern-internship-seattle", outputDir);
