...
const articleData = {
  ...
  metaDescription: "Apply now for the TransMarket Group Quantitative Trader Intern internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("transmarket-group-quantitative-trader-intern-internship-chicago", outputDir);
