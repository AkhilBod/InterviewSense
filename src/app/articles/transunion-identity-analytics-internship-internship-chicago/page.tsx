...
const articleData = {
  ...
  metaDescription: "Apply now for the TransUnion Identity Analytics Internship internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("transunion-identity-analytics-internship-internship-chicago", outputDir);
