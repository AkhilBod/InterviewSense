...
const articleData = {
  ...
  metaDescription: "Apply now for the Trayt.Health Engineering Summer Intern internship in Menlo Park, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("traythealth-engineering-summer-intern-internship-menlo-park", outputDir);
