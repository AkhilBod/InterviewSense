...
const articleData = {
  ...
  metaDescription: "Apply now for the Trepp Data Science Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trepp-data-science-intern-internship-nyc", outputDir);
