...
const articleData = {
  ...
  metaDescription: "Apply now for the Trepp Product & Data Analytics Intern internship in Dallas, TX</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trepp-product-data-analytics-intern-internship-dallas", outputDir);
