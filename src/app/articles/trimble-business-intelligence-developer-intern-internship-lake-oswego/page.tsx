...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Business Intelligence Developer Intern internship in Lake Oswego, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-business-intelligence-developer-intern-internship-lake-oswego", outputDir);
