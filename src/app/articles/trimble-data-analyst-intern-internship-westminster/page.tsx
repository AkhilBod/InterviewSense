...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Data Analyst Intern internship in Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-data-analyst-intern-internship-westminster", outputDir);
