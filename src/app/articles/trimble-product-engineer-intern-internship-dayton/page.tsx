...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Product Engineer Intern internship in Dayton, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-product-engineer-intern-internship-dayton", outputDir);
