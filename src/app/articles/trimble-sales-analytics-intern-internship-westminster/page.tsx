...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Sales Analytics Intern internship in Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-sales-analytics-intern-internship-westminster", outputDir);
