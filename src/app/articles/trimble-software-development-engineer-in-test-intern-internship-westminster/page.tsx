...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Software Development Engineer in Test Intern internship in Westminster, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-software-development-engineer-in-test-intern-internship-westminster", outputDir);
