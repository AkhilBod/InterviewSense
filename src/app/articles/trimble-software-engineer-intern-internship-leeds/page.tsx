...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Software Engineer Intern internship in Leeds, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-software-engineer-intern-internship-leeds", outputDir);
