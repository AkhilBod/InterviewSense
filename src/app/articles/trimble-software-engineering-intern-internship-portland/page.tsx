...
const articleData = {
  ...
  metaDescription: "Apply now for the Trimble Software Engineering Intern internship in Portland, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trimble-software-engineering-intern-internship-portland", outputDir);
