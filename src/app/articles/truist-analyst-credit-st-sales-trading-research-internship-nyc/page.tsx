...
const articleData = {
  ...
  metaDescription: "Apply now for the Truist Analyst - Credit S&T - Sales - Trading & Research internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("truist-analyst-credit-st-sales-trading-research-internship-nyc", outputDir);
