...
const articleData = {
  ...
  metaDescription: "Apply now for the TruStage Full-stack – Application Developer IT Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("trustage-fullstack-application-developer-it-intern-internship-remote-in-usa", outputDir);
