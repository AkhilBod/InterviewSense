...
const articleData = {
  ...
  metaDescription: "Apply now for the Truveta Clinical Data Analyst Intern/Apprentice internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("truveta-clinical-data-analyst-internapprentice-internship-seattle", outputDir);
