...
const articleData = {
  ...
  metaDescription: "Apply now for the Truveta Summer Undergraduate Engineering Internship internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("truveta-summer-undergraduate-engineering-internship-internship-seattle", outputDir);
