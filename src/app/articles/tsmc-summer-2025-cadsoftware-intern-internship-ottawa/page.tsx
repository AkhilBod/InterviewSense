...
const articleData = {
  ...
  metaDescription: "Apply now for the TSMC Summer 2025 - CAD/Software Intern internship in Ottawa, Ontario, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tsmc-summer-2025-cadsoftware-intern-internship-ottawa", outputDir);
