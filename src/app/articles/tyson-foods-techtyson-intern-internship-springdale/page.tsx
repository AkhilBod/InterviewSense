...
const articleData = {
  ...
  metaDescription: "Apply now for the Tyson Foods Tech@Tyson Intern internship in Springdale, AR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("tyson-foods-techtyson-intern-internship-springdale", outputDir);
