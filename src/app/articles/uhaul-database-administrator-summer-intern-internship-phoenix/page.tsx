...
const articleData = {
  ...
  metaDescription: "Apply now for the Uhaul Database Administrator Summer Intern internship in Phoenix, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("uhaul-database-administrator-summer-intern-internship-phoenix", outputDir);
