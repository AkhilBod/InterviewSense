...
const articleData = {
  ...
  metaDescription: "Apply now for the Uhaul Software Development Summer Intern internship in Phoenix, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("uhaul-software-development-summer-intern-internship-phoenix", outputDir);
