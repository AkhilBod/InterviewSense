...
const articleData = {
  ...
  metaDescription: "Apply now for the ULINE Inc. Software Developer Internship internship in Pleasant Prairie, WI, USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("uline-incsoftware-developer-internshipinternshippleasant-prairie-wi-usa", outputDir);
