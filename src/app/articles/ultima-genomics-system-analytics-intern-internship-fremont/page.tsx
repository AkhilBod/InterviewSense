...
const articleData = {
  ...
  metaDescription: "Apply now for the Ultima Genomics System Analytics Intern internship in Fremont, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ultima-genomics-system-analytics-intern-internship-fremont", outputDir);
