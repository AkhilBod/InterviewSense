...
const articleData = {
  ...
  metaDescription: "Apply now for the Unisys Software Developer Intern - Placement Year internship in Manchester, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("unisys-software-developer-intern-placement-year-internship-manchester", outputDir);
