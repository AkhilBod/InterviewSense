...
const articleData = {
  ...
  metaDescription: "Apply now for the United Parcel Service (UPS) Engineering Co-Op internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("united-parcel-service-ups-engineering-coop-internship-united-states", outputDir);
