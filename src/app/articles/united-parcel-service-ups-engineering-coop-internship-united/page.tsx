...
// Article metadata
const articleData = {
  slug: "united-parcel-service-ups-engineering-coop-internship-united",
  title: "United Parcel Service (UPS) Engineering Co-Op Interview Questions",
  metaDescription: "Ace your United Parcel Service (UPS) Engineering Co-Op interview with AI-powered practice questions and feedback. Get ready for your United States internship.",
  keywords: ["United Parcel Service (UPS) interview", "Engineering Co-Op interview questions", "United Parcel Service (UPS) internship", "interview practice", "AI interview prep", "United Parcel Service (UPS) Engineering Co-Op", "Software Engineering interview questions"],
  lastUpdated: "2025-06-24T12:16:11.355Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "United Parcel Service (UPS) Engineering Co-Op Interview Questions",
  "description": "Ace your United Parcel Service (UPS) Engineering Co-Op interview with AI-powered practice questions and feedback. Get ready for your United States internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/united-parcel-service-ups-engineering-coop-internship-united"
},
  openGraph: {
  "title": "United Parcel Service (UPS) Engineering Co-Op Interview Questions",
  "description": "Ace your United Parcel Service (UPS) Engineering Co-Op interview with AI-powered practice questions and feedback. Get ready for your United States internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("united-parcel-service-ups-engineering-coop-internship-united", outputDir);
