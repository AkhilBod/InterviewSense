...
const articleData = {
  ...
  metaDescription: "Apply now for the United Parcel Service (UPS) GBS Data Science Intern internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("united-parcel-service-ups-gbs-data-science-intern-internship-united-states", outputDir);
