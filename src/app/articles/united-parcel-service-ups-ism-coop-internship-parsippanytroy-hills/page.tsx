...
const articleData = {
  ...
  metaDescription: "Apply now for the United Parcel Service (UPS) ISM Co-Op internship in Parsippany-Troy Hills, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("united-parcel-service-ups-ism-coop-internship-parsippanytroy-hills", outputDir);
