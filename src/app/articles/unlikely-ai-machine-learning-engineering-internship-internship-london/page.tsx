...
const articleData = {
  ...
  metaDescription: "Apply now for the Unlikely AI Machine Learning Engineering Internship internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("unlikely-ai-machine-learning-engineering-internship-internship-london", outputDir);
