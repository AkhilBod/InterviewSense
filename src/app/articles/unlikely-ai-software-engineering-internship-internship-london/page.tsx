...
const articleData = {
  ...
  metaDescription: "Apply now for the Unlikely AI Software Engineering Internship internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("unlikely-ai-software-engineering-internship-internship-london", outputDir);
