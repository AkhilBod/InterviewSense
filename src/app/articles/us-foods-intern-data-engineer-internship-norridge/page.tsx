...
const articleData = {
  ...
  metaDescription: "Apply now for the US Foods Intern – Data Engineer internship in Norridge, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("us-foods-intern-data-engineer-internship-norridge", outputDir);
