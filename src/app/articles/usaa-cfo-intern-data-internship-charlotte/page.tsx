...
const articleData = {
  ...
  metaDescription: "Apply now for the USAA CFO Intern - Data internship in Charlotte, NC</br>San Antonio, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("usaa-cfo-intern-data-internship-charlotte", outputDir);
