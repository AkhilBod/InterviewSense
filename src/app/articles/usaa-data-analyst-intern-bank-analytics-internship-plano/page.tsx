...
const articleData = {
  ...
  metaDescription: "Apply now for the USAA Data Analyst Intern - Bank Analytics internship in Plano, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("usaa-data-analyst-intern-bank-analytics-internship-plano", outputDir);
