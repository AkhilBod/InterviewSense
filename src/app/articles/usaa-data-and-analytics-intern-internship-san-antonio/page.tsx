...
const articleData = {
  ...
  metaDescription: "Apply now for the USAA Data and Analytics Intern internship in San Antonio, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("usaa-data-and-analytics-intern-internship-san-antonio", outputDir);
