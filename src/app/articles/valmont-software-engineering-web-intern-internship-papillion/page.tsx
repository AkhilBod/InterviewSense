...
const articleData = {
  ...
  metaDescription: "Apply now for the Valmont Software Engineering Web Intern internship in Papillion, NE. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("valmont-software-engineering-web-intern-internship-papillion", outputDir);
