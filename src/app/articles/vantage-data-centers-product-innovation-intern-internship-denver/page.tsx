...
const articleData = {
  ...
  metaDescription: "Apply now for the Vantage Data Centers Product Innovation Intern internship in Denver, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vantage-data-centers-product-innovation-intern-internship-denver", outputDir);
