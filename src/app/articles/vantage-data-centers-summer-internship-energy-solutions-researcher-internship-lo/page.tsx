...
const articleData = {
  ...
  metaDescription: "Apply now for the Vantage Data Centers Summer Internship - Energy Solutions Researcher internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vantage-data-centers-summer-internship-energy-solutions-researcher-internship-lo", outputDir);
