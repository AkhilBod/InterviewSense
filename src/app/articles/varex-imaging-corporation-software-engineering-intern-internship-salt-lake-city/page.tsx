...
const articleData = {
  ...
  metaDescription: "Apply now for the Varex Imaging Corporation Software Engineering Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("varex-imaging-corporation-software-engineering-intern-internship-salt-lake-city", outputDir);
