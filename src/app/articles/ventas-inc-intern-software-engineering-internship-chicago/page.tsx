...
const articleData = {
  ...
  metaDescription: "Apply now for the Ventas Inc Intern – Software Engineering internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("ventas-inc-intern-software-engineering-internship-chicago", outputDir);
