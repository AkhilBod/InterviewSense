...
const articleData = {
  ...
  metaDescription: "Apply now for the Veolia 2025 Summer Intern - Laboratory internship in Paramus, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("veolia-2025-summer-intern-laboratory-internship-paramus", outputDir);
