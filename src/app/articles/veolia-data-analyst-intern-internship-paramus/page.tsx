...
const articleData = {
  ...
  metaDescription: "Apply now for the Veolia Data Analyst Intern internship in Paramus, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("veolia-data-analyst-intern-internship-paramus", outputDir);
