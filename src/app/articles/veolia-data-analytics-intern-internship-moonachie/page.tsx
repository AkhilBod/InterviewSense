...
const articleData = {
  ...
  metaDescription: "Apply now for the Veolia Data Analytics Intern internship in Moonachie, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("veolia-data-analytics-intern-internship-moonachie", outputDir);
