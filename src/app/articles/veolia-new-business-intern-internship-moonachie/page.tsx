...
const articleData = {
  ...
  metaDescription: "Apply now for the Veolia New Business Intern internship in Moonachie, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("veolia-new-business-intern-internship-moonachie", outputDir);
