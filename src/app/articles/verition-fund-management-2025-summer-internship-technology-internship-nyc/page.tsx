...
const articleData = {
  ...
  metaDescription: "Apply now for the Verition Fund Management 2025 Summer Internship - Technology internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verition-fund-management-2025-summer-internship-technology-internship-nyc", outputDir);
