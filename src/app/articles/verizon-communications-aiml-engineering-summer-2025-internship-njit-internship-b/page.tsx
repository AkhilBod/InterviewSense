...
const articleData = {
  ...
  metaDescription: "Apply now for the Verizon Communications AI/ML Engineering Summer 2025 Internship - Njit internship in Berkeley Heights, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verizon-communications-aiml-engineering-summer-2025-internship-njit-internship-b", outputDir);
