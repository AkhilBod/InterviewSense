...
const articleData = {
  ...
  metaDescription: "Apply now for the Verizon Communications Break Through Tech Sprinternship internship in Berkeley Heights, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verizon-communications-break-through-tech-sprinternship-internship-berkeley-heig", outputDir);
