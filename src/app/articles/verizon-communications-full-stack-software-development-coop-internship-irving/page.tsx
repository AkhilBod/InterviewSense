...
const articleData = {
  ...
  metaDescription: "Apply now for the Verizon Communications Full Stack Software Development Co-op internship in Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verizon-communications-full-stack-software-development-coop-internship-irving", outputDir);
