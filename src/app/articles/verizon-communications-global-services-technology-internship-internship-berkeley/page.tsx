...
const articleData = {
  ...
  metaDescription: "Apply now for the Verizon Communications Global Services Technology Internship internship in Berkeley Heights, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verizon-communications-global-services-technology-internship-internship-berkeley", outputDir);
