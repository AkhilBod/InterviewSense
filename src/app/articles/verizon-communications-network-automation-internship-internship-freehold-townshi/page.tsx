...
const articleData = {
  ...
  metaDescription: "Apply now for the Verizon Communications Network Automation Internship internship in Freehold Township, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verizon-communications-network-automation-internship-internship-freehold-townshi", outputDir);
