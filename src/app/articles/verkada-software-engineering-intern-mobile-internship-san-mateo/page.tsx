...
const articleData = {
  ...
  metaDescription: "Apply now for the Verkada Software Engineering Intern - Mobile internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("verkada-software-engineering-intern-mobile-internship-san-mateo", outputDir);
