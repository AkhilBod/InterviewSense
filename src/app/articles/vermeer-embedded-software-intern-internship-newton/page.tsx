...
const articleData = {
  ...
  metaDescription: "Apply now for the Vermeer Embedded Software Intern internship in Newton, IA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vermeer-embedded-software-intern-internship-newton", outputDir);
