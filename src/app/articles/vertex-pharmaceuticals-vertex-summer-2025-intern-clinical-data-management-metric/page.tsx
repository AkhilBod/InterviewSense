...
const articleData = {
  ...
  metaDescription: "Apply now for the Vertex Pharmaceuticals Vertex Summer 2025 Intern - Clinical Data Management & Metrics internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vertex-pharmaceuticals-vertex-summer-2025-intern-clinical-data-management-metric", outputDir);
