...
const articleData = {
  ...
  metaDescription: "Apply now for the Veterans United Intern – Data Engineer - Summer 2025 internship in Columbia, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("veterans-united-intern-data-engineer-summer-2025-internship-columbia", outputDir);
