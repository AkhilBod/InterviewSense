...
const articleData = {
  ...
  metaDescription: "Apply now for the Viant Engineering Intern - Corp IT internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("viant-engineering-intern-corp-it-internship-irvine", outputDir);
