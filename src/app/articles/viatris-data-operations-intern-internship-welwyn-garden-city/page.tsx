...
const articleData = {
  ...
  metaDescription: "Apply now for the Viatris Data Operations Intern internship in Welwyn Garden City, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("viatris-data-operations-intern-internship-welwyn-garden-city", outputDir);
