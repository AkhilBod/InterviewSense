...
const articleData = {
  ...
  metaDescription: "Apply now for the Viatris Intern – IT Analytics internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("viatris-intern-it-analytics-internship-remote-in-usa", outputDir);
