...
const articleData = {
  ...
  metaDescription: "Apply now for the Visa Associate Data Scientist – Intern - Cybersecurity internship in Ashburn, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("visa-associate-data-scientist-intern-cybersecurity-internship-ashburn", outputDir);
