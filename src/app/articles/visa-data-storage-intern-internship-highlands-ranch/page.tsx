...
const articleData = {
  ...
  metaDescription: "Apply now for the Visa Data Storage Intern internship in Highlands Ranch, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("visa-data-storage-intern-internship-highlands-ranch", outputDir);
