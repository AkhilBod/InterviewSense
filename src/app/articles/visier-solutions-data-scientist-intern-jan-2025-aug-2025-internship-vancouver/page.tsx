...
const articleData = {
  ...
  metaDescription: "Apply now for the Visier Solutions Data Scientist Intern - Jan 2025 - Aug 2025 internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("visier-solutions-data-scientist-intern-jan-2025-aug-2025-internship-vancouver", outputDir);
