...
const articleData = {
  ...
  metaDescription: "Apply now for the Vistra Simulator Software Engineering Intern internship in Concordville, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vistra-simulator-software-engineering-intern-internship-concordville", outputDir);
