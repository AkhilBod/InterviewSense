...
const articleData = {
  ...
  metaDescription: "Apply now for the Vizient Summer Intern-Corp IT internship in Centennial, CO</br>Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("vizient-summer-interncorp-it-internship-centennial", outputDir);
