...
const articleData = {
  ...
  metaDescription: "Apply now for the Voltus Software Engineering Internship internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("voltus-software-engineering-internship-internship-remote-in-usabrremote-in-canad", outputDir);
