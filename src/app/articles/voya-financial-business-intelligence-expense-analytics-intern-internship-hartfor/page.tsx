...
const articleData = {
  ...
  metaDescription: "Apply now for the Voya Financial Business Intelligence & Expense Analytics Intern internship in Hartford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("voya-financial-business-intelligence-expense-analytics-intern-internship-hartfor", outputDir);
