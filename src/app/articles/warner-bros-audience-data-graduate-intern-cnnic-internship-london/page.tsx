...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Audience & Data Graduate Intern - Cnnic internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-audience-data-graduate-intern-cnnic-internship-london", outputDir);
