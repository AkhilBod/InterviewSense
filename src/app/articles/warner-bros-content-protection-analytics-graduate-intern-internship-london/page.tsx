...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Content Protection & Analytics Graduate Intern internship in London, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-content-protection-analytics-graduate-intern-internship-london", outputDir);
