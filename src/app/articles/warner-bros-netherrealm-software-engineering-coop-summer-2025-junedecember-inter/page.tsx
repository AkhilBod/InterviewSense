...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Netherrealm Software Engineering Co-op - Summer 2025 - June-December internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-netherrealm-software-engineering-coop-summer-2025-junedecember-inter", outputDir);
