...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Research & Analytics Internships - Summer 2025 internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-research-analytics-internships-summer-2025-internship-atlanta", outputDir);
