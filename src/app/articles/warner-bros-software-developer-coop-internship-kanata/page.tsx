...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Software Developer Coop internship in Kanata, Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-software-developer-coop-internship-kanata", outputDir);
