...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. Software Engineering Intern internship in Bellevue, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-software-engineering-intern-internship-bellevue", outputDir);
