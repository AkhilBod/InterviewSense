...
const articleData = {
  ...
  metaDescription: "Apply now for the Warner Bros. WB Games User Research Intern - Summer 2025 internship in Kirkland, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("warner-bros-wb-games-user-research-intern-summer-2025-internship-kirkland", outputDir);
