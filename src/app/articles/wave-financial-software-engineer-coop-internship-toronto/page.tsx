...
// Article metadata
const articleData = {
  slug: "wave-financial-software-engineer-coop-internship-toronto",
  title: "Wave Financial Internship: Software Engineer – Co-op Position in Toronto, ON, Canada (2025)",
  metaDescription: "Apply now for the Wave Financial Software Engineer – Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  keywords: ["Wave Financial internship", "Software Engineer – Co-op internship", "Wave Financial Software Engineer – Co-op", "summer 2025 internship", "tech internship Toronto, ON, Canada", "software internship", "Wave Financial careers", "internship application", "tech jobs 2025", "Toronto internship", "Wave Financial Toronto", "ON internship", "Wave Financial ON", "Canada internship", "Wave Financial Canada"],
  lastUpdated: "2025-06-19T22:10:25.642Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "JobPosting",
  "title": "Software Engineer – Co-op Internship",
  "description": "Software Engineer – Co-op internship opportunity at Wave Financial in Toronto, ON, Canada for Summer 2025.",
  "hiringOrganization": {
    "@type": "Organization",
    "name": "Wave Financial"
  },
  ...
  "url": "http://localhost:3000/internships/wave-financial-software-engineer-coop-internship-toronto",
  "applicationDeadline": "Applications accepted on rolling basis"
},
  openGraph: {
  "title": "Wave Financial Internship: Software Engineer – Co-op Position in Toronto, ON, Canada (2025)",
  "description": "Apply now for the Wave Financial Software Engineer – Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wave-financial-software-engineer-coop-internship-toronto", outputDir);
