...
const articleData = {
  ...
  metaDescription: "Apply now for the Waymo 2025 Summer Intern - MS/ PhD - Perception internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("waymo-2025-summer-intern-ms-phd-perception-internship-mountain-view", outputDir);
