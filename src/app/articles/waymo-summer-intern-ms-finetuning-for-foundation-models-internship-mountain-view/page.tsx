...
const articleData = {
  ...
  metaDescription: "Apply now for the Waymo Summer Intern - MS - Fine-Tuning for Foundation Models internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("waymo-summer-intern-ms-finetuning-for-foundation-models-internship-mountain-view", outputDir);
