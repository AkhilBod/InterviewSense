...
const articleData = {
  ...
  metaDescription: "Apply now for the WebAI Summer Internship - Machine Learning Engineer internship in Austin, TX</br>Grand Rapids, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("webai-summer-internship-machine-learning-engineer-internship-austin", outputDir);
