...
const articleData = {
  ...
  metaDescription: "Apply now for the Weber Shandwick Data Science Intern internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("weber-shandwick-data-science-intern-internship-washington", outputDir);
