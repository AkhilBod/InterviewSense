...
const articleData = {
  ...
  metaDescription: "Apply now for the Webster Bank Summer AI Intern - Cio internship in Brooklawn, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("webster-bank-summer-ai-intern-cio-internship-brooklawn", outputDir);
