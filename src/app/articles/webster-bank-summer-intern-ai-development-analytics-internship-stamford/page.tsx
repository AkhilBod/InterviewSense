...
const articleData = {
  ...
  metaDescription: "Apply now for the Webster Bank Summer Intern - AI Development & Analytics internship in Stamford, CT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("webster-bank-summer-intern-ai-development-analytics-internship-stamford", outputDir);
