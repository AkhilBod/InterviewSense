...
const articleData = {
  ...
  metaDescription: "Apply now for the Webster Bank Summer Intern - Front End Developer internship in Jericho, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("webster-bank-summer-intern-front-end-developer-internship-jericho", outputDir);
