...
const articleData = {
  ...
  metaDescription: "Apply now for the Weld County Health Education Data Paid Intern internship in Greeley, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("weld-county-health-education-data-paid-intern-internship-greeley", outputDir);
