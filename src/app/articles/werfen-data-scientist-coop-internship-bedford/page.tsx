...
const articleData = {
  ...
  metaDescription: "Apply now for the Werfen Data Scientist Co-Op internship in Bedford, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("werfen-data-scientist-coop-internship-bedford", outputDir);
