...
const articleData = {
  ...
  metaDescription: "Apply now for the Werfen Intern – Software Engineering internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("werfen-intern-software-engineering-internship-san-diego", outputDir);
