...
const articleData = {
  ...
  metaDescription: "Apply now for the Werfen Software Engineer Intern internship in Bedford, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("werfen-software-engineer-intern-internship-bedford", outputDir);
