...
const articleData = {
  ...
  metaDescription: "Apply now for the Werfen Summer Firmware Intern internship in Bedford, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("werfen-summer-firmware-intern-internship-bedford", outputDir);
