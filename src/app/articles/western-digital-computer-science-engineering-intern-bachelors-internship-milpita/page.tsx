...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Computer Science & Engineering Intern - Bachelors internship in Milpitas, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-computer-science-engineering-intern-bachelors-internship-milpita", outputDir);
