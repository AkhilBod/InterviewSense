...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Data Engineering Summer Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-data-engineering-summer-intern-internship-san-jose", outputDir);
