...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Intern - Data Engineering internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-intern-data-engineering-internship-san-jose", outputDir);
