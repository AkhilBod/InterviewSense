...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Intern - Failure Analysis Automation Engineering internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-intern-failure-analysis-automation-engineering-internship-san-jo", outputDir);
