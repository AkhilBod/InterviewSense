...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital SSD Firmware Engineer Intern - Bachelors internship in Milpitas, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-ssd-firmware-engineer-intern-bachelors-internship-milpitas", outputDir);
