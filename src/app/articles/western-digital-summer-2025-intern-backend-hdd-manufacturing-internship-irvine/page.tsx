...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Summer 2025 Intern - Back-End HDD Manufacturing internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-summer-2025-intern-backend-hdd-manufacturing-internship-irvine", outputDir);
