...
const articleData = {
  ...
  metaDescription: "Apply now for the Western Digital Summer 2025 Intern - Operations Research & Analytics Engineering internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("western-digital-summer-2025-intern-operations-research-analytics-engineering-int", outputDir);
