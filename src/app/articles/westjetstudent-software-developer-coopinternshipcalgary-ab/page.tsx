...
const articleData = {
  ...
  metaDescription: "Apply now for the WestJet Student - Software Developer (Co-op) internship in Calgary, AB. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("westjetstudent-software-developer-coopinternshipcalgary-ab", outputDir);
