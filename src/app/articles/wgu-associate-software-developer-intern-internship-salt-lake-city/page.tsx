...
const articleData = {
  ...
  metaDescription: "Apply now for the WGU Associate Software Developer Intern internship in Salt Lake City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wgu-associate-software-developer-intern-internship-salt-lake-city", outputDir);
