...
const articleData = {
  ...
  metaDescription: "Apply now for the WhatNot Summer 2025 Data Science Intern internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("whatnot-summer-2025-data-science-intern-internship-remote-in-usabrremote-in-cana", outputDir);
