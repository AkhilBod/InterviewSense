...
const articleData = {
  ...
  metaDescription: "Apply now for the WillowTree Analytics Intern internship in Charlottesville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("willowtree-analytics-intern-internship-charlottesville", outputDir);
