...
const articleData = {
  ...
  metaDescription: "Apply now for the WillowTree Data Science Intern - US - Summer 2025 internship in Charlottesville, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("willowtree-data-science-intern-us-summer-2025-internship-charlottesville", outputDir);
