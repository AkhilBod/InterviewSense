...
const articleData = {
  ...
  metaDescription: "Apply now for the Wizards of the Coast Intern - Software Development Engineer internship in Renton, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wizards-of-the-coastintern-software-development-engineerinternshiprenton-wa", outputDir);
