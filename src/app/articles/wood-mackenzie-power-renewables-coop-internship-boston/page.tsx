...
const articleData = {
  ...
  metaDescription: "Apply now for the Wood Mackenzie Power & Renewables Co-Op internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wood-mackenzie-power-renewables-coop-internship-boston", outputDir);
