...
const articleData = {
  ...
  metaDescription: "Apply now for the Wordware Engineering intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wordware-engineering-intern-internship-sf", outputDir);
