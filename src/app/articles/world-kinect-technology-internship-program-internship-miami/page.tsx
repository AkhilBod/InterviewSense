...
const articleData = {
  ...
  metaDescription: "Apply now for the World Kinect Technology Internship Program internship in Miami, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("world-kinect-technology-internship-program-internship-miami", outputDir);
