...
const articleData = {
  ...
  metaDescription: "Apply now for the World Surf League Intern – Digital internship in El Segundo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("world-surf-league-intern-digital-internship-el-segundo", outputDir);
