...
const articleData = {
  ...
  metaDescription: "Apply now for the Wunderman Thompson Intern – Enterprise Solutions - Innovation internship in Kansas City, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("wunderman-thompson-intern-enterprise-solutions-innovation-internship-kansas-city", outputDir);
