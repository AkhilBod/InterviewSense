...
const articleData = {
  ...
  metaDescription: "Apply now for the X Engineering Intern internship in Palo Alto, CA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("x-engineering-intern-internship-palo-alto", outputDir);
