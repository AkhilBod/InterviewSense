...
// Article metadata
const articleData = {
  slug: "x-engineering-intern-internship-palo",
  title: "X Engineering Intern Interview Questions",
  metaDescription: "Ace your X Engineering Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA</br>NYC internship.",
  keywords: ["X interview", "Engineering Intern interview questions", "X internship", "interview practice", "AI interview prep", "X Engineering Intern", "Software Engineering interview questions"],
  lastUpdated: "2025-06-24T12:16:11.313Z",
  structuredData: {
  "@context": "https://schema.org/",
  "@type": "Article",
  "headline": "X Engineering Intern Interview Questions",
  "description": "Ace your X Engineering Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA</br>NYC internship.",
  "author": {
    "@type": "Organization",
    "name": "InterviewSense"
  },
  ...
  "url": "https://interviewsense.org/opportunities/x-engineering-intern-internship-palo"
},
  openGraph: {
  "title": "X Engineering Intern Interview Questions",
  "description": "Ace your X Engineering Intern interview with AI-powered practice questions and feedback. Get ready for your Palo Alto, CA</br>NYC internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("x-engineering-intern-internship-palo", outputDir);
