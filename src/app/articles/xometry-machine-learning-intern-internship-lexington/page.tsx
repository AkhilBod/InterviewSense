...
const articleData = {
  ...
  metaDescription: "Apply now for the Xometry Machine Learning Intern internship in Lexington, KY</br>North Bethesda, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("xometry-machine-learning-intern-internship-lexington", outputDir);
