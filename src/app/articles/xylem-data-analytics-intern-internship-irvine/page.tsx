...
const articleData = {
  ...
  metaDescription: "Apply now for the Xylem Data Analytics Intern internship in Irvine, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("xylem-data-analytics-intern-internship-irvine", outputDir);
