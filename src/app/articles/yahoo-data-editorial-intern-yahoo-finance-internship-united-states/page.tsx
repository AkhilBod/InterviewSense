...
const articleData = {
  ...
  metaDescription: "Apply now for the Yahoo Data Editorial Intern - Yahoo Finance internship in United States. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("yahoo-data-editorial-intern-yahoo-finance-internship-united-states", outputDir);
