...
const articleData = {
  ...
  metaDescription: "Apply now for the Yodlee AI Engineer Intern internship in Raleigh, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("yodlee-ai-engineer-intern-internship-raleigh", outputDir);
