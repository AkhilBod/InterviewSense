...
const articleData = {
  ...
  metaDescription: "Apply now for the Yodlee AI Implementations Intern internship in Raleigh, NC</br>Berwyn, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("yodlee-ai-implementations-intern-internship-raleigh", outputDir);
