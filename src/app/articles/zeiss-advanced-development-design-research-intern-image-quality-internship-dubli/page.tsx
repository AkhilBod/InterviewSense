...
const articleData = {
  ...
  metaDescription: "Apply now for the Zeiss Advanced Development & Design Research Intern Image Quality internship in Dublin, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zeiss-advanced-development-design-research-intern-image-quality-internship-dubli", outputDir);
