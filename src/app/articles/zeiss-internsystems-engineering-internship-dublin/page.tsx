...
const articleData = {
  ...
  metaDescription: "Apply now for the Zeiss Intern-Systems Engineering internship in Dublin, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zeiss-internsystems-engineering-internship-dublin", outputDir);
