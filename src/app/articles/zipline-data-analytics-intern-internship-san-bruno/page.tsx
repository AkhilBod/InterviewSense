...
const articleData = {
  ...
  metaDescription: "Apply now for the Zipline Data Analytics Intern internship in San Bruno, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zipline-data-analytics-intern-internship-san-bruno", outputDir);
