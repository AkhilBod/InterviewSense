...
const articleData = {
  ...
  metaDescription: "Apply now for the Zipline Droid Autonomy Intern - Motion Planning internship in San Bruno, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zipline-droid-autonomy-intern-motion-planning-internship-san-bruno", outputDir);
