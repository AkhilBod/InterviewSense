...
const articleData = {
  ...
  metaDescription: "Apply now for the Zipline Spatial Planning Intern internship in San Bruno, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zipline-spatial-planning-intern-internship-san-bruno", outputDir);
