...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoetis 4-Hana Supply Chain Analytics Intern internship in Kalamazoo, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoetis-4hana-supply-chain-analytics-intern-internship-kalamazoo", outputDir);
