...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoetis Biodevices Software Test – Intern internship in Durham, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoetis-biodevices-software-test-intern-internship-durham", outputDir);
