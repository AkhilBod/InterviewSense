...
const articleData = {
  ...
  metaDescription: "Apply now for the ZOLL Medical Corporation IT Application Intern internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoll-medical-corporation-it-application-intern-internship-pittsburgh", outputDir);
