...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoox Developer Platforms Intern internship in Foster City, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoox-developer-platforms-intern-internship-foster-city", outputDir);
