...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoox System Behavior Analysis Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoox-system-behavior-analysis-intern-internship-san-mateo", outputDir);
