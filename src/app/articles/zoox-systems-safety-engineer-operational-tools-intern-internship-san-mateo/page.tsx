...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoox Systems Safety Engineer – Operational Tools Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoox-systems-safety-engineer-operational-tools-intern-internship-san-mateo", outputDir);
