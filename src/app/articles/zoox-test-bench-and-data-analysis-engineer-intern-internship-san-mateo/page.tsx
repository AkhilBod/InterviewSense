...
const articleData = {
  ...
  metaDescription: "Apply now for the Zoox Test Bench and Data Analysis Engineer Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zoox-test-bench-and-data-analysis-engineer-intern-internship-san-mateo", outputDir);
