...
const articleData = {
  ...
  metaDescription: "Apply now for the Zscaler Artificial Intelligence/Machine Learning/Data Science Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zscaler-artificial-intelligencemachine-learningdata-science-engineering-intern-i", outputDir);
