...
const articleData = {
  ...
  metaDescription: "Apply now for the Zscaler Training Content and Lab Developer Intern - Zscaler Academy internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zscaler-training-content-and-lab-developer-intern-zscaler-academy-internship-san", outputDir);
