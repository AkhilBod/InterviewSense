...
const articleData = {
  ...
  metaDescription: "Apply now for the Zus Health Fullstack Software Engineering Co-op internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
async function ArticleContent() {
  try {
    ...
    const article = await contentManager.getArticleBySlug("zus-health-fullstack-software-engineering-coop-internship-boston", outputDir);
