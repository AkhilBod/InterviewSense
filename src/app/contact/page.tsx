...
import { User, LogOut, MessageSquare, ArrowLeft, Mail, Building2, Phone, CheckCircle2, ArrowRight, AlertCircle } from "lucide-react"
...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-zinc-950 to-zinc-900 text-white">
      ...
      <div className="flex-1 pt-20 py-12 relative">
