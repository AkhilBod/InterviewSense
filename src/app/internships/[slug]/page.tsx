...
/**
 * Dynamic Internship Article Page
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <ul className="space-y-1">
                <li><a href="/internships/software" className="text-blue-600 hover:underline">Software Engineering</a></li>
                <li><a href="/internships/data-science" className="text-blue-600 hover:underline">Data Science & AI</a></li>
                <li><a href="/internships/quant" className="text-blue-600 hover:underline">Quantitative Finance</a></li>
                <li><a href="/internships/hardware" className="text-blue-600 hover:underline">Hardware Engineering</a></li>
              </ul>
            </div>
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-2">
