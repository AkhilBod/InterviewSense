...
const pageData = {
  ...
  "title": "Airbnb Data Science Intern Algorithms Questions",
  "slug": "airbnb-data-science-intern-algorithms",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Airbnb Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbDataScienceInternAlgorithmsPage() {
