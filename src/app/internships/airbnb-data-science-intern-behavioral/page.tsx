...
const pageData = {
  ...
  "title": "Airbnb Data Science Intern Behavioral Questions Questions",
  "slug": "airbnb-data-science-intern-behavioral",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Airbnb Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbDataScienceInternBehavioralPage() {
