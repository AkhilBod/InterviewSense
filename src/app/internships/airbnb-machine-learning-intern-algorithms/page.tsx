...
const pageData = {
  ...
  "title": "Airbnb Machine Learning Intern Algorithms Questions",
  "slug": "airbnb-machine-learning-intern-algorithms",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Airbnb Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbMachineLearningInternAlgorithmsPage() {
