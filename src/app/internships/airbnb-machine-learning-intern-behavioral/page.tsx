...
const pageData = {
  ...
  "title": "Airbnb Machine Learning Intern Behavioral Questions Questions",
  "slug": "airbnb-machine-learning-intern-behavioral",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Airbnb Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbMachineLearningInternBehavioralPage() {
