...
const pageData = {
  ...
  "title": "Airbnb Machine Learning Intern System Design Questions",
  "slug": "airbnb-machine-learning-intern-system-design",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Airbnb Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbMachineLearningInternSystemDesignPage() {
