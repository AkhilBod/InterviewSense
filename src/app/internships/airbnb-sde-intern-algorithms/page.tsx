...
const pageData = {
  ...
  "title": "Airbnb SDE Intern Algorithms Questions",
  "slug": "airbnb-sde-intern-algorithms",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Airbnb SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSdeInternAlgorithmsPage() {
