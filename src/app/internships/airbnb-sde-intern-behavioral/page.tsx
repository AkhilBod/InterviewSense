...
const pageData = {
  ...
  "title": "Airbnb SDE Intern Behavioral Questions Questions",
  "slug": "airbnb-sde-intern-behavioral",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Airbnb SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSdeInternBehavioralPage() {
