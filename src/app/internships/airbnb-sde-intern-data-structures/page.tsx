...
const pageData = {
  ...
  "title": "Airbnb SDE Intern Data Structures Questions",
  "slug": "airbnb-sde-intern-data-structures",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Airbnb SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSdeInternDataStructuresPage() {
