...
const pageData = {
  ...
  "title": "Airbnb SDE Intern System Design Questions",
  "slug": "airbnb-sde-intern-system-design",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb SDE Intern System Design questions",
  "description": "Targeted System Design practice for Airbnb SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSdeInternSystemDesignPage() {
