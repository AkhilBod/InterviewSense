...
const pageData = {
  ...
  "title": "Airbnb Software Developer Intern Algorithms Questions",
  "slug": "airbnb-software-developer-intern-algorithms",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Airbnb Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareDeveloperInternAlgorithmsPage() {
