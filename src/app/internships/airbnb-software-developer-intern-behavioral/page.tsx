...
const pageData = {
  ...
  "title": "Airbnb Software Developer Intern Behavioral Questions Questions",
  "slug": "airbnb-software-developer-intern-behavioral",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Airbnb Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareDeveloperInternBehavioralPage() {
