...
const pageData = {
  ...
  "title": "Airbnb Software Engineer Intern Algorithms Questions",
  "slug": "airbnb-software-engineer-intern-algorithms",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Airbnb Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareEngineerInternAlgorithmsPage() {
