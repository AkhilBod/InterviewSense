...
const pageData = {
  ...
  "title": "Airbnb Software Engineer Intern Behavioral Questions Questions",
  "slug": "airbnb-software-engineer-intern-behavioral",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Airbnb Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareEngineerInternBehavioralPage() {
