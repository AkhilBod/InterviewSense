...
const pageData = {
  ...
  "title": "Airbnb Software Engineer Intern Data Structures Questions",
  "slug": "airbnb-software-engineer-intern-data-structures",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Airbnb Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareEngineerInternDataStructuresPage() {
