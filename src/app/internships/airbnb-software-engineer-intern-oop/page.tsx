...
const pageData = {
  ...
  "title": "Airbnb Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "airbnb-software-engineer-intern-oop",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Airbnb Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareEngineerInternOopPage() {
