...
const pageData = {
  ...
  "title": "Airbnb Software Engineer Intern System Design Questions",
  "slug": "airbnb-software-engineer-intern-system-design",
  "company": {
    "name": "Airbnb",
    "slug": "airbnb",
    "tier": "Unicorn",
  ...
  "keyword": "Airbnb Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Airbnb Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AirbnbSoftwareEngineerInternSystemDesignPage() {
