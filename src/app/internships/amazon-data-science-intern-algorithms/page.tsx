...
const pageData = {
  ...
  "title": "Amazon Data Science Intern Algorithms Questions",
  "slug": "amazon-data-science-intern-algorithms",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Amazon Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonDataScienceInternAlgorithmsPage() {
