...
const pageData = {
  ...
  "title": "Amazon Data Science Intern Behavioral Questions Questions",
  "slug": "amazon-data-science-intern-behavioral",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Amazon Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonDataScienceInternBehavioralPage() {
