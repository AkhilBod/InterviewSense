...
const pageData = {
  ...
  "title": "Amazon Machine Learning Intern Algorithms Questions",
  "slug": "amazon-machine-learning-intern-algorithms",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Amazon Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonMachineLearningInternAlgorithmsPage() {
