...
const pageData = {
  ...
  "title": "Amazon Machine Learning Intern Behavioral Questions Questions",
  "slug": "amazon-machine-learning-intern-behavioral",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Amazon Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonMachineLearningInternBehavioralPage() {
