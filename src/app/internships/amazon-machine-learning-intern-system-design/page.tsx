...
const pageData = {
  ...
  "title": "Amazon Machine Learning Intern System Design Questions",
  "slug": "amazon-machine-learning-intern-system-design",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Amazon Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonMachineLearningInternSystemDesignPage() {
