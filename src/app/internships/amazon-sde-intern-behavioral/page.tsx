...
const pageData = {
  ...
  "title": "Amazon SDE Intern Behavioral Questions Questions",
  "slug": "amazon-sde-intern-behavioral",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Amazon SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSdeInternBehavioralPage() {
