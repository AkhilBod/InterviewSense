...
const pageData = {
  ...
  "title": "Amazon SDE Intern Data Structures Questions",
  "slug": "amazon-sde-intern-data-structures",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Amazon SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSdeInternDataStructuresPage() {
