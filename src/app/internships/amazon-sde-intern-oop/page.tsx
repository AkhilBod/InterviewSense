...
const pageData = {
  ...
  "title": "Amazon SDE Intern Object-Oriented Programming Questions",
  "slug": "amazon-sde-intern-oop",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon SDE Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Amazon SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSdeInternOopPage() {
