...
const pageData = {
  ...
  "title": "Amazon SDE Intern System Design Questions",
  "slug": "amazon-sde-intern-system-design",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon SDE Intern System Design questions",
  "description": "Targeted System Design practice for Amazon SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSdeInternSystemDesignPage() {
