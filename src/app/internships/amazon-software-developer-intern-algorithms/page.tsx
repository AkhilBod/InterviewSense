...
const pageData = {
  ...
  "title": "Amazon Software Developer Intern Algorithms Questions",
  "slug": "amazon-software-developer-intern-algorithms",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Amazon Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareDeveloperInternAlgorithmsPage() {
