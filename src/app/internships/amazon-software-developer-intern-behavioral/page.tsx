...
const pageData = {
  ...
  "title": "Amazon Software Developer Intern Behavioral Questions Questions",
  "slug": "amazon-software-developer-intern-behavioral",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Amazon Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareDeveloperInternBehavioralPage() {
