...
const pageData = {
  ...
  "title": "Amazon Software Engineer Intern Algorithms Questions",
  "slug": "amazon-software-engineer-intern-algorithms",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Amazon Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareEngineerInternAlgorithmsPage() {
