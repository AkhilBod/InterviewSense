...
const pageData = {
  ...
  "title": "Amazon Software Engineer Intern Data Structures Questions",
  "slug": "amazon-software-engineer-intern-data-structures",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Amazon Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareEngineerInternDataStructuresPage() {
