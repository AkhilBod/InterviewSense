...
const pageData = {
  ...
  "title": "Amazon Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "amazon-software-engineer-intern-oop",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Amazon Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareEngineerInternOopPage() {
