...
const pageData = {
  ...
  "title": "Amazon Software Engineer Intern System Design Questions",
  "slug": "amazon-software-engineer-intern-system-design",
  "company": {
    "name": "Amazon",
    "slug": "amazon",
    "tier": "FAANG",
  ...
  "keyword": "Amazon Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Amazon Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AmazonSoftwareEngineerInternSystemDesignPage() {
