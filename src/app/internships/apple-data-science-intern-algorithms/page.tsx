...
const pageData = {
  ...
  "title": "Apple Data Science Intern Algorithms Questions",
  "slug": "apple-data-science-intern-algorithms",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Apple Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleDataScienceInternAlgorithmsPage() {
