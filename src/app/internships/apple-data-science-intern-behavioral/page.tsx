...
const pageData = {
  ...
  "title": "Apple Data Science Intern Behavioral Questions Questions",
  "slug": "apple-data-science-intern-behavioral",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Apple Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleDataScienceInternBehavioralPage() {
