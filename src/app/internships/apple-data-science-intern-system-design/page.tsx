...
const pageData = {
  ...
  "title": "Apple Data Science Intern System Design Questions",
  "slug": "apple-data-science-intern-system-design",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Data Science Intern System Design questions",
  "description": "Targeted System Design practice for Apple Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleDataScienceInternSystemDesignPage() {
