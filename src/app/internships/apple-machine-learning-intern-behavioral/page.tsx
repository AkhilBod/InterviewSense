...
const pageData = {
  ...
  "title": "Apple Machine Learning Intern Behavioral Questions Questions",
  "slug": "apple-machine-learning-intern-behavioral",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Apple Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleMachineLearningInternBehavioralPage() {
