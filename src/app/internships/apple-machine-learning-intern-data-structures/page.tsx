...
const pageData = {
  ...
  "title": "Apple Machine Learning Intern Data Structures Questions",
  "slug": "apple-machine-learning-intern-data-structures",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Machine Learning Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Apple Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleMachineLearningInternDataStructuresPage() {
