...
const pageData = {
  ...
  "title": "Apple Machine Learning Intern System Design Questions",
  "slug": "apple-machine-learning-intern-system-design",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Apple Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleMachineLearningInternSystemDesignPage() {
