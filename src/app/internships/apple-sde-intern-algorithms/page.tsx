...
const pageData = {
  ...
  "title": "Apple SDE Intern Algorithms Questions",
  "slug": "apple-sde-intern-algorithms",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Apple SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSdeInternAlgorithmsPage() {
