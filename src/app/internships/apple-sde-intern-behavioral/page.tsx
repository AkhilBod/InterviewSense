...
const pageData = {
  ...
  "title": "Apple SDE Intern Behavioral Questions Questions",
  "slug": "apple-sde-intern-behavioral",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Apple SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSdeInternBehavioralPage() {
