...
const pageData = {
  ...
  "title": "Apple SDE Intern Data Structures Questions",
  "slug": "apple-sde-intern-data-structures",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Apple SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSdeInternDataStructuresPage() {
