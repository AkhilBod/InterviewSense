...
const pageData = {
  ...
  "title": "Apple SDE Intern System Design Questions",
  "slug": "apple-sde-intern-system-design",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple SDE Intern System Design questions",
  "description": "Targeted System Design practice for Apple SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSdeInternSystemDesignPage() {
