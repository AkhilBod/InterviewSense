...
const pageData = {
  ...
  "title": "Apple Software Developer Intern Algorithms Questions",
  "slug": "apple-software-developer-intern-algorithms",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Apple Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareDeveloperInternAlgorithmsPage() {
