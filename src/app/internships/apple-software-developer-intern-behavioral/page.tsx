...
const pageData = {
  ...
  "title": "Apple Software Developer Intern Behavioral Questions Questions",
  "slug": "apple-software-developer-intern-behavioral",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Apple Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareDeveloperInternBehavioralPage() {
