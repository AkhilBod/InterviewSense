...
const pageData = {
  ...
  "title": "Apple Software Developer Intern Data Structures Questions",
  "slug": "apple-software-developer-intern-data-structures",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Developer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Apple Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareDeveloperInternDataStructuresPage() {
