...
const pageData = {
  ...
  "title": "Apple Software Developer Intern System Design Questions",
  "slug": "apple-software-developer-intern-system-design",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Developer Intern System Design questions",
  "description": "Targeted System Design practice for Apple Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareDeveloperInternSystemDesignPage() {
