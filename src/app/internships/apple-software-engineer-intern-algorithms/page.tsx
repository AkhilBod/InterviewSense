...
const pageData = {
  ...
  "title": "Apple Software Engineer Intern Algorithms Questions",
  "slug": "apple-software-engineer-intern-algorithms",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Apple Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareEngineerInternAlgorithmsPage() {
