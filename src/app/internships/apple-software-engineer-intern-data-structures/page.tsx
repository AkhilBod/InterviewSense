...
const pageData = {
  ...
  "title": "Apple Software Engineer Intern Data Structures Questions",
  "slug": "apple-software-engineer-intern-data-structures",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Apple Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareEngineerInternDataStructuresPage() {
