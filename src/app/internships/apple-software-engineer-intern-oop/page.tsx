...
const pageData = {
  ...
  "title": "Apple Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "apple-software-engineer-intern-oop",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Apple Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareEngineerInternOopPage() {
