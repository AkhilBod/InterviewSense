...
const pageData = {
  ...
  "title": "Apple Software Engineer Intern System Design Questions",
  "slug": "apple-software-engineer-intern-system-design",
  "company": {
    "name": "Apple",
    "slug": "apple",
    "tier": "FAANG",
  ...
  "keyword": "Apple Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Apple Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function AppleSoftwareEngineerInternSystemDesignPage() {
