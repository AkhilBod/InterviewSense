...
export const metadata: Metadata = {
  title: 'Apple Internship Interview Questions | CS Interview Prep - InterviewSense',
  description: 'Ace your Apple internship interview with real questions and AI-powered practice. 280+ questions from actual Apple interviews.',
  keywords: 'Apple interview questions, Apple internship, Apple coding interview, Apple software engineer intern',
}

export default function AppleInterviewPage() {
  const rolePages = [
  {
    "type": "company-role",
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold">
                <span className="text-blue-500">Apple</span> Interview Questions
              </h1>
            </div>
            
            <p className="text-xl text-zinc-400 mb-8 max-w-3xl mx-auto">
              Practice real Apple internship interview questions. Get AI-powered feedback and land your dream CS internship at Apple.
            </p>
            ...
            >
              <Link href="/signup">
                Practice Apple Questions Now <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
