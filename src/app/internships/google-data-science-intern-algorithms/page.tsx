...
const pageData = {
  ...
  "title": "Google Data Science Intern Algorithms Questions",
  "slug": "google-data-science-intern-algorithms",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Google Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleDataScienceInternAlgorithmsPage() {
