...
const pageData = {
  ...
  "title": "Google Data Science Intern Behavioral Questions Questions",
  "slug": "google-data-science-intern-behavioral",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Google Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleDataScienceInternBehavioralPage() {
