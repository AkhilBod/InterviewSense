...
const pageData = {
  ...
  "title": "Google Data Science Intern Data Structures Questions",
  "slug": "google-data-science-intern-data-structures",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Data Science Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Google Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleDataScienceInternDataStructuresPage() {
