...
const pageData = {
  ...
  "title": "Google Data Science Intern System Design Questions",
  "slug": "google-data-science-intern-system-design",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Data Science Intern System Design questions",
  "description": "Targeted System Design practice for Google Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleDataScienceInternSystemDesignPage() {
