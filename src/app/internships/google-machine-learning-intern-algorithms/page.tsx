...
const pageData = {
  ...
  "title": "Google Machine Learning Intern Algorithms Questions",
  "slug": "google-machine-learning-intern-algorithms",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Google Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleMachineLearningInternAlgorithmsPage() {
