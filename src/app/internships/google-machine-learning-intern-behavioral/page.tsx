...
const pageData = {
  ...
  "title": "Google Machine Learning Intern Behavioral Questions Questions",
  "slug": "google-machine-learning-intern-behavioral",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Google Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleMachineLearningInternBehavioralPage() {
