...
const pageData = {
  ...
  "title": "Google Machine Learning Intern Data Structures Questions",
  "slug": "google-machine-learning-intern-data-structures",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Machine Learning Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Google Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleMachineLearningInternDataStructuresPage() {
