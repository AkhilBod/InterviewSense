...
const pageData = {
  ...
  "title": "Google Machine Learning Intern Object-Oriented Programming Questions",
  "slug": "google-machine-learning-intern-oop",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Machine Learning Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Google Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleMachineLearningInternOopPage() {
