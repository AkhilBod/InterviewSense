...
const pageData = {
  ...
  "title": "Google Machine Learning Intern System Design Questions",
  "slug": "google-machine-learning-intern-system-design",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Google Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleMachineLearningInternSystemDesignPage() {
