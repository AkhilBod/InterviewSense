...
const pageData = {
  ...
  "title": "Google SDE Intern Algorithms Questions",
  "slug": "google-sde-intern-algorithms",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Google SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSdeInternAlgorithmsPage() {
