...
const pageData = {
  ...
  "title": "Google SDE Intern Behavioral Questions Questions",
  "slug": "google-sde-intern-behavioral",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Google SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSdeInternBehavioralPage() {
