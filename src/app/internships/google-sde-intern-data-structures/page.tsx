...
const pageData = {
  ...
  "title": "Google SDE Intern Data Structures Questions",
  "slug": "google-sde-intern-data-structures",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Google SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSdeInternDataStructuresPage() {
