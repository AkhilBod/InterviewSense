...
const pageData = {
  ...
  "title": "Google SDE Intern Object-Oriented Programming Questions",
  "slug": "google-sde-intern-oop",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google SDE Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Google SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSdeInternOopPage() {
