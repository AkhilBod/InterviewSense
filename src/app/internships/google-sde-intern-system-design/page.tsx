...
const pageData = {
  ...
  "title": "Google SDE Intern System Design Questions",
  "slug": "google-sde-intern-system-design",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google SDE Intern System Design questions",
  "description": "Targeted System Design practice for Google SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSdeInternSystemDesignPage() {
