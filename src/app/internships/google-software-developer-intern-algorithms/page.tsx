...
const pageData = {
  ...
  "title": "Google Software Developer Intern Algorithms Questions",
  "slug": "google-software-developer-intern-algorithms",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Google Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareDeveloperInternAlgorithmsPage() {
