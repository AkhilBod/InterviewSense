...
const pageData = {
  ...
  "title": "Google Software Developer Intern Behavioral Questions Questions",
  "slug": "google-software-developer-intern-behavioral",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Google Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareDeveloperInternBehavioralPage() {
