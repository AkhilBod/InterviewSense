...
const pageData = {
  ...
  "title": "Google Software Developer Intern Data Structures Questions",
  "slug": "google-software-developer-intern-data-structures",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Developer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Google Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareDeveloperInternDataStructuresPage() {
