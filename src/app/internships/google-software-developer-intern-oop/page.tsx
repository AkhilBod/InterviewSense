...
const pageData = {
  ...
  "title": "Google Software Developer Intern Object-Oriented Programming Questions",
  "slug": "google-software-developer-intern-oop",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Developer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Google Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareDeveloperInternOopPage() {
