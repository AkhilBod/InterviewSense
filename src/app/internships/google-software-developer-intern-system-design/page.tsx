...
const pageData = {
  ...
  "title": "Google Software Developer Intern System Design Questions",
  "slug": "google-software-developer-intern-system-design",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Developer Intern System Design questions",
  "description": "Targeted System Design practice for Google Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareDeveloperInternSystemDesignPage() {
