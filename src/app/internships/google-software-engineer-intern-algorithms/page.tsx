...
const pageData = {
  ...
  "title": "Google Software Engineer Intern Algorithms Questions",
  "slug": "google-software-engineer-intern-algorithms",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Google Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareEngineerInternAlgorithmsPage() {
