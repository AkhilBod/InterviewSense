...
const pageData = {
  ...
  "title": "Google Software Engineer Intern Behavioral Questions Questions",
  "slug": "google-software-engineer-intern-behavioral",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Google Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareEngineerInternBehavioralPage() {
