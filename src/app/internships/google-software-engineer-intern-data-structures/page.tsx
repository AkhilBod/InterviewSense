...
const pageData = {
  ...
  "title": "Google Software Engineer Intern Data Structures Questions",
  "slug": "google-software-engineer-intern-data-structures",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Google Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareEngineerInternDataStructuresPage() {
