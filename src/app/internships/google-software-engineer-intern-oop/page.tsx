...
const pageData = {
  ...
  "title": "Google Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "google-software-engineer-intern-oop",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Google Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareEngineerInternOopPage() {
