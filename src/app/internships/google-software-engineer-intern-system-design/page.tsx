...
const pageData = {
  ...
  "title": "Google Software Engineer Intern System Design Questions",
  "slug": "google-software-engineer-intern-system-design",
  "company": {
    "name": "Google",
    "slug": "google",
    "tier": "FAANG",
  ...
  "keyword": "Google Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Google Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function GoogleSoftwareEngineerInternSystemDesignPage() {
