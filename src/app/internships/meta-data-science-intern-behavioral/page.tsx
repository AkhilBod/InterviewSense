...
const pageData = {
  ...
  "title": "Meta Data Science Intern Behavioral Questions Questions",
  "slug": "meta-data-science-intern-behavioral",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Meta Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaDataScienceInternBehavioralPage() {
