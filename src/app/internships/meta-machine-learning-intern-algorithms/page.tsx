...
const pageData = {
  ...
  "title": "Meta Machine Learning Intern Algorithms Questions",
  "slug": "meta-machine-learning-intern-algorithms",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Meta Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaMachineLearningInternAlgorithmsPage() {
