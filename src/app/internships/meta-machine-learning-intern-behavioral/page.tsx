...
const pageData = {
  ...
  "title": "Meta Machine Learning Intern Behavioral Questions Questions",
  "slug": "meta-machine-learning-intern-behavioral",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Meta Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaMachineLearningInternBehavioralPage() {
