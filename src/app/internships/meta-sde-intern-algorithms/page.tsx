...
const pageData = {
  ...
  "title": "Meta SDE Intern Algorithms Questions",
  "slug": "meta-sde-intern-algorithms",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Meta SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSdeInternAlgorithmsPage() {
