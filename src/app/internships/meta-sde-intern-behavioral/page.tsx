...
const pageData = {
  ...
  "title": "Meta SDE Intern Behavioral Questions Questions",
  "slug": "meta-sde-intern-behavioral",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Meta SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSdeInternBehavioralPage() {
