...
const pageData = {
  ...
  "title": "Meta SDE Intern Data Structures Questions",
  "slug": "meta-sde-intern-data-structures",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Meta SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSdeInternDataStructuresPage() {
