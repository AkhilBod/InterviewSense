...
const pageData = {
  ...
  "title": "Meta SDE Intern System Design Questions",
  "slug": "meta-sde-intern-system-design",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta SDE Intern System Design questions",
  "description": "Targeted System Design practice for Meta SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSdeInternSystemDesignPage() {
