...
const pageData = {
  ...
  "title": "Meta Software Developer Intern Algorithms Questions",
  "slug": "meta-software-developer-intern-algorithms",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Meta Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareDeveloperInternAlgorithmsPage() {
