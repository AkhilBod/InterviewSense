...
const pageData = {
  ...
  "title": "Meta Software Developer Intern Behavioral Questions Questions",
  "slug": "meta-software-developer-intern-behavioral",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Meta Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareDeveloperInternBehavioralPage() {
