...
const pageData = {
  ...
  "title": "Meta Software Engineer Intern Algorithms Questions",
  "slug": "meta-software-engineer-intern-algorithms",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Meta Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareEngineerInternAlgorithmsPage() {
