...
const pageData = {
  ...
  "title": "Meta Software Engineer Intern Behavioral Questions Questions",
  "slug": "meta-software-engineer-intern-behavioral",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Meta Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareEngineerInternBehavioralPage() {
