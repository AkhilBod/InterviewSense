...
const pageData = {
  ...
  "title": "Meta Software Engineer Intern Data Structures Questions",
  "slug": "meta-software-engineer-intern-data-structures",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Meta Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareEngineerInternDataStructuresPage() {
