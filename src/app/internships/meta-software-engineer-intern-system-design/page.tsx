...
const pageData = {
  ...
  "title": "Meta Software Engineer Intern System Design Questions",
  "slug": "meta-software-engineer-intern-system-design",
  "company": {
    "name": "Meta",
    "slug": "meta",
    "tier": "FAANG",
  ...
  "keyword": "Meta Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Meta Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MetaSoftwareEngineerInternSystemDesignPage() {
