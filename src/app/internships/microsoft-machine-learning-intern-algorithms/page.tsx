...
const pageData = {
  ...
  "title": "Microsoft Machine Learning Intern Algorithms Questions",
  "slug": "microsoft-machine-learning-intern-algorithms",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Microsoft Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftMachineLearningInternAlgorithmsPage() {
