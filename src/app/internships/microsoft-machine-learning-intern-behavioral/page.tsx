...
const pageData = {
  ...
  "title": "Microsoft Machine Learning Intern Behavioral Questions Questions",
  "slug": "microsoft-machine-learning-intern-behavioral",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Microsoft Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftMachineLearningInternBehavioralPage() {
