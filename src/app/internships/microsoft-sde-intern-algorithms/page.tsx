...
const pageData = {
  ...
  "title": "Microsoft SDE Intern Algorithms Questions",
  "slug": "microsoft-sde-intern-algorithms",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Microsoft SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSdeInternAlgorithmsPage() {
