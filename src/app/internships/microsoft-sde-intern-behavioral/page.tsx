...
const pageData = {
  ...
  "title": "Microsoft SDE Intern Behavioral Questions Questions",
  "slug": "microsoft-sde-intern-behavioral",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Microsoft SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSdeInternBehavioralPage() {
