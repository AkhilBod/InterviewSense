...
const pageData = {
  ...
  "title": "Microsoft SDE Intern Data Structures Questions",
  "slug": "microsoft-sde-intern-data-structures",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Microsoft SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSdeInternDataStructuresPage() {
