...
const pageData = {
  ...
  "title": "Microsoft Software Developer Intern Algorithms Questions",
  "slug": "microsoft-software-developer-intern-algorithms",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Microsoft Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSoftwareDeveloperInternAlgorithmsPage() {
