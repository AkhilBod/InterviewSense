...
const pageData = {
  ...
  "title": "Microsoft Software Engineer Intern Algorithms Questions",
  "slug": "microsoft-software-engineer-intern-algorithms",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Microsoft Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSoftwareEngineerInternAlgorithmsPage() {
