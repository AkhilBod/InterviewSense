...
const pageData = {
  ...
  "title": "Microsoft Software Engineer Intern Behavioral Questions Questions",
  "slug": "microsoft-software-engineer-intern-behavioral",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Microsoft Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSoftwareEngineerInternBehavioralPage() {
