...
const pageData = {
  ...
  "title": "Microsoft Software Engineer Intern Data Structures Questions",
  "slug": "microsoft-software-engineer-intern-data-structures",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Microsoft Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSoftwareEngineerInternDataStructuresPage() {
