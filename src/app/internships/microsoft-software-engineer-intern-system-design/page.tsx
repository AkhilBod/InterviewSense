...
const pageData = {
  ...
  "title": "Microsoft Software Engineer Intern System Design Questions",
  "slug": "microsoft-software-engineer-intern-system-design",
  "company": {
    "name": "Microsoft",
    "slug": "microsoft",
    "tier": "Big Tech",
  ...
  "keyword": "Microsoft Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Microsoft Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function MicrosoftSoftwareEngineerInternSystemDesignPage() {
