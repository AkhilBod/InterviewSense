...
const pageData = {
  ...
  "title": "Netflix Data Science Intern Algorithms Questions",
  "slug": "netflix-data-science-intern-algorithms",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Netflix Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixDataScienceInternAlgorithmsPage() {
