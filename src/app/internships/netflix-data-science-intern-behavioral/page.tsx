...
const pageData = {
  ...
  "title": "Netflix Data Science Intern Behavioral Questions Questions",
  "slug": "netflix-data-science-intern-behavioral",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Netflix Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixDataScienceInternBehavioralPage() {
