...
const pageData = {
  ...
  "title": "Netflix Machine Learning Intern Algorithms Questions",
  "slug": "netflix-machine-learning-intern-algorithms",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Netflix Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixMachineLearningInternAlgorithmsPage() {
