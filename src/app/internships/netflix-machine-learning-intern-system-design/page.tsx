...
const pageData = {
  ...
  "title": "Netflix Machine Learning Intern System Design Questions",
  "slug": "netflix-machine-learning-intern-system-design",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Netflix Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixMachineLearningInternSystemDesignPage() {
