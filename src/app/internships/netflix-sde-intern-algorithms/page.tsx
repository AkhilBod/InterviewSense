...
const pageData = {
  ...
  "title": "Netflix SDE Intern Algorithms Questions",
  "slug": "netflix-sde-intern-algorithms",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Netflix SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSdeInternAlgorithmsPage() {
