...
const pageData = {
  ...
  "title": "Netflix SDE Intern Behavioral Questions Questions",
  "slug": "netflix-sde-intern-behavioral",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Netflix SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSdeInternBehavioralPage() {
