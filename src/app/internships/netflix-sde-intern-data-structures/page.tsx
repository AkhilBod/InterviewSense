...
const pageData = {
  ...
  "title": "Netflix SDE Intern Data Structures Questions",
  "slug": "netflix-sde-intern-data-structures",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Netflix SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSdeInternDataStructuresPage() {
