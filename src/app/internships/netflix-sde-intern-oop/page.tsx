...
const pageData = {
  ...
  "title": "Netflix SDE Intern Object-Oriented Programming Questions",
  "slug": "netflix-sde-intern-oop",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix SDE Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Netflix SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSdeInternOopPage() {
