...
const pageData = {
  ...
  "title": "Netflix SDE Intern System Design Questions",
  "slug": "netflix-sde-intern-system-design",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix SDE Intern System Design questions",
  "description": "Targeted System Design practice for Netflix SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSdeInternSystemDesignPage() {
