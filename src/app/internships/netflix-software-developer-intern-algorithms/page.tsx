...
const pageData = {
  ...
  "title": "Netflix Software Developer Intern Algorithms Questions",
  "slug": "netflix-software-developer-intern-algorithms",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Netflix Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareDeveloperInternAlgorithmsPage() {
