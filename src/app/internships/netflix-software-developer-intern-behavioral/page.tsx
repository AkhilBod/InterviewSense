...
const pageData = {
  ...
  "title": "Netflix Software Developer Intern Behavioral Questions Questions",
  "slug": "netflix-software-developer-intern-behavioral",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Netflix Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareDeveloperInternBehavioralPage() {
