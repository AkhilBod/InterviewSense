...
const pageData = {
  ...
  "title": "Netflix Software Developer Intern Data Structures Questions",
  "slug": "netflix-software-developer-intern-data-structures",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Developer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Netflix Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareDeveloperInternDataStructuresPage() {
