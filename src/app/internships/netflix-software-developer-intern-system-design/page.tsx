...
const pageData = {
  ...
  "title": "Netflix Software Developer Intern System Design Questions",
  "slug": "netflix-software-developer-intern-system-design",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Developer Intern System Design questions",
  "description": "Targeted System Design practice for Netflix Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareDeveloperInternSystemDesignPage() {
