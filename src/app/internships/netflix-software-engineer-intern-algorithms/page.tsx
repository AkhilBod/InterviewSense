...
const pageData = {
  ...
  "title": "Netflix Software Engineer Intern Algorithms Questions",
  "slug": "netflix-software-engineer-intern-algorithms",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Netflix Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareEngineerInternAlgorithmsPage() {
