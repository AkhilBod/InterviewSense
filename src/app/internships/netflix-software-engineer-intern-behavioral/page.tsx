...
const pageData = {
  ...
  "title": "Netflix Software Engineer Intern Behavioral Questions Questions",
  "slug": "netflix-software-engineer-intern-behavioral",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Netflix Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareEngineerInternBehavioralPage() {
