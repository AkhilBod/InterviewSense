...
const pageData = {
  ...
  "title": "Netflix Software Engineer Intern Data Structures Questions",
  "slug": "netflix-software-engineer-intern-data-structures",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Netflix Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareEngineerInternDataStructuresPage() {
