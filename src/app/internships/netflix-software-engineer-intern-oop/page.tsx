...
const pageData = {
  ...
  "title": "Netflix Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "netflix-software-engineer-intern-oop",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Netflix Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareEngineerInternOopPage() {
