...
const pageData = {
  ...
  "title": "Netflix Software Engineer Intern System Design Questions",
  "slug": "netflix-software-engineer-intern-system-design",
  "company": {
    "name": "Netflix",
    "slug": "netflix",
    "tier": "FAANG",
  ...
  "keyword": "Netflix Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Netflix Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NetflixSoftwareEngineerInternSystemDesignPage() {
