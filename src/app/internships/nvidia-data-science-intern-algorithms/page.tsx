...
const pageData = {
  ...
  "title": "Nvidia Data Science Intern Algorithms Questions",
  "slug": "nvidia-data-science-intern-algorithms",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Nvidia Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaDataScienceInternAlgorithmsPage() {
