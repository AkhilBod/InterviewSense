...
const pageData = {
  ...
  "title": "Nvidia Data Science Intern Behavioral Questions Questions",
  "slug": "nvidia-data-science-intern-behavioral",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Nvidia Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaDataScienceInternBehavioralPage() {
