...
const pageData = {
  ...
  "title": "Nvidia Machine Learning Intern Algorithms Questions",
  "slug": "nvidia-machine-learning-intern-algorithms",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Nvidia Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaMachineLearningInternAlgorithmsPage() {
