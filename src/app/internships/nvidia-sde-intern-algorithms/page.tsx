...
const pageData = {
  ...
  "title": "Nvidia SDE Intern Algorithms Questions",
  "slug": "nvidia-sde-intern-algorithms",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Nvidia SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSdeInternAlgorithmsPage() {
