...
const pageData = {
  ...
  "title": "Nvidia SDE Intern Behavioral Questions Questions",
  "slug": "nvidia-sde-intern-behavioral",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Nvidia SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSdeInternBehavioralPage() {
