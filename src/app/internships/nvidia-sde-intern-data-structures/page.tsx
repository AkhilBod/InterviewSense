...
const pageData = {
  ...
  "title": "Nvidia SDE Intern Data Structures Questions",
  "slug": "nvidia-sde-intern-data-structures",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Nvidia SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSdeInternDataStructuresPage() {
