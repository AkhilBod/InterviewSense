...
const pageData = {
  ...
  "title": "Nvidia SDE Intern System Design Questions",
  "slug": "nvidia-sde-intern-system-design",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia SDE Intern System Design questions",
  "description": "Targeted System Design practice for Nvidia SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSdeInternSystemDesignPage() {
