...
const pageData = {
  ...
  "title": "Nvidia Software Developer Intern Algorithms Questions",
  "slug": "nvidia-software-developer-intern-algorithms",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Nvidia Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareDeveloperInternAlgorithmsPage() {
