...
const pageData = {
  ...
  "title": "Nvidia Software Developer Intern Behavioral Questions Questions",
  "slug": "nvidia-software-developer-intern-behavioral",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Nvidia Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareDeveloperInternBehavioralPage() {
