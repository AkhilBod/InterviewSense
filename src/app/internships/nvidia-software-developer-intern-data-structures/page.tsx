...
const pageData = {
  ...
  "title": "Nvidia Software Developer Intern Data Structures Questions",
  "slug": "nvidia-software-developer-intern-data-structures",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Developer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Nvidia Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareDeveloperInternDataStructuresPage() {
