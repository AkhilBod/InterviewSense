...
const pageData = {
  ...
  "title": "Nvidia Software Engineer Intern Algorithms Questions",
  "slug": "nvidia-software-engineer-intern-algorithms",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Nvidia Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareEngineerInternAlgorithmsPage() {
