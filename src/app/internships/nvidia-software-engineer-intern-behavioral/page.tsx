...
const pageData = {
  ...
  "title": "Nvidia Software Engineer Intern Behavioral Questions Questions",
  "slug": "nvidia-software-engineer-intern-behavioral",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Nvidia Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareEngineerInternBehavioralPage() {
