...
const pageData = {
  ...
  "title": "Nvidia Software Engineer Intern Data Structures Questions",
  "slug": "nvidia-software-engineer-intern-data-structures",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Nvidia Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareEngineerInternDataStructuresPage() {
