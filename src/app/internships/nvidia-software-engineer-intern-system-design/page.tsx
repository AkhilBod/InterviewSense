...
const pageData = {
  ...
  "title": "Nvidia Software Engineer Intern System Design Questions",
  "slug": "nvidia-software-engineer-intern-system-design",
  "company": {
    "name": "Nvidia",
    "slug": "nvidia",
    "tier": "Big Tech",
  ...
  "keyword": "Nvidia Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Nvidia Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function NvidiaSoftwareEngineerInternSystemDesignPage() {
