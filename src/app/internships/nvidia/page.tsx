...
export const metadata: Metadata = {
  title: 'Nvidia Internship Interview Questions | CS Interview Prep - InterviewSense',
  description: 'Ace your Nvidia internship interview with real questions and AI-powered practice. 220+ questions from actual Nvidia interviews.',
  keywords: 'Nvidia interview questions, Nvidia internship, Nvidia coding interview, Nvidia software engineer intern',
}

export default function NvidiaInterviewPage() {
  const rolePages = [
  {
    "type": "company-role",
  ...
  {
    "type": "company-role",
    "title": "Nvidia Backend Developer Intern Interview Questions",
    "slug": "nvidia-backend-developer-intern",
    "company": {
      "name": "Nvidia",
      "slug": "nvidia",
      "tier": "Big Tech",
    ...
    "keyword": "Nvidia Backend Developer Intern interview questions",
    "description": "Ace your Nvidia Backend Developer Intern interview with real questions and AI-powered practice."
  },
  {
    "type": "company-role",
    "title": "Nvidia Full Stack Developer Intern Interview Questions",
    "slug": "nvidia-full-stack-developer-intern",
    "company": {
      "name": "Nvidia",
      "slug": "nvidia",
      "tier": "Big Tech",
    ...
    "keyword": "Nvidia Full Stack Developer Intern interview questions",
    "description": "Ace your Nvidia Full Stack Developer Intern interview with real questions and AI-powered practice."
  },
  {
    "type": "company-role",
  ...
  {
    "type": "company-role",
    "title": "Nvidia Cybersecurity Intern Interview Questions",
    "slug": "nvidia-cybersecurity-intern",
    "company": {
      "name": "Nvidia",
      "slug": "nvidia",
      "tier": "Big Tech",
    ...
    "keyword": "Nvidia Cybersecurity Intern interview questions",
    "description": "Ace your Nvidia Cybersecurity Intern interview with real questions and AI-powered practice."
  }
]
  const skillPages = [
  {
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold">
                <span className="text-blue-500">Nvidia</span> Interview Questions
              </h1>
            </div>
            
            <p className="text-xl text-zinc-400 mb-8 max-w-3xl mx-auto">
              Practice real Nvidia internship interview questions. Get AI-powered feedback and land your dream CS internship at Nvidia.
            </p>
            ...
            >
              <Link href="/signup">
                Practice Nvidia Questions Now <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
