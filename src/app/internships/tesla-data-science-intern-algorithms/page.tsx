...
const pageData = {
  ...
  "title": "Tesla Data Science Intern Algorithms Questions",
  "slug": "tesla-data-science-intern-algorithms",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Tesla Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaDataScienceInternAlgorithmsPage() {
