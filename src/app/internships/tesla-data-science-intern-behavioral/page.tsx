...
const pageData = {
  ...
  "title": "Tesla Data Science Intern Behavioral Questions Questions",
  "slug": "tesla-data-science-intern-behavioral",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Tesla Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaDataScienceInternBehavioralPage() {
