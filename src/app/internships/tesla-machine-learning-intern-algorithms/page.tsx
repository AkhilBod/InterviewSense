...
const pageData = {
  ...
  "title": "Tesla Machine Learning Intern Algorithms Questions",
  "slug": "tesla-machine-learning-intern-algorithms",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Tesla Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaMachineLearningInternAlgorithmsPage() {
