...
const pageData = {
  ...
  "title": "Tesla Machine Learning Intern Behavioral Questions Questions",
  "slug": "tesla-machine-learning-intern-behavioral",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Tesla Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaMachineLearningInternBehavioralPage() {
