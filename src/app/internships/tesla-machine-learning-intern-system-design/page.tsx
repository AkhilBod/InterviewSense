...
const pageData = {
  ...
  "title": "Tesla Machine Learning Intern System Design Questions",
  "slug": "tesla-machine-learning-intern-system-design",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Tesla Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaMachineLearningInternSystemDesignPage() {
