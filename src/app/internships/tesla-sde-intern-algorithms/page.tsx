...
const pageData = {
  ...
  "title": "Tesla SDE Intern Algorithms Questions",
  "slug": "tesla-sde-intern-algorithms",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Tesla SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSdeInternAlgorithmsPage() {
