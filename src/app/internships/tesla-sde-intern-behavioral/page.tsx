...
const pageData = {
  ...
  "title": "Tesla SDE Intern Behavioral Questions Questions",
  "slug": "tesla-sde-intern-behavioral",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Tesla SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSdeInternBehavioralPage() {
