...
const pageData = {
  ...
  "title": "Tesla SDE Intern Data Structures Questions",
  "slug": "tesla-sde-intern-data-structures",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Tesla SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSdeInternDataStructuresPage() {
