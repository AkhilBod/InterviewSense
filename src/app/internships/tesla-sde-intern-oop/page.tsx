...
const pageData = {
  ...
  "title": "Tesla SDE Intern Object-Oriented Programming Questions",
  "slug": "tesla-sde-intern-oop",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla SDE Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Tesla SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSdeInternOopPage() {
