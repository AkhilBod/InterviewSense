...
const pageData = {
  ...
  "title": "Tesla SDE Intern System Design Questions",
  "slug": "tesla-sde-intern-system-design",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla SDE Intern System Design questions",
  "description": "Targeted System Design practice for Tesla SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSdeInternSystemDesignPage() {
