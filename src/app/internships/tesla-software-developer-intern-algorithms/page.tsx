...
const pageData = {
  ...
  "title": "Tesla Software Developer Intern Algorithms Questions",
  "slug": "tesla-software-developer-intern-algorithms",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Tesla Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareDeveloperInternAlgorithmsPage() {
