...
const pageData = {
  ...
  "title": "Tesla Software Developer Intern Behavioral Questions Questions",
  "slug": "tesla-software-developer-intern-behavioral",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Tesla Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareDeveloperInternBehavioralPage() {
