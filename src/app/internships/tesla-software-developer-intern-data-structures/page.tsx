...
const pageData = {
  ...
  "title": "Tesla Software Developer Intern Data Structures Questions",
  "slug": "tesla-software-developer-intern-data-structures",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Developer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Tesla Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareDeveloperInternDataStructuresPage() {
