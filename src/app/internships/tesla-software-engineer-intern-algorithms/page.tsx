...
const pageData = {
  ...
  "title": "Tesla Software Engineer Intern Algorithms Questions",
  "slug": "tesla-software-engineer-intern-algorithms",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Tesla Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareEngineerInternAlgorithmsPage() {
