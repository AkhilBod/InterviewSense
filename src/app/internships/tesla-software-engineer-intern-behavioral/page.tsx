...
const pageData = {
  ...
  "title": "Tesla Software Engineer Intern Behavioral Questions Questions",
  "slug": "tesla-software-engineer-intern-behavioral",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Tesla Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareEngineerInternBehavioralPage() {
