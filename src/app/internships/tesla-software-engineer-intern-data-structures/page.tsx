...
const pageData = {
  ...
  "title": "Tesla Software Engineer Intern Data Structures Questions",
  "slug": "tesla-software-engineer-intern-data-structures",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Tesla Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareEngineerInternDataStructuresPage() {
