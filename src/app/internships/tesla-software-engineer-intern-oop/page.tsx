...
const pageData = {
  ...
  "title": "Tesla Software Engineer Intern Object-Oriented Programming Questions",
  "slug": "tesla-software-engineer-intern-oop",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Engineer Intern Object-Oriented Programming questions",
  "description": "Targeted Object-Oriented Programming practice for Tesla Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareEngineerInternOopPage() {
