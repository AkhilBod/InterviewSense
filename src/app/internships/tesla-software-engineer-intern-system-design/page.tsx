...
const pageData = {
  ...
  "title": "Tesla Software Engineer Intern System Design Questions",
  "slug": "tesla-software-engineer-intern-system-design",
  "company": {
    "name": "Tesla",
    "slug": "tesla",
    "tier": "Innovative",
  ...
  "keyword": "Tesla Software Engineer Intern System Design questions",
  "description": "Targeted System Design practice for Tesla Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function TeslaSoftwareEngineerInternSystemDesignPage() {
