...
const pageData = {
  ...
  "title": "Uber Data Science Intern Algorithms Questions",
  "slug": "uber-data-science-intern-algorithms",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Data Science Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Uber Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberDataScienceInternAlgorithmsPage() {
