...
const pageData = {
  ...
  "title": "Uber Data Science Intern Behavioral Questions Questions",
  "slug": "uber-data-science-intern-behavioral",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Data Science Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Uber Data Science Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberDataScienceInternBehavioralPage() {
