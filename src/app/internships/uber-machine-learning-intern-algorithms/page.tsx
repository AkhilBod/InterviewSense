...
const pageData = {
  ...
  "title": "Uber Machine Learning Intern Algorithms Questions",
  "slug": "uber-machine-learning-intern-algorithms",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Machine Learning Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Uber Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberMachineLearningInternAlgorithmsPage() {
