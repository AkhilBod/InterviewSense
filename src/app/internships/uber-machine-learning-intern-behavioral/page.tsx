...
const pageData = {
  ...
  "title": "Uber Machine Learning Intern Behavioral Questions Questions",
  "slug": "uber-machine-learning-intern-behavioral",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Machine Learning Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Uber Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberMachineLearningInternBehavioralPage() {
