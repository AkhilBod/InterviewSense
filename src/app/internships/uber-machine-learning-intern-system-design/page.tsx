...
const pageData = {
  ...
  "title": "Uber Machine Learning Intern System Design Questions",
  "slug": "uber-machine-learning-intern-system-design",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Machine Learning Intern System Design questions",
  "description": "Targeted System Design practice for Uber Machine Learning Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberMachineLearningInternSystemDesignPage() {
