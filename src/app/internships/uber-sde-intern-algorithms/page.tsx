...
const pageData = {
  ...
  "title": "Uber SDE Intern Algorithms Questions",
  "slug": "uber-sde-intern-algorithms",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber SDE Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Uber SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSdeInternAlgorithmsPage() {
