...
const pageData = {
  ...
  "title": "Uber SDE Intern Behavioral Questions Questions",
  "slug": "uber-sde-intern-behavioral",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber SDE Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Uber SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSdeInternBehavioralPage() {
