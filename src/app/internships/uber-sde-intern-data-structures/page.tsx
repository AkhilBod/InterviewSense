...
const pageData = {
  ...
  "title": "Uber SDE Intern Data Structures Questions",
  "slug": "uber-sde-intern-data-structures",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber SDE Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Uber SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSdeInternDataStructuresPage() {
