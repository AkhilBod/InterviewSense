...
const pageData = {
  ...
  "title": "Uber SDE Intern System Design Questions",
  "slug": "uber-sde-intern-system-design",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber SDE Intern System Design questions",
  "description": "Targeted System Design practice for Uber SDE Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSdeInternSystemDesignPage() {
