...
const pageData = {
  ...
  "title": "Uber Software Developer Intern Algorithms Questions",
  "slug": "uber-software-developer-intern-algorithms",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Software Developer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Uber Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSoftwareDeveloperInternAlgorithmsPage() {
