...
const pageData = {
  ...
  "title": "Uber Software Developer Intern Behavioral Questions Questions",
  "slug": "uber-software-developer-intern-behavioral",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Software Developer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Uber Software Developer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSoftwareDeveloperInternBehavioralPage() {
