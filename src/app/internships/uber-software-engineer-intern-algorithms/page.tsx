...
const pageData = {
  ...
  "title": "Uber Software Engineer Intern Algorithms Questions",
  "slug": "uber-software-engineer-intern-algorithms",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Software Engineer Intern Algorithms questions",
  "description": "Targeted Algorithms practice for Uber Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSoftwareEngineerInternAlgorithmsPage() {
