...
const pageData = {
  ...
  "title": "Uber Software Engineer Intern Behavioral Questions Questions",
  "slug": "uber-software-engineer-intern-behavioral",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Software Engineer Intern Behavioral Questions questions",
  "description": "Targeted Behavioral Questions practice for Uber Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSoftwareEngineerInternBehavioralPage() {
