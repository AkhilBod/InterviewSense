...
const pageData = {
  ...
  "title": "Uber Software Engineer Intern Data Structures Questions",
  "slug": "uber-software-engineer-intern-data-structures",
  "company": {
    "name": "Uber",
    "slug": "uber",
    "tier": "Unicorn",
  ...
  "keyword": "Uber Software Engineer Intern Data Structures questions",
  "description": "Targeted Data Structures practice for Uber Software Engineer Intern interviews."
}

export const metadata: Metadata = generateMetadata(pageData)

export default function UberSoftwareEngineerInternDataStructuresPage() {
