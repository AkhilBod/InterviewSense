...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/7eleven-software-engineer-intern-anaplan-summer-2025-internship-san-francisco",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "7-Eleven Internship: Software Engineer Intern, Anaplan (Summer 2025) Position in San Francisco, CA (2025)",
    "description": "Apply now for the 7-Eleven Software Engineer Intern, Anaplan (Summer 2025) internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function 7elevenSoftwareEngineerInternAnaplanSummer2025InternshipSanFranciscoPage() {
