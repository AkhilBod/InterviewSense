...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/acadian-asset-management-software-engineering-coop-internship-boston",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Acadian Asset Management Internship: Software Engineering Co-Op Position in Boston, MA (2025)",
    "description": "Apply now for the Acadian Asset Management Software Engineering Co-Op internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AcadianAssetManagementSoftwareEngineeringCoopInternshipBostonPage() {
