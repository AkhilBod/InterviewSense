...
const pageData = {
  ...
  "metaDescription": "Apply now for the Affirm Software Engineering Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Affirm internship",
    "Software Engineering Intern internship",
    "Affirm Software Engineering Intern",
...
export default function AffirmSoftwareEngineeringInternInternshipSfPage() {
