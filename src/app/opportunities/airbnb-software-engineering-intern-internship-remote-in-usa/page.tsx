...
const pageData = {
  ...
  "metaDescription": "Apply now for the Airbnb Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Airbnb internship",
...
export default function AirbnbSoftwareEngineeringInternInternshipRemoteInUsaPage() {
