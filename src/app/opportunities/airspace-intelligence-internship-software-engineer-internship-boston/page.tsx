...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/airspace-intelligence-internship-software-engineer-internship-boston",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Airspace Intelligence Internship: Internship - Software Engineer Position in Boston, MA (2025)",
    "description": "Apply now for the Airspace Intelligence Internship - Software Engineer internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AirspaceIntelligenceInternshipSoftwareEngineerInternshipBostonPage() {
