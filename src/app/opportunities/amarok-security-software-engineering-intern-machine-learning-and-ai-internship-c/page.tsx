...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/amarok-security-software-engineering-intern-machine-learning-and-ai-internship-c",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "AMAROK Security Internship: Software Engineering Intern - Machine Learning and AI Position in Columbia, SC (2025)",
    "description": "Apply now for the AMAROK Security Software Engineering Intern - Machine Learning and AI internship in Columbia, SC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AmarokSecuritySoftwareEngineeringInternMachineLearningAndAiInternshipCPage() {
