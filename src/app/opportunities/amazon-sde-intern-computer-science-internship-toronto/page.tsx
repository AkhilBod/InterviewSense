...
const pageData = {
  "slug": "amazon-sde-intern-computer-science-internship-toronto",
  "title": "Amazon Internship: SDE Intern - Computer Science Position in Toronto, ON, Canada</br>Vancouver, BC, Canada (2025)",
  "metaDescription": "Apply now for the Amazon SDE Intern - Computer Science internship in Toronto, ON, Canada</br>Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Amazon internship",
    "SDE Intern - Computer Science internship",
    "Amazon SDE Intern - Computer Science",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/amazon-sde-intern-computer-science-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Amazon Internship: SDE Intern - Computer Science Position in Toronto, ON, Canada</br>Vancouver, BC, Canada (2025)",
    "description": "Apply now for the Amazon SDE Intern - Computer Science internship in Toronto, ON, Canada</br>Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AmazonSdeInternComputerScienceInternshipTorontoPage() {
