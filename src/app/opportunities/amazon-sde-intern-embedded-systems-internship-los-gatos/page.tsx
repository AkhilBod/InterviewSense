...
const pageData = {
  "slug": "amazon-sde-intern-embedded-systems-internship-los-gatos",
  "title": "Amazon Internship: SDE Intern - Embedded Systems Position in Los Gatos, CA (2025)",
  "metaDescription": "Apply now for the Amazon SDE Intern - Embedded Systems internship in Los Gatos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Amazon internship",
    "SDE Intern - Embedded Systems internship",
    "Amazon SDE Intern - Embedded Systems",
    "summer 2025 internship",
    "tech internship Los Gatos, CA",
    "hardware internship",
    "Amazon careers",
    "internship application",
    "tech jobs 2025",
    "Los Gatos internship",
    "Amazon Los Gatos",
    "CA internship",
    "Amazon CA",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/amazon-sde-intern-embedded-systems-internship-los-gatos",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Amazon Internship: SDE Intern - Embedded Systems Position in Los Gatos, CA (2025)",
    "description": "Apply now for the Amazon SDE Intern - Embedded Systems internship in Los Gatos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AmazonSdeInternEmbeddedSystemsInternshipLosGatosPage() {
