...
const pageData = {
  "slug": "amazon-sde-intern-embedded-systems-internship-sunnyvale",
  "title": "Amazon Internship: SDE Intern (Embedded Systems) Position in Sunnyvale, CA (2025)",
  "metaDescription": "Apply now for the Amazon SDE Intern (Embedded Systems) internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Amazon internship",
    "SDE Intern (Embedded Systems) internship",
    "Amazon SDE Intern (Embedded Systems)",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/amazon-sde-intern-embedded-systems-internship-sunnyvale",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Amazon Internship: SDE Intern (Embedded Systems) Position in Sunnyvale, CA (2025)",
    "description": "Apply now for the Amazon SDE Intern (Embedded Systems) internship in Sunnyvale, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AmazonSdeInternEmbeddedSystemsInternshipSunnyvalePage() {
