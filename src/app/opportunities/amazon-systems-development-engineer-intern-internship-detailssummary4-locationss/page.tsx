...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/amazon-systems-development-engineer-intern-internship-detailssummary4-locationss",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Amazon Internship: Systems Development Engineer Intern Position in <details><summary>**4 locations**</summary>Seattle, WA</br>Austin, TX</br>Cupertino, CA</br>Sunnyvale, CA</details> (2025)",
    "description": "Apply now for the Amazon Systems Development Engineer Intern internship in <details><summary>**4 locations**</summary>Seattle, WA</br>Austin, TX</br>Cupertino, CA</br>Sunnyvale, CA</details>. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AmazonSystemsDevelopmentEngineerInternInternshipDetailssummary4LocationssPage() {
