...
const pageData = {
  ...
  "metaDescription": "Apply now for the Ambrook Software Engineering Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Ambrook internship",
    "Software Engineering Internship internship",
    "Ambrook Software Engineering Internship",
...
export default function AmbrookSoftwareEngineeringInternshipInternshipNycPage() {
