...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/antora-energy-software-engineering-intern-product-management-analytics-internshi",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Antora Energy Internship: Software Engineering Intern - Product Management & Analytics Position in San Jose, CA (2025)",
    "description": "Apply now for the Antora Energy Software Engineering Intern - Product Management & Analytics internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AntoraEnergySoftwareEngineeringInternProductManagementAnalyticsInternshiPage() {
