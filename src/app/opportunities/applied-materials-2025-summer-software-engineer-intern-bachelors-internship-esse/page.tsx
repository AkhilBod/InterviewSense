...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/applied-materials-2025-summer-software-engineer-intern-bachelors-internship-esse",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Applied Materials Internship: 2025 Summer Software Engineer Intern - Bachelors Position in Essex County, MA (2025)",
    "description": "Apply now for the Applied Materials 2025 Summer Software Engineer Intern - Bachelors internship in Essex County, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AppliedMaterials2025SummerSoftwareEngineerInternBachelorsInternshipEssePage() {
