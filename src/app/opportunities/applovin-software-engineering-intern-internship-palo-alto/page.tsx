...
const pageData = {
  ...
  "metaDescription": "Apply now for the AppLovin Software Engineering Intern internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "AppLovin internship",
    "Software Engineering Intern internship",
    "AppLovin Software Engineering Intern",
...
export default function ApplovinSoftwareEngineeringInternInternshipPaloAltoPage() {
