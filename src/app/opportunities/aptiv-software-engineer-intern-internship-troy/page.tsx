...
const pageData = {
  ...
  "metaDescription": "Apply now for the Aptiv Software Engineer Intern internship in Troy, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Aptiv internship",
    "Software Engineer Intern internship",
    "Aptiv Software Engineer Intern",
    "summer 2025 internship",
    "tech internship Troy, MI",
    "software internship",
    "Aptiv careers",
...
export default function AptivSoftwareEngineerInternInternshipTroyPage() {
