...
const pageData = {
  "slug": "archer-electric-engine-control-software-engineering-intern-internship-san-jose",
  "title": "Archer Internship: Electric Engine Control Software Engineering Intern Position in San Jose, CA (2025)",
  "metaDescription": "Apply now for the Archer Electric Engine Control Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Archer internship",
    "Electric Engine Control Software Engineering Intern internship",
    "Archer Electric Engine Control Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/archer-electric-engine-control-software-engineering-intern-internship-san-jose",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Archer Internship: Electric Engine Control Software Engineering Intern Position in San Jose, CA (2025)",
    "description": "Apply now for the Archer Electric Engine Control Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ArcherElectricEngineControlSoftwareEngineeringInternInternshipSanJosePage() {
