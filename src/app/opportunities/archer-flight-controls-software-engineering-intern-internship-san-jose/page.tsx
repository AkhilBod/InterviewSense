...
const pageData = {
  "slug": "archer-flight-controls-software-engineering-intern-internship-san-jose",
  "title": "Archer Internship: Flight Controls Software Engineering Intern Position in San Jose, CA (2025)",
  "metaDescription": "Apply now for the Archer Flight Controls Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Archer internship",
    "Flight Controls Software Engineering Intern internship",
    "Archer Flight Controls Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/archer-flight-controls-software-engineering-intern-internship-san-jose",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Archer Internship: Flight Controls Software Engineering Intern Position in San Jose, CA (2025)",
    "description": "Apply now for the Archer Flight Controls Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ArcherFlightControlsSoftwareEngineeringInternInternshipSanJosePage() {
