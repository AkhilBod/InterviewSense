...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/arcteryx-equipment-software-engineer-coop-student-internship-vancouver",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Arc'teryx Equipment Internship: Software Engineer Co-Op Student Position in Vancouver, BC, Canada (2025)",
    "description": "Apply now for the Arc'teryx Equipment Software Engineer Co-Op Student internship in Vancouver, BC, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ArcteryxEquipmentSoftwareEngineerCoopStudentInternshipVancouverPage() {
