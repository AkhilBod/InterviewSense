...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ascend-analytics-software-engineering-intern-internship-boulder",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Ascend Analytics Internship: Software Engineering Intern Position in Boulder, CO (2025)",
    "description": "Apply now for the Ascend Analytics Software Engineering Intern internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AscendAnalyticsSoftwareEngineeringInternInternshipBoulderPage() {
