...
const pageData = {
  ...
  "metaDescription": "Apply now for the Atlassian Software Engineer Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
...
export default function AtlassianSoftwareEngineerInternInternshipMountainViewPage() {
