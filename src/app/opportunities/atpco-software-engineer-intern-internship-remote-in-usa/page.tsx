...
const pageData = {
  "slug": "atpco-software-engineer-intern-internship-remote-in-usa",
  "title": "ATPCO Internship: Software Engineer Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the ATPCO Software Engineer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "ATPCO internship",
    "Software Engineer Intern internship",
    "ATPCO Software Engineer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/atpco-software-engineer-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "ATPCO Internship: Software Engineer Intern Position in Remote in USA (2025)",
    "description": "Apply now for the ATPCO Software Engineer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AtpcoSoftwareEngineerInternInternshipRemoteInUsaPage() {
