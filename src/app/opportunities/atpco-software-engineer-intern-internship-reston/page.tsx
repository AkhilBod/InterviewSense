...
const pageData = {
  "slug": "atpco-software-engineer-intern-internship-reston",
  "title": "ATPCO Internship: Software Engineer Intern Position in Reston, VA (2025)",
  "metaDescription": "Apply now for the ATPCO Software Engineer Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "ATPCO internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/atpco-software-engineer-intern-internship-reston",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "ATPCO Internship: Software Engineer Intern Position in Reston, VA (2025)",
    "description": "Apply now for the ATPCO Software Engineer Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AtpcoSoftwareEngineerInternInternshipRestonPage() {
