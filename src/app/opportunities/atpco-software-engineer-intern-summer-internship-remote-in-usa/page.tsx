...
const pageData = {
  "slug": "atpco-software-engineer-intern-summer-internship-remote-in-usa",
  "title": "ATPCO Internship: Software Engineer Intern - Summer Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the ATPCO Software Engineer Intern - Summer internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "ATPCO internship",
    "Software Engineer Intern - Summer internship",
    "ATPCO Software Engineer Intern - Summer",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/atpco-software-engineer-intern-summer-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "ATPCO Internship: Software Engineer Intern - Summer Position in Remote in USA (2025)",
    "description": "Apply now for the ATPCO Software Engineer Intern - Summer internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AtpcoSoftwareEngineerInternSummerInternshipRemoteInUsaPage() {
