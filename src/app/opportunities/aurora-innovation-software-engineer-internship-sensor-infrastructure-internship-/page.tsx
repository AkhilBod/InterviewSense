...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/aurora-innovation-software-engineer-internship-sensor-infrastructure-internship-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Aurora Innovation Internship: Software Engineer Internship - Sensor Infrastructure Position in Mountain View, CA (2025)",
    "description": "Apply now for the Aurora Innovation Software Engineer Internship - Sensor Infrastructure internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AuroraInnovationSoftwareEngineerInternshipSensorInfrastructureInternshipPage() {
