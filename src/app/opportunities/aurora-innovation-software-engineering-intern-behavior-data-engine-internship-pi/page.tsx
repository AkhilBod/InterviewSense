...
const pageData = {
  "slug": "aurora-innovation-software-engineering-intern-behavior-data-engine-internship-pi",
  "title": "Aurora Innovation Internship: Software Engineering Intern - Behavior Data Engine Position in Pittsburgh, PA (2025)",
  "metaDescription": "Apply now for the Aurora Innovation Software Engineering Intern - Behavior Data Engine internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Aurora Innovation internship",
    "Software Engineering Intern - Behavior Data Engine internship",
    "Aurora Innovation Software Engineering Intern - Behavior Data Engine",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/aurora-innovation-software-engineering-intern-behavior-data-engine-internship-pi",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Aurora Innovation Internship: Software Engineering Intern - Behavior Data Engine Position in Pittsburgh, PA (2025)",
    "description": "Apply now for the Aurora Innovation Software Engineering Intern - Behavior Data Engine internship in Pittsburgh, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AuroraInnovationSoftwareEngineeringInternBehaviorDataEngineInternshipPiPage() {
