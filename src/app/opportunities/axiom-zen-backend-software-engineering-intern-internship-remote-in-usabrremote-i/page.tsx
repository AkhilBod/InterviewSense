...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/axiom-zen-backend-software-engineering-intern-internship-remote-in-usabrremote-i",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Axiom Zen Internship: Backend Software Engineering Intern Position in Remote in USA</br>Remote in Canada (2025)",
    "description": "Apply now for the Axiom Zen Backend Software Engineering Intern internship in Remote in USA</br>Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function AxiomZenBackendSoftwareEngineeringInternInternshipRemoteInUsabrremoteIPage() {
