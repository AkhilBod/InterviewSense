...
const pageData = {
  ...
  "metaDescription": "Apply now for the Box Software Engineering Intern internship in San Carlos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Box internship",
    "Software Engineering Intern internship",
    "Box Software Engineering Intern",
    "summer 2025 internship",
    "tech internship San Carlos, CA",
    "software internship",
    "Box careers",
    "internship application",
    "tech jobs 2025",
    "San Carlos internship",
    "Box San Carlos",
    "CA internship",
    "Box CA",
...
export default function BoxSoftwareEngineeringInternInternshipSanCarlosPage() {
