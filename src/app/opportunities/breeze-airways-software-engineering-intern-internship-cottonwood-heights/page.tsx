...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/breeze-airways-software-engineering-intern-internship-cottonwood-heights",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Breeze Airways Internship: Software Engineering Intern Position in Cottonwood Heights, UT (2025)",
    "description": "Apply now for the Breeze Airways Software Engineering Intern internship in Cottonwood Heights, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function BreezeAirwaysSoftwareEngineeringInternInternshipCottonwoodHeightsPage() {
