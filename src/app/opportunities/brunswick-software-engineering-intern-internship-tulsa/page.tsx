...
const pageData = {
  ...
  "metaDescription": "Apply now for the Brunswick Software Engineering Intern internship in Tulsa, OK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Brunswick internship",
    "Software Engineering Intern internship",
    "Brunswick Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Tulsa, OK",
    "software internship",
    "Brunswick careers",
...
export default function BrunswickSoftwareEngineeringInternInternshipTulsaPage() {
