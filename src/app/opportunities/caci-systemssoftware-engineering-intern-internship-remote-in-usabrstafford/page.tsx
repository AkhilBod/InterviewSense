...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/caci-systemssoftware-engineering-intern-internship-remote-in-usabrstafford",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "CACI Internship: Systems/Software Engineering Intern Position in Remote in USA</br>Stafford, VA (2025)",
    "description": "Apply now for the CACI Systems/Software Engineering Intern internship in Remote in USA</br>Stafford, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CaciSystemssoftwareEngineeringInternInternshipRemoteInUsabrstaffordPage() {
