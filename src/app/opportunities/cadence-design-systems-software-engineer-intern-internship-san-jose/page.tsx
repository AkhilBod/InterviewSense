...
const pageData = {
  ...
  "metaDescription": "Apply now for the Cadence Design Systems Software Engineer Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
...
export default function CadenceDesignSystemsSoftwareEngineerInternInternshipSanJosePage() {
