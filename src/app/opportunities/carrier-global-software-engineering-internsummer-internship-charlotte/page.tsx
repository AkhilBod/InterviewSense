...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/carrier-global-software-engineering-internsummer-internship-charlotte",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Carrier Global Internship: Software Engineering Intern-Summer Position in Charlotte, NC (2025)",
    "description": "Apply now for the Carrier Global Software Engineering Intern-Summer internship in Charlotte, NC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CarrierGlobalSoftwareEngineeringInternsummerInternshipCharlottePage() {
