...
const pageData = {
  ...
  "metaDescription": "Apply now for the Centerfield Software Engineer Intern internship in LA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Centerfield internship",
...
export default function CenterfieldSoftwareEngineerInternInternshipLaPage() {
