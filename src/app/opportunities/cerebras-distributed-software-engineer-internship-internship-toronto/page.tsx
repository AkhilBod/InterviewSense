...
const pageData = {
  "slug": "cerebras-distributed-software-engineer-internship-internship-toronto",
  "title": "Cerebras Internship: Distributed Software Engineer – Internship Position in Toronto, ON, Canada (2025)",
  "metaDescription": "Apply now for the Cerebras Distributed Software Engineer – Internship internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Cerebras internship",
    "Distributed Software Engineer – Internship internship",
    "Cerebras Distributed Software Engineer – Internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/cerebras-distributed-software-engineer-internship-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Cerebras Internship: Distributed Software Engineer – Internship Position in Toronto, ON, Canada (2025)",
    "description": "Apply now for the Cerebras Distributed Software Engineer – Internship internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CerebrasDistributedSoftwareEngineerInternshipInternshipTorontoPage() {
