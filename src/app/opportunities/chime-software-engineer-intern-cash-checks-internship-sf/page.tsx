...
const pageData = {
  ...
  "metaDescription": "Apply now for the Chime Software Engineer Intern - Cash & Checks internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Chime internship",
    "Software Engineer Intern - Cash & Checks internship",
...
export default function ChimeSoftwareEngineerInternCashChecksInternshipSfPage() {
