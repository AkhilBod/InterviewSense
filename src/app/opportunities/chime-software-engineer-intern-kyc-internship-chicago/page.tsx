...
const pageData = {
  "slug": "chime-software-engineer-intern-kyc-internship-chicago",
  "title": "Chime Internship: Software Engineer Intern - Kyc Position in Chicago, IL (2025)",
  "metaDescription": "Apply now for the Chime Software Engineer Intern - Kyc internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Chime internship",
    "Software Engineer Intern - Kyc internship",
    "Chime Software Engineer Intern - Kyc",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/chime-software-engineer-intern-kyc-internship-chicago",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Chime Internship: Software Engineer Intern - Kyc Position in Chicago, IL (2025)",
    "description": "Apply now for the Chime Software Engineer Intern - Kyc internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ChimeSoftwareEngineerInternKycInternshipChicagoPage() {
