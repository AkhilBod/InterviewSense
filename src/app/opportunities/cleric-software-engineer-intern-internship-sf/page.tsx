...
const pageData = {
  ...
  "metaDescription": "Apply now for the Cleric Software Engineer – Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Cleric internship",
    "Software Engineer – Intern internship",
    "Cleric Software Engineer – Intern",
...
export default function ClericSoftwareEngineerInternInternshipSfPage() {
