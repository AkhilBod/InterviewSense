...
const pageData = {
  ...
  "structuredData": {
    ...
    "jobLocation": {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "San Francisco, CA</br>In-person"
      }
    },
    "datePosted": "2025-05-28T22:10:25.586Z",
    ...
    "url": "http://localhost:3000/internships/cluely-software-engineer-intern-internship-san-francisco",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Cluely Internship: Software Engineer Intern Position in San Francisco, CA</br>In-person (2025)",
    "description": "Apply now for the Cluely Software Engineer Intern internship in San Francisco, CA</br>In-person. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CluelySoftwareEngineerInternInternshipSanFranciscoPage() {
