...
const pageData = {
  ...
  "metaDescription": "Apply now for the Cohesity Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Cohesity internship",
    "Software Engineering Intern internship",
    "Cohesity Software Engineering Intern",
...
export default function CohesitySoftwareEngineeringInternInternshipSanJosePage() {
