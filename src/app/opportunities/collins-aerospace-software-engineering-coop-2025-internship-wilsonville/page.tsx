...
const pageData = {
  ...
  "structuredData": {
    ...
    "jobLocation": {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Wilsonville, OR"
      }
    },
    ...
    "url": "http://localhost:3000/internships/collins-aerospace-software-engineering-coop-2025-internship-wilsonville",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Collins Aerospace Internship: Software Engineering Co-op (2025) Position in Wilsonville, OR (2025)",
    "description": "Apply now for the Collins Aerospace Software Engineering Co-op (2025) internship in Wilsonville, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CollinsAerospaceSoftwareEngineeringCoop2025InternshipWilsonvillePage() {
