...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/collins-aerospace-software-engineering-intern-summer-2025-onsite-internship-anah",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Collins Aerospace Internship: Software Engineering Intern- Summer 2025 (Onsite) Position in Anaheim, CA (2025)",
    "description": "Apply now for the Collins Aerospace Software Engineering Intern- Summer 2025 (Onsite) internship in Anaheim, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CollinsAerospaceSoftwareEngineeringInternSummer2025OnsiteInternshipAnahPage() {
