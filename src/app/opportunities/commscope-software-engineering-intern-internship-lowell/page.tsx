...
const pageData = {
  ...
  "metaDescription": "Apply now for the CommScope Software Engineering Intern internship in Lowell, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "CommScope internship",
    "Software Engineering Intern internship",
    "CommScope Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Lowell, MA",
    "software internship",
    "CommScope careers",
...
export default function CommscopeSoftwareEngineeringInternInternshipLowellPage() {
