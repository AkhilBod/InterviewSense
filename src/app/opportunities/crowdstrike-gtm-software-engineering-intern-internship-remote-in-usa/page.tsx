...
const pageData = {
  "slug": "crowdstrike-gtm-software-engineering-intern-internship-remote-in-usa",
  "title": "Crowdstrike Internship: GTM Software Engineering Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Crowdstrike GTM Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Crowdstrike internship",
    "GTM Software Engineering Intern internship",
    "Crowdstrike GTM Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/crowdstrike-gtm-software-engineering-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Crowdstrike Internship: GTM Software Engineering Intern Position in Remote in USA (2025)",
    "description": "Apply now for the Crowdstrike GTM Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CrowdstrikeGtmSoftwareEngineeringInternInternshipRemoteInUsaPage() {
