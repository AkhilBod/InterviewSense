...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/crowdstrike-software-engineer-intern-intelligence-automation-internship-remote-i",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Crowdstrike Internship: Software Engineer Intern - Intelligence Automation Position in Remote in UK (2025)",
    "description": "Apply now for the Crowdstrike Software Engineer Intern - Intelligence Automation internship in Remote in UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CrowdstrikeSoftwareEngineerInternIntelligenceAutomationInternshipRemoteIPage() {
