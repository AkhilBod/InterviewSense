...
const pageData = {
  "slug": "crowdstrike-software-engineering-intern-internship-remote-in-usa",
  "title": "Crowdstrike Internship: Software Engineering Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Crowdstrike Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Crowdstrike internship",
    "Software Engineering Intern internship",
    "Crowdstrike Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/crowdstrike-software-engineering-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Crowdstrike Internship: Software Engineering Intern Position in Remote in USA (2025)",
    "description": "Apply now for the Crowdstrike Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function CrowdstrikeSoftwareEngineeringInternInternshipRemoteInUsaPage() {
