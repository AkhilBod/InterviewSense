...
const pageData = {
  ...
  "metaDescription": "Apply now for the Cyberark Software Engineer Intern internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Cyberark internship",
...
export default function CyberarkSoftwareEngineerInternInternshipPaloAltoPage() {
