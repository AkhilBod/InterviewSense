...
const pageData = {
  "slug": "datadog-software-engineer-intern-sre-internship-nyc",
  "title": "Datadog Internship: Software Engineer – Intern - SRE Position in NYC (2025)",
  "metaDescription": "Apply now for the Datadog Software Engineer – Intern - SRE internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Datadog internship",
    "Software Engineer – Intern - SRE internship",
    "Datadog Software Engineer – Intern - SRE",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/datadog-software-engineer-intern-sre-internship-nyc",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Datadog Internship: Software Engineer – Intern - SRE Position in NYC (2025)",
    "description": "Apply now for the Datadog Software Engineer – Intern - SRE internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function DatadogSoftwareEngineerInternSreInternshipNycPage() {
