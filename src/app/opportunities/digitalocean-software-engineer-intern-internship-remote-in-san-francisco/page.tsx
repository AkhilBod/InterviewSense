...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/digitalocean-software-engineer-intern-internship-remote-in-san-francisco",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "DigitalOcean Internship: Software Engineer, Intern Position in Remote in San Francisco, CA (2025)",
    "description": "Apply now for the DigitalOcean Software Engineer, Intern internship in Remote in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function DigitaloceanSoftwareEngineerInternInternshipRemoteInSanFranciscoPage() {
