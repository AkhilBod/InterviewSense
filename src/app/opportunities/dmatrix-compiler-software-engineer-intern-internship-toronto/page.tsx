...
const pageData = {
  "slug": "dmatrix-compiler-software-engineer-intern-internship-toronto",
  "title": "d-Matrix Internship: Compiler Software Engineer Intern Position in Toronto, ON, Canada (2025)",
  "metaDescription": "Apply now for the d-Matrix Compiler Software Engineer Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "d-Matrix internship",
    "Compiler Software Engineer Intern internship",
    "d-Matrix Compiler Software Engineer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/dmatrix-compiler-software-engineer-intern-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "d-Matrix Internship: Compiler Software Engineer Intern Position in Toronto, ON, Canada (2025)",
    "description": "Apply now for the d-Matrix Compiler Software Engineer Intern internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function DmatrixCompilerSoftwareEngineerInternInternshipTorontoPage() {
