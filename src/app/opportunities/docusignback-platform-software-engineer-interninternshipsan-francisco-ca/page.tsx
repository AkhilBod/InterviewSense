...
const pageData = {
  "slug": "docusignback-platform-software-engineer-interninternshipsan-francisco-ca",
  "title": "Docusign Internship: Back Platform Software Engineer Intern Position in San Francisco, CA (2025)",
  "metaDescription": "Apply now for the Docusign Back Platform Software Engineer Intern internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
    "Docusign internship",
    "Back Platform Software Engineer Intern internship",
    "Docusign Back Platform Software Engineer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/docusignback-platform-software-engineer-interninternshipsan-francisco-ca",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Docusign Internship: Back Platform Software Engineer Intern Position in San Francisco, CA (2025)",
    "description": "Apply now for the Docusign Back Platform Software Engineer Intern internship in San Francisco, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function DocusignbackPlatformSoftwareEngineerInterninternshipsanFranciscoCaPage() {
