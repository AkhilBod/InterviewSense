...
const pageData = {
  "slug": "dropbox-software-engineer-intern-internship-remote-in-canada",
  "title": "Dropbox Internship: Software Engineer Intern Position in Remote in Canada (2025)",
  "metaDescription": "Apply now for the Dropbox Software Engineer Intern internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
    "Dropbox internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/dropbox-software-engineer-intern-internship-remote-in-canada",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Dropbox Internship: Software Engineer Intern Position in Remote in Canada (2025)",
    "description": "Apply now for the Dropbox Software Engineer Intern internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function DropboxSoftwareEngineerInternInternshipRemoteInCanadaPage() {
