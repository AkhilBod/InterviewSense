...
const pageData = {
  ...
  "metaDescription": "Apply now for the Dropbox Software Engineer Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Dropbox internship",
...
export default function DropboxSoftwareEngineerInternInternshipRemoteInUsaPage() {
