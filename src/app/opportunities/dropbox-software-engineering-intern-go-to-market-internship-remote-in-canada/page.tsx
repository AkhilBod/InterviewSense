...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/dropbox-software-engineering-intern-go-to-market-internship-remote-in-canada",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Dropbox Internship: Software Engineering Intern - Go To Market Position in Remote in Canada (2025)",
    "description": "Apply now for the Dropbox Software Engineering Intern - Go To Market internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function DropboxSoftwareEngineeringInternGoToMarketInternshipRemoteInCanadaPage() {
