...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/dyno-therapeutics-software-engineering-internship-internship-belmont",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Dyno Therapeutics Internship: Software Engineering Internship Position in Belmont, MA (2025)",
    "description": "Apply now for the Dyno Therapeutics Software Engineering Internship internship in Belmont, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function DynoTherapeuticsSoftwareEngineeringInternshipInternshipBelmontPage() {
