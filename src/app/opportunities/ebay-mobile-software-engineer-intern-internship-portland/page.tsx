...
const pageData = {
  "slug": "ebay-mobile-software-engineer-intern-internship-portland",
  "title": "eBay Internship: Mobile Software Engineer Intern Position in Portland, OR, USA (2025)",
  "metaDescription": "Apply now for the eBay Mobile Software Engineer Intern internship in Portland, OR, USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "eBay internship",
    "Mobile Software Engineer Intern internship",
    "eBay Mobile Software Engineer Intern",
    "summer 2025 internship",
    "tech internship Portland, OR, USA",
    "software internship",
    "eBay careers",
  ...
  "structuredData": {
    ...
    "jobLocation": {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Portland, OR, USA"
      }
    },
    ...
    "url": "http://localhost:3000/internships/ebay-mobile-software-engineer-intern-internship-portland",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "eBay Internship: Mobile Software Engineer Intern Position in Portland, OR, USA (2025)",
    "description": "Apply now for the eBay Mobile Software Engineer Intern internship in Portland, OR, USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EbayMobileSoftwareEngineerInternInternshipPortlandPage() {
