...
const pageData = {
  "slug": "ebay-software-engineer-intern-canada-internship-toronto",
  "title": "eBay Internship: Software Engineer Intern - (Canada) Position in Toronto, ON, Canada (2025)",
  "metaDescription": "Apply now for the eBay Software Engineer Intern - (Canada) internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "eBay internship",
    "Software Engineer Intern - (Canada) internship",
    "eBay Software Engineer Intern - (Canada)",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ebay-software-engineer-intern-canada-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "eBay Internship: Software Engineer Intern - (Canada) Position in Toronto, ON, Canada (2025)",
    "description": "Apply now for the eBay Software Engineer Intern - (Canada) internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EbaySoftwareEngineerInternCanadaInternshipTorontoPage() {
