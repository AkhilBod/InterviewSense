...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/echo-global-logistics-software-engineering-internchicago-internship-chicago",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Echo Global Logistics Internship: Software Engineering Intern-Chicago Position in Chicago, IL (2025)",
    "description": "Apply now for the Echo Global Logistics Software Engineering Intern-Chicago internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EchoGlobalLogisticsSoftwareEngineeringInternchicagoInternshipChicagoPage() {
