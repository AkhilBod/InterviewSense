...
const pageData = {
  "slug": "echostar-software-engineering-summer-intern-internship-san-diego",
  "title": "Echostar Internship: Software Engineering Summer Intern Position in San Diego, CA (2025)",
  "metaDescription": "Apply now for the Echostar Software Engineering Summer Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Echostar internship",
    "Software Engineering Summer Intern internship",
    "Echostar Software Engineering Summer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/echostar-software-engineering-summer-intern-internship-san-diego",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Echostar Internship: Software Engineering Summer Intern Position in San Diego, CA (2025)",
    "description": "Apply now for the Echostar Software Engineering Summer Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EchostarSoftwareEngineeringSummerInternInternshipSanDiegoPage() {
