...
const pageData = {
  ...
  "metaDescription": "Apply now for the Electronic Arts Software Engineer Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
...
export default function ElectronicArtsSoftwareEngineerInternInternshipAustinPage() {
