...
const pageData = {
  "slug": "ethereum-foundation-software-engineering-intern-internship-remote-in-usa",
  "title": "Ethereum Foundation Internship: Software Engineering Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Ethereum Foundation Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Ethereum Foundation internship",
    "Software Engineering Intern internship",
    "Ethereum Foundation Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ethereum-foundation-software-engineering-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Ethereum Foundation Internship: Software Engineering Intern Position in Remote in USA (2025)",
    "description": "Apply now for the Ethereum Foundation Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EthereumFoundationSoftwareEngineeringInternInternshipRemoteInUsaPage() {
