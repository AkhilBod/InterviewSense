...
const pageData = {
  "slug": "eyefinity-software-engineer-eyefinity-internship-remote",
  "title": "Eyefinity Internship: Software Engineer - Eyefinity Position in Remote (2025)",
  "metaDescription": "Apply now for the Eyefinity Software Engineer - Eyefinity internship in Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Eyefinity internship",
    "Software Engineer - Eyefinity internship",
    "Eyefinity Software Engineer - Eyefinity",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/eyefinity-software-engineer-eyefinity-internship-remote",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Eyefinity Internship: Software Engineer - Eyefinity Position in Remote (2025)",
    "description": "Apply now for the Eyefinity Software Engineer - Eyefinity internship in Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function EyefinitySoftwareEngineerEyefinityInternshipRemotePage() {
