...
const pageData = {
  ...
  "metaDescription": "Apply now for the F5 Software Engineer Intern internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "F5 internship",
...
export default function F5SoftwareEngineerInternInternshipBoulderPage() {
