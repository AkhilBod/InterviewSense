...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/f5-software-engineer-intern-internship-greater-seattle-area",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "F5 Internship: Software Engineer Intern Position in Greater Seattle Area (2025)",
    "description": "Apply now for the F5 Software Engineer Intern internship in Greater Seattle Area. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function F5SoftwareEngineerInternInternshipGreaterSeattleAreaPage() {
