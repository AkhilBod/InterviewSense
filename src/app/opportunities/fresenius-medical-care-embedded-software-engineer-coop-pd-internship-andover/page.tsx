...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/fresenius-medical-care-embedded-software-engineer-coop-pd-internship-andover",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Fresenius Medical Care Internship: Embedded Software Engineer Co-Op - Pd Position in Andover, MA (2025)",
    "description": "Apply now for the Fresenius Medical Care Embedded Software Engineer Co-Op - Pd internship in Andover, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function FreseniusMedicalCareEmbeddedSoftwareEngineerCoopPdInternshipAndoverPage() {
