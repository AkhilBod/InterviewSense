...
const pageData = {
  "slug": "gamechanger-backend-software-engineer-intern-core-services-internship-remote-in-",
  "title": "Gamechanger Internship: Backend Software Engineer Intern - Core Services Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Gamechanger Backend Software Engineer Intern - Core Services internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Gamechanger internship",
    "Backend Software Engineer Intern - Core Services internship",
    "Gamechanger Backend Software Engineer Intern - Core Services",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/gamechanger-backend-software-engineer-intern-core-services-internship-remote-in-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Gamechanger Internship: Backend Software Engineer Intern - Core Services Position in Remote in USA (2025)",
    "description": "Apply now for the Gamechanger Backend Software Engineer Intern - Core Services internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GamechangerBackendSoftwareEngineerInternCoreServicesInternshipRemoteInPage() {
