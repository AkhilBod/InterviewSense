...
const pageData = {
  "slug": "gamechanger-full-stack-software-engineer-intern-diamond-sports-internship-remote",
  "title": "Gamechanger Internship: Full Stack Software Engineer Intern - Diamond Sports Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Gamechanger Full Stack Software Engineer Intern - Diamond Sports internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Gamechanger internship",
    "Full Stack Software Engineer Intern - Diamond Sports internship",
    "Gamechanger Full Stack Software Engineer Intern - Diamond Sports",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/gamechanger-full-stack-software-engineer-intern-diamond-sports-internship-remote",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Gamechanger Internship: Full Stack Software Engineer Intern - Diamond Sports Position in Remote in USA (2025)",
    "description": "Apply now for the Gamechanger Full Stack Software Engineer Intern - Diamond Sports internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GamechangerFullStackSoftwareEngineerInternDiamondSportsInternshipRemotePage() {
