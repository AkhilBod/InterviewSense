...
const pageData = {
  ...
  "metaDescription": "Apply now for the Garmin Software Engineering Intern internship in Yarmouth, ME. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Garmin internship",
    "Software Engineering Intern internship",
    "Garmin Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Yarmouth, ME",
    "software internship",
    "Garmin careers",
...
export default function GarminSoftwareEngineeringInternInternshipYarmouthPage() {
