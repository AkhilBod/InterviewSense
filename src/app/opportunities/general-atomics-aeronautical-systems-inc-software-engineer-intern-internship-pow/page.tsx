...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/general-atomics-aeronautical-systems-inc-software-engineer-intern-internship-pow",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "General Atomics Aeronautical Systems, Inc. Internship: Software Engineer Intern Position in Poway, CA (2025)",
    "description": "Apply now for the General Atomics Aeronautical Systems, Inc. Software Engineer Intern internship in Poway, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GeneralAtomicsAeronauticalSystemsIncSoftwareEngineerInternInternshipPowPage() {
