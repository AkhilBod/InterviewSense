...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/genesys-software-engineer-intern-internship-indianapolis",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Genesys Internship: Software Engineer Intern Position in Indianapolis, IN</br>Indiana (2025)",
    "description": "Apply now for the Genesys Software Engineer Intern internship in Indianapolis, IN</br>Indiana. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GenesysSoftwareEngineerInternInternshipIndianapolisPage() {
