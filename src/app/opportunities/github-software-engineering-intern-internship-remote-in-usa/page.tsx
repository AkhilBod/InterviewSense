...
const pageData = {
  ...
  "metaDescription": "Apply now for the GitHub Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "GitHub internship",
...
export default function GithubSoftwareEngineeringInternInternshipRemoteInUsaPage() {
