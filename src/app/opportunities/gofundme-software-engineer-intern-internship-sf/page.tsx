...
const pageData = {
  ...
  "metaDescription": "Apply now for the GoFundMe Software Engineer Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "GoFundMe internship",
    "Software Engineer Intern internship",
    "GoFundMe Software Engineer Intern",
...
export default function GofundmeSoftwareEngineerInternInternshipSfPage() {
