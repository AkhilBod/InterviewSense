...
const pageData = {
  ...
  "metaDescription": "Apply now for the GrammaTech Software Engineer Intern internship in Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "GrammaTech internship",
    "Software Engineer Intern internship",
    "GrammaTech Software Engineer Intern",
...
export default function GrammatechSoftwareEngineerInternInternshipRemotePage() {
