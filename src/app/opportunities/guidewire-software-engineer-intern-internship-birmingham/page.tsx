...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/guidewire-software-engineer-intern-internship-birmingham",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Guidewire Internship: Software Engineer Intern Position in Birmingham, AL (2025)",
    "description": "Apply now for the Guidewire Software Engineer Intern internship in Birmingham, AL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GuidewireSoftwareEngineerInternInternshipBirminghamPage() {
