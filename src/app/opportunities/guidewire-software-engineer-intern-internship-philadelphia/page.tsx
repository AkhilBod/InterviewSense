...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/guidewire-software-engineer-intern-internship-philadelphia",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Guidewire Internship: Software Engineer Intern Position in Philadelphia, PA (2025)",
    "description": "Apply now for the Guidewire Software Engineer Intern internship in Philadelphia, PA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function GuidewireSoftwareEngineerInternInternshipPhiladelphiaPage() {
