...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/gusto-software-engineering-intern-summer-2025-internship-detailssummary4-locatio",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Gusto Internship: Software Engineering Intern (Summer 2025) Position in <details><summary>**4 locations**</summary>San Francisco, CA</br>New York, NY</br>Denver, CO</br>Hybrid</details> (2025)",
    "description": "Apply now for the Gusto Software Engineering Intern (Summer 2025) internship in <details><summary>**4 locations**</summary>San Francisco, CA</br>New York, NY</br>Denver, CO</br>Hybrid</details>. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function GustoSoftwareEngineeringInternSummer2025InternshipDetailssummary4LocatioPage() {
