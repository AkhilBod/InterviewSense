...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/harman-international-summer-intern-embedded-software-engineer-internship-novi",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "HARMAN International Internship: Summer Intern - Embedded Software Engineer Position in Novi, MI (2025)",
    "description": "Apply now for the HARMAN International Summer Intern - Embedded Software Engineer internship in Novi, MI. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function HarmanInternationalSummerInternEmbeddedSoftwareEngineerInternshipNoviPage() {
