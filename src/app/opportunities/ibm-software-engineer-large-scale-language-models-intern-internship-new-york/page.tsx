...
const pageData = {
  "slug": "ibm-software-engineer-large-scale-language-models-intern-internship-new-york",
  "title": "IBM Internship: Software Engineer – Large Scale Language Models Intern Position in New York (2025)",
  "metaDescription": "Apply now for the IBM Software Engineer – Large Scale Language Models Intern internship in New York. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "IBM internship",
    "Software Engineer – Large Scale Language Models Intern internship",
    "IBM Software Engineer – Large Scale Language Models Intern",
    "summer 2025 internship",
    "tech internship New York",
    "software internship",
    "IBM careers",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ibm-software-engineer-large-scale-language-models-intern-internship-new-york",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "IBM Internship: Software Engineer – Large Scale Language Models Intern Position in New York (2025)",
    "description": "Apply now for the IBM Software Engineer – Large Scale Language Models Intern internship in New York. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function IbmSoftwareEngineerLargeScaleLanguageModelsInternInternshipNewYorkPage() {
