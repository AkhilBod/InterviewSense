...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/intercontinental-exchange-trading-web-applications-intern-software-engineer-inte",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Intercontinental Exchange Internship: Trading Web Applications Intern - Software Engineer Position in NYC (2025)",
    "description": "Apply now for the Intercontinental Exchange Trading Web Applications Intern - Software Engineer internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function IntercontinentalExchangeTradingWebApplicationsInternSoftwareEngineerIntePage() {
