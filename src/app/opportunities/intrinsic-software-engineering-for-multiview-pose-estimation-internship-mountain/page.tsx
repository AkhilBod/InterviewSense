...
const pageData = {
  "slug": "intrinsic-software-engineering-for-multiview-pose-estimation-internship-mountain",
  "title": "Intrinsic Internship: Software Engineering for Multi-View Pose Estimation Position in Mountain View, CA (2025)",
  "metaDescription": "Apply now for the Intrinsic Software Engineering for Multi-View Pose Estimation internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Intrinsic internship",
    "Software Engineering for Multi-View Pose Estimation internship",
    "Intrinsic Software Engineering for Multi-View Pose Estimation",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/intrinsic-software-engineering-for-multiview-pose-estimation-internship-mountain",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Intrinsic Internship: Software Engineering for Multi-View Pose Estimation Position in Mountain View, CA (2025)",
    "description": "Apply now for the Intrinsic Software Engineering for Multi-View Pose Estimation internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function IntrinsicSoftwareEngineeringForMultiviewPoseEstimationInternshipMountainPage() {
