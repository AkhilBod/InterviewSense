...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/johnson-johnson-2025-make-summer-software-engineering-intern-internship-jacksonv",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Johnson & Johnson Internship: 2025 MAKE Summer Software Engineering Intern Position in Jacksonville, FL (2025)",
    "description": "Apply now for the Johnson & Johnson 2025 MAKE Summer Software Engineering Intern internship in Jacksonville, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function JohnsonJohnson2025MakeSummerSoftwareEngineeringInternInternshipJacksonvPage() {
