...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/jones-lang-lasalle-jll-software-engineering-summer-2025-internship-internship-ny",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Jones Lang LaSalle (JLL) Internship: Software Engineering Summer 2025 Internship Position in NYC (2025)",
    "description": "Apply now for the Jones Lang LaSalle (JLL) Software Engineering Summer 2025 Internship internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function JonesLangLasalleJllSoftwareEngineeringSummer2025InternshipInternshipNyPage() {
