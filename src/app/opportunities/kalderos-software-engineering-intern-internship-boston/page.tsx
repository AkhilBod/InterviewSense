...
const pageData = {
  ...
  "metaDescription": "Apply now for the Kalderos Software Engineering Intern internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Kalderos internship",
    "Software Engineering Intern internship",
    "Kalderos Software Engineering Intern",
...
export default function KalderosSoftwareEngineeringInternInternshipBostonPage() {
