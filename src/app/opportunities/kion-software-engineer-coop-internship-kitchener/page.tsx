...
const pageData = {
  "slug": "kion-software-engineer-coop-internship-kitchener",
  "title": "KION Internship: Software Engineer Co-op Position in Kitchener, ON, Canada (2025)",
  "metaDescription": "Apply now for the KION Software Engineer Co-op internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "KION internship",
    "Software Engineer Co-op internship",
    "KION Software Engineer Co-op",
    "summer 2025 internship",
    "tech internship Kitchener, ON, Canada",
    "software internship",
    "KION careers",
    "internship application",
    "tech jobs 2025",
    "Kitchener internship",
    "KION Kitchener",
    "ON internship",
    "KION ON",
    "Canada internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/kion-software-engineer-coop-internship-kitchener",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "KION Internship: Software Engineer Co-op Position in Kitchener, ON, Canada (2025)",
    "description": "Apply now for the KION Software Engineer Co-op internship in Kitchener, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function KionSoftwareEngineerCoopInternshipKitchenerPage() {
