...
const pageData = {
  ...
  "metaDescription": "Apply now for the Leidos Software Engineer Intern internship in Reston, VA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Leidos internship",
...
export default function LeidosSoftwareEngineerInternInternshipRestonPage() {
