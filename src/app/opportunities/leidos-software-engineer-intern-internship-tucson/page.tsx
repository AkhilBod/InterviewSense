...
const pageData = {
  ...
  "metaDescription": "Apply now for the Leidos Software Engineer Intern internship in Tucson, AZ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Leidos internship",
    "Software Engineer Intern internship",
    "Leidos Software Engineer Intern",
    "summer 2025 internship",
    "tech internship Tucson, AZ",
    "software internship",
    "Leidos careers",
...
export default function LeidosSoftwareEngineerInternInternshipTucsonPage() {
