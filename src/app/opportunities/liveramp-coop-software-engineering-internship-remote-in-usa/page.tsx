...
const pageData = {
  "slug": "liveramp-coop-software-engineering-internship-remote-in-usa",
  "title": "LiveRamp Internship: Co-Op – Software Engineering Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the LiveRamp Co-Op – Software Engineering internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "LiveRamp internship",
    "Co-Op – Software Engineering internship",
    "LiveRamp Co-Op – Software Engineering",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/liveramp-coop-software-engineering-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "LiveRamp Internship: Co-Op – Software Engineering Position in Remote in USA (2025)",
    "description": "Apply now for the LiveRamp Co-Op – Software Engineering internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function LiverampCoopSoftwareEngineeringInternshipRemoteInUsaPage() {
