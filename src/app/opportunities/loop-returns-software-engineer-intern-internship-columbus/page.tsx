...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/loop-returns-software-engineer-intern-internship-columbus",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Loop Returns Internship: Software Engineer Intern Position in Columbus, OH (2025)",
    "description": "Apply now for the Loop Returns Software Engineer Intern internship in Columbus, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function LoopReturnsSoftwareEngineerInternInternshipColumbusPage() {
