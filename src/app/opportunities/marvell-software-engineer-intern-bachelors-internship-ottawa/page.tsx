...
const pageData = {
  "slug": "marvell-software-engineer-intern-bachelors-internship-ottawa",
  "title": "Marvell Internship: Software Engineer Intern - Bachelors Position in Ottawa, ON, Canada (2025)",
  "metaDescription": "Apply now for the Marvell Software Engineer Intern - Bachelors internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Marvell internship",
    "Software Engineer Intern - Bachelors internship",
    "Marvell Software Engineer Intern - Bachelors",
  ...
  "structuredData": {
    ...
    "datePosted": "2025-06-13T22:10:25.907Z",
    ...
    "url": "http://localhost:3000/internships/marvell-software-engineer-intern-bachelors-internship-ottawa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Marvell Internship: Software Engineer Intern - Bachelors Position in Ottawa, ON, Canada (2025)",
    "description": "Apply now for the Marvell Software Engineer Intern - Bachelors internship in Ottawa, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MarvellSoftwareEngineerInternBachelorsInternshipOttawaPage() {
