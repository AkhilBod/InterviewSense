...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/meta-data-scientist-intern-product-analytics-phd-internship-menlo-park",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Meta Internship: Data Scientist Intern - Product Analytics - PhD Position in Menlo Park, CA</br>NYC (2025)",
    "description": "Apply now for the Meta Data Scientist Intern - Product Analytics - PhD internship in Menlo Park, CA</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MetaDataScientistInternProductAnalyticsPhdInternshipMenloParkPage() {
