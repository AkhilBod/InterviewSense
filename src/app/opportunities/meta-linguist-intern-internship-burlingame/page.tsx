...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/meta-linguist-intern-internship-burlingame",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Meta Internship: Linguist Intern Position in Burlingame, CA</br>Redmond, WA (2025)",
    "description": "Apply now for the Meta Linguist Intern internship in Burlingame, CA</br>Redmond, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MetaLinguistInternInternshipBurlingamePage() {
