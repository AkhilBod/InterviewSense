...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/method-financial-software-engineer-summer-intern-internship-austin",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Method Financial Internship: Software Engineer – Summer Intern Position in Austin, TX</br>NYC (2025)",
    "description": "Apply now for the Method Financial Software Engineer – Summer Intern internship in Austin, TX</br>NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MethodFinancialSoftwareEngineerSummerInternInternshipAustinPage() {
