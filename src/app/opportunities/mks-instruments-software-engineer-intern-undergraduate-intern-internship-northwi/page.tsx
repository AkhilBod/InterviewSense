...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/mks-instruments-software-engineer-intern-undergraduate-intern-internship-northwi",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "MKS Instruments Internship: Software Engineer Intern – Undergraduate intern Position in Northwich, UK (2025)",
    "description": "Apply now for the MKS Instruments Software Engineer Intern – Undergraduate intern internship in Northwich, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MksInstrumentsSoftwareEngineerInternUndergraduateInternInternshipNorthwiPage() {
