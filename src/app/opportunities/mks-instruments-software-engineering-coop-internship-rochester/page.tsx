...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/mks-instruments-software-engineering-coop-internship-rochester",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "MKS Instruments Internship: Software Engineering Co-op Position in Rochester, NY (2025)",
    "description": "Apply now for the MKS Instruments Software Engineering Co-op internship in Rochester, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MksInstrumentsSoftwareEngineeringCoopInternshipRochesterPage() {
