...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/mks-instruments-undergraduate-mecop-coop-software-engineer-reliability-modeling-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "MKS Instruments Internship: Undergraduate MECOP Co-op - Software Engineer - Reliability Modeling Position in Beaverton, OR (2025)",
    "description": "Apply now for the MKS Instruments Undergraduate MECOP Co-op - Software Engineer - Reliability Modeling internship in Beaverton, OR. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MksInstrumentsUndergraduateMecopCoopSoftwareEngineerReliabilityModelingPage() {
