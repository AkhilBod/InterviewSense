...
const pageData = {
  ...
  "metaDescription": "Apply now for the Modern Treasury Software Engineer – Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Modern Treasury internship",
    "Software Engineer – Intern internship",
    "Modern Treasury Software Engineer – Intern",
    "summer 2025 internship",
    "tech internship SF",
    "software internship",
    "Modern Treasury careers",
...
export default function ModernTreasurySoftwareEngineerInternInternshipSfPage() {
