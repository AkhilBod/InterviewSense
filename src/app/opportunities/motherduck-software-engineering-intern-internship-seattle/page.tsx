...
const pageData = {
  "slug": "motherduck-software-engineering-intern-internship-seattle",
  "title": "MotherDuck Internship: Software Engineering Intern Position in Seattle, WA (2025)",
  "metaDescription": "Apply now for the MotherDuck Software Engineering Intern internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "MotherDuck internship",
    "Software Engineering Intern internship",
    "MotherDuck Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/motherduck-software-engineering-intern-internship-seattle",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "MotherDuck Internship: Software Engineering Intern Position in Seattle, WA (2025)",
    "description": "Apply now for the MotherDuck Software Engineering Intern internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MotherduckSoftwareEngineeringInternInternshipSeattlePage() {
