...
const pageData = {
  "slug": "motorola-critical-communication-networks-software-engineer-internship-hoffman-es",
  "title": "Motorola Internship: Critical Communication Networks Software Engineer Position in Hoffman Estates, IL (2025)",
  "metaDescription": "Apply now for the Motorola Critical Communication Networks Software Engineer internship in Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Motorola internship",
    "Critical Communication Networks Software Engineer internship",
    "Motorola Critical Communication Networks Software Engineer",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/motorola-critical-communication-networks-software-engineer-internship-hoffman-es",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Motorola Internship: Critical Communication Networks Software Engineer Position in Hoffman Estates, IL (2025)",
    "description": "Apply now for the Motorola Critical Communication Networks Software Engineer internship in Hoffman Estates, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MotorolaCriticalCommunicationNetworksSoftwareEngineerInternshipHoffmanEsPage() {
