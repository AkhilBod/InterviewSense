...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/motorola-software-engineer-intern-internship-detailssummary4-locationssummarylin",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Motorola Internship: Software Engineer Intern Position in <details><summary>**4 locations**</summary>Linthicum, MD</br>Virginia, US</br>Washington DC, US</br>Maryland, US</details> (2025)",
    "description": "Apply now for the Motorola Software Engineer Intern internship in <details><summary>**4 locations**</summary>Linthicum, MD</br>Virginia, US</br>Washington DC, US</br>Maryland, US</details>. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MotorolaSoftwareEngineerInternInternshipDetailssummary4LocationssummarylinPage() {
