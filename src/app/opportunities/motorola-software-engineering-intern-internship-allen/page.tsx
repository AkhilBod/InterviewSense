...
const pageData = {
  ...
  "metaDescription": "Apply now for the Motorola Software Engineering Intern internship in Allen, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Motorola internship",
    "Software Engineering Intern internship",
    "Motorola Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Allen, TX",
    "software internship",
    "Motorola careers",
...
export default function MotorolaSoftwareEngineeringInternInternshipAllenPage() {
