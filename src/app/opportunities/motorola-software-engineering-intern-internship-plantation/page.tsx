...
const pageData = {
  ...
  "metaDescription": "Apply now for the Motorola Software Engineering Intern internship in Plantation, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Motorola internship",
...
export default function MotorolaSoftwareEngineeringInternInternshipPlantationPage() {
