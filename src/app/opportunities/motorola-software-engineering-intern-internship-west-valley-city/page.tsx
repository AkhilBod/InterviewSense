...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/motorola-software-engineering-intern-internship-west-valley-city",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Motorola Internship: Software Engineering Intern Position in West Valley City, UT (2025)",
    "description": "Apply now for the Motorola Software Engineering Intern internship in West Valley City, UT. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function MotorolaSoftwareEngineeringInternInternshipWestValleyCityPage() {
