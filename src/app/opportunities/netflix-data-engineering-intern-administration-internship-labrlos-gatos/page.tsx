...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/netflix-data-engineering-intern-administration-internship-labrlos-gatos",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Netflix Internship: Data Engineering Intern - Administration Position in LA</br>Los Gatos, CA (2025)",
    "description": "Apply now for the Netflix Data Engineering Intern - Administration internship in LA</br>Los Gatos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function NetflixDataEngineeringInternAdministrationInternshipLabrlosGatosPage() {
