...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/north-atlantic-industries-internfull-stack-software-engineer-internship-long-isl",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "North Atlantic Industries Internship: Intern-Full Stack Software Engineer Position in Long Island, New York (2025)",
    "description": "Apply now for the North Atlantic Industries Intern-Full Stack Software Engineer internship in Long Island, New York. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function NorthAtlanticIndustriesInternfullStackSoftwareEngineerInternshipLongIslPage() {
