...
const pageData = {
  "slug": "notion-software-engineer-ai-intern-summer-2025-internship-new-york",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/notion-software-engineer-ai-intern-summer-2025-internship-new-york",
...
export default function NotionSoftwareEngineerAiInternSummer2025InternshipNewYorkPage() {
