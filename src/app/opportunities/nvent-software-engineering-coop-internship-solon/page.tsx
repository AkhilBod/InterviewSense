...
const pageData = {
  ...
  "metaDescription": "Apply now for the nVent Software Engineering Co-op internship in Solon, OH. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "nVent internship",
    "Software Engineering Co-op internship",
    "nVent Software Engineering Co-op",
    "summer 2025 internship",
    "tech internship Solon, OH",
    "software internship",
    "nVent careers",
...
export default function NventSoftwareEngineeringCoopInternshipSolonPage() {
