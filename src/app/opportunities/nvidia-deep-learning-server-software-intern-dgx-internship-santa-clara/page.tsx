...
const pageData = {
  "slug": "nvidia-deep-learning-server-software-intern-dgx-internship-santa-clara",
  "title": "NVIDIA Internship: Deep Learning Server Software Intern - Dgx Position in Santa Clara, CA (2025)",
  "metaDescription": "Apply now for the NVIDIA Deep Learning Server Software Intern - Dgx internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "NVIDIA internship",
    "Deep Learning Server Software Intern - Dgx internship",
    "NVIDIA Deep Learning Server Software Intern - Dgx",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/nvidia-deep-learning-server-software-intern-dgx-internship-santa-clara",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "NVIDIA Internship: Deep Learning Server Software Intern - Dgx Position in Santa Clara, CA (2025)",
    "description": "Apply now for the NVIDIA Deep Learning Server Software Intern - Dgx internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function NvidiaDeepLearningServerSoftwareInternDgxInternshipSantaClaraPage() {
