...
const pageData = {
  "slug": "nvidia-software-intern-server-firmware-manageability-internship-santa-clara",
  "title": "NVIDIA Internship: Software Intern - Server Firmware Manageability Position in Santa Clara, CA (2025)",
  "metaDescription": "Apply now for the NVIDIA Software Intern - Server Firmware Manageability internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "NVIDIA internship",
    "Software Intern - Server Firmware Manageability internship",
    "NVIDIA Software Intern - Server Firmware Manageability",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/nvidia-software-intern-server-firmware-manageability-internship-santa-clara",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "NVIDIA Internship: Software Intern - Server Firmware Manageability Position in Santa Clara, CA (2025)",
    "description": "Apply now for the NVIDIA Software Intern - Server Firmware Manageability internship in Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function NvidiaSoftwareInternServerFirmwareManageabilityInternshipSantaClaraPage() {
