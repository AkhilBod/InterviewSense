...
const pageData = {
  ...
  "metaDescription": "Apply now for the Omnidian Software Engineer Internship internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Omnidian internship",
    "Software Engineer Internship internship",
    "Omnidian Software Engineer Internship",
...
export default function OmnidianSoftwareEngineerInternshipInternshipSeattlePage() {
