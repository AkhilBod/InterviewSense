...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ontra-software-engineering-intern-internship-sfbrsanta-barbara",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Ontra Internship: Software Engineering Intern Position in SF</br>Santa Barbara, CA (2025)",
    "description": "Apply now for the Ontra Software Engineering Intern internship in SF</br>Santa Barbara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function OntraSoftwareEngineeringInternInternshipSfbrsantaBarbaraPage() {
