...
const pageData = {
  "slug": "openlane-software-engineer-intern-internship-remote-in-usa",
  "title": "Openlane Internship: Software Engineer – Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Openlane Software Engineer – Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Openlane internship",
    "Software Engineer – Intern internship",
    "Openlane Software Engineer – Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/openlane-software-engineer-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Openlane Internship: Software Engineer – Intern Position in Remote in USA (2025)",
    "description": "Apply now for the Openlane Software Engineer – Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function OpenlaneSoftwareEngineerInternInternshipRemoteInUsaPage() {
