...
const pageData = {
  ...
  "metaDescription": "Apply now for the Palantir Deployment Strategist – Internship internship in Washington, DC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Palantir internship",
    "Deployment Strategist – Internship internship",
    "Palantir Deployment Strategist – Internship",
    "summer 2025 internship",
    "tech internship Washington, DC",
    "software internship",
    "Palantir careers",
...
export default function PalantirDeploymentStrategistInternshipInternshipWashingtonPage() {
