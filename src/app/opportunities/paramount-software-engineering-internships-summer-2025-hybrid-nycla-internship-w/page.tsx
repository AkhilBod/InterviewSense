...
const pageData = {
  ...
  "structuredData": {
    ...
    "jobLocation": {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "West Hollywood, CA</br>Burbank, CA</br>New York, NY"
      }
    },
    ...
    "url": "http://localhost:3000/internships/paramount-software-engineering-internships-summer-2025-hybrid-nycla-internship-w",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Paramount Internship: Software Engineering Internships (Summer 2025, Hybrid - NYC/LA) Position in West Hollywood, CA</br>Burbank, CA</br>New York, NY (2025)",
    "description": "Apply now for the Paramount Software Engineering Internships (Summer 2025, Hybrid - NYC/LA) internship in West Hollywood, CA</br>Burbank, CA</br>New York, NY. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function ParamountSoftwareEngineeringInternshipsSummer2025HybridNyclaInternshipWPage() {
