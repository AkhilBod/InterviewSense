...
const pageData = {
  ...
  "metaDescription": "Apply now for the Parsons Software Engineer Intern internship in Colorado Springs, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Parsons internship",
    "Software Engineer Intern internship",
    "Parsons Software Engineer Intern",
...
export default function ParsonsSoftwareEngineerInternInternshipColoradoSpringsPage() {
