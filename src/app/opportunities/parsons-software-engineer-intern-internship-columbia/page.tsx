...
const pageData = {
  ...
  "metaDescription": "Apply now for the Parsons Software Engineer – Intern internship in Columbia, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Parsons internship",
    "Software Engineer – Intern internship",
    "Parsons Software Engineer – Intern",
    "summer 2025 internship",
    "tech internship Columbia, MD",
    "software internship",
    "Parsons careers",
...
export default function ParsonsSoftwareEngineerInternInternshipColumbiaPage() {
