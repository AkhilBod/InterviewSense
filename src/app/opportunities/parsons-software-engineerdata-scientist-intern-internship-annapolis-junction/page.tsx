...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/parsons-software-engineerdata-scientist-intern-internship-annapolis-junction",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Parsons Internship: Software Engineer/Data Scientist Intern Position in Annapolis Junction, MD (2025)",
    "description": "Apply now for the Parsons Software Engineer/Data Scientist Intern internship in Annapolis Junction, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ParsonsSoftwareEngineerdataScientistInternInternshipAnnapolisJunctionPage() {
