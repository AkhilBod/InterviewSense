...
const pageData = {
  ...
  "metaDescription": "Apply now for the Pavilion Software Engineering Intern internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Pavilion internship",
    "Software Engineering Intern internship",
    "Pavilion Software Engineering Intern",
...
export default function PavilionSoftwareEngineeringInternInternshipSfPage() {
