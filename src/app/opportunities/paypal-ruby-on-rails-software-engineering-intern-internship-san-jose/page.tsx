...
const pageData = {
  "slug": "paypal-ruby-on-rails-software-engineering-intern-internship-san-jose",
  "title": "PayPal Internship: Ruby on Rails Software Engineering Intern Position in San Jose, CA (2025)",
  "metaDescription": "Apply now for the PayPal Ruby on Rails Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
    "PayPal internship",
    "Ruby on Rails Software Engineering Intern internship",
    "PayPal Ruby on Rails Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/paypal-ruby-on-rails-software-engineering-intern-internship-san-jose",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "PayPal Internship: Ruby on Rails Software Engineering Intern Position in San Jose, CA (2025)",
    "description": "Apply now for the PayPal Ruby on Rails Software Engineering Intern internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function PaypalRubyOnRailsSoftwareEngineeringInternInternshipSanJosePage() {
