...
const pageData = {
  "slug": "pluralsight-software-engineering-intern-internship-remote-in-usa",
  "title": "Pluralsight Internship: Software Engineering Intern Position in Remote in USA (2025)",
  "metaDescription": "Apply now for the Pluralsight Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Pluralsight internship",
    "Software Engineering Intern internship",
    "Pluralsight Software Engineering Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/pluralsight-software-engineering-intern-internship-remote-in-usa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Pluralsight Internship: Software Engineering Intern Position in Remote in USA (2025)",
    "description": "Apply now for the Pluralsight Software Engineering Intern internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function PluralsightSoftwareEngineeringInternInternshipRemoteInUsaPage() {
