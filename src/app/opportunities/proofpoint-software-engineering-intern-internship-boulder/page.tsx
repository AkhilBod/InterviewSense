...
const pageData = {
  ...
  "metaDescription": "Apply now for the Proofpoint Software Engineering Intern internship in Boulder, CO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Proofpoint internship",
    "Software Engineering Intern internship",
    "Proofpoint Software Engineering Intern",
...
export default function ProofpointSoftwareEngineeringInternInternshipBoulderPage() {
