...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/rakuten-international-intern-software-engineering-ai-user-experience-internship-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Rakuten International Internship: Intern – Software Engineering - AI User Experience Position in San Mateo, CA (2025)",
    "description": "Apply now for the Rakuten International Intern – Software Engineering - AI User Experience internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RakutenInternationalInternSoftwareEngineeringAiUserExperienceInternshipPage() {
