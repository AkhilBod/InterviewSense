...
const pageData = {
  "slug": "recursion-pharmaceuticals-software-engineering-coop-internship-toronto",
  "title": "Recursion Pharmaceuticals Internship: Software Engineering Co-Op Position in Toronto, ON, Canada (2025)",
  "metaDescription": "Apply now for the Recursion Pharmaceuticals Software Engineering Co-Op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Recursion Pharmaceuticals internship",
    "Software Engineering Co-Op internship",
    "Recursion Pharmaceuticals Software Engineering Co-Op",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/recursion-pharmaceuticals-software-engineering-coop-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Recursion Pharmaceuticals Internship: Software Engineering Co-Op Position in Toronto, ON, Canada (2025)",
    "description": "Apply now for the Recursion Pharmaceuticals Software Engineering Co-Op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RecursionPharmaceuticalsSoftwareEngineeringCoopInternshipTorontoPage() {
