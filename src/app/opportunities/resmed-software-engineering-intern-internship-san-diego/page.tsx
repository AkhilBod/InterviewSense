...
const pageData = {
  ...
  "metaDescription": "Apply now for the Resmed Software Engineering Intern internship in San Diego, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Resmed internship",
    "Software Engineering Intern internship",
    "Resmed Software Engineering Intern",
...
export default function ResmedSoftwareEngineeringInternInternshipSanDiegoPage() {
