...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/ripplematch-rockwell-automation-intern-embedded-software-engineering-internship-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "RippleMatch Internship: Rockwell Automation – Intern - Embedded Software Engineering Position in Eden Prairie, MN (2025)",
    "description": "Apply now for the RippleMatch Rockwell Automation – Intern - Embedded Software Engineering internship in Eden Prairie, MN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RipplematchRockwellAutomationInternEmbeddedSoftwareEngineeringInternshipPage() {
