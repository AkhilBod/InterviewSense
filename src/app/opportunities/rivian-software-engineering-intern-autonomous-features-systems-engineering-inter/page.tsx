...
const pageData = {
  "slug": "rivian-software-engineering-intern-autonomous-features-systems-engineering-inter",
  "title": "Rivian Internship: Software Engineering Intern - Autonomous Features - Systems Engineering Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Rivian Software Engineering Intern - Autonomous Features - Systems Engineering internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Rivian internship",
    "Software Engineering Intern - Autonomous Features - Systems Engineering internship",
    "Rivian Software Engineering Intern - Autonomous Features - Systems Engineering",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/rivian-software-engineering-intern-autonomous-features-systems-engineering-inter",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Rivian Internship: Software Engineering Intern - Autonomous Features - Systems Engineering Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Rivian Software Engineering Intern - Autonomous Features - Systems Engineering internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RivianSoftwareEngineeringInternAutonomousFeaturesSystemsEngineeringInterPage() {
