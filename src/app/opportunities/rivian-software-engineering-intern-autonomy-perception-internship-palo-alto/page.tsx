...
const pageData = {
  "slug": "rivian-software-engineering-intern-autonomy-perception-internship-palo-alto",
  "title": "Rivian Internship: Software Engineering Intern - Autonomy - Perception Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Rivian Software Engineering Intern - Autonomy - Perception internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Rivian internship",
    "Software Engineering Intern - Autonomy - Perception internship",
    "Rivian Software Engineering Intern - Autonomy - Perception",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/rivian-software-engineering-intern-autonomy-perception-internship-palo-alto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Rivian Internship: Software Engineering Intern - Autonomy - Perception Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Rivian Software Engineering Intern - Autonomy - Perception internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RivianSoftwareEngineeringInternAutonomyPerceptionInternshipPaloAltoPage() {
