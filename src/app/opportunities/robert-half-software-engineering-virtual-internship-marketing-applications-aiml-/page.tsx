...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/robert-half-software-engineering-virtual-internship-marketing-applications-aiml-",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Robert Half Internship: Software Engineering Virtual Internship - Marketing Applications & AI/ML Position in Remote in USA (2025)",
    "description": "Apply now for the Robert Half Software Engineering Virtual Internship - Marketing Applications & AI/ML internship in Remote in USA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RobertHalfSoftwareEngineeringVirtualInternshipMarketingApplicationsAimlPage() {
