...
const pageData = {
  "slug": "rokt-software-engineering-summer-internship-internship-seattle",
  "title": "Rokt Internship: Software Engineering Summer Internship Position in Seattle, WA (2025)",
  "metaDescription": "Apply now for the Rokt Software Engineering Summer Internship internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Rokt internship",
    "Software Engineering Summer Internship internship",
    "Rokt Software Engineering Summer Internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/rokt-software-engineering-summer-internship-internship-seattle",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Rokt Internship: Software Engineering Summer Internship Position in Seattle, WA (2025)",
    "description": "Apply now for the Rokt Software Engineering Summer Internship internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RoktSoftwareEngineeringSummerInternshipInternshipSeattlePage() {
