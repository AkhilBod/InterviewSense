...
const pageData = {
  "slug": "roku-software-engineer-intern-automatic-speech-recognition-internship-cambridge",
  "title": "Roku Internship: Software Engineer Intern - Automatic Speech Recognition Position in Cambridge, UK (2025)",
  "metaDescription": "Apply now for the Roku Software Engineer Intern - Automatic Speech Recognition internship in Cambridge, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Roku internship",
    "Software Engineer Intern - Automatic Speech Recognition internship",
    "Roku Software Engineer Intern - Automatic Speech Recognition",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/roku-software-engineer-intern-automatic-speech-recognition-internship-cambridge",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Roku Internship: Software Engineer Intern - Automatic Speech Recognition Position in Cambridge, UK (2025)",
    "description": "Apply now for the Roku Software Engineer Intern - Automatic Speech Recognition internship in Cambridge, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function RokuSoftwareEngineerInternAutomaticSpeechRecognitionInternshipCambridgePage() {
