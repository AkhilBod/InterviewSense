...
const pageData = {
  ...
  "metaDescription": "Apply now for the Roku Software Engineer Intern internship in Manchester, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Roku internship",
...
export default function RokuSoftwareEngineerInternInternshipManchesterPage() {
