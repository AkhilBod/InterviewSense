...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/salesforce-intern-ai-scientist-internship-cambridge",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Salesforce Internship: Intern - AI Scientist Position in Cambridge, MA</br>SF (2025)",
    "description": "Apply now for the Salesforce Intern - AI Scientist internship in Cambridge, MA</br>SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SalesforceInternAiScientistInternshipCambridgePage() {
