...
const pageData = {
  "slug": "schonfeld-software-engineering-summer-intern-internship-nyc",
  "title": "Schonfeld Internship: Software Engineering Summer Intern Position in NYC (2025)",
  "metaDescription": "Apply now for the Schonfeld Software Engineering Summer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Schonfeld internship",
    "Software Engineering Summer Intern internship",
    "Schonfeld Software Engineering Summer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/schonfeld-software-engineering-summer-intern-internship-nyc",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Schonfeld Internship: Software Engineering Summer Intern Position in NYC (2025)",
    "description": "Apply now for the Schonfeld Software Engineering Summer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SchonfeldSoftwareEngineeringSummerInternInternshipNycPage() {
