...
const pageData = {
  ...
  "metaDescription": "Apply now for the Schoolhouse.world Software Engineer Intern internship in Remote. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Schoolhouse.world internship",
    "Software Engineer Intern internship",
    "Schoolhouse.world Software Engineer Intern",
    "summer 2025 internship",
    "tech internship Remote",
    "software internship",
    "Schoolhouse.world careers",
...
export default function SchoolhouseworldSoftwareEngineerInternInternshipRemotePage() {
