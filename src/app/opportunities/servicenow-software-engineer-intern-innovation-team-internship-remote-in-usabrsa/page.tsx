...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/servicenow-software-engineer-intern-innovation-team-internship-remote-in-usabrsa",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "ServiceNow Internship: Software Engineer Intern - Innovation Team Position in Remote in USA</br>Santa Clara, CA (2025)",
    "description": "Apply now for the ServiceNow Software Engineer Intern - Innovation Team internship in Remote in USA</br>Santa Clara, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ServicenowSoftwareEngineerInternInnovationTeamInternshipRemoteInUsabrsaPage() {
