...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/sharkninja-software-engineering-intern-internship-goodlettsville",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "SharkNinja Internship: Software Engineering Intern Position in Goodlettsville, TN (2025)",
    "description": "Apply now for the SharkNinja Software Engineering Intern internship in Goodlettsville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SharkninjaSoftwareEngineeringInternInternshipGoodlettsvillePage() {
