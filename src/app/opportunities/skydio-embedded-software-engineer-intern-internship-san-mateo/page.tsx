...
const pageData = {
  "slug": "skydio-embedded-software-engineer-intern-internship-san-mateo",
  "title": "Skydio Internship: Embedded Software Engineer Intern Position in San Mateo, CA (2025)",
  "metaDescription": "Apply now for the Skydio Embedded Software Engineer Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Skydio internship",
    "Embedded Software Engineer Intern internship",
    "Skydio Embedded Software Engineer Intern",
    "summer 2025 internship",
    "tech internship San Mateo, CA",
    "hardware internship",
    "Skydio careers",
    "internship application",
    "tech jobs 2025",
    "San Mateo internship",
    "Skydio San Mateo",
    "CA internship",
    "Skydio CA",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/skydio-embedded-software-engineer-intern-internship-san-mateo",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Skydio Internship: Embedded Software Engineer Intern Position in San Mateo, CA (2025)",
    "description": "Apply now for the Skydio Embedded Software Engineer Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SkydioEmbeddedSoftwareEngineerInternInternshipSanMateoPage() {
