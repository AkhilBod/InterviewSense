...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/snorkel-ai-software-engineer-summer-intern-internship-sfbrsan-carlos",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Snorkel AI Internship: Software Engineer – Summer Intern Position in SF</br>San Carlos, CA (2025)",
    "description": "Apply now for the Snorkel AI Software Engineer – Summer Intern internship in SF</br>San Carlos, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SnorkelAiSoftwareEngineerSummerInternInternshipSfbrsanCarlosPage() {
