...
const pageData = {
  ...
  "metaDescription": "Apply now for the SoFi Intern – Software Engineer internship in SF. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "SoFi internship",
    "Intern – Software Engineer internship",
    "SoFi Intern – Software Engineer",
...
export default function SofiInternSoftwareEngineerInternshipSfPage() {
