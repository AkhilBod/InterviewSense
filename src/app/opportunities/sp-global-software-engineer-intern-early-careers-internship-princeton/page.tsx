...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/sp-global-software-engineer-intern-early-careers-internship-princeton",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "S&P Global Internship: Software Engineer Intern - Early Careers Position in Princeton, NJ (2025)",
    "description": "Apply now for the S&P Global Software Engineer Intern - Early Careers internship in Princeton, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SpGlobalSoftwareEngineerInternEarlyCareersInternshipPrincetonPage() {
