...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/spark-climate-solutions-ai-software-engineer-intern-internship-belmont",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Spark Climate Solutions Internship: AI Software Engineer Intern Position in Belmont, MA (2025)",
    "description": "Apply now for the Spark Climate Solutions AI Software Engineer Intern internship in Belmont, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function SparkClimateSolutionsAiSoftwareEngineerInternInternshipBelmontPage() {
