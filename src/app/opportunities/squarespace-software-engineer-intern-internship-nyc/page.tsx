...
const pageData = {
  ...
  "metaDescription": "Apply now for the Squarespace Software Engineer Intern internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Squarespace internship",
    "Software Engineer Intern internship",
    "Squarespace Software Engineer Intern",
...
export default function SquarespaceSoftwareEngineerInternInternshipNycPage() {
