...
const pageData = {
  "slug": "staples-software-engineering-intern-quill-hybrid-internship-lincolnshire",
  "title": "Staples Internship: Software Engineering Intern (Quill - Hybrid) Position in Lincolnshire, IL (2025)",
  "metaDescription": "Apply now for the Staples Software Engineering Intern (Quill - Hybrid) internship in Lincolnshire, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Staples internship",
    "Software Engineering Intern (Quill - Hybrid) internship",
    "Staples Software Engineering Intern (Quill - Hybrid)",
    "summer 2025 internship",
    "tech internship Lincolnshire, IL",
    "software internship",
    "Staples careers",
    "internship application",
    "tech jobs 2025",
    "Lincolnshire internship",
  ...
  "structuredData": {
    ...
    "jobLocation": {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Lincolnshire, IL"
      }
    },
    ...
    "url": "http://localhost:3000/internships/staples-software-engineering-intern-quill-hybrid-internship-lincolnshire",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Staples Internship: Software Engineering Intern (Quill - Hybrid) Position in Lincolnshire, IL (2025)",
    "description": "Apply now for the Staples Software Engineering Intern (Quill - Hybrid) internship in Lincolnshire, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function StaplesSoftwareEngineeringInternQuillHybridInternshipLincolnshirePage() {
