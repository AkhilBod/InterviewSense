...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/story-protocol-software-engineer-intern-internship-san-mateo",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Story Protocol Internship: Software Engineer Intern Position in San Mateo, CA (2025)",
    "description": "Apply now for the Story Protocol Software Engineer Intern internship in San Mateo, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function StoryProtocolSoftwareEngineerInternInternshipSanMateoPage() {
