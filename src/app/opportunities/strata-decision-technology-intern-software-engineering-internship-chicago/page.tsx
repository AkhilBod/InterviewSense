...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/strata-decision-technology-intern-software-engineering-internship-chicago",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Strata Decision Technology Internship: Intern – Software Engineering Position in Chicago, IL</br>St. Louis, MO (2025)",
    "description": "Apply now for the Strata Decision Technology Intern – Software Engineering internship in Chicago, IL</br>St. Louis, MO. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function StrataDecisionTechnologyInternSoftwareEngineeringInternshipChicagoPage() {
