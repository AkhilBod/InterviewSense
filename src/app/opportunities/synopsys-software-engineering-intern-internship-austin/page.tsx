...
const pageData = {
  ...
  "metaDescription": "Apply now for the Synopsys Software Engineering Intern internship in Austin, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Synopsys internship",
...
export default function SynopsysSoftwareEngineeringInternInternshipAustinPage() {
