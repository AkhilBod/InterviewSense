...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/t-rowe-price-software-engineering-internship-program-internship-owings-mills",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "T. Rowe Price Internship: Software Engineering Internship Program Position in Owings Mills, MD</br>Baltimore, MD (2025)",
    "description": "Apply now for the T. Rowe Price Software Engineering Internship Program internship in Owings Mills, MD</br>Baltimore, MD. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TRowePriceSoftwareEngineeringInternshipProgramInternshipOwingsMillsPage() {
