...
const pageData = {
  ...
  "metaDescription": "Apply now for the Talkdesk Software Engineer Intern internship in Seattle, WA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Talkdesk internship",
    "Software Engineer Intern internship",
    "Talkdesk Software Engineer Intern",
...
export default function TalkdeskSoftwareEngineerInternInternshipSeattlePage() {
