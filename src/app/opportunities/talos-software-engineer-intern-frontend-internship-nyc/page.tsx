...
const pageData = {
  "slug": "talos-software-engineer-intern-frontend-internship-nyc",
  "title": "Talos Internship: Software Engineer Intern - Front-End Position in NYC (2025)",
  "metaDescription": "Apply now for the Talos Software Engineer Intern - Front-End internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
    "Talos internship",
    "Software Engineer Intern - Front-End internship",
    "Talos Software Engineer Intern - Front-End",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/talos-software-engineer-intern-frontend-internship-nyc",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Talos Internship: Software Engineer Intern - Front-End Position in NYC (2025)",
    "description": "Apply now for the Talos Software Engineer Intern - Front-End internship in NYC. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function TalosSoftwareEngineerInternFrontendInternshipNycPage() {
