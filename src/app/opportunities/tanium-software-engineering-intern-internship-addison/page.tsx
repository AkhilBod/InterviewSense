...
const pageData = {
  "slug": "tanium-software-engineering-intern-internship-addison",
  "title": "Tanium Internship: Software Engineering Intern Position in Addison, TX (2025)",
  "metaDescription": "Apply now for the Tanium Software Engineering Intern internship in Addison, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
  "keywords": [
    "Tanium internship",
    "Software Engineering Intern internship",
    "Tanium Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Addison, TX",
    "software internship",
    "Tanium careers",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tanium-software-engineering-intern-internship-addison",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tanium Internship: Software Engineering Intern Position in Addison, TX (2025)",
    "description": "Apply now for the Tanium Software Engineering Intern internship in Addison, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship (No sponsorship).",
...
export default function TaniumSoftwareEngineeringInternInternshipAddisonPage() {
