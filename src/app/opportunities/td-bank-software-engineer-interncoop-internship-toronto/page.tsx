...
const pageData = {
  "slug": "td-bank-software-engineer-interncoop-internship-toronto",
  "title": "TD Bank Internship: Software Engineer Intern/Co-op Position in Toronto, ON, Canada (2025)",
  "metaDescription": "Apply now for the TD Bank Software Engineer Intern/Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "TD Bank internship",
    "Software Engineer Intern/Co-op internship",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/td-bank-software-engineer-interncoop-internship-toronto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "TD Bank Internship: Software Engineer Intern/Co-op Position in Toronto, ON, Canada (2025)",
    "description": "Apply now for the TD Bank Software Engineer Intern/Co-op internship in Toronto, ON, Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TdBankSoftwareEngineerInterncoopInternshipTorontoPage() {
