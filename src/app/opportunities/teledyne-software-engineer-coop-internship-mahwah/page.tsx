...
const pageData = {
  ...
  "metaDescription": "Apply now for the Teledyne Software Engineer Co-op internship in Mahwah, NJ. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Teledyne internship",
    "Software Engineer Co-op internship",
    "Teledyne Software Engineer Co-op",
    "summer 2025 internship",
    "tech internship Mahwah, NJ",
    "software internship",
    "Teledyne careers",
...
export default function TeledyneSoftwareEngineerCoopInternshipMahwahPage() {
