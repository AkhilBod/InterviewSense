...
const pageData = {
  "slug": "tempus-software-engineering-summer-analyst-testing-pipeline-internship-chicago",
  "title": "Tempus Internship: Software Engineering Summer Analyst - Testing Pipeline Position in Chicago, IL (2025)",
  "metaDescription": "Apply now for the Tempus Software Engineering Summer Analyst - Testing Pipeline internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tempus internship",
    "Software Engineering Summer Analyst - Testing Pipeline internship",
    "Tempus Software Engineering Summer Analyst - Testing Pipeline",
    "summer 2025 internship",
    "tech internship Chicago, IL",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tempus-software-engineering-summer-analyst-testing-pipeline-internship-chicago",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tempus Internship: Software Engineering Summer Analyst - Testing Pipeline Position in Chicago, IL (2025)",
    "description": "Apply now for the Tempus Software Engineering Summer Analyst - Testing Pipeline internship in Chicago, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TempusSoftwareEngineeringSummerAnalystTestingPipelineInternshipChicagoPage() {
