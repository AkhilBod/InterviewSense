...
const pageData = {
  "slug": "tesla-internship-fullstack-c-engineer-vehicle-user-interface-internship-palo-alt",
  "title": "Tesla Internship: Internship, Fullstack C++ Engineer, Vehicle User Interface Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Tesla Internship, Fullstack C++ Engineer, Vehicle User Interface internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tesla internship",
    "Internship, Fullstack C++ Engineer, Vehicle User Interface internship",
    "Tesla Internship, Fullstack C++ Engineer, Vehicle User Interface",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tesla-internship-fullstack-c-engineer-vehicle-user-interface-internship-palo-alt",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tesla Internship: Internship, Fullstack C++ Engineer, Vehicle User Interface Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Tesla Internship, Fullstack C++ Engineer, Vehicle User Interface internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TeslaInternshipFullstackCEngineerVehicleUserInterfaceInternshipPaloAltPage() {
