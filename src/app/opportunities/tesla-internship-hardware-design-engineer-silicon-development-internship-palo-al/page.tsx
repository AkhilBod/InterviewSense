...
const pageData = {
  "slug": "tesla-internship-hardware-design-engineer-silicon-development-internship-palo-al",
  "title": "Tesla Internship: Internship - Hardware Design Engineer - Silicon Development Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Tesla Internship - Hardware Design Engineer - Silicon Development internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tesla internship",
    "Internship - Hardware Design Engineer - Silicon Development internship",
    "Tesla Internship - Hardware Design Engineer - Silicon Development",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tesla-internship-hardware-design-engineer-silicon-development-internship-palo-al",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tesla Internship: Internship - Hardware Design Engineer - Silicon Development Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Tesla Internship - Hardware Design Engineer - Silicon Development internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TeslaInternshipHardwareDesignEngineerSiliconDevelopmentInternshipPaloAlPage() {
