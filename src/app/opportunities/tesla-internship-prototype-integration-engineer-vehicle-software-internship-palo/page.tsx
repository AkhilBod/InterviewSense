...
const pageData = {
  "slug": "tesla-internship-prototype-integration-engineer-vehicle-software-internship-palo",
  "title": "Tesla Internship: Internship - Prototype Integration Engineer - Vehicle Software Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Tesla Internship - Prototype Integration Engineer - Vehicle Software internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tesla internship",
    "Internship - Prototype Integration Engineer - Vehicle Software internship",
    "Tesla Internship - Prototype Integration Engineer - Vehicle Software",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tesla-internship-prototype-integration-engineer-vehicle-software-internship-palo",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tesla Internship: Internship - Prototype Integration Engineer - Vehicle Software Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Tesla Internship - Prototype Integration Engineer - Vehicle Software internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TeslaInternshipPrototypeIntegrationEngineerVehicleSoftwareInternshipPaloPage() {
