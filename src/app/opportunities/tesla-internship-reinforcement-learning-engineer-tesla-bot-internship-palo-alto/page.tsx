...
const pageData = {
  "slug": "tesla-internship-reinforcement-learning-engineer-tesla-bot-internship-palo-alto",
  "title": "Tesla Internship: Internship, Reinforcement Learning Engineer, Tesla Bot Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Tesla Internship, Reinforcement Learning Engineer, Tesla Bot internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tesla internship",
    "Internship, Reinforcement Learning Engineer, Tesla Bot internship",
    "Tesla Internship, Reinforcement Learning Engineer, Tesla Bot",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tesla-internship-reinforcement-learning-engineer-tesla-bot-internship-palo-alto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tesla Internship: Internship, Reinforcement Learning Engineer, Tesla Bot Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Tesla Internship, Reinforcement Learning Engineer, Tesla Bot internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TeslaInternshipReinforcementLearningEngineerTeslaBotInternshipPaloAltoPage() {
