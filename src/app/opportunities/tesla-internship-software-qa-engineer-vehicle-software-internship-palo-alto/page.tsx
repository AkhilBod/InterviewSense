...
const pageData = {
  "slug": "tesla-internship-software-qa-engineer-vehicle-software-internship-palo-alto",
  "title": "Tesla Internship: Internship, Software QA Engineer, Vehicle Software Position in Palo Alto, CA (2025)",
  "metaDescription": "Apply now for the Tesla Internship, Software QA Engineer, Vehicle Software internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tesla internship",
    "Internship, Software QA Engineer, Vehicle Software internship",
    "Tesla Internship, Software QA Engineer, Vehicle Software",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tesla-internship-software-qa-engineer-vehicle-software-internship-palo-alto",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tesla Internship: Internship, Software QA Engineer, Vehicle Software Position in Palo Alto, CA (2025)",
    "description": "Apply now for the Tesla Internship, Software QA Engineer, Vehicle Software internship in Palo Alto, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TeslaInternshipSoftwareQaEngineerVehicleSoftwareInternshipPaloAltoPage() {
