...
const pageData = {
  "slug": "tombras-software-engineer-intern-internship-knoxville",
  "title": "Tombras Internship: Software Engineer Intern Position in Knoxville, TN (2025)",
  "metaDescription": "Apply now for the Tombras Software Engineer Intern internship in Knoxville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Tombras internship",
    "Software Engineer Intern internship",
    "Tombras Software Engineer Intern",
    "summer 2025 internship",
    "tech internship Knoxville, TN",
    "software internship",
    "Tombras careers",
    "internship application",
    "tech jobs 2025",
    "Knoxville internship",
    "Tombras Knoxville",
    "TN internship",
    "Tombras TN",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/tombras-software-engineer-intern-internship-knoxville",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Tombras Internship: Software Engineer Intern Position in Knoxville, TN (2025)",
    "description": "Apply now for the Tombras Software Engineer Intern internship in Knoxville, TN. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TombrasSoftwareEngineerInternInternshipKnoxvillePage() {
