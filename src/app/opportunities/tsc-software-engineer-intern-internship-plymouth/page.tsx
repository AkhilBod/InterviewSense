...
const pageData = {
  ...
  "metaDescription": "Apply now for the TSC Software Engineer – Intern internship in Plymouth, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "TSC internship",
    "Software Engineer – Intern internship",
    "TSC Software Engineer – Intern",
    "summer 2025 internship",
    "tech internship Plymouth, MA",
    "software internship",
    "TSC careers",
...
export default function TscSoftwareEngineerInternInternshipPlymouthPage() {
