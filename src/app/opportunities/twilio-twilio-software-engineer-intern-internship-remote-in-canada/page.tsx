...
const pageData = {
  "slug": "twilio-twilio-software-engineer-intern-internship-remote-in-canada",
  "title": "Twilio Internship: Twilio Software Engineer Intern Position in Remote in Canada (2025)",
  "metaDescription": "Apply now for the Twilio Twilio Software Engineer Intern internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Twilio internship",
    "Twilio Software Engineer Intern internship",
    "Twilio Twilio Software Engineer Intern",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/twilio-twilio-software-engineer-intern-internship-remote-in-canada",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Twilio Internship: Twilio Software Engineer Intern Position in Remote in Canada (2025)",
    "description": "Apply now for the Twilio Twilio Software Engineer Intern internship in Remote in Canada. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function TwilioTwilioSoftwareEngineerInternInternshipRemoteInCanadaPage() {
