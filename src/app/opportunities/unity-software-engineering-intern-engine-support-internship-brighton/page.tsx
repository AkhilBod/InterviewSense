...
const pageData = {
  "slug": "unity-software-engineering-intern-engine-support-internship-brighton",
  "title": "Unity Internship: Software Engineering Intern - Engine Support Position in Brighton, UK (2025)",
  "metaDescription": "Apply now for the Unity Software Engineering Intern - Engine Support internship in Brighton, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Unity internship",
    "Software Engineering Intern - Engine Support internship",
    "Unity Software Engineering Intern - Engine Support",
    "summer 2025 internship",
    "tech internship Brighton, UK",
    "software internship",
    "Unity careers",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/unity-software-engineering-intern-engine-support-internship-brighton",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Unity Internship: Software Engineering Intern - Engine Support Position in Brighton, UK (2025)",
    "description": "Apply now for the Unity Software Engineering Intern - Engine Support internship in Brighton, UK. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function UnitySoftwareEngineeringInternEngineSupportInternshipBrightonPage() {
