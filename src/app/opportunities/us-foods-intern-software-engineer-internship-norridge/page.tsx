...
const pageData = {
  ...
  "metaDescription": "Apply now for the US Foods Intern – Software Engineer internship in Norridge, IL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "US Foods internship",
    "Intern – Software Engineer internship",
    "US Foods Intern – Software Engineer",
    "summer 2025 internship",
    "tech internship Norridge, IL",
    "software internship",
    "US Foods careers",
...
export default function UsFoodsInternSoftwareEngineerInternshipNorridgePage() {
