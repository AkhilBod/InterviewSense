...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/verizon-communications-software-engineering-engr-i-network-engrg-internship-irvi",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Verizon Communications Internship: Software Engineering - Engr I - Network Engrg Position in Irvine, CA</br>Irving, TX (2025)",
    "description": "Apply now for the Verizon Communications Software Engineering - Engr I - Network Engrg internship in Irvine, CA</br>Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function VerizonCommunicationsSoftwareEngineeringEngrINetworkEngrgInternshipIrviPage() {
