...
const pageData = {
  "slug": "verizon-communications-thrive-apprentice-software-engineering-sre-internship-irv",
  "title": "Verizon Communications Internship: Thrive Apprentice - Software Engineering - SRE Position in Irving, TX (2025)",
  "metaDescription": "Apply now for the Verizon Communications Thrive Apprentice - Software Engineering - SRE internship in Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Verizon Communications internship",
    "Thrive Apprentice - Software Engineering - SRE internship",
    "Verizon Communications Thrive Apprentice - Software Engineering - SRE",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/verizon-communications-thrive-apprentice-software-engineering-sre-internship-irv",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Verizon Communications Internship: Thrive Apprentice - Software Engineering - SRE Position in Irving, TX (2025)",
    "description": "Apply now for the Verizon Communications Thrive Apprentice - Software Engineering - SRE internship in Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function VerizonCommunicationsThriveApprenticeSoftwareEngineeringSreInternshipIrvPage() {
