...
const pageData = {
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/verizon-communications-thrive-apprentice-software-engineering-tech-project-manag",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Verizon Communications Internship: Thrive Apprentice - Software Engineering - Tech Project Management Position in E Fowler Ave, Tampa, FL (2025)",
    "description": "Apply now for the Verizon Communications Thrive Apprentice - Software Engineering - Tech Project Management internship in E Fowler Ave, Tampa, FL. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function VerizonCommunicationsThriveApprenticeSoftwareEngineeringTechProjectManagPage() {
