...
const pageData = {
  "slug": "vestmark-summer-coop-software-engineer-internship-wakefield",
  "title": "Vestmark Internship: Summer Co-op Software Engineer Position in Wakefield, MA (2025)",
  "metaDescription": "Apply now for the Vestmark Summer Co-op Software Engineer internship in Wakefield, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Vestmark internship",
    "Summer Co-op Software Engineer internship",
    "Vestmark Summer Co-op Software Engineer",
    "summer 2025 internship",
    "tech internship Wakefield, MA",
    "software internship",
    "Vestmark careers",
    "internship application",
    "tech jobs 2025",
    "Wakefield internship",
    "Vestmark Wakefield",
    "MA internship",
    "Vestmark MA",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/vestmark-summer-coop-software-engineer-internship-wakefield",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Vestmark Internship: Summer Co-op Software Engineer Position in Wakefield, MA (2025)",
    "description": "Apply now for the Vestmark Summer Co-op Software Engineer internship in Wakefield, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function VestmarkSummerCoopSoftwareEngineerInternshipWakefieldPage() {
