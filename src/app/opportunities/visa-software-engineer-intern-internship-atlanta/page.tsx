...
const pageData = {
  ...
  "metaDescription": "Apply now for the Visa Software Engineer Intern internship in Atlanta, GA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Visa internship",
...
export default function VisaSoftwareEngineerInternInternshipAtlantaPage() {
