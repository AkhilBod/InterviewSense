...
const pageData = {
  "slug": "vizient-summer-intern-software-engineering-internship-chicago",
  "title": "Vizient Internship: Summer Intern - Software Engineering Position in Chicago, IL</br>Irving, TX (2025)",
  "metaDescription": "Apply now for the Vizient Summer Intern - Software Engineering internship in Chicago, IL</br>Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Vizient internship",
    "Summer Intern - Software Engineering internship",
    "Vizient Summer Intern - Software Engineering",
    "summer 2025 internship",
    "tech internship Chicago, IL</br>Irving, TX",
    "software internship",
    "Vizient careers",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/vizient-summer-intern-software-engineering-internship-chicago",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Vizient Internship: Summer Intern - Software Engineering Position in Chicago, IL</br>Irving, TX (2025)",
    "description": "Apply now for the Vizient Summer Intern - Software Engineering internship in Chicago, IL</br>Irving, TX. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function VizientSummerInternSoftwareEngineeringInternshipChicagoPage() {
