...
const pageData = {
  ...
  "metaDescription": "Apply now for the Wayfair Software Engineering Co-op internship in Boston, MA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Wayfair internship",
    "Software Engineering Co-op internship",
    "Wayfair Software Engineering Co-op",
...
export default function WayfairSoftwareEngineeringCoopInternshipBostonPage() {
