...
const pageData = {
  ...
  "metaDescription": "Apply now for the Wisk Software Engineering Intern internship in Mountain View, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Wisk internship",
    "Software Engineering Intern internship",
    "Wisk Software Engineering Intern",
...
export default function WiskSoftwareEngineeringInternInternshipMountainViewPage() {
