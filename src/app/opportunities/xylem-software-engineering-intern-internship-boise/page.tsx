...
const pageData = {
  ...
  "metaDescription": "Apply now for the Xylem Software Engineering Intern internship in Boise, ID. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Xylem internship",
    "Software Engineering Intern internship",
    "Xylem Software Engineering Intern",
    "summer 2025 internship",
    "tech internship Boise, ID",
    "software internship",
    "Xylem careers",
...
export default function XylemSoftwareEngineeringInternInternshipBoisePage() {
