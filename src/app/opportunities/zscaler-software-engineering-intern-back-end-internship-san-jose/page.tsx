...
const pageData = {
  "slug": "zscaler-software-engineering-intern-back-end-internship-san-jose",
  "title": "Zscaler Internship: Software Engineering Intern - Back End Position in San Jose, CA (2025)",
  "metaDescription": "Apply now for the Zscaler Software Engineering Intern - Back End internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
  "keywords": [
    "Zscaler internship",
    "Software Engineering Intern - Back End internship",
    "Zscaler Software Engineering Intern - Back End",
  ...
  "structuredData": {
    ...
    "url": "http://localhost:3000/internships/zscaler-software-engineering-intern-back-end-internship-san-jose",
    "applicationDeadline": "Applications accepted on rolling basis"
  },
  "openGraph": {
    "title": "Zscaler Internship: Software Engineering Intern - Back End Position in San Jose, CA (2025)",
    "description": "Apply now for the Zscaler Software Engineering Intern - Back End internship in San Jose, CA. Learn about requirements, application process, and tips for landing this Summer 2025 tech internship.",
...
export default function ZscalerSoftwareEngineeringInternBackEndInternshipSanJosePage() {
