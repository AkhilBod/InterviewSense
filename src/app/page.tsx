            ...
            <Card className="bg-zinc-800/50 border-zinc-700/50 backdrop-blur-sm hover:shadow-blue-500/5 hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-zinc-300 mb-8 text-lg">
                  ...
                  felt so much more confident in my technical interview and landed my dream job at Google as a Senior Software Engineer.
                </p>
                <div className="flex items-center">
                  <div>
                    <p className="font-medium text-white">Ethan Gray</p>
                    <p className="text-sm text-zinc-400">Senior Software Engineer at Google</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zinc-800/50 border-zinc-700/50 backdrop-blur-sm hover:shadow-blue-500/5 hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-zinc-300 mb-8 text-lg">
                  ...
                  asked follow-up questions just like a real interviewer would. This helped me secure my internship at Microsoft.
                </p>
                <div className="flex items-center">
                  <div>
                    <p className="font-medium text-white">Akhil B</p>
                    <p className="text-sm text-zinc-400">Software Engineer Intern at Microsoft</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zinc-800/50 border-zinc-700/50 backdrop-blur-sm hover:shadow-blue-500/5 hover:shadow-lg transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-zinc-300 mb-8 text-lg">
                  ...
                  for two weeks before my Meta interview series, and it helped me stay calm and articulate under pressure.
                </p>
                <div className="flex items-center"> 
                  <div>
                    <p className="font-medium text-white">Justin Li</p>
                    <p className="text-sm text-zinc-400">Full Stack Developer at Meta</p>
                  </div>
                </div>
              </CardContent>
            </Card>
