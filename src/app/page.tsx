  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-zinc-950 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 md:mb-4">Simple, Transparent Pricing</h2>
            <p className="text-base text-zinc-400 max-w-2xl mx-auto">
              Choose the plan that's right for your interview prep journey.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {/* Basic Plan */}
            <Card className="bg-zinc-800/30 border-zinc-700/50 backdrop-blur-sm hover:border-blue-500/50 transition-colors">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-zinc-400 text-sm mt-1">6 credits per week</p>
                  </div>
                  
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">1 Resume Review</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">1 Cover Letter</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">2 Behavioral Interviews</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">Resets every Monday</span>
                    </li>
                  </ul>
            ...
            {/* Plus Plan */}
            <Card className="bg-blue-600/10 border-blue-500/50 backdrop-blur-sm hover:border-blue-500 transition-colors ring-2 ring-blue-500/20 md:scale-105">
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <CardTitle className="text-white text-2xl">Plus</CardTitle>
                  <span className="text-xs font-semibold text-blue-400 bg-blue-500/20 px-2 py-1 rounded">POPULAR</span>
                </div>
                <p className="text-zinc-400 text-sm">For serious interview prep</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-zinc-300 text-sm">Unlimited Reviews</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">Unlimited Interviews</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">Progress Analytics</span>
                    </li>
                  </ul>
            ...
            <Card className="bg-zinc-800/30 border-zinc-700/50 backdrop-blur-sm hover:border-blue-500/50 transition-colors">
              <CardHeader>
                ...
                <p className="text-zinc-400 text-sm">For maximum growth</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">Everything in Plus</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">System Design Prep</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">Portfolio Review</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-zinc-300 text-sm">1-on-1 Guidance</span>
                    </li>
                  </ul>
          ...
          <div className="text-center mt-12">
            <p className="text-zinc-400 text-sm">
              All plans include access to core features. Billing is handled securely through Stripe.
            </p>
          </div>
        </div>
      </section>
