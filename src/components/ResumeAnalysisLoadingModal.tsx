...
const analysisSteps: AnalysisStep[] = [
  {
    ...
    duration: 3000,
    color: "text-blue-400",
    tip: "Our AI has been trained on thousands of successful resumes from top companies"
  },
  {
    id: 2,
    icon: Brain,
    ...
    tip: "We're checking for quantifiable achievements and impact statements"
  },
  {
    id: 3,
    icon: Target,
    ...
    tip: "Matching your profile to what hiring managers actually look for"
  },
  {
    id: 4,
    icon: Sparkles,
    ...
    tip: "Discovering opportunities to make your achievements more compelling"
  },
  {
    id: 5,
    icon: TrendingUp,
    ...
    tip: "Scoring based on standards from Google, Apple, Microsoft, and other top companies"
  },
  {
    id: 6,
    icon: Shield,
    ...
    tip: "Making sure your resume gets seen by human recruiters, not filtered out"
  }
];
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6 text-center">
            ...
            <p className="text-slate-400 text-lg">
              Our AI is performing a comprehensive analysis to help you stand out
            </p>
          </div>
