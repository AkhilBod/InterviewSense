...
export async function sendAbandonedCheckoutEmail(email: string, name: string) {
  try {
    console.log('Sending abandoned checkout email to:', email);
      ...
      html: `
        ...
        <head>
          ...
          <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .feature-icon { margin-right: 12px; font-size: 18px; min-width: 24px; text-align: center; }
        ...
        <body>
          <div class="container">
            ...
            <div class="button-container">
              <a href="${process.env.NEXT_PUBLIC_APP_URL}/pricing" class="button">Complete Your Setup</a>
    ...
    console.log('Abandoned checkout email sent');
  } catch (error) {
